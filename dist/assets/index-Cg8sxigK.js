(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();let Gt=new Date,Ze=[],je=[],Ne=[],Qa=[],da=[],at=[],_e=[],Pt=[],Ct=[],xs=!1,Ta=[],Ot=[],de=[];window.att_multiSelectMode=!1;window.att_selectedDates=new Set;window.att_selectedCategories=new Set;window.att_selectedGroups=new Set;function hn(e){let t=e.target_group_ids||[];if(t.length===0&&e.target_group_id&&(t=[e.target_group_id]),t.length===0)return{ids:[],name:"全体",color:"#e5e7eb"};const n=je.filter(a=>t.includes(a.id));return n.length===0?{ids:[],name:"全体",color:"#e5e7eb"}:{ids:t,name:n.map(a=>a.name).join(", "),color:n[0].color||"#e5e7eb",groups:n}}function Ws(e){return e.ids.length===0?'<span class="text-xs border border-gray-300 text-gray-800 px-2 py-0.5 rounded shadow-sm" style="background-color: #e5e7eb">全体</span>':e.groups.map(t=>`<span class="text-xs border border-gray-300 text-gray-800 px-2 py-0.5 rounded shadow-sm" style="background-color: ${t.color||"#e5e7eb"}">${t.name}</span>`).join(" ")}function zs(e){if(!e)return"-";try{const t=new Date(e);if(isNaN(t.getTime()))return"-";const n=t.getMonth()+1,a=t.getDate(),s=String(t.getHours()).padStart(2,"0"),r=String(t.getMinutes()).padStart(2,"0");return`${n}/${a} ${s}:${r}`}catch{return"-"}}async function Ca(){try{xs||(Pr(),xs=!0),await tn(),He(),Or(),Mr()}catch(e){console.error("Attendance App Init Error:",e),typeof qe=="function"&&qe()}}function Pr(){var n,a,s,r,o,i,d,l,c,m,u,f,b,y,p,g,w,x,h,k,L,v,I,E,$;const e=document.getElementById("btn-logout-att");if(e&&!document.getElementById("btn-change-password-att")){const _=document.createElement("button");_.id="btn-change-password-att",_.className="text-xs md:text-sm bg-gray-500 hover:bg-gray-600 text-white px-2 py-1 md:px-3 md:py-1 rounded shadow mr-2 font-bold",_.textContent="パスワード変更",_.onclick=()=>ms(),e.parentNode.insertBefore(_,e)}(n=document.getElementById("tab-calendar"))==null||n.addEventListener("click",()=>vs("calendar")),(a=document.getElementById("tab-list"))==null||a.addEventListener("click",()=>{vs("list"),Lt()}),(s=document.getElementById("cal-prev-month"))==null||s.addEventListener("click",()=>{Gt.setMonth(Gt.getMonth()-1),He()}),(r=document.getElementById("cal-next-month"))==null||r.addEventListener("click",()=>{Gt.setMonth(Gt.getMonth()+1),He()}),(o=document.getElementById("cal-today"))==null||o.addEventListener("click",()=>{Gt=new Date,He()}),(i=document.getElementById("btn-add-event"))==null||i.addEventListener("click",()=>Tn()),(d=document.getElementById("btn-export-events"))==null||d.addEventListener("click",to),(l=document.getElementById("btn-import-events"))==null||l.addEventListener("click",()=>document.getElementById("input-import-events-csv").click()),(c=document.getElementById("btn-import-ics-events"))==null||c.addEventListener("click",()=>document.getElementById("input-import-events-ics").click()),(m=document.getElementById("btn-download-events-sample"))==null||m.addEventListener("click",so),(u=document.getElementById("input-import-events-csv"))==null||u.addEventListener("change",no),(f=document.getElementById("input-import-events-ics"))==null||f.addEventListener("change",oo),(b=document.getElementById("btn-close-ics-modal-x"))==null||b.addEventListener("click",Aa),(y=document.getElementById("btn-close-ics-modal"))==null||y.addEventListener("click",Aa),(p=document.getElementById("btn-execute-ics-import"))==null||p.addEventListener("click",lo),(g=document.getElementById("ics-import-list"))==null||g.addEventListener("change",_=>{if(_.target&&_.target.classList.contains("ics-row-location-select")){const A=_.target,P=A.closest(".ics-row").querySelector(".ics-row-location");A.value&&A.value!=="custom"?P.value=A.value:A.value==="custom"&&(P.value="",P.focus())}});const t=document.getElementById("btn-group-manage");t&&(t.style.display="none"),(w=document.getElementById("btn-toggle-multiselect"))==null||w.addEventListener("click",function(){window.att_multiSelectMode=!window.att_multiSelectMode,window.att_multiSelectMode||window.att_selectedDates.clear(),this.classList.toggle("bg-blue-600",window.att_multiSelectMode),this.classList.toggle("text-white",window.att_multiSelectMode),this.classList.toggle("bg-blue-50",!window.att_multiSelectMode),this.classList.toggle("text-blue-600",!window.att_multiSelectMode),He(),window.att_updateMultiselectBar()}),(x=document.getElementById("btn-cal-filter"))==null||x.addEventListener("click",ws),(h=document.getElementById("btn-cal-filter-clear"))==null||h.addEventListener("click",xa),(k=document.getElementById("btn-list-filter"))==null||k.addEventListener("click",ws),(L=document.getElementById("btn-list-filter-clear"))==null||L.addEventListener("click",xa),(v=document.getElementById("btn-close-filter-modal-x"))==null||v.addEventListener("click",Jn),(I=document.getElementById("btn-close-filter-modal"))==null||I.addEventListener("click",Jn),(E=document.getElementById("btn-apply-filter"))==null||E.addEventListener("click",Rr),($=document.getElementById("btn-filter-clear"))==null||$.addEventListener("click",xa)}function vs(e){const t=document.getElementById("tab-calendar"),n=document.getElementById("tab-list");e==="calendar"?(document.getElementById("calendar-container").classList.remove("hidden"),document.getElementById("list-container").classList.add("hidden"),t.classList.replace("bg-white","bg-green-600"),t.classList.replace("text-green-600","text-white"),n.classList.replace("bg-green-600","bg-white"),n.classList.replace("text-white","text-green-600")):(document.getElementById("calendar-container").classList.add("hidden"),document.getElementById("list-container").classList.remove("hidden"),n.classList.replace("bg-white","bg-green-600"),n.classList.replace("text-green-600","text-white"),t.classList.replace("bg-green-600","bg-white"),t.classList.replace("text-white","text-green-600"))}async function tn(){j("イベント・出欠データ読み込み中...");try{const{data:e}=await S.from("groups").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});e&&(je=e);const{data:t}=await S.from("event_categories").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});t&&t.length>0?Ne=t:Ne=[{id:"1",name:"練習"},{id:"2",name:"試合"},{id:"3",name:"イベント"}];const n=new Date,a=new Date(n.getFullYear(),n.getMonth()-6,1),s=new Date(n.getFullYear(),n.getMonth()+7,1),{data:r}=await S.from("events").select("*").gte("start_time",a.toISOString()).lt("start_time",s.toISOString()).order("start_time");r&&(Ze=r);const{data:o}=await S.from("app_users").select("email, name, attribute_id, can_use_attendance");o&&(Pt=o);const{data:i}=await S.from("user_attributes").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});i&&(Ct=i);try{const{data:c}=await S.from("event_locations").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});c&&(Ot=c)}catch(c){console.warn("event_locations table might not exist yet:",c),Ot=[]}const{data:d}=await S.from("user_groups").select("*");d&&(at=d,U&&(Qa=d.filter(c=>c.user_email===U.email)));let l=[];if(Ze&&Ze.length>0){const c=Ze.map(u=>u.id),{data:m}=await S.from("attendances").select("*").in("event_id",c);m&&(l=m)}_e=l,U&&(da=l.filter(c=>c.user_email===U.email));try{const{data:c}=await S.from("master_data").select("data").eq("key","ATTENDANCE_DELEGATIONS").single();c&&c.data&&U&&(Ta=c.data[U.email]||[])}catch{Ta=[]}}catch(e){console.error("Attendance DB Error:",e)}finally{typeof qe=="function"?qe():F()}}function Or(){const e=document.getElementById("filter-group");e&&(e.innerHTML='<option value="">すべてのグループ</option>'+je.map(t=>`<option value="${t.id}">${t.name}</option>`).join(""))}function Mr(){const e=document.getElementById("filter-category");if(!e)return;const t=e.value;e.innerHTML='<option value="">すべてのカテゴリ</option>'+Ne.map(n=>`<option value="${n.name}">${n.name}</option>`).join(""),Ne.some(n=>n.name===t)&&(e.value=t)}function ws(){const e=document.getElementById("filter-modal-content");if(!e)return;let t="";t+='<div class="mb-5">',t+='<h4 class="text-xs font-bold text-gray-400 tracking-wider uppercase mb-2">カテゴリ（複数選択）</h4>',Ne.length===0?t+='<p class="text-xs text-gray-400">カテゴリが登録されていません</p>':(t+='<div class="grid grid-cols-2 gap-2">',Ne.forEach(a=>{const s=window.att_selectedCategories.has(a.name)?"checked":"";t+=`
    ...
    `,je.length>0&&je.forEach(a=>{const s=window.att_selectedGroups.has(a.id)?"checked":"";t+=`
        ...
        `,d.forEach(m=>{const u=hn(m);u.name,u.color;const f=Ne.find(L=>L.name===m.category),b=(f==null?void 0:f.color)||"#bfdbfe",y=da.find(L=>L.event_id===m.id);let p=y&&y.status?y.status:"未回答";p==="未定"&&(p="保留");const g=qr(m.start_time,m.end_time,m.is_all_day);let w="不明";if(m.created_by){const L=Pt.find(v=>v.email===m.created_by);w=L&&L.name||m.created_by.split("@")[0]}const x=jr(m.created_at),h=m.created_by?`
            ...
            `}),o+="</div>"}),t.innerHTML=o}function Tn(e="",t=null,n=!1,a=null){let s="";t&&(s=t.title.replace(/"/g,"&quot;"),n||(s+=" (コピー)"));const r=!t&&!n;a&&a.length>0?de=[...a]:t?de=[t.start_time.split("T")[0]]:e?de=[e]:de=[new Date().toISOString().split("T")[0]],window.att_modalSelectedDates=de,window.att_isEditingModal=n;const o=t&&t.start_time&&!t.is_all_day?t.start_time.split("T")[1].substring(0,5):r?"12:30":"",i=t&&t.end_time&&!t.is_all_day?t.end_time.split("T")[1].substring(0,5):r?"17:00":"",d=t?t.is_all_day:!1,l=t?t.category:"",c=t?(t.location||"").replace(/"/g,"&quot;"):"",m=t?(t.description||"").replace(/</g,"&lt;").replace(/>/g,"&gt;"):"",u=t?t.requires_attendance:!0,f=t?t.require_detailed_attendance:!1,b=o?o.split(":")[0]:"",y=o?o.split(":")[1]:"",p=i?i.split(":")[0]:"",g=i?i.split(":")[1]:"",w=!c||!Ot.some(T=>(T.url?`${T.name} ${T.url}`:T.name)===c);let x="",h="";if(c){const T=c.match(/(https?:\/\/[^\s\<\>\"]+)/);T?(h=T[0],x=c.replace(h,"").trim()):x=c}const k=!!(t&&t.attendance_deadline&&t.attendance_deadline!==wt(t.start_time.split("T")[0])),L=wt(de[0])?wt(de[0]).split("T")[0]:"",v=t&&t.attendance_deadline?t.attendance_deadline.split("T")[0]:L,I=t&&t.attendance_deadline?t.attendance_deadline.split("T")[1].substring(0,5):"12:00",E=I?I.split(":")[0]:"12",$=I?I.split(":")[1]:"00",_=T=>'<option value="">--</option>'+Array.from({length:24},(M,G)=>String(G).padStart(2,"0")).map(M=>`<option value="${M}" ${M===T?"selected":""}>${M}</option>`).join(""),A=T=>'<option value="">--</option>'+Array.from({length:60},(M,G)=>String(G).padStart(2,"0")).map(M=>`<option value="${M}" ${M===T?"selected":""}>${M}</option>`).join(""),P=t?t.target_group_ids&&t.target_group_ids.length>0?t.target_group_ids:t.target_group_id?[t.target_group_id]:[]:[],D=n?"イベントを編集":t?"イベントを複製":"新規イベント登録",O=`
                ...
                <div class="flex space-x-4 items-end">
                    ...
                    <div id="ev-end-time-container" class="flex-1 ${d?"opacity-50":""}">
                        ...
                        <div class="flex items-center space-x-1 mt-1">
                            ...
                            <span class="font-bold text-gray-500">:</span>
                            <select id="ev-end-time-m" class="w-full border py-1.5 px-1.5 rounded text-xs bg-white" ${d?"disabled":""}>${A(g)}</select>
                        </div>
                    </div>
                ...
                <div class="flex space-x-2 pb-2 mb-2 border-b">
                    ...
                    <div class="w-1/2" id="ev-deadline-container" style="display: ${u?"block":"none"}">
                        ...
                        <div id="ev-deadline-custom-inputs" class="flex items-center space-x-0.5 ${k?"":"hidden"}">
                            ...
                            <span class="font-bold text-gray-500">:</span>
                            <select id="ev-deadline-time-m" class="w-[25%] border py-1.5 px-1 rounded text-xs bg-white">${A($)}</select>
                        </div>
    ...
    </div>`;document.getElementById("attendance-modals").innerHTML=B,Mt(),n||Cn();const C=document.getElementById("ev-group-all"),N=document.querySelectorAll('input[name="ev-group-cb"]');C.addEventListener("change",function(){this.checked&&N.forEach(T=>T.checked=!1)}),N.forEach(T=>{T.addEventListener("change",function(){this.checked&&(C.checked=!1)})})}async function Hr(e=null){var A,P,D,O,q,B;const t=document.getElementById("ev-title").value.trim(),n=document.querySelectorAll('#ev-dates-container input[type="date"]'),a=Array.from(n).map(C=>C.value).filter(Boolean);if(!t)return alert("イベント名は必須です");if(a.length===0)return alert("日付を1つ以上指定してください");const s=document.getElementById("ev-time-h").value,r=document.getElementById("ev-time-m").value;let o="";(s||r)&&(o=`${s||"00"}:${r||"00"}`);const i=document.getElementById("ev-end-time-h").value,d=document.getElementById("ev-end-time-m").value;let l="";(i||d)&&(l=`${i||"00"}:${d||"00"}`);const c=document.getElementById("ev-all-day").checked,m=document.getElementById("ev-category").value,u=document.getElementById("ev-description").value,f=document.getElementById("ev-location-select");let b="";if(f)if(f.value==="custom"){const C=((A=document.getElementById("ev-location-custom-name"))==null?void 0:A.value.trim())||"",N=((P=document.getElementById("ev-location-custom-url"))==null?void 0:P.value.trim())||"";b=N?`${C} ${N}`:C}else b=f.value;const y=document.getElementById("ev-attendance-type").value,p=y!=="none",g=y==="detailed",w=((D=document.getElementById("ev-deadline-custom-cb"))==null?void 0:D.checked)||!1,x=(O=document.getElementById("ev-deadline-date"))==null?void 0:O.value,h=(q=document.getElementById("ev-deadline-time-h"))==null?void 0:q.value,k=(B=document.getElementById("ev-deadline-time-m"))==null?void 0:B.value,L=document.getElementById("ev-group-all").checked;let v=[];L||document.querySelectorAll('input[name="ev-group-cb"]:checked').forEach(C=>v.push(C.value));const I=v.length>0?v[0]:null,E=C=>new Promise(N=>setTimeout(N,C)),$=3;let _=0;for(;_<$;){_++,_>1?(j(`通信リトライ中 (${_-1}/${$-1}回目)...`),await E(1500)):j("イベント保存中...");try{if(e){const C=a[0],N=`${C}T${o||"00:00"}:00`;let T=null;l&&(T=`${C}T${l}:00`);let M=null;p&&(w?x&&h&&k&&(M=`${x}T${h}:${k}:00`):M=wt(C));const G={title:t,category:m,description:u,location:b,start_time:N,end_time:T,is_all_day:c,requires_attendance:p,require_detailed_attendance:g,attendance_deadline:M,target_group_id:I,target_group_ids:v.length>0?v:null},{error:H}=await S.from("events").update(G).eq("id",e);if(H)throw H;await ne("UPDATE_EVENT",`イベント「${t}」を更新しました`)}else{const C=a.map(T=>{const M=`${T}T${o||"00:00"}:00`;let G=null;l&&(G=`${T}T${l}:00`);let H=null;return p&&(w?x&&h&&k&&(H=`${x}T${h}:${k}:00`):H=wt(T)),{title:t,category:m,description:u,location:b,start_time:M,end_time:G,is_all_day:c,requires_attendance:p,require_detailed_attendance:g,attendance_deadline:H,target_group_id:I,target_group_ids:v.length>0?v:null,created_by:U==null?void 0:U.email}}),{error:N}=await S.from("events").insert(C);if(N)throw N;await ne("CREATE_EVENT",`イベント「${t}」を${C.length}件作成しました`)}await tn(),He(),document.getElementById("list-container").classList.contains("hidden")||Lt(),!e&&typeof window.att_clearDateSelection=="function"&&window.att_clearDateSelection(),window.att_closeModal();break}catch(C){console.error(`Save Event Attempt ${_} Error:`,C);const N=C.message==="Load failed"||C.message==="Failed to fetch"||!C.code;if(_<$&&N)continue;{let T=C.message||String(C);C.details&&(T+=`
Details: `+C.details),C.hint&&(T+=`
Hint: `+C.hint),C.code&&(T+=`
Code: `+C.code),alert("保存エラー: "+T+`
（ネットワーク接続をご確認のうえ、再度お試しください）`);break}}}F()}async function Ur(e){if(confirm("このイベントを削除しますか？")){j("イベント削除中...");try{await S.from("events").delete().eq("id",e),await ne("DELETE_EVENT",`イベント(ID:${e})を削除しました`),await tn(),He(),Lt(),window.att_closeModal()}catch(t){console.error(t)}finally{F()}}}function Ks(e,t,n=!1){const a=t.ids.length===0||Qa.some(l=>t.ids.includes(l.group_id)),s=Pt.find(l=>l.email===U.email),r=s?s.can_use_attendance!==!1:!0,o=[];r&&o.push({email:U.email,name:"自分 ( "+((U==null?void 0:U.name)||U.email.split("@")[0])+" )",canAttend:a}),Ta.forEach(l=>{const c=Pt.find(m=>m.email===l);if(c&&c.can_use_attendance!==!1){const m=t.ids.length===0||at.some(u=>t.ids.includes(u.group_id)&&u.user_email===l);o.push({email:l,name:c.name||l.split("@")[0],canAttend:m})}});let i=!1;return{formsHtml:o.map((l,c)=>{if(!l.canAttend)return`<div class="p-3 bg-gray-50 border rounded mb-2">
    ...
    `,k=m.filter(B=>{const C=_e.find(T=>T.event_id===n.id&&T.user_email===B.email),N=(C==null?void 0:C.status)||"未回答";return window.att_statusFilter==="all"?!0:window.att_statusFilter==="answered"?N==="出席"||N==="欠席"||N==="保留"||N==="未定":window.att_statusFilter==="attending"?N==="出席":window.att_statusFilter==="absent"?N==="欠席":window.att_statusFilter==="pending"?N==="保留"||N==="未定":window.att_statusFilter==="unanswered"?N==="未回答"||!N:!0});window.att_statusSortKey||(window.att_statusSortKey="default"),window.att_statusSortOrder||(window.att_statusSortOrder="asc");const L=window.att_statusSortKey,v=window.att_statusSortOrder;L!=="default"&&k.sort((B,C)=>{var M,G;let N,T;if(L==="name")N=B.name||B.email.split("@")[0],T=C.name||C.email.split("@")[0];else if(L==="group")if(u){const H=at.filter(R=>R.user_email===B.email).map(R=>R.group_id);N=je.filter(R=>H.includes(R.id)).map(R=>R.name).join(", ")||"-";const z=at.filter(R=>R.user_email===C.email).map(R=>R.group_id);T=je.filter(R=>z.includes(R.id)).map(R=>R.name).join(", ")||"-"}else N=((M=Ct.find(H=>H.id===B.attribute_id))==null?void 0:M.name)||"-",T=((G=Ct.find(H=>H.id===C.attribute_id))==null?void 0:G.name)||"-";else if(L==="status"){const H=z=>{const R=_e.find(ye=>ye.event_id===n.id&&ye.user_email===z.email),W=(R==null?void 0:R.status)||"未回答";return W==="出席"?1:W==="保留"||W==="未定"?2:W==="未回答"?3:W==="欠席"?4:5};N=H(B),T=H(C)}else if(L==="comment"){const H=z=>{const R=_e.find(ce=>ce.event_id===n.id&&ce.user_email===z.email);if(!R||!R.status||R.status==="未回答")return"";let W=R.comment||"",ye="否";W.startsWith("[荷物車:可]")?(ye="可",W=W.substring(8)):W.startsWith("[荷物車:否]")&&(ye="否",W=W.substring(8));let re=[];return n.require_detailed_attendance&&(R.accompanying_persons&&re.push(`同伴: ${R.accompanying_persons}`),R.car_capacity&&R.car_capacity>0&&(re.push(`車出: 可[${R.car_capacity}人]`),re.push(`荷物車: ${ye}`))),W.trim()&&re.push(`メモ: ${W.trim()}`),re.join(", ")};N=H(B),T=H(C)}else if(L==="updated_at"){const H=_e.find(R=>R.event_id===n.id&&R.user_email===B.email),z=_e.find(R=>R.event_id===n.id&&R.user_email===C.email);N=H?new Date(H.updated_at).getTime():0,T=z?new Date(z.updated_at).getTime():0}return N<T?v==="asc"?-1:1:N>T?v==="asc"?1:-1:0});const E=[{type:"all",label:"すべて"},{type:"answered",label:"回答済"},{type:"attending",label:"出席"},{type:"absent",label:"欠席"},{type:"pending",label:"保留"},{type:"unanswered",label:"未回答"}].map(B=>{const C=window.att_statusFilter===B.type;return`<button onclick="window.att_setStatusFilter('${n.id}', '${B.type}')" class="px-2.5 py-1 rounded-full text-xs font-bold transition ${C?"bg-blue-600 text-white shadow-sm":"bg-gray-100 text-gray-600 hover:bg-gray-200"}">${B.label}</button>`}).join(" ");let $="";k.length===0?$=`
            <tr>
                <td colspan="5" class="px-4 py-6 text-center text-gray-400 text-xs">該当するメンバーはいません。</td>
            </tr>
        `:$=k.map(B=>{var re;const C=B.name||B.email.split("@")[0];let N="-";if(u){const ce=at.filter(ee=>ee.user_email===B.email).map(ee=>ee.group_id);N=je.filter(ee=>ce.includes(ee.id)).map(ee=>ee.name).join(", ")||"-"}else N=((re=Ct.find(ce=>ce.id===B.attribute_id))==null?void 0:re.name)||"-";const T=_e.find(ce=>ce.event_id===n.id&&ce.user_email===B.email);let M=(T==null?void 0:T.status)||"未回答";M==="未定"&&(M="保留");let G="";M==="出席"?G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-green-100 text-green-800 border border-green-200">🟢 参加</span>':M==="欠席"?G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-red-100 text-red-800 border border-red-200">❌ 不参加</span>':M==="保留"?G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-yellow-100 text-yellow-800 border border-yellow-200">❓ 未定/その他</span>':G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-gray-100 text-gray-500 border border-gray-200">❓ 未定/その他</span>';let H=(T==null?void 0:T.comment)||"",z="否";H.startsWith("[荷物車:可]")?(z="可",H=H.substring(8)):H.startsWith("[荷物車:否]")&&(z="否",H=H.substring(8));let R=[];T&&T.status&&T.status!=="未回答"&&(n.require_detailed_attendance&&(T.accompanying_persons&&R.push(`同伴: ${T.accompanying_persons}`),T.car_capacity&&T.car_capacity>0&&(R.push(`車出: 可[${T.car_capacity}人]`),R.push(`荷物車: ${z}`))),H.trim()&&R.push(`メモ: ${H.trim()}`));const W=R.length>0?R.join(", "):"-",ye=T?zs(T.updated_at):"-";return`
                <tr class="hover:bg-gray-50/50 border-b border-gray-100 transition">
                    ...
                    <td class="px-4 py-2 text-gray-600 text-[11px] max-w-[180px] truncate" title="${W}">${W}</td>
                    <td class="px-4 py-2 text-gray-400 text-[11px] font-semibold">${ye}</td>
                </tr>
            `}).join("");const _=B=>L!==B?'<span class="text-gray-300 ml-1">⇅</span>':v==="asc"?'<span class="text-blue-600 ml-1">▲</span>':'<span class="text-blue-600 ml-1">▼</span>',A=`
            ...
            <div class="p-4 overflow-y-auto">
                ...
                `:t==="attendance"?`
                    <div class="space-y-4">
                        ...
                        ${(()=>{const{formsHtml:B,hasAnyForm:C}=Ks(n,a,l);return B+(C?`
...
`).replace(/\\r/g,"\r").replace(/\\t/g,"	").replace(/\\,/g,",").replace(/\\;/g,";").replace(/\\\\/g,"\\")}function _s(e,t){if(!e)return null;const n=parseInt(e.substring(0,4)),a=parseInt(e.substring(4,6))-1,s=parseInt(e.substring(6,8));if(t||e.indexOf("T")===-1)return new Date(n,a,s);const r=e.indexOf("T"),o=parseInt(e.substring(r+1,r+3)),i=parseInt(e.substring(r+3,r+5)),d=parseInt(e.substring(r+5,r+7))||0;return e.endsWith("Z")?new Date(Date.UTC(n,a,s,o,i,d)):new Date(n,a,s,o,i,d)}async function oo(e){const t=e.target.files[0];if(!t)return;j("ICSファイルを解析中...");const n=new FileReader;n.onload=async a=>{try{const s=a.target.result,r=ro(s);if(F(),r.length===0){alert("ICSファイルから有効な予定が見つかりませんでした。");return}io(r)}catch(s){console.error(s),alert("ICSファイルの解析に失敗しました: "+s.message),F()}},n.readAsText(t),e.target.value=""}function io(e){const t=document.getElementById("ics-import-list");if(!t)return;const n=document.getElementById("ics-import-count");n&&(n.textContent=e.length),t.innerHTML=e.map((r,o)=>{var y,p;const i=r.title||"",d=i.toLowerCase();let l=((y=Ne[0])==null?void 0:y.name)||"練習";for(let g of Ne)if(d.includes(g.name)){l=g.name;break}l===((p=Ne[0])==null?void 0:p.name)&&(d.includes("試合")||d.includes("vs")||d.includes("戦")?Ne.find(w=>w.name==="試合")&&(l="試合"):(d.includes("イベント")||d.includes("会")||d.includes("式")||d.includes("フェス"))&&Ne.find(w=>w.name==="イベント")&&(l="イベント"));let c="";if(r.location){const g=Ot.find(w=>w.name===r.location);g?c=g.name:c="custom"}const m=va(r.start),u=va(r.end||(r.start?new Date(r.start.getTime()+2*60*60*1e3):null));let f=r.start?new Date(r.start.getTime()-3*24*60*60*1e3):null;f&&f.setHours(12,0,0,0);const b=va(f);return`
        ...
        `}).join("");const a=document.getElementById("ics-select-all");a&&(a.checked=!0,a.onclick=r=>{document.querySelectorAll(".ics-row-select").forEach(o=>o.checked=r.target.checked)});const s=document.getElementById("ics-import-modal");s&&s.classList.remove("hidden")}function Aa(){var e;(e=document.getElementById("ics-import-modal"))==null||e.classList.add("hidden")}async function lo(){const e=document.querySelectorAll(".ics-row"),t=[];if(e.forEach(n=>{var p,g,w,x,h,k,L,v,I,E;const a=n.querySelector(".ics-row-select");if(!a||!a.checked)return;const s=((p=n.querySelector(".ics-row-title"))==null?void 0:p.value)||"";if(!s)return;const r=((g=n.querySelector(".ics-row-category"))==null?void 0:g.value)||"",o=((w=n.querySelector(".ics-row-location"))==null?void 0:w.value)||"",i=((x=n.querySelector(".ics-row-start"))==null?void 0:x.value)||"",d=((h=n.querySelector(".ics-row-end"))==null?void 0:h.value)||"",l=((k=n.querySelector(".ics-row-allday"))==null?void 0:k.checked)||!1,c=[];n.querySelectorAll(".ics-row-group-cb:checked").forEach($=>{c.push($.value)});const m=((L=n.querySelector(".ics-row-req-att"))==null?void 0:L.checked)||!1,u=((v=n.querySelector(".ics-row-req-det"))==null?void 0:v.checked)||!1,f=((I=n.querySelector(".ics-row-deadline"))==null?void 0:I.value)||"",b=((E=n.querySelector(".ics-row-description"))==null?void 0:E.value)||"",y=$=>$?new Date($).toISOString():null;t.push({title:s,category:r,location:o,start_time:y(i),end_time:y(d),is_all_day:l,target_group_ids:c.length>0?c:null,requires_attendance:m,require_detailed_attendance:m?u:!1,attendance_deadline:m?y(f):null,description:b,created_by:U==null?void 0:U.email})}),t.length===0){alert("登録対象の予定が選択されていません。");return}j("予定データを登録中...");try{const{error:n}=await S.from("events").insert(t);if(n)throw n;await ne("IMPORT_ICS_EVENTS",`${t.length}件の予定をICSファイルから一括登録しました`),alert(`${t.length}件の予定を登録しました。`),Aa(),await tn(),He(),document.getElementById("list-container").classList.contains("hidden")||Lt()}catch(n){console.error(n),alert("予定の登録に失敗しました: "+n.message)}finally{F()}}const co="modulepreload",uo=function(e){return"/"+e},Is={},mo=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),i=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(n.map(d=>{if(d=uo(d),d in Is)return;Is[d]=!0;const l=d.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const m=document.createElement("link");if(m.rel=l?"stylesheet":co,l||(m.as="script"),m.crossOrigin="",m.href=d,i&&m.setAttribute("nonce",i),document.head.appendChild(m),l)return new Promise((u,f)=>{m.addEventListener("load",u),m.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return s.then(o=>{for(const i of o||[])i.status==="rejected"&&r(i.reason);return t().catch(r)})};let $s=!1,Xs=[],er=[],tr=[],ot=[],we={homeTeamNames:["ありんこアントス@A軍"],defaultFilterDate:{from:"",to:"",teamRegex:"",category:"",outcome:"all"}},ks=!1,_n={},At={},Ea={},_a={},Da={batter:[],pitcher:[]},Vt={batter:{key:"ops",order:"desc"},pitcher:{key:"era",order:"asc"}},an={batter:{key:"ops",order:"desc"},pitcher:{key:"era",order:"asc"}},yt=null,gt={};async function Na(){$s||(go(),$s=!0);const e=document.querySelector('button[data-tab="import-data"]');e&&(xe==="admin"?e.classList.remove("hidden"):e.classList.add("hidden")),await nr()}function po(e){const t=[];let n=[],a="",s=!1;for(let r=0;r<e.length;r++){const o=e[r];s?o==='"'?r+1<e.length&&e[r+1]==='"'?(a+='"',r++):s=!1:a+=o:o==='"'?s=!0:o===","?(n.push(a),a=""):o===`
`||o==="\r"?(n.push(a),t.push(n),n=[],a="",o==="\r"&&r+1<e.length&&e[r+1]===`
...
${$.myTeam} vs ${$.oppTeam}`:""},label:function(I){const E=I.dataIndex,$=k[E],_=I.dataset.label||"";return _==="得点"?`得点 (${($==null?void 0:$.myTeam)||"自チーム"}): ${I.raw} 点`:_==="失点"?`失点 (${($==null?void 0:$.oppTeam)||"相手チーム"}): ${Math.abs(I.raw)} 点`:_==="累積勝率(%)"?`累積勝率: ${I.raw} %`:`${_}: ${I.raw}`}}}},scales:{x:{stacked:!0,ticks:{font:{size:10}}},y:{stacked:!0,position:"left"},y1:{position:"right",beginAtZero:!0,min:0,max:100}}}})}function $t(e){let t=0,n=0,a=0,s=0,r=0,o=0,i=0,d=0,l=0,c=0,m=0,u=0,f=0,b=0,y=0;e.forEach(v=>{const I=v.plate_appearances||0,E=v.at_bats||0,$=v.hits||0,_=v.doubles||0,A=v.triples||0,P=v.home_runs||0,D=v.walks||0,O=v.hit_by_pitch||0,q=v.strike_outs||v.strikeouts||0,B=v.sacrifice_flies||v.sac_flies||0,C=v.sacrifice_hits||v.sac_bunts||0,N=v.runs_batted_in||0,T=v.runs||0,M=v.stolen_bases||0;t+=I,n+=E,a+=$,u+=_,f+=A,m+=P,d+=D,l+=O,c+=q,b+=B,y+=C,r+=N,o+=T,i+=M;const H=(v.singles!==void 0?v.singles:Math.max(0,$-_-A-P))*1+_*2+A*3+P*4,z=v.total_bases&&v.total_bases>H?v.total_bases:H;s+=z});const p=n>0?a/n:0,g=n+d+l+b,w=g>0?(a+d+l)/g:t>0?(a+d+l)/t:0,x=n>0?s/n:0,h=w+x,k=a+d+l,L=k>0?o/k:0;return{pa:t,ab:n,h:a,doubles:u,triples:f,hr:m,tb:s,sf:b,sh:y,bb:d,hbp:l,rbi:r,r:o,sb:i,so:c,ob:k,avg:p,obp:w,slg:x,ops:h,runRate:L,avgStr:p.toFixed(3).replace(/^0/,""),obpStr:w.toFixed(3).replace(/^0/,""),slgStr:x.toFixed(3).replace(/^0/,""),opsStr:h.toFixed(3),runRateStr:k>0?(L*100).toFixed(1)+"%":"0.0%",bbRate:t>0?(d+l)/t:0,soRate:t>0?c/t:0}}function kt(e){let t=0,n=0,a=0,s=0,r=0,o=0,i=0,d=0,l=0,c=0;e.forEach(p=>{t+=p.outs||0,n+=p.earned_runs||0,a+=p.hits_allowed||0,s+=(p.walks_allowed||0)+(p.hit_batters||0),r+=p.strike_outs||0,o+=p.batters_faced||0,i+=p.pitch_count||0,d+=p.strikes||0,l+=p.wins||0,c+=p.losses||0});const m=t/3,u=m>0?n*7/m:0,f=m>0?(a+s)/m:0,b=m>0?r*7/m:0,y=m>0?s*7/m:0;return{outs:t,er:n,h:a,bb:s,so:r,bf:o,pc:i,st:d,wins:l,losses:c,era:u,whip:f,k7:b,bb7:y,eraStr:u.toFixed(2),whipStr:f.toFixed(2),k7Str:b.toFixed(2),bb7Str:y.toFixed(2),kRate:o>0?r/o:0,bbRate:o>0?s/o:0,kbb:s>0?r/s:r>0?99.9:0,sRate:i>0?d/i:0}}async function es(){var d,l,c,m,u,f;await An();const e=((d=document.getElementById("ps-mode"))==null?void 0:d.value)||"single",t=(l=document.getElementById("ps-player"))==null?void 0:l.value,n=((c=document.getElementById("ps-role"))==null?void 0:c.value)||"batter",a=((m=document.getElementById("ps-limit-games"))==null?void 0:m.value)||"5",s=((u=document.getElementById("ps-ma-unit"))==null?void 0:u.value)||"ab",r=parseInt(((f=document.getElementById("ps-ma-window"))==null?void 0:f.value)||"10",10),o=document.getElementById("ps-single-container"),i=document.getElementById("ps-all-container");e==="single"?(o==null||o.classList.remove("hidden"),i==null||i.classList.add("hidden"),t&&ho(t,n,a,s,r)):(o==null||o.classList.add("hidden"),i==null||i.classList.remove("hidden"),_o(n,a,s,r))}function ho(e,t,n,a,s){var y;const{games:r,bStats:o,pStats:i}=xn,d=((y=ot.find(p=>p.id==e))==null?void 0:y.name)||"選手",c=(t==="batter"?o:i).filter(p=>p.player_id==e).map(p=>{const g=r.find(w=>w.id===p.game_id);return{date:(g==null?void 0:g.date)||"",game:g,stats:p}}).filter(p=>p.date).sort((p,g)=>p.date.localeCompare(g.date)),m=t==="batter"?$t(c.map(p=>p.stats)):kt(c.map(p=>p.stats));let u=[...c];if(n!=="all"){const p=parseInt(n,10);u.length>p&&(u=u.slice(u.length-p))}const f=t==="batter"?$t(u.map(p=>p.stats)):kt(u.map(p=>p.stats));xo(d,t,f,m,u);const b=ar(u,t,a,s);vo(d,t,u),wo(d,t,b,a,s),Eo(t,u)}function xo(e,t,n,a,s){const r=document.getElementById("ps-highlight-cards");if(r)if(t==="batter"){const o=n.avg-a.avg,i=(o>=0?"+":"")+o.toFixed(3).replace(/^0/,""),d=o>=.03,l=o<=-.05,c=d?"🔥 好調":l?"❄️ 不調":"⚖️ 安定",m=d?"bg-red-100 text-red-700 border-red-200":l?"bg-blue-100 text-blue-700 border-blue-200":"bg-gray-100 text-gray-700 border-gray-200";let u=0;for(let f=s.length-1;f>=0;f--){const b=s[f].stats.hits||0,y=s[f].stats.at_bats||0;if(b>0)u++;else if(y>0)break}r.innerHTML=`
        ...
        `,a.innerHTML=r.map(o=>{var q,B,C;const i=o.stats,d=ut((q=o.game)==null?void 0:q.team_first)?(B=o.game)==null?void 0:B.team_second:(C=o.game)==null?void 0:C.team_first,l=i.plate_appearances||0,c=i.at_bats||0,m=i.hits||0,u=i.doubles||0,f=i.triples||0,b=i.home_runs||0,y=i.singles!==void 0?i.singles:Math.max(0,m-u-f-b),p=i.runs_batted_in||0,g=i.runs||0,w=i.walks||0,x=i.hit_by_pitch||0,h=i.strikeouts||i.strike_outs||0,k=i.sacrifice_flies||i.sac_flies||0,L=(i.sacrifice_hits||i.sac_bunts||0)+k,v=i.stolen_bases||0,I=i.errors||0,E=c>0?(m/c).toFixed(3).replace(/^0/,""):".000",$=c+w+x+k,_=$>0?(m+w+x)/$:l>0?(m+w+x)/l:0;_.toFixed(3).replace(/^0/,"");const A=y+u*2+f*3+b*4,P=i.total_bases&&i.total_bases>A?i.total_bases:A,D=c>0?P/c:0;D.toFixed(3).replace(/^0/,"");const O=(_+D).toFixed(3);return`
...
`,r+=`◆ スターティングメンバー (打順順)
`;const o=a.length,i=e.basePositions||{},d={};a.forEach(f=>{const b=i[f];b&&(d[b]=f)});for(let f=1;f<=o;f++){const b=e.battingOrder[f];if(b){const y=fe.find(g=>g.id===b),p=d[b];if(y&&p){const g=dn[p],w=y.number?` [#${y.number}]`:"";r+=`${f}. [${g}] ${xt[p]} : ${y.name}${w}
`}}}r+=`
◆ 控え選手 (ベンチ)
...
（集計や出欠、注文数から除外されます）`)&&await wi(i)})}))}function Ai(){if(!fn)return;const e=fn,t=me.filter(d=>d.survey_id===e.id),n=["回答ID","回答日時","回答者(代表者名)"];e.enable_family&&n.push("家族メンバー一覧"),e.enable_schedule&&e.schedule_options&&e.schedule_options.forEach(d=>{n.push(`日程: ${d}`)}),e.questions&&e.questions.forEach((d,l)=>{n.push(`設問${l+1}: ${d.title}`)}),e.enable_orders&&e.order_items&&(e.order_items.forEach(d=>{n.push(`注文: ${d.name} (${d.price}円)`)}),n.push("注文合計金額(円)"));const a=[n];t.forEach(d=>{const l=[d.id,d.created_at||"",d.respondent_name||""];if(e.enable_family){const c=(d.family_members||[]).map(m=>`${m.name}${m.role?`(${m.role})`:""}`).join(", ");l.push(c)}e.enable_schedule&&e.schedule_options&&e.schedule_options.forEach(c=>{l.push(d.schedules&&d.schedules[c]||"")}),e.questions&&e.questions.forEach(c=>{const m=d.answers?d.answers[c.id]:"";Array.isArray(m)?l.push(m.join("; ")):l.push(m||"")}),e.enable_orders&&e.order_items&&(e.order_items.forEach(c=>{const m=d.orders&&d.orders[c.id]||0;l.push(m)}),l.push(d.total_amount||0)),a.push(l)});const s=a.map(d=>d.map(l=>`"${String(l||"").replace(/"/g,'""')}"`).join(",")).join(`
`),r=new Blob([new Uint8Array([239,187,191]),s],{type:"text/csv;charset=utf-8;"}),o=document.createElement("a");o.href=URL.createObjectURL(r);const i=new Date().toISOString().split("T")[0];o.download=`survey_${e.id}_${i}.csv`,o.click()}let kn=null,vt=[],Qn=null;async function mn(e,t=null,n=null){var d;(d=document.getElementById("loading-overlay"))==null||d.classList.add("hidden");const a=document.getElementById("loading-detail-text");a&&(a.style.opacity="0"),["auth-view","signup-view","password-reset-view","password-update-view","app-menu-view","app-view","attendance-view","view-users","dashboard-view","dashboard-settings","position-simulator-view","info-view"].forEach(l=>{const c=document.getElementById(l);c&&c.classList.add("hidden")});const s=document.getElementById("survey-respond-view");s&&s.classList.remove("hidden");const r=document.getElementById("survey-respond-form-container"),o=document.getElementById("survey-respond-error-container"),i=document.getElementById("survey-respond-success-container");i&&i.classList.add("hidden");try{if(ur(),(!te||te.length===0)&&await Fa(),!n){const y=window.location.hash||"",p=window.location.search||"",g=(y+"&"+p).match(/[?&#]d=([^&]+)/);g&&g[1]&&(n=g[1])}let l=te.find(y=>y.id===e);if(!l&&n)try{const y=_i(n);if(y&&(y.id===e||!e)){l=y,te.unshift(l);try{localStorage.setItem(Yt,JSON.stringify(te))}catch{}}}catch(y){console.warn("Embedded survey restore failed:",y)}if(l||(await Fa(),l=te.find(y=>y.id===e)),!l&&e)try{const y=decodeURIComponent(e).trim();l=te.find(p=>p.id===y)}catch{}if(!l){if(r&&r.classList.add("hidden"),o){o.classList.remove("hidden");const y=document.getElementById("survey-respond-error-title"),p=document.getElementById("survey-respond-error-desc");y&&(y.textContent="アンケートが見つかりませんでした"),p&&(p.innerHTML=`指定されたアンケート（ID: <span class="font-mono font-bold">${e||"未指定"}</span>）が存在しないか、URLが正しくない可能性があります。<br>最新のアンケートURLをご確認ください。`)}return}o&&o.classList.add("hidden"),r&&r.classList.remove("hidden"),kn=l,vt=[];let c=null;t&&(c=me.find(y=>y.id===t));const m=document.getElementById("respond-edit-mode-banner"),u=document.getElementById("btn-submit-survey-response");c?(Qn=c.id,m&&m.classList.remove("hidden"),u&&(u.textContent="回答を更新する")):(Qn=null,m&&m.classList.add("hidden"),u&&(u.textContent="回答を送信する")),document.getElementById("respond-survey-title").textContent=l.title,document.getElementById("respond-survey-desc").innerHTML=l.description?l.description.replace(/\n/g,"<br>"):"",document.getElementById("respond-survey-deadline").textContent=l.deadline?`回答期限: ${l.deadline}`:"";const f=document.getElementById("btn-view-public-results");f&&(l.public_results!==!1?(f.classList.remove("hidden"),f.onclick=()=>ua(l.id,!0)):f.classList.add("hidden"));const b=document.getElementById("input-respondent-name");b&&(c?b.value=c.respondent_name||"":b.value=Dt&&Dt.name?Dt.name:""),c&&c.family_members?vt=JSON.parse(JSON.stringify(c.family_members)):vt=[],os(l),Di(l,c?c.schedules:null),Ni(l,c?c.answers:null),Oi(l,c?c.orders:null),window.scrollTo({top:0,behavior:"smooth"})}catch(l){if(console.error("Error in openSurveyResponsePage:",l),r&&r.classList.add("hidden"),o){o.classList.remove("hidden");const c=document.getElementById("survey-respond-error-title"),m=document.getElementById("survey-respond-error-desc");c&&(c.textContent="エラーが発生しました"),m&&(m.innerHTML=`アンケートの読み込み中にエラーが発生しました。<br><span class="text-xs text-red-500 font-mono">${l.message||l}</span>`)}}}function os(e){const t=document.getElementById("respond-family-section");if(!t)return;if(!e.enable_family){t.classList.add("hidden");return}t.classList.remove("hidden");const n=document.getElementById("respond-family-list");n&&(n.innerHTML=vt.map((a,s)=>`
    ...
    `).join(""),n.querySelectorAll(".input-fam-name").forEach(a=>{a.addEventListener("input",s=>{const r=Number(s.target.getAttribute("data-index"));vt[r].name=s.target.value})}),n.querySelectorAll(".select-fam-role").forEach(a=>{a.addEventListener("change",s=>{const r=Number(s.target.getAttribute("data-index"));vt[r].role=s.target.value})}),n.querySelectorAll(".btn-del-fam").forEach(a=>{a.addEventListener("click",()=>{const s=Number(a.getAttribute("data-index"));vt.splice(s,1),os(e)})}))}function Di(e,t=null){const n=document.getElementById("respond-schedule-section");if(!n)return;if(!e.enable_schedule||!e.schedule_options||e.schedule_options.length===0){n.classList.add("hidden");return}n.classList.remove("hidden");const a=document.getElementById("respond-schedule-list");a&&(a.innerHTML=e.schedule_options.map((s,r)=>{const o=t&&t[s]?t[s]:"○";return`
...
Vercel等の設定を確認してください。`),console.error("Missing SUPABASE_URL or SUPABASE_ANON_KEY");console.log("Checking Supabase URL:","Empty");!window.supabaseClient&&window.supabase&&window.supabase.createClient&&(window.supabaseClient=window.supabase.createClient(cs,us));const S=window.supabaseClient;let U=null,bn=!1,xe="user";function pa(e){return e=e.trim(),e?e.includes("@")?e:`${e}@ants.local`:""}function en(e){return e?e.endsWith("@ants.local")?e.split("@")[0]:e:""}let pn=0,nt=null;function rd(e){const t=document.getElementById("loading-overlay");if(t){const n=t.querySelector("span");n&&(n.textContent=e)}nt||(nt=document.createElement("div"),nt.id="loading-detail-text",nt.className="fixed bottom-2 right-2 text-xs md:text-sm font-bold text-gray-600 bg-white/90 border border-gray-300 px-3 py-1.5 rounded shadow-lg pointer-events-none z-[9999] transition-opacity duration-300",document.body.appendChild(nt)),nt.textContent=e,nt.style.opacity="1"}function j(e="通信中..."){pn++;const t=document.getElementById("loading-overlay");t&&pn===1&&t.classList.remove("hidden"),rd(e)}function F(){var e;pn--,pn<=0&&(pn=0,(e=document.getElementById("loading-overlay"))==null||e.classList.add("hidden"),nt&&(nt.style.opacity="0"))}function qe(){var e;pn=0,(e=document.getElementById("loading-overlay"))==null||e.classList.add("hidden"),nt&&(nt.style.opacity="0")}async function he(e,t="通信中..."){{alert("環境変数 (VITE_SUPABASE_URL) が設定されていません。Vercelの設定を確認してください。");return}}async function ne(e,t){if(U&&e!=="NAVIGATE")try{await S.from("action_logs").insert({user_email:U.email,action_type:e,details:t})}catch(n){console.error("Log error:",n)}}function js(){var e,t,n,a,s,r,o,i,d,l,c,m,u,f,b,y,p,g,w,x,h,k,L,v,I,E,$,_,A,P,D,O,q,B,C,N,T,M,G,H,z,R,W,ye,re,ce;if(!window.isDomInitialized)try{if(window.isDomInitialized=!0,document.title="bb-sys for arinko ants.",document.body){const V=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null,!1);let ue;for(;ue=V.nextNode();)ue.nodeValue.includes("配車調整アプリ")&&(ue.nodeValue=ue.nodeValue.replace(/配車調整アプリ/g,"bb-sys for arinko ants.")),ue.nodeValue.includes("少年野球に役立つツール for arinko ants.")&&(ue.nodeValue=ue.nodeValue.replace(/少年野球に役立つツール for arinko ants./g,"bb-sys for arinko ants."))}document.documentElement.style.setProperty("--layout-columns",Ya),window.addEventListener("resize",Us),Us(),(e=document.getElementById("btn-login"))==null||e.addEventListener("click",Hs),(t=document.getElementById("auth-form"))==null||t.addEventListener("submit",Hs),(n=document.getElementById("btn-logout"))==null||n.addEventListener("click",jn),(a=document.getElementById("btn-logout-menu"))==null||a.addEventListener("click",jn),(s=document.getElementById("btn-clear-cache"))==null||s.addEventListener("click",od),(r=document.getElementById("link-to-signup"))==null||r.addEventListener("click",V=>{V.preventDefault(),Y("signup-view")}),(o=document.getElementById("link-to-reset"))==null||o.addEventListener("click",V=>{V.preventDefault(),Y("password-reset-view")}),document.querySelectorAll(".link-back-to-login").forEach(V=>V.addEventListener("click",ue=>{ue.preventDefault(),Y("auth-view")})),(i=document.getElementById("btn-submit-signup"))==null||i.addEventListener("click",id),(d=document.getElementById("btn-send-reset"))==null||d.addEventListener("click",dd),(l=document.getElementById("btn-update-password"))==null||l.addEventListener("click",ld),(c=document.getElementById("btn-change-password"))==null||c.addEventListener("click",()=>{var V;(V=document.getElementById("change-password-modal"))==null||V.classList.remove("hidden")}),(m=document.getElementById("btn-close-change-password"))==null||m.addEventListener("click",()=>{var V;(V=document.getElementById("change-password-modal"))==null||V.classList.add("hidden")}),(u=document.getElementById("btn-submit-change-password"))==null||u.addEventListener("click",cd);const ee=document.getElementById("btn-change-password");ee&&(ee.textContent="パスワード変更"),(f=document.getElementById("nav-users"))==null||f.addEventListener("click",Sn),(b=document.getElementById("btn-admin-add-user"))==null||b.addEventListener("click",adminAddUser),(y=document.getElementById("btn-reload-users"))==null||y.addEventListener("click",se),(p=document.getElementById("btn-save-all-users"))==null||p.addEventListener("click",ud),(g=document.getElementById("admin-users-sort"))==null||g.addEventListener("change",V=>{localStorage.setItem("admin_users_sort",V.target.value),se()}),(w=document.getElementById("btn-export-users"))==null||w.addEventListener("click",Xd),(x=document.getElementById("btn-import-users"))==null||x.addEventListener("click",()=>document.getElementById("input-import-users-csv").click()),(h=document.getElementById("btn-download-users-sample"))==null||h.addEventListener("click",al),(k=document.getElementById("input-import-users-csv"))==null||k.addEventListener("change",el),(L=document.getElementById("btn-close-csv-modal"))==null||L.addEventListener("click",ia),(v=document.getElementById("btn-close-csv-modal-x"))==null||v.addEventListener("click",ia),(I=document.getElementById("btn-execute-csv-import"))==null||I.addEventListener("click",tl);const tt=document.getElementById("btn-admin-add-user");if(tt&&!document.getElementById("btn-admin-add-dummy-user")){const V=document.createElement("button");V.id="btn-admin-add-dummy-user",V.className="ml-2 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded shadow font-bold text-sm",V.textContent="代行専用メンバー追加",V.onclick=adminAddDummyUser,(E=tt.parentNode)==null||E.appendChild(V)}const lt=document.querySelector("#view-master #btn-load-logs");lt&&lt.remove();const ae=document.querySelector("#view-master #log-list");if(ae){const V=ae.closest(".bg-white");V?V.remove():ae.remove()}document.querySelectorAll("#view-master h2").forEach(V=>{V.textContent.includes("操作ログ")&&V.remove()});const Je=document.getElementById("tab-master-admin");if(Je&&!document.getElementById("tab-logs-admin")){const V=Je.parentElement,ue=document.createElement("button");ue.id="tab-logs-admin",ue.className="px-4 py-2 font-bold text-gray-500 hover:text-gray-700 border-b-2 border-transparent transition-colors",ue.textContent="操作ログ",V==null||V.appendChild(ue);const Re=document.createElement("div");Re.id="tab-content-logs-admin",Re.className="hidden",Re.innerHTML=`
            ...
            `;const Ge=document.getElementById("tab-content-master-admin");Ge&&Ge.parentElement&&Ge.parentElement.appendChild(Re)}const Ae=V=>{[{btnId:"tab-users-admin",contentId:"tab-content-users-admin"},{btnId:"tab-master-admin",contentId:"tab-content-master-admin"},{btnId:"tab-logs-admin",contentId:"tab-content-logs-admin"}].forEach(Re=>{const Ge=document.getElementById(Re.btnId),Ut=document.getElementById(Re.contentId);!Ge||!Ut||(Re.btnId===V?(Ge.className="px-4 py-2 font-bold text-blue-600 border-b-2 border-blue-600 transition-colors",Ut.classList.remove("hidden"),V==="tab-logs-admin"&&Bn()):(Ge.className="px-4 py-2 font-bold text-gray-500 hover:text-gray-700 border-b-2 border-transparent transition-colors",Ut.classList.add("hidden")))})};($=document.getElementById("tab-users-admin"))==null||$.addEventListener("click",()=>Ae("tab-users-admin")),(_=document.getElementById("tab-master-admin"))==null||_.addEventListener("click",()=>Ae("tab-master-admin")),(A=document.getElementById("tab-logs-admin"))==null||A.addEventListener("click",()=>Ae("tab-logs-admin")),(P=document.getElementById("btn-load-logs"))==null||P.addEventListener("click",Bn),(D=document.getElementById("btn-app-dispatch"))==null||D.addEventListener("click",()=>{var V;Y("app-view","dispatch"),bn?(V=document.getElementById("nav-dispatch"))==null||V.click():Ja()}),(O=document.getElementById("btn-app-attendance"))==null||O.addEventListener("click",async()=>{Y("attendance-view"),await he(Ca,"出欠管理画面を準備中...")}),(q=document.getElementById("btn-app-dashboard"))==null||q.addEventListener("click",async()=>{await he(Na,"ダッシュボードを準備中..."),Y("dashboard-view")}),(B=document.getElementById("btn-app-info"))==null||B.addEventListener("click",async()=>{await he(async()=>{await Gn({supabaseClient:S,currentUser:U,currentUserRole:xe})},"Info画面を準備中..."),Y("info-view")}),(C=document.getElementById("btn-back-to-menu-info"))==null||C.addEventListener("click",()=>Y("app-menu-view")),(N=document.getElementById("btn-logout-info"))==null||N.addEventListener("click",jn),(T=document.getElementById("btn-back-to-menu"))==null||T.addEventListener("click",()=>{Y("app-menu-view")}),(M=document.getElementById("btn-back-to-menu-att"))==null||M.addEventListener("click",()=>Y("app-menu-view")),(G=document.getElementById("btn-logout-att"))==null||G.addEventListener("click",jn),(H=document.getElementById("btn-change-password-menu"))==null||H.addEventListener("click",ms);const mt=(z=document.getElementById("app-menu-view"))==null?void 0:z.querySelector(".space-y-4");mt&&(mt.className="w-full max-w-xs mx-auto space-y-3 mt-4");const pt=document.getElementById("btn-app-dispatch");pt&&(pt.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-blue-600 hover:bg-blue-700 hover:shadow-lg text-white text-left",pt.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">🚗</span><span>配車調整</span></div><span class="text-white/60 text-sm font-normal">❯</span>');const ct=document.getElementById("btn-app-attendance");ct&&(ct.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-green-600 hover:bg-green-700 hover:shadow-lg text-white text-left",ct.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">📅</span><span>出欠管理</span></div><span class="text-white/60 text-sm font-normal">❯</span>');const Ye=document.getElementById("btn-app-simulator");Ye&&(Ye.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-amber-600 hover:bg-amber-700 hover:shadow-lg text-white text-left",Ye.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">⚾</span><span>ポジション設定</span></div><span class="text-white/60 text-sm font-normal">❯</span>',Ye.onclick=()=>{Y("position-simulator-view"),Vn()});const De=document.getElementById("btn-app-info");De&&(De.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-teal-600 hover:bg-teal-700 hover:shadow-lg text-white text-left",De.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">ℹ️</span><span>Info</span></div><span class="text-white/60 text-sm font-normal">❯</span>',De.onclick=async()=>{await he(async()=>{await Gn({supabaseClient:S,currentUser:U,currentUserRole:xe})},"Info画面を準備中..."),Y("info-view")}),(R=document.getElementById("nav-info"))==null||R.addEventListener("click",async()=>{await he(async()=>{await Gn({supabaseClient:S,currentUser:U,currentUserRole:xe})},"Info画面を準備中..."),Y("info-view")}),(W=document.getElementById("nav-simulator"))==null||W.addEventListener("click",()=>{Y("position-simulator-view"),Vn()}),(ye=document.getElementById("nav-simulator-att"))==null||ye.addEventListener("click",()=>{Y("position-simulator-view"),Vn()}),(re=document.getElementById("nav-dispatch-sim"))==null||re.addEventListener("click",()=>{var V;Y("app-view","dispatch"),bn?(V=document.getElementById("nav-dispatch"))==null||V.click():Ja()}),(ce=document.getElementById("nav-attendance-sim"))==null||ce.addEventListener("click",async()=>{Y("attendance-view"),await he(Ca,"出欠管理画面を準備中...")})}catch(ee){console.error("DOM Initialization failed:",ee),qe(),Y("auth-view")}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",js):setTimeout(js,0);let za=!1;function ra(e,t=null){if(za)return;const n="#"+e+(t?"-"+t:"");window.location.hash!==n&&history.pushState({screenId:e,subView:t},"",n)}function Y(e,t=null){["auth-view","signup-view","password-reset-view","password-update-view","app-menu-view","app-view","attendance-view","view-users","dashboard-view","dashboard-settings","position-simulator-view","info-view","survey-respond-view"].forEach(a=>{const s=document.getElementById(a);s&&s.classList.add("hidden")});const n=document.getElementById(e);n&&n.classList.remove("hidden"),ra(e,t),e!=="auth-view"&&e!=="survey-respond-view"&&U&&ne("NAVIGATE",`画面遷移: ${e}${t?" > "+t:""}`)}function Wn(){let e=null,t=null,n=null;try{const a=new URLSearchParams(window.location.search);e=a.get("survey"),t=a.get("response"),n=a.get("d");let s=window.location.hash||"";if(s.startsWith("#/")&&(s="#"+s.substring(2)),s.includes("?")){const[r,o]=s.split("?");s=r;try{const i=new URLSearchParams(o);e||(e=i.get("survey")),t||(t=i.get("response")),n||(n=i.get("d"))}catch{}}if(s.startsWith("#survey-")||s.startsWith("#survey=")){const o=(s.startsWith("#survey-")?s.replace("#survey-",""):s.replace("#survey=","")).split("&");e||(e=o[0]);for(let i=1;i<o.length;i++){const d=o[i],l=d.indexOf("=");if(l!==-1){const c=d.substring(0,l),m=d.substring(l+1);c==="response"&&m&&!t&&(t=m),c==="d"&&m&&!n&&(n=m)}}}}catch(a){console.warn("parseSurveyUrlParams error:",a)}if(e)try{e=decodeURIComponent(e).trim().replace(/^\/+|\/+$/g,"")}catch{}if(t)try{t=decodeURIComponent(t).trim()}catch{}return{surveyId:e,responseId:t,surveyData:n||null}}window.addEventListener("popstate",async e=>{var t,n;za=!0;try{const{surveyId:a,responseId:s,surveyData:r}=Wn();if(a){await mn(a,s,r);return}e.state&&e.state.screenId?(Y(e.state.screenId,e.state.subView),e.state.screenId==="app-view"&&(e.state.subView==="users"?await Sn():e.state.subView==="master"?(t=document.getElementById("nav-master"))==null||t.click():(n=document.getElementById("nav-dispatch"))==null||n.click())):Y(U?"app-menu-view":"auth-view")}finally{za=!1}});S&&S.auth.onAuthStateChange(async(e,t)=>{if(e==="PASSWORD_RECOVERY"){Y("password-update-view");return}if(t&&bn&&U&&(e==="TOKEN_REFRESHED"||e==="USER_UPDATED")){console.log(`Bypassing auth state change handling for event: ${e}`);return}const n=async()=>{var o,i,d,l,c,m,u,f;const{surveyId:a,responseId:s,surveyData:r}=Wn();if(a){if(qe(),t){U={...t.user};try{const{data:b}=await S.from("app_users").select("name, role").eq("email",U.email).single();b&&(U.name=b.name,xe=b.role)}catch{}}await mn(a,s,r);return}if(t){j("ユーザー権限確認中...");try{const b=!U||U.id!==t.user.id;U={...t.user},b&&await ne("LOGIN","ログインしました");let y=!0,p=!0,g=!0,w=!0,x=!0;try{const{data:W}=await S.from("app_users").select("role, name, can_use_dispatch, can_use_dashboard, can_use_attendance, can_use_simulator, can_use_info").eq("email",U.email).single();W?(xe=W.role,U.name=W.name,W.can_use_dispatch===!1&&(y=!1),W.can_use_dashboard===!1&&(p=!1),W.can_use_attendance===!1&&(g=!1),W.can_use_simulator===!1&&(w=!1),W.can_use_info===!1&&(x=!1)):xe="user"}catch{xe="user"}U.email==="hishinumak@gmail.com"&&(xe="admin"),xe==="admin"&&(y=!0,p=!0,g=!0,w=!0,x=!0);let h=document.getElementById("btn-app-dashboard");if(p)if(h)h.classList.remove("hidden");else{const W=((o=document.getElementById("app-menu-view"))==null?void 0:o.querySelector(".space-y-3"))||((i=document.getElementById("app-menu-view"))==null?void 0:i.querySelector(".space-y-4"))||((d=document.getElementById("app-menu-view"))==null?void 0:d.querySelector(".grid"));W&&(h=document.createElement("button"),h.id="btn-app-dashboard",h.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-indigo-600 hover:bg-indigo-700 hover:shadow-lg text-white text-left",h.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">📊</span><span>分析</span></div><span class="text-white/60 text-sm font-normal">❯</span>',h.onclick=async()=>{await he(Na,"ダッシュボードを準備中..."),Y("dashboard-view")},W.appendChild(h))}else h&&h.classList.add("hidden");const k=document.getElementById("nav-users"),L=document.getElementById("nav-master"),v=document.getElementById("nav-dispatch"),I=document.getElementById("btn-app-dispatch"),E=document.getElementById("btn-goto-master"),$=document.getElementById("clear-db-button");let _=document.getElementById("btn-app-users-admin");if(k==null||k.classList.add("hidden"),xe==="admin"?(v==null||v.classList.remove("hidden"),L==null||L.classList.remove("hidden")):xe==="leader"?(v==null||v.classList.remove("hidden"),L==null||L.classList.add("hidden")):(v==null||v.classList.add("hidden"),L==null||L.classList.add("hidden")),xe==="admin")if(E==null||E.classList.remove("hidden"),$==null||$.classList.remove("hidden"),_)_.classList.remove("hidden");else{const W=((l=document.getElementById("app-menu-view"))==null?void 0:l.querySelector(".space-y-3"))||((c=document.getElementById("app-menu-view"))==null?void 0:c.querySelector(".space-y-4"))||((m=document.getElementById("app-menu-view"))==null?void 0:m.querySelector(".grid"));W&&(_=document.createElement("button"),_.id="btn-app-users-admin",_.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-purple-600 hover:bg-purple-700 hover:shadow-lg text-white text-left order-last",_.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">⚙️</span><span>管理者メニュー</span></div><span class="text-white/60 text-sm font-normal">❯</span>',_.onclick=()=>wr(),W.appendChild(_))}else E==null||E.classList.add("hidden"),$==null||$.classList.add("hidden"),_&&_.classList.add("hidden");y?I==null||I.classList.remove("hidden"):I==null||I.classList.add("hidden");const A=document.getElementById("btn-app-attendance");g?A==null||A.classList.remove("hidden"):A==null||A.classList.add("hidden");const P=document.getElementById("btn-app-simulator"),D=document.getElementById("nav-simulator"),O=document.getElementById("nav-simulator-att"),q=document.getElementById("nav-dispatch-sim"),B=document.getElementById("nav-attendance-sim");w?(P==null||P.classList.remove("hidden"),D==null||D.classList.remove("hidden"),O==null||O.classList.remove("hidden")):(P==null||P.classList.add("hidden"),D==null||D.classList.add("hidden"),O==null||O.classList.add("hidden")),y?q==null||q.classList.remove("hidden"):q==null||q.classList.add("hidden"),g?B==null||B.classList.remove("hidden"):B==null||B.classList.add("hidden");const C=document.getElementById("btn-app-info"),N=document.getElementById("nav-info");x?(C==null||C.classList.remove("hidden"),N==null||N.classList.remove("hidden")):(C==null||C.classList.add("hidden"),N==null||N.classList.add("hidden"));const T=document.getElementById("user-email-display");T&&(T.textContent=U.name||en(U.email));const M=document.getElementById("sim-user-email-display");M&&(M.textContent=U.name||en(U.email));const{surveyId:G,responseId:H,surveyData:z}=Wn();if(G){await mn(G,H,z);return}const R=window.location.hash;if(R&&R!=="#app-menu-view"&&R!=="#auth-view"){const W=["app-view","attendance-view","dashboard-view","position-simulator-view","info-view"];let ye=!1;for(const re of W)if(R.startsWith("#"+re)){const ce=R.length>re.length+1?R.substring(re.length+2):null;re==="app-view"?(Y("app-view",ce),bn?ce==="users"?Sn():ce==="master"?(u=document.getElementById("nav-master"))==null||u.click():(f=document.getElementById("nav-dispatch"))==null||f.click():Ja().then(()=>{var ee,tt;ce==="users"?Sn():ce==="master"?(ee=document.getElementById("nav-master"))==null||ee.click():(tt=document.getElementById("nav-dispatch"))==null||tt.click()}).catch(ee=>{console.error("App init error:",ee),qe()})):re==="attendance-view"?(Y("attendance-view"),Ca().catch(ee=>{console.error("Attendance init error:",ee),qe()})):re==="dashboard-view"?(Y("dashboard-view"),Na().catch(ee=>{console.error("Dashboard init error:",ee),qe()})):re==="position-simulator-view"?(Y("position-simulator-view"),Vn()):re==="info-view"&&(Y("info-view"),Gn({supabaseClient:S,currentUser:U,currentUserRole:xe}).catch(ee=>{console.error("Info init error:",ee),qe()})),ye=!0;break}ye||Y("app-menu-view")}else Y("app-menu-view")}catch(b){console.error("Auth state handling error:",b),qe()}finally{F()}}else{U=null,qe();const{surveyId:b,responseId:y,surveyData:p}=Wn();if(b){await mn(b,y,p);return}const g=document.getElementById("password-update-view");(!g||g.classList.contains("hidden"))&&Y("auth-view")}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{n().catch(console.error)}):setTimeout(()=>{n().catch(console.error)},0)});async function od(e){if(e&&e.preventDefault&&e.preventDefault(),!!confirm(`ブラウザに保存されているログイン情報（キャッシュ）をクリアして、ページを再読み込みしますか？
...
（※ログインはできず、他のメンバーからの代行入力専用アカウントとなります）`);if(!e||e.trim()==="")return;const t=`dummy_${Date.now()}@local.dummy`;j("代行専用メンバー追加処理中...");try{await S.from("app_users").insert([{email:t,name:e.trim(),role:"user"}]),await ne("ADD_DUMMY_USER",`代行専用メンバー「${e.trim()}」を追加しました`),await se()}catch(n){console.error(n),alert("追加エラー: "+(n.message==="Load failed"||n.message==="Failed to fetch"?"通信に失敗しました。":n.message))}finally{F()}};window.deleteAdminUser=async function(e){if(confirm(`${e} のアクセス許可を取り消しますか？`)){j("ユーザー削除処理中...");try{await S.from("app_users").delete().eq("email",e),await ne("DELETE_USER",`ユーザー「${e}」を削除しました`),await se()}catch(t){console.error(t),alert("削除エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{F()}}};window.saveNewCategoryAdmin=async function(){var n;const e=document.getElementById("admin-new-category-name").value.trim(),t=((n=document.getElementById("admin-new-category-color"))==null?void 0:n.value)||"#bfdbfe";if(!e)return alert("カテゴリ名を入力してください");j("カテゴリ追加中...");try{const{error:a}=await S.from("event_categories").insert([{name:e,color:t}]);if(a)throw a;await se()}catch(a){alert("追加エラー: "+(a.message==="Load failed"||a.message==="Failed to fetch"?"通信に失敗しました。":a.message))}finally{F()}};window.deleteCategoryAdmin=async function(e){if(confirm(`このカテゴリを削除しますか？
...
お手数ですが、ログイン画面の『パスワードを忘れた場合』からユーザー自身で再設定を行っていただくよう案内するか、時間をおいてメンバーリストの『PWリセット送信』から再送信してください。`))}catch(s){console.error("Auto password reset email exception:",s)}await se()}catch(n){console.error(n),alert("承認エラー: "+(n.message==="Load failed"||n.message==="Failed to fetch"?"通信に失敗しました。":n.message))}finally{F()}};window.rejectRequest=async function(e){if(confirm("この申請を拒否しますか？")){j("申請拒否中...");try{await S.from("signup_requests").update({status:"rejected"}).eq("id",e),await se()}catch(t){console.error(t),alert("拒否エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{F()}}};const J={initMasterData:async()=>he(async()=>{const{data:e,error:t}=await S.from("master_data").select("*");if(t)throw t;if(oe=[],ie=[],e){const n=e.find(s=>s.key==="FAMILIES"),a=e.find(s=>s.key==="CARS");n&&(oe=n.data||[]),a&&(ie=a.data||[])}},"マスターデータ初期化中..."),getAllFamilies:async()=>oe,getFamily:async e=>oe.find(t=>t.familyName===e),addFamily:e=>{oe.push(e)},updateFamily:e=>{const t=oe.findIndex(n=>n.familyName===e.familyName);t>-1&&(oe[t]=e)},deleteFamily:e=>{oe=oe.filter(t=>t.familyName!==e)},bulkAddFamilies:e=>{oe=e},getAllCars:async()=>ie,getCar:async e=>ie.find(t=>t.id===e),addCar:e=>{ie.push(e)},updateCar:e=>{const t=ie.findIndex(n=>n.id===e.id);t>-1&&(ie[t]=e)},deleteCar:e=>{ie=ie.filter(t=>t.id!==e)},bulkAddCars:e=>{ie=e},syncMaster:async()=>he(async()=>{const{error:e}=await S.from("master_data").upsert([{key:"FAMILIES",data:oe},{key:"CARS",data:ie}]);if(e)throw e;await ne("UPDATE_MASTER","初期データ(または強制)のマスター保存を実行しました")},"マスターデータ同期中..."),saveState:async(e,t)=>he(async()=>{const n=Date.now().toString(),{error:a}=await S.from("states").insert({id:n,name:t,created_at:Date.now(),state_data:e});if(a)throw a;return await ne("SAVE_DISPATCH",`配車データ「${t}」を保存しました`),!0},"配車状態を保存中..."),getAllSavedStates:async()=>he(async()=>{const{data:e,error:t}=await S.from("states").select("*").order("created_at",{ascending:!1});if(t)throw t;return e.map(n=>({id:n.id,name:n.name,timestamp:n.created_at,state:n.state_data}))},"配車状態一覧を取得中..."),getState:async e=>he(async()=>{const{data:t,error:n}=await S.from("states").select("*").eq("id",e).single();if(n)throw n;return t?{id:t.id,name:t.name,timestamp:t.created_at,state:t.state_data}:null},"配車状態を取得中..."),deleteState:async e=>he(async()=>{const{error:t}=await S.from("states").delete().eq("id",e);if(t)throw t;return await ne("DELETE_DISPATCH",`配車データ(ID:${e})を削除しました`),!0},"配車状態を削除中..."),saveParking:async(e,t)=>he(async()=>{const n="p"+Date.now()+Math.floor(Math.random()*1e3),{error:a}=await S.from("parkings").insert({id:n,name:t,created_at:Date.now(),parking_data:e});if(a)throw a;return await ne("SAVE_PARKING",`駐車場データ「${t}」を保存しました`),!0},"駐車場データを保存中..."),getAllSavedParking:async()=>he(async()=>{const{data:e,error:t}=await S.from("parkings").select("*").order("created_at",{ascending:!1});if(t)throw t;return e.map(n=>({id:n.id,name:n.name,timestamp:n.created_at,parking:n.parking_data}))},"駐車場データ一覧を取得中..."),getParking:async e=>he(async()=>{const{data:t,error:n}=await S.from("parkings").select("*").eq("id",e).single();if(n)throw n;return t?{id:t.id,name:t.name,timestamp:t.created_at,parking:t.parking_data}:null},"駐車場データを取得中..."),updateParking:async e=>he(async()=>{const{error:t}=await S.from("parkings").update({name:e.name,parking_data:e.parking}).eq("id",e.id);if(t)throw t;return!0},"駐車場データを更新中..."),deleteParking:async e=>he(async()=>{const{error:t}=await S.from("parkings").delete().eq("id",e);if(t)throw t;return await ne("DELETE_PARKING",`駐車場データ(ID:${e})を削除しました`),!0},"駐車場データを削除中..."),addParkingMaster:(e,t)=>{Fe.push({id:"p"+Date.now()+Math.floor(Math.random()*1e3),name:t,timestamp:Date.now(),parking:e,isNew:!0})},updateParkingMaster:e=>{const t=Fe.findIndex(n=>n.id===e.id);t>-1&&(Fe[t]=e,Fe[t].isModified=!0)},deleteParkingMaster:e=>{const t=Fe.find(n=>n.id===e);t&&!t.isNew&&$n.add(e),Fe=Fe.filter(n=>n.id!==e)},syncAllMaster:async()=>he(async()=>{const{error:e}=await S.from("master_data").upsert([{key:"FAMILIES",data:oe},{key:"CARS",data:ie}]);if(e)throw e;for(const t of $n)await S.from("parkings").delete().eq("id",t);$n.clear();for(const t of Fe)if(t.isNew||t.isModified){const{error:n}=await S.from("parkings").upsert({id:t.id,name:t.name,created_at:t.timestamp,parking_data:t.parking});if(n)throw n;t.isNew=!1,t.isModified=!1}await ne("UPDATE_MASTER","マスターデータ(家族・車・駐車場)を一括保存しました")},"マスターデータ一括同期中..."),clearDatabase:async()=>he(async()=>{oe=[],ie=[],await S.from("master_data").delete().neq("key",""),await S.from("states").delete().neq("id",""),await S.from("parkings").delete().neq("id",""),await ne("CLEAR_DB","データベースの全リセットを実行しました")},"データベース初期化中...")},pd=[{familyName:"山田家",order:1,members:[{id:"p1",name:"太郎",type:"選手",isFlagTarget:!0,data:{grade:"5年",school:"A小",other:"",memo:""}},{id:"p2",name:"山田父",type:"保護者",data:{memo:""}}]},{familyName:"佐藤家",order:2,members:[{id:"p3",name:"次郎",type:"選手",isFlagTarget:!0,data:{grade:"5年",school:"B小",other:"",memo:""}},{id:"p4",name:"佐藤母",type:"保護者",data:{memo:""}}]},{familyName:"スタッフ・個人",order:99,members:[{id:"p99",name:"監督",type:"その他",data:{memo:""}}]}],gd=[{id:"c1",name:"山田カー",familyName:"山田家",baseCapacity:6,order:1},{id:"c2",name:"佐藤カー",familyName:"佐藤家",baseCapacity:5,order:2}];let qt=[],oa=[],ga=[],jt=new Set,Ht=new Set,_t=new Map,Nt=new Set,Xe=new Set,et=new Map,be={groundName:"",designated:{name:"",limit:0,memo:""},other:{name:"",memo:""}},ke={date:"",name:"",timeline:"",notes:""},K=[],ft={car:null,seat:null},La=null,Sa=null;const Ya=3,Ie=document.getElementById("nav-dispatch"),$e=document.getElementById("nav-master"),sn=document.getElementById("view-dispatch"),rn=document.getElementById("view-master"),We=document.getElementById("participant-list"),Wt=document.getElementById("car-list"),zt=document.getElementById("exclusion-list"),Ba=document.getElementById("results");document.getElementById("text-output");const Qe=document.getElementById("family-list"),bt=document.getElementById("car-list-master"),Bt=document.getElementById("parking-list-master");function Us(){const e=document.getElementById("results-section"),t=document.getElementById("main-content");t&&(t.style.display="grid",t.style.gap="1.5rem",window.innerWidth>=768?(t.style.gridTemplateColumns=`repeat(${Ya}, minmax(0, 1fr))`,e&&(e.style.gridColumn=`span ${Ya}`)):(t.style.gridTemplateColumns="repeat(1, minmax(0, 1fr))",e&&(e.style.gridColumn="auto")))}async function Vs(){qt=await J.getAllFamilies(),oa=await J.getAllCars(),ga=qt.flatMap(e=>e.members),Er(),fa(),ba(),Rn(),await ps(),await gs()}async function fd(){Fe=await J.getAllSavedParking()||[],$n.clear(),Jt(),yn(),ha()}async function Bn(){const e=document.getElementById("btn-load-logs");if(e&&!document.getElementById("btn-download-logs-csv")){const s=document.createElement("button");s.id="btn-download-logs-csv",s.className="ml-2 bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-sm font-bold shadow",s.textContent="CSVダウンロード",s.onclick=bd,e.parentNode.insertBefore(s,e.nextSibling)}try{const s=new Date;s.setMonth(s.getMonth()-6),await S.from("action_logs").delete().lt("created_at",s.toISOString())}catch(s){console.error("Log rotation error:",s)}e&&(e.textContent="読込中...");const{data:t,error:n}=await S.from("action_logs").select("*").order("created_at",{ascending:!1}).limit(50);if(e&&(e.textContent="最新を読み込み"),n){console.error("Failed to load logs:",n);return}const a=document.getElementById("log-list");if(a){if(!t||t.length===0){a.innerHTML='<p class="text-gray-500 text-center py-4">ログはありません</p>';return}a.innerHTML=t.map(s=>`
...
`)],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(s),o=document.createElement("a");o.href=r,o.download=`action_logs_${new Date().toISOString().split("T")[0]}.csv`,o.click(),URL.revokeObjectURL(r)}catch(e){console.error(e),alert("CSVの作成に失敗しました: "+e.message)}finally{F()}}function yd(){var e,t,n,a,s,r,o,i,d,l,c,m,u,f,b;We==null||We.addEventListener("change",xd),We==null||We.addEventListener("input",vd),We==null||We.addEventListener("click",hd),Wt==null||Wt.addEventListener("change",wd),zt==null||zt.addEventListener("change",Ed),(e=document.getElementById("assign-button"))==null||e.addEventListener("click",_d),(t=document.getElementById("dispatch-message-close"))==null||t.addEventListener("click",fs),Ba==null||Ba.addEventListener("change",$d),(n=document.getElementById("export-state-button"))==null||n.addEventListener("click",Sd),(a=document.getElementById("import-state-input"))==null||a.addEventListener("change",Bd),(s=document.getElementById("show-text-output-button"))==null||s.addEventListener("click",()=>{var y;(y=document.getElementById("text-output-container"))==null||y.classList.toggle("hidden"),Fn()}),(r=document.getElementById("copy-text-output-button"))==null||r.addEventListener("click",kd),(o=document.getElementById("toggle-details-button"))==null||o.addEventListener("click",Ld),(i=document.getElementById("save-state-db-button"))==null||i.addEventListener("click",Td),(d=document.getElementById("load-state-db-button"))==null||d.addEventListener("click",Cd),(l=document.getElementById("delete-state-db-button"))==null||l.addEventListener("click",Ad),(c=document.getElementById("save-parking-db-button"))==null||c.addEventListener("click",Dd),(m=document.getElementById("load-parking-db-button"))==null||m.addEventListener("click",Nd),(u=document.getElementById("delete-parking-db-button"))==null||u.addEventListener("click",Pd),(f=document.getElementById("clear-db-button"))==null||f.addEventListener("click",Od),(b=document.getElementById("btn-clear-inputs"))==null||b.addEventListener("click",window.clearCurrentInputs)}function Er(){et.clear(),qt.forEach(e=>{e.members.forEach(t=>{const n={grade:"",school:"",other:"",memo:"",...t.data||{}};t.isFlagTarget||(n.grade="",n.school="",n.other=""),et.set(t.id,n)})})}function fa(){if(We){if(We.innerHTML="",qt.length===0)return We.innerHTML='<p class="text-gray-500">データなし</p>';qt.forEach(e=>{const t=document.createElement("details");t.className="bg-gray-50 rounded border",t.open=!0;const n=document.createElement("summary");n.className="p-3 cursor-pointer select-none flex justify-between items-center",n.innerHTML=`<span class="font-semibold">${e.familyName}</span><div class="space-x-1"><button data-family-id="${e.familyName}" data-check-action="check" class="text-xs bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded">全員参加</button><button data-family-id="${e.familyName}" data-check-action="uncheck" class="text-xs bg-gray-400 hover:bg-gray-500 text-white py-1 px-2 rounded">全員不参加</button></div>`;const a=document.createElement("div");a.className="p-3 border-t border-gray-200 space-y-3",e.members.forEach(s=>{const r=jt.has(s.id),o=et.get(s.id)||{grade:"",school:"",other:"",memo:""};let i=s.isFlagTarget?`<input type="text" data-id="${s.id}" data-type="grade" value="${o.grade}" placeholder="学年" class="w-full text-sm p-1 border rounded" ${r?"":"disabled"}>
            ...
            </div></div>`})}}function Rn(){if(!zt)return;zt.innerHTML="";const e=ga.filter(t=>jt.has(t.id));if(e.length===0)return zt.innerHTML='<p class="text-gray-500 text-sm">参加者を選択してください</p>';e.forEach(t=>{zt.innerHTML+=`<div class="flex items-center"><input type="checkbox" id="ex-${t.id}" data-id="${t.id}" data-action="exclude-participant" class="mr-3" ${Xe.has(t.id)?"checked":""}><label for="ex-${t.id}">${t.name} (${t.type})</label></div>`})}function xd(e){const t=e.target;if(t.dataset.action==="select-participant"){const n=t.dataset.id,a=document.getElementById(`data-inputs-${n}`);t.checked?(jt.add(n),a&&(a.classList.remove("opacity-50"),a.querySelectorAll("input").forEach(s=>s.disabled=!1))):(jt.delete(n),Xe.delete(n),a&&(a.classList.add("opacity-50"),a.querySelectorAll("input").forEach(s=>s.disabled=!0))),Rn()}}function vd(e){const t=e.target;if(t.dataset.type){const n=et.get(t.dataset.id);n[t.dataset.type]=t.value,et.set(t.dataset.id,n)}}function wd(e){var a;const t=e.target,n=(a=t.closest("[data-car-id]"))==null?void 0:a.dataset.carId;n&&(t.dataset.action==="select-car"?t.checked?(Ht.add(n),document.getElementById(`car-options-${n}`).classList.remove("hidden")):(Ht.delete(n),Nt.delete(n),document.getElementById(`car-options-${n}`).classList.add("hidden")):t.dataset.action==="select-driver"?t.value?_t.set(n,t.value):_t.delete(n):t.dataset.action==="select-luggage"&&(t.checked?Nt.add(n):Nt.delete(n)))}function Ed(e){const t=e.target;t.dataset.action==="exclude-participant"&&(t.checked?Xe.add(t.dataset.id):Xe.delete(t.dataset.id))}function _d(){var y,p,g,w,x,h,k,L,v,I;if(Ht.size===0)return Ve("車を選択してください","error");ke={date:((y=document.getElementById("event-date"))==null?void 0:y.value)||"",name:((p=document.getElementById("event-name"))==null?void 0:p.value)||"",timeline:((g=document.getElementById("event-timeline"))==null?void 0:g.value)||"",notes:((w=document.getElementById("event-notes"))==null?void 0:w.value)||""},be={groundName:((x=document.getElementById("ground-name"))==null?void 0:x.value)||"",designated:{name:((h=document.getElementById("parking-designated-name"))==null?void 0:h.value)||"指定駐車場",limit:parseInt((k=document.getElementById("parking-designated-limit"))==null?void 0:k.value)||999,memo:((L=document.getElementById("parking-designated-memo"))==null?void 0:L.value)||""},other:{name:((v=document.getElementById("parking-other-name"))==null?void 0:v.value)||"指定以外",memo:((I=document.getElementById("parking-other-memo"))==null?void 0:I.value)||""}};let e=!1;if(K&&K.length>0&&K.some(E=>E.id!=="excluded-car")){if(confirm(`すでに配車結果が存在します。
現在の配車状態を【維持】して、追加・変更分のみを反映しますか？
（「キャンセル」を選ぶと、全てリセットして最初からやり直すか確認します）`))e=!0;else if(!confirm(`現在の状態を【全てリセット】して、最初から割り当てをやり直しますか？
（キャンセルを選ぶと処理を中断します）`))return}let t=[],n=new Map,a=[];const s=ga.filter(E=>jt.has(E.id)).map(E=>{const $=qt.find(A=>A.members.some(P=>P.id===E.id)),_=et.get(E.id)||{};return{...E,grade:_.grade,school:_.school,other:_.other,memo:_.memo,familyName:$?$.familyName:null}});if(Ht.forEach(E=>{const $=_t.get(E),_=oa.find(D=>D.id===E);if(!_)return;if(!$)return t.push(`${_.name}のドライバー未選択`);const A=s.find(D=>D.id===$);if(!A)return t.push(`${_.name}のドライバーが参加者にいません`);n.set(E,A);const P=Nt.has(E);a.push({id:E,name:_.name,familyName:_.familyName,baseCapacity:P?2:_.baseCapacity,driverId:$,capacity:P?1:_.baseCapacity-1,hasLuggage:P})}),t.length>0)return Ve(t.join("<br>"),"error");const r=new Set(Array.from(n.values()).map(E=>E.id));let o=s.filter(E=>Xe.has(E.id)&&!r.has(E.id)),i=[];e?a.forEach(E=>{let $=K.find(A=>A.id===E.id),_=[];$&&(_=$.members.filter(A=>{if(!A)return!1;let P=s.some(q=>q.id===A.id),D=Xe.has(A.id),O=r.has(A.id);return P&&!D&&!O}),_.length>E.capacity&&(_=_.slice(0,E.capacity))),i.push({...E,driver:n.get(E.id),members:_})}):i=a.map(E=>({...E,driver:n.get(E.id),members:[]}));let d=new Set(r);i.forEach(E=>E.members.forEach($=>{$&&d.add($.id)}));let l=s.filter(E=>!d.has(E.id)&&!Xe.has(E.id));i.reduce((E,$)=>E+$.capacity,0),i.reduce((E,$)=>E+$.members.length,0);let c=[...l];const m={保護者:1,兄弟:2,選手:3,その他:4};i.forEach(E=>{E.driver&&E.familyName&&c.filter(_=>_.familyName===E.familyName).sort((_,A)=>(m[_.type]||9)-(m[A.type]||9)).forEach(_=>{E.members.length<E.capacity&&(E.members.push(_),c=c.filter(A=>A.id!==_.id))})}),c.sort((E,$)=>E.isFlagTarget===$.isFlagTarget?Math.random()-.5:E.isFlagTarget?-1:1).forEach(E=>{let $=[],_=0;if(i.forEach(A=>{if(A.members.length>=A.capacity)return;let P=A.members.filter(D=>D).reduce((D,O)=>D+(O.isFlagTarget&&E.isFlagTarget?(E.grade===O.grade?1:0)+(E.school===O.school?1:0):0),0);P>_?(_=P,$=[A]):P===_&&$.push(A)}),$.length>0)$[Math.floor(Math.random()*$.length)].members.push(E);else{let A=i.filter(P=>P.members.length<P.capacity);A.length>0&&A[0].members.push(E)}}),i.forEach(E=>{for(E.members=E.members.filter($=>$);E.members.length<E.capacity;)E.members.push(null)}),e?i.sort((E,$)=>{let _=K.findIndex(P=>P.id===E.id),A=K.findIndex(P=>P.id===$.id);return _!==-1&&A!==-1?_-A:_!==-1?-1:A!==-1?1:$.members.filter(P=>P&&P.type==="選手").length-E.members.filter(P=>P&&P.type==="選手").length}):i.sort((E,$)=>$.members.filter(_=>_&&_.type==="選手").length-E.members.filter(_=>_&&_.type==="選手").length);let u=0;i.forEach(E=>{if(e){let $=K.find(_=>_.id===E.id);$?(E.assignedParking=$.assignedParking,E.assignedParking==="designated"&&u++):u<be.designated.limit?(E.assignedParking="designated",u++):E.assignedParking="other"}else u<be.designated.limit?(E.assignedParking="designated",u++):E.assignedParking="other"});const f=new Set(r);i.forEach(E=>{E.members.forEach($=>{$&&f.add($.id)})}),s.filter(E=>!f.has(E.id)&&!Xe.has(E.id)).forEach(E=>{o.some($=>$.id===E.id)||o.push(E)}),i.push({id:"excluded-car",name:"別便",capacity:999,baseCapacity:999,driver:null,members:o,hasLuggage:!1,assignedParking:"excluded"}),K=i,ya(),Fn()}function ya(){const e=document.getElementById("results");if(!e)return;if(e.innerHTML="",ft={car:null,seat:null},K.length===0){e.innerHTML='<p class="text-gray-500 bg-white p-4 rounded shadow">結果なし</p>',Gs();return}(ke.name||ke.date)&&(e.innerHTML+=`<h2 class="text-2xl font-bold mb-2">${ke.date} ${ke.name} ${be.groundName?`@${be.groundName}`:""}</h2>`);const t=K.filter(r=>r.assignedParking==="designated"),n=K.filter(r=>r.assignedParking==="other"),a=K.filter(r=>r.id==="excluded-car"),s=(r,o,i)=>`<div class="bg-white rounded shadow p-4"><h3 class="font-bold text-lg mb-2">◆${o.name||"別便"} ${r==="designated"&&o.limit<999?`(${o.limit}台)`:""}</h3><p class="text-sm text-gray-600 mb-4 whitespace-pre-line">${o.memo}</p><div class="grid grid-cols-1 md:grid-cols-3 gap-4">${i.map(Id).join("")}</div></div>`;e.innerHTML+=s("designated",be.designated,t),e.innerHTML+=s("other",be.other,n),a[0].members.length>0&&(e.innerHTML+=s("excluded",{name:"別便",memo:""},a)),Gs()}function Id(e){var r,o;`${e.id}`;let t="",n="",a="";const s=`swap-car-${e.id}`;if(e.id==="excluded-car"){t=`<div class="p-4 border-b bg-gray-100 flex-shrink-0"><h4 class="font-bold text-lg text-gray-700">合計: ${e.members.length}名</h4></div>`,a=e.members.map((d,l)=>{var f;if(!d)return"";const c=(((f=et.get(d.id))==null?void 0:f.memo)||"").trim(),m=d.isFlagTarget&&(d.grade||d.school||d.other)?[d.grade,d.school,d.other].filter(Boolean).join(" "):"",u=`seat-${e.id}-${d.id}`;return`<li class="p-2 bg-gray-100 rounded shadow-sm flex items-center justify-between">
...
`),a=new Blob([new Uint8Array([239,187,191]),n],{type:"text/csv;charset=utf-8;"}),s=document.createElement("a");s.href=URL.createObjectURL(a),s.download="members_sample.csv",s.click()}const sl=Object.freeze(Object.defineProperty({__proto__:null,get csvImportState(){return It},get currentUser(){return U},get currentUserRole(){return xe},forceHideLoading:qe,goToUsersAdmin:wr,hideLoading:F,logAction:ne,openChangePasswordModal:ms,showLoading:j,supabaseClient:S,switchAuthScreen:Y,withLoading:he},Symbol.toStringTag,{value:"Module"}));
