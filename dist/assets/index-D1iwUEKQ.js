(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();let Jt=new Date,et=[],Ve=[],qe=[],as=[],ua=[],rt=[],$e=[],Rt=[],Dt=[],$s=!1,Na=[],qt=[],ue=[];window.att_multiSelectMode=!1;window.att_selectedDates=new Set;window.att_selectedCategories=new Set;window.att_selectedGroups=new Set;function wn(e){let t=e.target_group_ids||[];if(t.length===0&&e.target_group_id&&(t=[e.target_group_id]),t.length===0)return{ids:[],name:"全体",color:"#e5e7eb"};const n=Ve.filter(a=>t.includes(a.id));return n.length===0?{ids:[],name:"全体",color:"#e5e7eb"}:{ids:t,name:n.map(a=>a.name).join(", "),color:n[0].color||"#e5e7eb",groups:n}}function Qs(e){return e.ids.length===0?'<span class="text-xs border border-gray-300 text-gray-800 px-2 py-0.5 rounded shadow-sm" style="background-color: #e5e7eb">全体</span>':e.groups.map(t=>`<span class="text-xs border border-gray-300 text-gray-800 px-2 py-0.5 rounded shadow-sm" style="background-color: ${t.color||"#e5e7eb"}">${t.name}</span>`).join(" ")}function Zs(e){if(!e)return"-";try{const t=new Date(e);if(isNaN(t.getTime()))return"-";const n=t.getMonth()+1,a=t.getDate(),s=String(t.getHours()).padStart(2,"0"),r=String(t.getMinutes()).padStart(2,"0");return`${n}/${a} ${s}:${r}`}catch{return"-"}}async function Pa(){try{$s||(Wr(),$s=!0),await sn(),Ge(),zr(),Jr()}catch(e){console.error("Attendance App Init Error:",e),typeof Ue=="function"&&Ue()}}function Wr(){var n,a,s,r,o,i,d,l,c,u,m,f,b,y,g,p,v,x,h,k,L,w,I,E,$;const e=document.getElementById("btn-logout-att");if(e&&!document.getElementById("btn-change-password-att")){const _=document.createElement("button");_.id="btn-change-password-att",_.className="text-xs md:text-sm bg-gray-500 hover:bg-gray-600 text-white px-2 py-1 md:px-3 md:py-1 rounded shadow mr-2 font-bold",_.textContent="パスワード変更",_.onclick=()=>hs(),e.parentNode.insertBefore(_,e)}(n=document.getElementById("tab-calendar"))==null||n.addEventListener("click",()=>ks("calendar")),(a=document.getElementById("tab-list"))==null||a.addEventListener("click",()=>{ks("list"),Bt()}),(s=document.getElementById("cal-prev-month"))==null||s.addEventListener("click",()=>{Jt.setMonth(Jt.getMonth()-1),Ge()}),(r=document.getElementById("cal-next-month"))==null||r.addEventListener("click",()=>{Jt.setMonth(Jt.getMonth()+1),Ge()}),(o=document.getElementById("cal-today"))==null||o.addEventListener("click",()=>{Jt=new Date,Ge()}),(i=document.getElementById("btn-add-event"))==null||i.addEventListener("click",()=>Nn()),(d=document.getElementById("btn-export-events"))==null||d.addEventListener("click",po),(l=document.getElementById("btn-import-events"))==null||l.addEventListener("click",()=>document.getElementById("input-import-events-csv").click()),(c=document.getElementById("btn-import-ics-events"))==null||c.addEventListener("click",()=>document.getElementById("input-import-events-ics").click()),(u=document.getElementById("btn-download-events-sample"))==null||u.addEventListener("click",bo),(m=document.getElementById("input-import-events-csv"))==null||m.addEventListener("change",go),(f=document.getElementById("input-import-events-ics"))==null||f.addEventListener("change",ho),(b=document.getElementById("btn-close-ics-modal-x"))==null||b.addEventListener("click",Oa),(y=document.getElementById("btn-close-ics-modal"))==null||y.addEventListener("click",Oa),(g=document.getElementById("btn-execute-ics-import"))==null||g.addEventListener("click",vo),(p=document.getElementById("ics-import-list"))==null||p.addEventListener("change",_=>{if(_.target&&_.target.classList.contains("ics-row-location-select")){const C=_.target,M=C.closest(".ics-row").querySelector(".ics-row-location");C.value&&C.value!=="custom"?M.value=C.value:C.value==="custom"&&(M.value="",M.focus())}});const t=document.getElementById("btn-group-manage");t&&(t.style.display="none"),(v=document.getElementById("btn-toggle-multiselect"))==null||v.addEventListener("click",function(){window.att_multiSelectMode=!window.att_multiSelectMode,window.att_multiSelectMode||window.att_selectedDates.clear(),this.classList.toggle("bg-blue-600",window.att_multiSelectMode),this.classList.toggle("text-white",window.att_multiSelectMode),this.classList.toggle("bg-blue-50",!window.att_multiSelectMode),this.classList.toggle("text-blue-600",!window.att_multiSelectMode),Ge(),window.att_updateMultiselectBar()}),(x=document.getElementById("btn-cal-filter"))==null||x.addEventListener("click",Ls),(h=document.getElementById("btn-cal-filter-clear"))==null||h.addEventListener("click",_a),(k=document.getElementById("btn-list-filter"))==null||k.addEventListener("click",Ls),(L=document.getElementById("btn-list-filter-clear"))==null||L.addEventListener("click",_a),(w=document.getElementById("btn-close-filter-modal-x"))==null||w.addEventListener("click",Zn),(I=document.getElementById("btn-close-filter-modal"))==null||I.addEventListener("click",Zn),(E=document.getElementById("btn-apply-filter"))==null||E.addEventListener("click",Yr),($=document.getElementById("btn-filter-clear"))==null||$.addEventListener("click",_a)}function ks(e){const t=document.getElementById("tab-calendar"),n=document.getElementById("tab-list");e==="calendar"?(document.getElementById("calendar-container").classList.remove("hidden"),document.getElementById("list-container").classList.add("hidden"),t.classList.replace("bg-white","bg-green-600"),t.classList.replace("text-green-600","text-white"),n.classList.replace("bg-green-600","bg-white"),n.classList.replace("text-white","text-green-600")):(document.getElementById("calendar-container").classList.add("hidden"),document.getElementById("list-container").classList.remove("hidden"),n.classList.replace("bg-white","bg-green-600"),n.classList.replace("text-green-600","text-white"),t.classList.replace("bg-green-600","bg-white"),t.classList.replace("text-white","text-green-600"))}async function sn(){j("イベント・出欠データ読み込み中...");try{const{data:e}=await S.from("groups").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});e&&(Ve=e);const{data:t}=await S.from("event_categories").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});t&&t.length>0?qe=t:qe=[{id:"1",name:"練習"},{id:"2",name:"試合"},{id:"3",name:"イベント"}];const n=new Date,a=new Date(n.getFullYear(),n.getMonth()-6,1),s=new Date(n.getFullYear(),n.getMonth()+7,1),{data:r}=await S.from("events").select("*").gte("start_time",a.toISOString()).lt("start_time",s.toISOString()).order("start_time");r&&(et=r);const{data:o}=await S.from("app_users").select("email, name, attribute_id, can_use_attendance");o&&(Rt=o);const{data:i}=await S.from("user_attributes").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});i&&(Dt=i);try{const{data:c}=await S.from("event_locations").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});c&&(qt=c)}catch(c){console.warn("event_locations table might not exist yet:",c),qt=[]}const{data:d}=await S.from("user_groups").select("*");d&&(rt=d,F&&(as=d.filter(c=>c.user_email===F.email)));let l=[];if(et&&et.length>0){const c=et.map(m=>m.id),{data:u}=await S.from("attendances").select("*").in("event_id",c);u&&(l=u)}$e=l,F&&(ua=l.filter(c=>c.user_email===F.email));try{const{data:c}=await S.from("master_data").select("data").eq("key","ATTENDANCE_DELEGATIONS").single();c&&c.data&&F&&(Na=c.data[F.email]||[])}catch{Na=[]}}catch(e){console.error("Attendance DB Error:",e)}finally{typeof Ue=="function"?Ue():q()}}function zr(){const e=document.getElementById("filter-group");e&&(e.innerHTML='<option value="">すべてのグループ</option>'+Ve.map(t=>`<option value="${t.id}">${t.name}</option>`).join(""))}function Jr(){const e=document.getElementById("filter-category");if(!e)return;const t=e.value;e.innerHTML='<option value="">すべてのカテゴリ</option>'+qe.map(n=>`<option value="${n.name}">${n.name}</option>`).join(""),qe.some(n=>n.name===t)&&(e.value=t)}function Ls(){const e=document.getElementById("filter-modal-content");if(!e)return;let t="";t+='<div class="mb-5">',t+='<h4 class="text-xs font-bold text-gray-400 tracking-wider uppercase mb-2">カテゴリ（複数選択）</h4>',qe.length===0?t+='<p class="text-xs text-gray-400">カテゴリが登録されていません</p>':(t+='<div class="grid grid-cols-2 gap-2">',qe.forEach(a=>{const s=window.att_selectedCategories.has(a.name)?"checked":"";t+=`
    ...
    `,Ve.length>0&&Ve.forEach(a=>{const s=window.att_selectedGroups.has(a.id)?"checked":"";t+=`
                <label class="flex items-center space-x-2 text-sm text-gray-700 cursor-pointer hover:bg-gray-50 p-1.5 rounded transition">
            ...
            `}),t+="</div>",t+="</div>",e.innerHTML=t,document.getElementById("filter-modal").classList.remove("hidden")}function Zn(){document.getElementById("filter-modal").classList.add("hidden")}function Yr(){const e=document.querySelectorAll(".filter-cat-checkbox"),t=document.querySelectorAll(".filter-group-checkbox");window.att_selectedCategories.clear(),e.forEach(n=>{n.checked&&window.att_selectedCategories.add(n.value)}),window.att_selectedGroups.clear(),t.forEach(n=>{n.checked&&window.att_selectedGroups.add(n.value)}),Xs(),Ge(),Bt(),Zn()}function _a(){window.att_selectedCategories.clear(),window.att_selectedGroups.clear(),Xs(),Ge(),Bt(),Zn()}function Xs(){const e=window.att_selectedCategories.size+window.att_selectedGroups.size,t=document.getElementById("cal-filter-badge"),n=document.getElementById("btn-cal-filter-clear"),a=document.getElementById("btn-cal-filter"),s=document.getElementById("list-filter-badge"),r=document.getElementById("btn-list-filter-clear"),o=document.getElementById("btn-list-filter");e>0?(t&&(t.textContent=e,t.classList.remove("hidden")),n&&n.classList.remove("hidden"),a&&(a.classList.remove("bg-[#e6e5dd]","hover:bg-[#dcdad2]","text-slate-800"),a.classList.add("bg-green-100","hover:bg-green-200","text-green-800","border-green-300")),s&&(s.textContent=e,s.classList.remove("hidden")),r&&r.classList.remove("hidden"),o&&(o.classList.remove("bg-gray-100","hover:bg-gray-200","text-gray-800"),o.classList.add("bg-green-100","hover:bg-green-200","text-green-800","border-green-300"))):(t&&t.classList.add("hidden"),n&&n.classList.add("hidden"),a&&(a.classList.remove("bg-green-100","hover:bg-green-200","text-green-800","border-green-300"),a.classList.add("bg-[#e6e5dd]","hover:bg-[#dcdad2]","text-slate-800")),s&&s.classList.add("hidden"),r&&r.classList.add("hidden"),o&&(o.classList.remove("bg-green-100","hover:bg-green-200","text-green-800","border-green-300"),o.classList.add("bg-gray-100","hover:bg-gray-200","text-gray-800")))}function er(){return et.filter(e=>{if(window.att_selectedCategories&&window.att_selectedCategories.size>0&&!window.att_selectedCategories.has(e.category))return!1;if(window.att_selectedGroups&&window.att_selectedGroups.size>0){const t=wn(e);if(t.ids.length===0){if(!window.att_selectedGroups.has("all"))return!1}else if(!t.ids.some(a=>window.att_selectedGroups.has(a)))return!1}return!0})}function Ge(){const e=Jt.getFullYear(),t=Jt.getMonth();document.getElementById("cal-current-month").textContent=`${e}年${t+1}月`;const n=document.getElementById("calendar-grid");n&&n.classList.remove("gap-1","gap-px","gap-2","p-1","p-2","p-4"),Array.from(n.children).forEach((i,d)=>{d>=7&&n.removeChild(i)});const s=new Date(e,t,1).getDay(),r=new Date(e,t,1-s),o=new Date;for(let i=0;i<42;i++){const d=new Date(r);d.setDate(r.getDate()+i);const l=d.getFullYear(),c=d.getMonth(),u=d.getDate(),m=c===t,f=`${l}-${String(c+1).padStart(2,"0")}-${String(u).padStart(2,"0")}`,b=window.att_multiSelectMode&&window.att_selectedDates.has(f),y=d.getDay(),g=mo(d),p=l===o.getFullYear()&&c===o.getMonth()&&u===o.getDate(),v=document.createElement("div");let x="border-r border-b min-h-[100px] flex flex-col p-0 cursor-pointer";m?g||y===0?x+=" bg-sunday-hatch":y===6?x+=" bg-saturday-hatch":x+=" bg-white":x+=" bg-gray-50 opacity-60",b&&(x="border-2 border-blue-500 min-h-[100px] flex flex-col p-0 bg-blue-50/70 cursor-pointer z-10"),p&&!window.att_multiSelectMode&&(x+=" today-cell-border"),v.className=x,v.onclick=()=>{window.att_multiSelectMode?(window.att_selectedDates.has(f)?window.att_selectedDates.delete(f):window.att_selectedDates.add(f),Ge(),window.att_updateMultiselectBar()):Nn(f)};const h=document.createElement("div");let k="text-gray-700";m&&(g||y===0?k="text-red-600 font-bold":y===6&&(k="text-blue-600 font-bold")),h.className=`text-right text-[11px] ${k} mb-0 pr-1 pt-1 leading-none`,h.textContent=u,v.appendChild(h);const L=document.createElement("div");L.className="flex-1 overflow-hidden flex flex-col gap-0";const I=er().filter(_=>_.start_time&&_.start_time.startsWith(f)),E=I.slice(0,5),$=I.length>5;if(E.forEach(_=>{const C=document.createElement("div"),M=ua.find(A=>A.event_id===_.id);let N="",P="text-gray-800";if(_.requires_attendance){const A=M?M.status:"未入力";A==="出席"?(N='<span class="inline-block text-[9px] font-bold text-white bg-blue-600 rounded px-0.5 mr-0.5 leading-none shrink-0 align-middle">出</span>',P="text-blue-700 font-bold"):A==="欠席"?(N='<span class="inline-block text-[9px] font-bold text-white bg-gray-400 rounded px-0.5 mr-0.5 leading-none shrink-0 align-middle">欠</span>',P="text-gray-800 opacity-70"):A==="保留"||A==="未定"?(N='<span class="inline-block text-[9px] font-bold text-white bg-amber-500 rounded px-0.5 mr-0.5 leading-none shrink-0 align-middle">保</span>',P="text-gray-800"):(N='<span class="inline-block text-[9px] font-bold text-white bg-red-500 rounded px-0.5 mr-0.5 leading-none shrink-0 align-middle">未</span>',P="text-red-600 font-bold")}const U=qe.find(A=>A.name===_.category),O=(U==null?void 0:U.color)||"#bfdbfe",B=(_.title||"").replace(/[\r\n]+/g," ");C.className=`text-[10px] rounded px-0.5 py-px truncate whitespace-nowrap overflow-hidden text-ellipsis w-full text-left cursor-pointer hover:opacity-80 leading-tight mb-0.5 ${P}`,C.style.backgroundColor=O,C.innerHTML=`${N}${B}`,C.title=_.title,C.onclick=A=>{A.stopPropagation(),window.att_openEventDetail(_.id)},L.appendChild(C)}),$){const _=document.createElement("div");_.className="text-[10px] text-gray-500 text-center mt-[1px] cursor-pointer hover:underline",_.textContent=`他 ${I.length-5} 件`,_.onclick=C=>{C.stopPropagation(),alert(`${f} の予定が多すぎます。リストビューで確認してください。`)},L.appendChild(_)}v.appendChild(L),n.appendChild(v)}}const ss=["日","月","火","水","木","金","土"];function Kr(e){const t=new Date(e);if(isNaN(t.getTime()))return e;const n=t.getDate(),a=ss[t.getDay()];return`${n}日(${a})`}function Qr(e,t,n){const a=new Date(e);if(isNaN(a.getTime()))return"日時未定";const s=a.getMonth()+1,r=a.getDate(),o=ss[a.getDay()],i=`${s}/${r}(${o})`;if(n)return`${i} 終日`;const d=e.substring(11,16);let l="";if(t){const c=new Date(t);isNaN(c.getTime())||(l=` - ${t.substring(11,16)}`)}return`${i}${d}${l}`}function Zr(e){if(!e)return"";const t=new Date(e);if(isNaN(t.getTime()))return"";const n=t.getFullYear(),a=t.getMonth()+1,s=t.getDate(),r=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${n}/${a}/${s} ${r}:${o}`}function Bt(){const e=er(),t=document.getElementById("event-list-content");if(e.length===0){t.innerHTML='<p class="text-gray-500 p-4">表示するイベントがありません。</p>';return}const n=[...e].sort((i,d)=>i.start_time?d.start_time?i.start_time.localeCompare(d.start_time):-1:1),a={};n.forEach(i=>{const d=i.start_time?i.start_time.split("T")[0]:"未定";a[d]||(a[d]=[]),a[d].push(i)});const s=new Date,r=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`;let o="";Object.keys(a).forEach(i=>{const d=a[i];let l="日時未定",c="";i!=="未定"&&(l=Kr(i),i===r&&(c=`<span class="ml-2 bg-green-600 text-white text-xs px-2.5 py-0.5 rounded-full font-bold shadow-sm">${new Date(i).getDate()}日(今日)</span>`)),o+=`
        <div class="space-y-2 mb-4">
            <div class="flex items-center text-sm font-bold text-gray-700 border-b border-gray-200 pb-1 px-1">
                <span>${l}</span>
                ${c}
            </div>
        `,d.forEach(u=>{const m=wn(u);m.name,m.color;const f=qe.find(L=>L.name===u.category),b=(f==null?void 0:f.color)||"#bfdbfe",y=ua.find(L=>L.event_id===u.id);let g=y&&y.status?y.status:"未回答";g==="未定"&&(g="保留");const p=Qr(u.start_time,u.end_time,u.is_all_day);let v="不明";if(u.created_by){const L=Rt.find(w=>w.email===u.created_by);v=L&&L.name||u.created_by.split("@")[0]}const x=Zr(u.created_at),h=u.created_by?`
            ...
            `}),o+="</div>"}),t.innerHTML=o}function Nn(e="",t=null,n=!1,a=null){let s="";t&&(s=t.title.replace(/"/g,"&quot;"),n||(s+=" (コピー)"));const r=!t&&!n;a&&a.length>0?ue=[...a]:t?ue=[t.start_time.split("T")[0]]:e?ue=[e]:ue=[new Date().toISOString().split("T")[0]],window.att_modalSelectedDates=ue,window.att_isEditingModal=n;const o=t&&t.start_time&&!t.is_all_day?t.start_time.split("T")[1].substring(0,5):r?"12:30":"",i=t&&t.end_time&&!t.is_all_day?t.end_time.split("T")[1].substring(0,5):r?"17:00":"",d=t?t.is_all_day:!1,l=t?t.category:"",c=t?(t.location||"").replace(/"/g,"&quot;"):"",u=t?(t.description||"").replace(/</g,"&lt;").replace(/>/g,"&gt;"):"",m=t?t.requires_attendance:!0,f=t?t.require_detailed_attendance:!1,b=o?o.split(":")[0]:"",y=o?o.split(":")[1]:"",g=i?i.split(":")[0]:"",p=i?i.split(":")[1]:"",v=!c||!qt.some(T=>(T.url?`${T.name} ${T.url}`:T.name)===c);let x="",h="";if(c){const T=c.match(/(https?:\/\/[^\s\<\>\"]+)/);T?(h=T[0],x=c.replace(h,"").trim()):x=c}const k=!!(t&&t.attendance_deadline&&t.attendance_deadline!==Et(t.start_time.split("T")[0])),L=Et(ue[0])?Et(ue[0]).split("T")[0]:"",w=t&&t.attendance_deadline?t.attendance_deadline.split("T")[0]:L,I=t&&t.attendance_deadline?t.attendance_deadline.split("T")[1].substring(0,5):"12:00",E=I?I.split(":")[0]:"12",$=I?I.split(":")[1]:"00",_=T=>'<option value="">--</option>'+Array.from({length:24},(D,G)=>String(G).padStart(2,"0")).map(D=>`<option value="${D}" ${D===T?"selected":""}>${D}</option>`).join(""),C=T=>'<option value="">--</option>'+Array.from({length:60},(D,G)=>String(G).padStart(2,"0")).map(D=>`<option value="${D}" ${D===T?"selected":""}>${D}</option>`).join(""),M=t?t.target_group_ids&&t.target_group_ids.length>0?t.target_group_ids:t.target_group_id?[t.target_group_id]:[]:[],N=n?"イベントを編集":t?"イベントを複製":"新規イベント登録",P=`
        <div class="border p-2 rounded max-h-32 overflow-y-auto space-y-1 bg-white">
            <label class="flex items-center space-x-2 cursor-pointer">
                <input type="checkbox" id="ev-group-all" value="all" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" ${M.length===0?"checked":""}>
                <span class="text-xs font-medium">全体</span>
            </label>
            ${Ve.map(T=>`
                <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="ev-group-cb" value="${T.id}" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" ${M.includes(T.id)?"checked":""}>
            ...
            <div class="space-y-3 overflow-y-auto pr-1 flex-1">
                ...
                <div class="flex space-x-2">
                    <div class="w-1/2">
                        ...
                        <select id="ev-category" class="w-full border p-1.5 rounded text-xs bg-white">
                            ${qe.map(T=>`<option value="${T.name}" ${T.name===l?"selected":""}>${T.name}</option>`).join("")}
                        </select>
                    </div>
                ...
                <div class="flex flex-col space-y-1.5">
                    ...
                    <select id="ev-location-select" class="w-full border p-1.5 rounded text-xs font-medium bg-white" onchange="window.att_onLocationSelectChange(this.value)">
                        ...
                        ${qt.map(T=>{const D=T.url?`${T.name} ${T.url}`:T.name;return`<option value="${D}" ${c===D?"selected":""}>${T.name}${T.url?" (URLあり)":""}</option>`}).join("")}
                    </select>
    ...
    </div>`;document.getElementById("attendance-modals").innerHTML=O,Ft(),n||Pn();const B=document.getElementById("ev-group-all"),A=document.querySelectorAll('input[name="ev-group-cb"]');B.addEventListener("change",function(){this.checked&&A.forEach(T=>T.checked=!1)}),A.forEach(T=>{T.addEventListener("change",function(){this.checked&&(B.checked=!1)})})}async function Xr(e=null){var C,M,N,P,U,O;const t=document.getElementById("ev-title").value.trim(),n=document.querySelectorAll('#ev-dates-container input[type="date"]'),a=Array.from(n).map(B=>B.value).filter(Boolean);if(!t)return alert("イベント名は必須です");if(a.length===0)return alert("日付を1つ以上指定してください");const s=document.getElementById("ev-time-h").value,r=document.getElementById("ev-time-m").value;let o="";(s||r)&&(o=`${s||"00"}:${r||"00"}`);const i=document.getElementById("ev-end-time-h").value,d=document.getElementById("ev-end-time-m").value;let l="";(i||d)&&(l=`${i||"00"}:${d||"00"}`);const c=document.getElementById("ev-all-day").checked,u=document.getElementById("ev-category").value,m=document.getElementById("ev-description").value,f=document.getElementById("ev-location-select");let b="";if(f)if(f.value==="custom"){const B=((C=document.getElementById("ev-location-custom-name"))==null?void 0:C.value.trim())||"",A=((M=document.getElementById("ev-location-custom-url"))==null?void 0:M.value.trim())||"";b=A?`${B} ${A}`:B}else b=f.value;const y=document.getElementById("ev-attendance-type").value,g=y!=="none",p=y==="detailed",v=((N=document.getElementById("ev-deadline-custom-cb"))==null?void 0:N.checked)||!1,x=(P=document.getElementById("ev-deadline-date"))==null?void 0:P.value,h=(U=document.getElementById("ev-deadline-time-h"))==null?void 0:U.value,k=(O=document.getElementById("ev-deadline-time-m"))==null?void 0:O.value,L=document.getElementById("ev-group-all").checked;let w=[];L||document.querySelectorAll('input[name="ev-group-cb"]:checked').forEach(B=>w.push(B.value));const I=w.length>0?w[0]:null,E=B=>new Promise(A=>setTimeout(A,B)),$=3;let _=0;for(;_<$;){_++,_>1?(j(`通信リトライ中 (${_-1}/${$-1}回目)...`),await E(1500)):j("イベント保存中...");try{if(e){const B=a[0],A=`${B}T${o||"00:00"}:00`;let T=null;l&&(T=`${B}T${l}:00`);let D=null;g&&(v?x&&h&&k&&(D=`${x}T${h}:${k}:00`):D=Et(B));const G={title:t,category:u,description:m,location:b,start_time:A,end_time:T,is_all_day:c,requires_attendance:g,require_detailed_attendance:p,attendance_deadline:D,target_group_id:I,target_group_ids:w.length>0?w:null},{error:H}=await S.from("events").update(G).eq("id",e);if(H)throw H;await ae("UPDATE_EVENT",`イベント「${t}」を更新しました`)}else{const B=a.map(T=>{const D=`${T}T${o||"00:00"}:00`;let G=null;l&&(G=`${T}T${l}:00`);let H=null;return g&&(v?x&&h&&k&&(H=`${x}T${h}:${k}:00`):H=Et(T)),{title:t,category:u,description:m,location:b,start_time:D,end_time:G,is_all_day:c,requires_attendance:g,require_detailed_attendance:p,attendance_deadline:H,target_group_id:I,target_group_ids:w.length>0?w:null,created_by:F==null?void 0:F.email}}),{error:A}=await S.from("events").insert(B);if(A)throw A;await ae("CREATE_EVENT",`イベント「${t}」を${B.length}件作成しました`)}await sn(),Ge(),document.getElementById("list-container").classList.contains("hidden")||Bt(),!e&&typeof window.att_clearDateSelection=="function"&&window.att_clearDateSelection(),window.att_closeModal();break}catch(B){console.error(`Save Event Attempt ${_} Error:`,B);const A=B.message==="Load failed"||B.message==="Failed to fetch"||!B.code;if(_<$&&A)continue;{let T=B.message||String(B);B.details&&(T+=`
Details: `+B.details),B.hint&&(T+=`
Hint: `+B.hint),B.code&&(T+=`
Code: `+B.code),alert("保存エラー: "+T+`
（ネットワーク接続をご確認のうえ、再度お試しください）`);break}}}q()}async function eo(e){if(confirm("このイベントを削除しますか？")){j("イベント削除中...");try{await S.from("events").delete().eq("id",e),await ae("DELETE_EVENT",`イベント(ID:${e})を削除しました`),await sn(),Ge(),Bt(),window.att_closeModal()}catch(t){console.error(t)}finally{q()}}}function tr(e,t,n=!1){const a=t.ids.length===0||as.some(l=>t.ids.includes(l.group_id)),s=Rt.find(l=>l.email===F.email),r=s?s.can_use_attendance!==!1:!0,o=[];r&&o.push({email:F.email,name:"自分 ( "+((F==null?void 0:F.name)||F.email.split("@")[0])+" )",canAttend:a}),Na.forEach(l=>{const c=Rt.find(u=>u.email===l);if(c&&c.can_use_attendance!==!1){const u=t.ids.length===0||rt.some(m=>t.ids.includes(m.group_id)&&m.user_email===l);o.push({email:l,name:c.name||l.split("@")[0],canAttend:u})}});let i=!1;return{formsHtml:o.map((l,c)=>{if(!l.canAttend)return`<div class="p-3 bg-gray-50 border rounded mb-2">
                <h4 class="font-bold text-gray-700 mb-1">${l.name}</h4>
                <p class="text-xs text-red-500">※対象グループに所属していないため入力できません</p>
            </div>`;i=!0;const u=$e.find(y=>y.event_id===e.id&&y.user_email===l.email)||{};let m=u.status||"未回答";m==="未定"&&(m="保留");let f="否",b=u.comment||"";return b.startsWith("[荷物車:可]")?(f="可",b=b.substring(8)):b.startsWith("[荷物車:否]")&&(f="否",b=b.substring(8)),`
        ...
        </div>`}).join(""),hasAnyForm:i}}window.att_openEventDetail=window.openEventDetailModal=function(e,t="basic"){const n=et.find(O=>O.id===e);if(!n)return;const a=wn(n);a.name,a.color;const s=qe.find(O=>O.name===n.category),r=(s==null?void 0:s.color)||"#bfdbfe";let o="日時未定";n.is_all_day&&n.start_time?o=n.start_time.substring(0,10)+" (終日)":n.start_time&&(o=n.start_time.substring(0,16).replace("T"," "),n.end_time&&(o+=" 〜 "+n.end_time.substring(11,16)));const i=ua.find(O=>O.event_id===n.id)||{};let d=i&&i.status?i.status:"未回答";d==="未定"&&(d="保留");const l=n.attendance_deadline?new Date>new Date(n.attendance_deadline):!1;let c=n.attendance_deadline?n.attendance_deadline.replace("T"," ").substring(0,16):"設定なし";a.ids.length===0||as.some(O=>a.ids.includes(O.group_id));let u=[];if(a.ids.length===0)u=Rt.filter(O=>O.can_use_attendance!==!1);else{const O=rt.filter(T=>a.ids.includes(T.group_id)).map(T=>T.user_email),A=$e.filter(T=>T.event_id===n.id).map(T=>T.user_email);u=Rt.filter(T=>T.can_use_attendance!==!1&&(O.includes(T.email)||A.includes(T.email)))}window.att_statusViewType||(window.att_statusViewType="group"),window.att_statusFilter||(window.att_statusFilter="all");const m=window.att_statusViewType==="group";let f=0,b=0,y=0;u.forEach(O=>{const B=$e.find(A=>A.event_id===n.id&&A.user_email===O.email);B&&B.status==="出席"?f++:B&&B.status==="欠席"?b++:y++});const g=[];m?Ve.forEach(O=>{const B=rt.filter(W=>W.group_id===O.id).map(W=>W.user_email),A=u.filter(W=>B.includes(W.email));let T=0,D=0,G=0,H=!1;A.forEach(W=>{const R=$e.find(z=>z.event_id===n.id&&z.user_email===W.email);R&&R.status&&R.status!=="未回答"?(H=!0,R.status==="出席"?T++:R.status==="欠席"?D++:G++):G++}),H&&g.push({name:O.name,attending:T,absent:D,pending:G})}):Dt.forEach(O=>{const B=u.filter(H=>H.attribute_id===O.id);let A=0,T=0,D=0,G=!1;B.forEach(H=>{const W=$e.find(R=>R.event_id===n.id&&R.user_email===H.email);W&&W.status&&W.status!=="未回答"?(G=!0,W.status==="出席"?A++:W.status==="欠席"?T++:D++):D++}),G&&g.push({name:O.name,attending:A,absent:T,pending:D})});const p=`
    ...
    `;g.length===0?x+=`
        ...
        `:x+=g.map(O=>`
            <tr class="border-b border-gray-100 hover:bg-gray-50/30 transition">
                <td class="px-4 py-2.5 text-gray-700 font-semibold text-xs">${O.name}</td>
                <td class="px-4 py-2.5 text-center text-green-600 font-bold text-xs">${O.attending}</td>
                <td class="px-4 py-2.5 text-center text-red-500 font-bold text-xs">${O.absent}</td>
                <td class="px-4 py-2.5 text-center text-gray-500 text-xs">${O.pending}</td>
            </tr>
        `).join("");const h=`
    ...
    `,k=u.filter(O=>{const B=$e.find(T=>T.event_id===n.id&&T.user_email===O.email),A=(B==null?void 0:B.status)||"未回答";return window.att_statusFilter==="all"?!0:window.att_statusFilter==="answered"?A==="出席"||A==="欠席"||A==="保留"||A==="未定":window.att_statusFilter==="attending"?A==="出席":window.att_statusFilter==="absent"?A==="欠席":window.att_statusFilter==="pending"?A==="保留"||A==="未定":window.att_statusFilter==="unanswered"?A==="未回答"||!A:!0});window.att_statusSortKey||(window.att_statusSortKey="default"),window.att_statusSortOrder||(window.att_statusSortOrder="asc");const L=window.att_statusSortKey,w=window.att_statusSortOrder;L!=="default"&&k.sort((O,B)=>{var D,G;let A,T;if(L==="name")A=O.name||O.email.split("@")[0],T=B.name||B.email.split("@")[0];else if(L==="group")if(m){const H=rt.filter(R=>R.user_email===O.email).map(R=>R.group_id);A=Ve.filter(R=>H.includes(R.id)).map(R=>R.name).join(", ")||"-";const W=rt.filter(R=>R.user_email===B.email).map(R=>R.group_id);T=Ve.filter(R=>W.includes(R.id)).map(R=>R.name).join(", ")||"-"}else A=((D=Dt.find(H=>H.id===O.attribute_id))==null?void 0:D.name)||"-",T=((G=Dt.find(H=>H.id===B.attribute_id))==null?void 0:G.name)||"-";else if(L==="status"){const H=W=>{const R=$e.find(J=>J.event_id===n.id&&J.user_email===W.email),z=(R==null?void 0:R.status)||"未回答";return z==="出席"?1:z==="保留"||z==="未定"?2:z==="未回答"?3:z==="欠席"?4:5};A=H(O),T=H(B)}else if(L==="comment"){const H=W=>{const R=$e.find(ne=>ne.event_id===n.id&&ne.user_email===W.email);if(!R||!R.status||R.status==="未回答")return"";let z=R.comment||"",J="否";z.startsWith("[荷物車:可]")?(J="可",z=z.substring(8)):z.startsWith("[荷物車:否]")&&(J="否",z=z.substring(8));let ye=[];return n.require_detailed_attendance&&(R.accompanying_persons&&ye.push(`同伴: ${R.accompanying_persons}`),R.car_capacity&&R.car_capacity>0&&(ye.push(`車出: 可[${R.car_capacity}人]`),ye.push(`荷物車: ${J}`))),z.trim()&&ye.push(`メモ: ${z.trim()}`),ye.join(", ")};A=H(O),T=H(B)}else if(L==="updated_at"){const H=$e.find(R=>R.event_id===n.id&&R.user_email===O.email),W=$e.find(R=>R.event_id===n.id&&R.user_email===B.email);A=H?new Date(H.updated_at).getTime():0,T=W?new Date(W.updated_at).getTime():0}return A<T?w==="asc"?-1:1:A>T?w==="asc"?1:-1:0});const E=[{type:"all",label:"すべて"},{type:"answered",label:"回答済"},{type:"attending",label:"出席"},{type:"absent",label:"欠席"},{type:"pending",label:"保留"},{type:"unanswered",label:"未回答"}].map(O=>{const B=window.att_statusFilter===O.type;return`<button onclick="window.att_setStatusFilter('${n.id}', '${O.type}')" class="px-2.5 py-1 rounded-full text-xs font-bold transition ${B?"bg-blue-600 text-white shadow-sm":"bg-gray-100 text-gray-600 hover:bg-gray-200"}">${O.label}</button>`}).join(" ");let $="";k.length===0?$=`
            <tr>
                <td colspan="5" class="px-4 py-6 text-center text-gray-400 text-xs">該当するメンバーはいません。</td>
            </tr>
        `:$=k.map(O=>{var ye;const B=O.name||O.email.split("@")[0];let A="-";if(m){const ne=rt.filter(de=>de.user_email===O.email).map(de=>de.group_id);A=Ve.filter(de=>ne.includes(de.id)).map(de=>de.name).join(", ")||"-"}else A=((ye=Dt.find(ne=>ne.id===O.attribute_id))==null?void 0:ye.name)||"-";const T=$e.find(ne=>ne.event_id===n.id&&ne.user_email===O.email);let D=(T==null?void 0:T.status)||"未回答";D==="未定"&&(D="保留");let G="";D==="出席"?G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-green-100 text-green-800 border border-green-200">🟢 参加</span>':D==="欠席"?G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-red-100 text-red-800 border border-red-200">❌ 不参加</span>':D==="保留"?G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-yellow-100 text-yellow-800 border border-yellow-200">❓ 未定/その他</span>':G='<span class="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold bg-gray-100 text-gray-500 border border-gray-200">❓ 未定/その他</span>';let H=(T==null?void 0:T.comment)||"",W="否";H.startsWith("[荷物車:可]")?(W="可",H=H.substring(8)):H.startsWith("[荷物車:否]")&&(W="否",H=H.substring(8));let R=[];T&&T.status&&T.status!=="未回答"&&(n.require_detailed_attendance&&(T.accompanying_persons&&R.push(`同伴: ${T.accompanying_persons}`),T.car_capacity&&T.car_capacity>0&&(R.push(`車出: 可[${T.car_capacity}人]`),R.push(`荷物車: ${W}`))),H.trim()&&R.push(`メモ: ${H.trim()}`));const z=R.length>0?R.join(", "):"-",J=T?Zs(T.updated_at):"-";return`
            ...
            `}).join("");const _=O=>L!==O?'<span class="text-gray-300 ml-1">⇅</span>':w==="asc"?'<span class="text-blue-600 ml-1">▲</span>':'<span class="text-blue-600 ml-1">▼</span>',C=`
    ...
    `,M=t==="basic"?"border-b-2 border-blue-500 text-blue-600 font-bold":"text-gray-500 hover:text-gray-700",N=t==="attendance"?"border-b-2 border-blue-500 text-blue-600 font-bold":"text-gray-500 hover:text-gray-700",P=t==="status"?"border-b-2 border-blue-500 text-blue-600 font-bold":"text-gray-500 hover:text-gray-700",U=`
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100]">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
            ...
            <div class="flex border-b shrink-0">
                <button onclick="window.att_openEventDetail('${n.id}', 'basic')" class="flex-1 py-2 text-sm font-medium ${M}">基本情報</button>
            ...
            <div class="p-4 overflow-y-auto">
                ${t==="basic"?`
                    <div class="text-sm text-gray-600 mb-4 space-y-1">
                        ...
                        <p><strong>場所:</strong> ${nr(n.location)}</p>
                        ...
                        <p class="flex items-center gap-1 mt-1"><strong>対象:</strong> ${Qs(a)}</p>
                ...
                `:t==="attendance"?`
                    <div class="space-y-4">
                        ...
                        ${(()=>{const{formsHtml:O,hasAnyForm:B}=tr(n,a,l);return O+(B?`
    ...
    </div>`;document.getElementById("attendance-modals").innerHTML=U};function to(e){const t=et.find(i=>i.id===e);if(!t)return;const n=wn(t),a=t.attendance_deadline?new Date>new Date(t.attendance_deadline):!1,{formsHtml:s,hasAnyForm:r}=tr(t,n,a),o=`
    ...
    </div>`;document.getElementById("attendance-modals").innerHTML=o}async function no(e){const t=document.querySelectorAll("[data-target-email]");if(t.length===0)return window.att_closeModal();const n=et.find(s=>s.id===e);if(!n)return;const a=[];t.forEach(s=>{const r=s.getAttribute("data-target-email"),o=s.querySelector('select[id^="att-status-"]');if(o){const i=s.querySelector('input[id^="att-acc-"]'),d=s.querySelector('select[id^="att-car-flag-"]'),l=s.querySelector('input[id^="att-car-cap-"]'),c=s.querySelector('select[id^="att-luggage-flag-"]'),u=s.querySelector('textarea[id^="att-comment-"]'),m=d?d.value:"否",f=m==="可"&&l&&parseInt(l.value)||0;let b=u?u.value.trim():"";n.require_detailed_attendance&&m==="可"&&(b=`[荷物車:${c?c.value:"否"}]`+b),a.push({event_id:e,user_email:r,status:o.value,accompanying_persons:i?i.value:"",car_capacity:f,separate_action:null,comment:b,updated_at:new Date().toISOString()})}}),j("出欠保存中...");try{const{error:s}=await S.from("attendances").upsert(a,{onConflict:"event_id, user_email"});if(s)throw s;await ae("UPDATE_ATTENDANCE",`イベント(ID:${e})の出欠を ${a.length}件更新しました`),await sn(),Ge(),Bt(),window.att_openEventDetail(e,"status")}catch(s){console.error("Save Attendance Error:",s),s.message==="Load failed"||s.message==="Failed to fetch"?alert("出欠登録エラー: 通信に失敗しました。ネットワーク接続やデータベースの状態を確認してください。"):alert("出欠登録エラー: "+s.message)}finally{q()}}function ao(){const t=[["タイトル","日付","開始時刻","終了時刻","終日","カテゴリ","対象グループ","場所","出欠管理","詳細出欠","説明","回答期限"].join(",")];et.forEach(o=>{const i=o.start_time?o.start_time.split("T")[0]:"",d=o.start_time&&!o.is_all_day?o.start_time.split("T")[1].substring(0,5):"",l=o.end_time&&!o.is_all_day?o.end_time.split("T")[1].substring(0,5):"",u=wn(o).name,m=f=>f==null?'""':`"${String(f).replace(/"/g,'""')}"`;t.push([m(o.title),m(i),m(d),m(l),o.is_all_day?"TRUE":"FALSE",m(o.category),m(u),m(o.location),o.requires_attendance?"TRUE":"FALSE",o.require_detailed_attendance?"TRUE":"FALSE",m(o.description),m(o.attendance_deadline)].join(","))});const n=new Uint8Array([239,187,191]),a=new Blob([n,t.join(`
`)],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(a),r=document.createElement("a");r.href=s,r.download=`events_${new Date().toISOString().split("T")[0]}.csv`,r.click(),URL.revokeObjectURL(s)}function so(e){const t=[];let n=[],a="",s=!1;for(let r=0;r<e.length;r++){const o=e[r];s?o==='"'?r+1<e.length&&e[r+1]==='"'?(a+='"',r++):s=!1:a+=o:o==='"'?s=!0:o===","?(n.push(a),a=""):o===`
`||o==="\r"?(n.push(a),t.push(n),n=[],a="",o==="\r"&&r+1<e.length&&e[r+1]===`
`&&r++):a+=o}return(a||n.length>0)&&(n.push(a),t.push(n)),t}window.att_importCsv=async function(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=async a=>{const s=a.target.result,r=so(s);if(r.length<2)return alert("インポートするデータがありません。");const o=[];for(let c=1;c<r.length;c++){const u=r[c];if(u.length<2||!u[0]||!u[1])continue;const m=u[0],f=u[1],b=u[2],y=u[3],g=(u[4]||"").toUpperCase()==="TRUE",p=u[5],v=u[6]||"",x=u[7],h=(u[8]||"").toUpperCase()==="TRUE"||(u[8]||"").trim()==="",k=(u[9]||"").toUpperCase()==="TRUE",L=u[10],w=u[11]||null,I=`${f}T${b||"00:00"}:00`;let E=null;y&&(E=`${f}T${y}:00`);const $=v.split(",").map(N=>N.trim()),_=Ve.filter(N=>$.includes(N.name)),C=_.length>0?_.map(N=>N.id):null,M=C?C[0]:null;o.push({title:m,category:p||null,description:L||null,location:x||null,start_time:I,end_time:E,is_all_day:g,requires_attendance:h,require_detailed_attendance:k,attendance_deadline:w,target_group_id:M,target_group_ids:C,created_by:F==null?void 0:F.email})}if(o.length===0)return alert(`インポート可能なイベントがありませんでした。
タイトルと日付は必須です。`);const i=o.map(c=>{const u=c.is_all_day?c.start_time.split("T")[0]+" (終日)":c.start_time.replace("T"," ").substring(0,16);return`<div class="text-sm border-b py-2 border-gray-200">
        ...
        </div>`,l=document.createElement("div");l.innerHTML=d,document.body.appendChild(l.firstElementChild),document.getElementById("btn-cancel-import").onclick=()=>{document.getElementById("csv-import-confirm-modal").remove(),document.getElementById("file-import-csv").value=""},document.getElementById("btn-exec-import").onclick=async()=>{document.getElementById("csv-import-confirm-modal").remove(),j("インポート実行中...");try{const{error:c}=await S.from("events").insert(o);if(c)throw c;await ae("IMPORT_EVENTS",`イベントデータを${o.length}件インポートしました`),alert(`${o.length}件のインポートが完了しました。`),await sn(),Ge(),Bt()}catch(c){alert(`インポート中にエラーが発生しました:
`+c.message)}finally{q(),document.getElementById("file-import-csv").value=""}}},n.readAsText(t)};function Et(e){if(!e)return null;const t=new Date(e+"T00:00:00");if(isNaN(t.getTime()))return null;const n=new Date(t.getTime()-3*24*60*60*1e3),a=n.getFullYear(),s=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0");return`${a}-${s}-${r}T12:00:00`}function Ss(e){const t=Et(e);if(!t)return"";const n=new Date(t),a=n.getFullYear(),s=n.getMonth()+1,r=n.getDate(),o=ss[n.getDay()];return`${a}/${s}/${r}(${o}) 12:00`}function nr(e){if(!e)return"未定";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");const n=/(https?:\/\/[^\s\<\>\"]+)/g;return t.replace(n,a=>`<a href="${a}" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()" class="text-blue-600 hover:underline inline-flex items-center space-x-0.5 ml-1 font-semibold">
            <span>地図/リンク</span>
            <svg class="w-3.5 h-3.5 inline ml-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
            </svg>
        </a>`)}function ar(){const e=document.getElementById("multiselect-bar"),t=document.getElementById("multiselect-count");!e||!t||(window.att_multiSelectMode&&window.att_selectedDates.size>0?(t.textContent=window.att_selectedDates.size,e.classList.remove("hidden")):e.classList.add("hidden"))}function ro(){window.att_selectedDates.clear(),Ge(),ar()}function oo(){if(window.att_selectedDates.size===0){alert("日程が選択されていません。");return}const e=Array.from(window.att_selectedDates).sort();Nn("",null,!1,e)}function Pn(){const e=document.getElementById("ev-dates-container");if(e){if(e.innerHTML="",ue.length===0){e.innerHTML='<div class="text-xs text-gray-500 py-1.5 text-center">日付が選択されていません</div>';return}ue.forEach((t,n)=>{const a=document.createElement("div");a.className="flex items-center space-x-2 bg-white p-1.5 rounded border shadow-sm";const s=document.createElement("input");if(s.type="date",s.value=t,s.className="border rounded text-xs px-2 py-1 flex-1 min-w-0 font-medium focus:ring-1 focus:ring-blue-500 focus:border-blue-500",s.onchange=r=>{ue[n]=r.target.value,Ft()},a.appendChild(s),!window.att_isEditingModal){const r=document.createElement("button");r.type="button",r.className="text-red-500 hover:text-red-700 font-bold p-1 transition rounded hover:bg-red-50",r.innerHTML=`
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
            `,r.onclick=()=>{ue.splice(n,1),Pn(),Ft()},a.appendChild(r)}e.appendChild(a)})}}function io(){let e=new Date().toISOString().split("T")[0];if(ue.length>0){const t=new Date(ue[ue.length-1]);isNaN(t.getTime())||(t.setDate(t.getDate()+1),e=t.toISOString().split("T")[0])}ue.push(e),Pn(),Ft()}function lo(e){ue.splice(e,1),Pn(),Ft()}function Ft(){const e=document.getElementById("ev-deadline-auto-preview");if(e){if(ue.length===0){e.innerHTML='<span class="text-red-500 font-semibold text-xs">日付を入力してください</span>';return}if(ue.length===1)if(Et(ue[0])){const n=Ss(ue[0]);e.innerHTML=`<span class="text-blue-600 font-bold">自動算出:</span> ${n}`}else e.innerHTML='<span class="text-red-500 font-semibold text-xs">日付が不正です</span>';else{const t=Ss(ue[0]);e.innerHTML=`<span class="text-blue-600 font-bold">自動算出:</span> 各日程の3日前の12:00<br><span class="text-[10px] text-gray-400 font-semibold">(例: ${ue[0]}分 → ${t})</span>`}}}function co(e){const t=document.getElementById("ev-location-custom-container");t&&(e==="custom"?t.classList.remove("hidden"):t.classList.add("hidden"))}async function uo(){const e=document.getElementById("ev-location-custom-name"),t=document.getElementById("ev-location-custom-url");if(!e)return;const n=e.value.trim(),a=t?t.value.trim():"";if(!n)return alert("場所名は必須です");j("場所マスタに登録中...");try{const{error:s}=await S.from("event_locations").insert({name:n,url:a||null});if(s)throw s;const{data:r}=await S.from("event_locations").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});r&&(qt=r);const o=document.getElementById("ev-location-select");if(o){const i=a?`${n} ${a}`:n;o.innerHTML=`
                <option value="custom">-- 直接入力 / 新規マスタ追加 --</option>
                ${qt.map(l=>{const c=l.url?`${l.name} ${l.url}`:l.name;return`<option value="${c}" ${c===i?"selected":""}>${l.name}${l.url?" (URLあり)":""}</option>`}).join("")}
            `;const d=document.getElementById("ev-location-custom-container");d&&d.classList.add("hidden"),e.value="",t&&(t.value="")}alert("場所マスタに登録しました")}catch(s){console.error("Failed to register location:",s),alert("マスタ登録エラー: "+(s.message||String(s)))}finally{q()}}window.att_closeModal=()=>{const e=document.getElementById("attendance-modals");e&&(e.innerHTML="")};window.att_saveEvent=Xr;window.att_deleteEvent=eo;window.att_openEventDetail=openEventDetailModal;window.att_openAttendanceForm=to;window.att_saveAttendance=no;window.att_exportCsv=ao;window.att_statusViewType=window.att_statusViewType||"group";window.att_statusFilter=window.att_statusFilter||"all";window.att_setStatusViewType=(e,t)=>{window.att_statusViewType=t,window.att_openEventDetail(e,"status")};window.att_setStatusFilter=(e,t)=>{window.att_statusFilter=t,window.att_openEventDetail(e,"status")};window.att_copyEvent=function(e){const t=et.find(a=>a.id===e);if(!t)return;const n=window.att_selectedDates&&window.att_selectedDates.size>0?Array.from(window.att_selectedDates).sort():null;Nn("",t,!1,n)};window.att_editEvent=function(e){const t=et.find(n=>n.id===e);t&&Nn("",t,!0)};window.att_addDateRow=io;window.att_removeDateRow=lo;window.att_renderDateRows=Pn;window.att_updateDefaultDeadlineLabel=Ft;window.att_openBulkAddEvent=oo;window.att_clearDateSelection=ro;window.att_onLocationSelectChange=co;window.att_registerNewLocation=uo;window.att_updateMultiselectBar=ar;window.att_onSingleDateChange=e=>{ue=[e],Ft();const t=Et(e);if(t){const n=t.split("T")[0],a=t.split("T")[1].substring(0,5),s=a.split(":")[0],r=a.split(":")[1],o=document.getElementById("ev-deadline-date"),i=document.getElementById("ev-deadline-time-h"),d=document.getElementById("ev-deadline-time-m");o&&(o.value=n),i&&(i.value=s),d&&(d.value=r)}};window.att_toggleDeadlineCustom=e=>{const t=document.getElementById("ev-deadline-custom-inputs"),n=document.getElementById("ev-deadline-auto-preview");if(!(!t||!n))if(e){t.classList.remove("hidden"),n.classList.add("hidden");const a=ue[0],s=Et(a);if(s){const r=s.split("T")[0],o=s.split("T")[1].substring(0,5),i=o.split(":")[0],d=o.split(":")[1],l=document.getElementById("ev-deadline-date"),c=document.getElementById("ev-deadline-time-h"),u=document.getElementById("ev-deadline-time-m");l&&!l.value&&(l.value=r),c&&!c.value&&(c.value=i),u&&!u.value&&(u.value=d)}}else t.classList.add("hidden"),n.classList.remove("hidden"),Ft()};function Un(e){const t=e.getFullYear(),n=e.getMonth()+1,a=e.getDate();if(n===1&&a===1||n===2&&a===11||n===2&&a===23||n===4&&a===29||n===5&&a===3||n===5&&a===4||n===5&&a===5||n===8&&a===11||n===11&&a===3||n===11&&a===23)return!0;if(e.getDay()===1){const r=Math.floor((a-1)/7)+1;if(n===1&&r===2||n===7&&r===3||n===9&&r===3||n===10&&r===2)return!0}if(n===3){const r=Math.floor(20.8431+.242194*(t-1980)-Math.floor((t-1980)/4));if(a===r)return!0}if(n===9){const r=Math.floor(23.2488+.242194*(t-1980)-Math.floor((t-1980)/4));if(a===r)return!0}return!1}function mo(e){if(Un(e))return!0;const t=e.getFullYear(),n=e.getMonth(),a=e.getDate(),s=e.getDay();if(s===1){const i=new Date(t,n,a-1);if(Un(i))return!0}const r=new Date(t,n,a-1),o=new Date(t,n,a+1);return!!(Un(r)&&Un(o)&&s!==0)}async function po(){j("予定情報をエクスポート中...");try{const{data:e}=await S.from("events").select("*").order("start_time",{ascending:!0}),{data:t}=await S.from("groups").select("*"),n=new Map(t.map(d=>[d.id,d.name])),s=[["ID","タイトル","カテゴリ","場所","開始日時","終了日時","説明","終日(1/0)","出欠回答要(1/0)","詳細回答要(1/0)","回答期限","対象グループ名","削除(1/0)"]];e.forEach(d=>{let l="";d.target_group_ids&&d.target_group_ids.length>0?l=d.target_group_ids.map(f=>n.get(f)||"").filter(f=>f).join(", "):d.target_group_id&&(l=n.get(d.target_group_id)||"");const c=d.start_time?d.start_time.replace("T"," ").substring(0,16):"",u=d.end_time?d.end_time.replace("T"," ").substring(0,16):"",m=d.attendance_deadline?d.attendance_deadline.replace("T"," ").substring(0,16):"";s.push([d.id,d.title||"",d.category||"",d.location||"",c,u,d.description||"",d.is_all_day?"1":"0",d.requires_attendance?"1":"0",d.require_detailed_attendance?"1":"0",m,l,"0"])});const r=s.map(d=>d.map(window.escapeCSV).join(",")).join(`
`),o=new Blob([new Uint8Array([239,187,191]),r],{type:"text/csv;charset=utf-8;"}),i=document.createElement("a");i.href=URL.createObjectURL(o),i.download=`schedule_${new Date().toISOString().split("T")[0]}.csv`,i.click()}catch(e){console.error(e),alert("予定のエクスポートに失敗しました: "+e.message)}finally{q()}}async function go(e){const t=e.target.files[0];if(!t)return;j("CSVファイルを解析中...");const n=new FileReader;n.onload=async a=>{try{const s=a.target.result,r=window.parseCSV(s);if(r.length<2){alert("有効なデータがありません。"),q();return}const o=r[0].map(N=>N.trim()),i=o.indexOf("ID"),d=o.indexOf("タイトル"),l=o.indexOf("カテゴリ"),c=o.indexOf("場所"),u=o.indexOf("開始日時"),m=o.indexOf("終了日時"),f=o.indexOf("説明"),b=o.findIndex(N=>N.includes("終日")),y=o.findIndex(N=>N.includes("出欠回答要")),g=o.findIndex(N=>N.includes("詳細回答要")),p=o.findIndex(N=>N.includes("回答期限")),v=o.findIndex(N=>N.includes("対象グループ名")),x=o.findIndex(N=>N.includes("削除"));if(d===-1||u===-1){alert("「タイトル」および「開始日時」列は必須です。"),q();return}const{data:h}=await S.from("events").select("*"),{data:k}=await S.from("groups").select("*"),L=new Map(k.map(N=>[N.name,N.id])),w=new Map(h.map(N=>[N.id,N])),I=new Map(h.map(N=>[`${N.title}_${N.start_time?N.start_time.substring(0,16).replace("T"," "):""}`,N])),E=[],$=[],_=[],C=N=>{if(!N)return null;let P=N.trim().replace(/\//g,"-").replace(" ","T");return P.length===10?P+="T00:00:00":P.length===16&&(P+=":00"),P};for(let N=1;N<r.length;N++){const P=r[N];if(P.length<2)continue;const U=(P[d]||"").trim(),O=(P[u]||"").trim();if(!U||!O)continue;const B=C(O),A=i!==-1?(P[i]||"").trim():"",T=l!==-1?(P[l]||"").trim():"",D=c!==-1?(P[c]||"").trim():"",G=m!==-1?C(P[m]):null,H=f!==-1?(P[f]||"").trim():"",W=b!==-1?P[b]==="1"||P[b]==="true":!1,R=y!==-1?!(P[y]==="0"||P[y]==="false"):!0,z=g!==-1?P[g]==="1"||P[g]==="true":!1,J=p!==-1?C(P[p]):null,ye=x!==-1?P[x]==="1"||P[x]==="削除":!1,ne=v!==-1?(P[v]||"").trim():"";let de=[],Ie="";if(ne){const Qe=ne.split(",").map(Me=>Me.trim()).filter(Me=>Me);de=Qe.map(Me=>L.get(Me)).filter(Me=>Me),Ie=Qe.join(", ")}const Ye={id:A,title:U,category:T,location:D,start_time:B,end_time:G,description:H,is_all_day:W,requires_attendance:R,require_detailed_attendance:z,attendance_deadline:J,target_group_ids:de,target_group_name:Ie};let se=null;if(A&&(se=w.get(A)),!se){const Qe=`${U}_${O.substring(0,16).replace(/\//g,"-")}`;se=I.get(Qe)}if(se)if(Ye.id=se.id,ye)_.push(Ye);else{const Qe=se.title!==U,Me=se.category!==T,Wt=se.location!==D,Tt=se.description!==H,ct=(se.start_time?se.start_time.substring(0,16):"")!==(B?B.substring(0,16):""),ut=(se.end_time?se.end_time.substring(0,16):"")!==(G?G.substring(0,16):""),at=se.is_all_day!==W,V=se.requires_attendance!==R,re=se.require_detailed_attendance!==z,ke=(se.attendance_deadline?se.attendance_deadline.substring(0,16):"")!==(J?J.substring(0,16):""),Re=se.target_group_ids||(se.target_group_id?[se.target_group_id]:[]),mt=JSON.stringify([...Re].sort())!==JSON.stringify([...de].sort());(Qe||Me||Wt||Tt||ct||ut||at||V||re||ke||mt)&&$.push(Ye)}else ye||E.push(Ye)}q();let M="";_.length>0&&(M=`⚠️ 警告: ${_.length}件の予定が削除されます。予定を削除すると、その予定に紐づいているメンバー全員の出欠データや配車データも自動的に削除されます。`),window.showCSVConfirmModal("events",E,$,_,"予定CSVインポート確認",M)}catch(s){console.error(s),alert("CSVの解析に失敗しました: "+s.message),q()}},n.readAsText(t)}async function fo(){const{add:e,update:t,delete:n}=$t;j("予定データを保存中...");try{if(n.length>0){const a=n.map(r=>r.id),{error:s}=await S.from("events").delete().in("id",a);if(s)throw s;await ae("IMPORT_EVENTS_DELETE",`${n.length}件の予定をインポートで削除しました`)}if(e.length>0){const a=e.map(r=>({title:r.title,category:r.category,location:r.location,start_time:r.start_time,end_time:r.end_time,description:r.description,is_all_day:r.is_all_day,requires_attendance:r.requires_attendance,require_detailed_attendance:r.requires_attendance?r.require_detailed_attendance:!1,attendance_deadline:r.attendance_deadline,target_group_ids:r.target_group_ids.length>0?r.target_group_ids:null,created_by:F==null?void 0:F.email})),{error:s}=await S.from("events").insert(a);if(s)throw s;await ae("IMPORT_EVENTS_ADD",`${e.length}件の予定をインポートで追加しました`)}if(t.length>0){for(let a of t){const{error:s}=await S.from("events").update({title:a.title,category:a.category,location:a.location,start_time:a.start_time,end_time:a.end_time,description:a.description,is_all_day:a.is_all_day,requires_attendance:a.requires_attendance,require_detailed_attendance:a.requires_attendance?a.require_detailed_attendance:!1,attendance_deadline:a.attendance_deadline,target_group_ids:a.target_group_ids.length>0?a.target_group_ids:null}).eq("id",a.id);if(s)throw s}await ae("IMPORT_EVENTS_UPDATE",`${t.length}件の予定をインポートで更新しました`)}alert("予定のインポートが完了しました。"),window.closeCSVConfirmModal(),await sn(),Ge(),document.getElementById("list-container").classList.contains("hidden")||Bt()}catch(a){console.error(a),alert("予定データの保存に失敗しました: "+a.message)}finally{q()}}window.executeEventsImport=fo;function bo(){const n=[["ID","タイトル","カテゴリ","場所","開始日時","終了日時","説明","終日(1/0)","出欠回答要(1/0)","詳細回答要(1/0)","回答期限","対象グループ名","削除(1/0)"],["","土曜練習","練習","第一グラウンド","2026-06-20 09:00","2026-06-20 12:00","通常練習を行います。","0","1","1","2026-06-19 18:00","選手・保護者","0"],["","練習試合(イーグルス戦)","試合","イーグルス球場","2026-06-21 13:00","2026-06-21 16:00","遠征試合です。車出しをお願いします。","0","1","1","2026-06-20 12:00","選手・保護者","0"]].map(r=>r.map(window.escapeCSV).join(",")).join(`
`),a=new Blob([new Uint8Array([239,187,191]),n],{type:"text/csv;charset=utf-8;"}),s=document.createElement("a");s.href=URL.createObjectURL(a),s.download="schedule_sample.csv",s.click()}window.att_toggleSort=function(e,t){window.att_statusSortKey===t?window.att_statusSortOrder==="asc"?window.att_statusSortOrder="desc":(window.att_statusSortKey="default",window.att_statusSortOrder="asc"):(window.att_statusSortKey=t,window.att_statusSortOrder="asc"),window.att_openEventDetail(e,"status")};window.att_exportParticipantList=function(e){const t=et.find(b=>b.id===e);if(!t)return;const n=wn(t),a=window.att_statusViewType==="group";let s=[];if(n.ids.length===0)s=Rt.filter(b=>b.can_use_attendance!==!1);else{const b=rt.filter(p=>n.ids.includes(p.group_id)).map(p=>p.user_email),g=$e.filter(p=>p.event_id===t.id).map(p=>p.user_email);s=Rt.filter(p=>p.can_use_attendance!==!1&&(b.includes(p.email)||g.includes(p.email)))}const r=s.filter(b=>{const y=$e.find(p=>p.event_id===t.id&&p.user_email===b.email),g=(y==null?void 0:y.status)||"未回答";return window.att_statusFilter==="all"?!0:window.att_statusFilter==="answered"?g==="出席"||g==="欠席"||g==="保留"||g==="未定":window.att_statusFilter==="attending"?g==="出席":window.att_statusFilter==="absent"?g==="欠席":window.att_statusFilter==="pending"?g==="保留"||g==="未定":window.att_statusFilter==="unanswered"?g==="未回答"||!g:!0}),o=window.att_statusSortKey||"default",i=window.att_statusSortOrder||"asc";o!=="default"&&r.sort((b,y)=>{var v,x;let g,p;if(o==="name")g=b.name||b.email.split("@")[0],p=y.name||y.email.split("@")[0];else if(o==="group")if(a){const h=rt.filter(L=>L.user_email===b.email).map(L=>L.group_id);g=Ve.filter(L=>h.includes(L.id)).map(L=>L.name).join(", ")||"-";const k=rt.filter(L=>L.user_email===y.email).map(L=>L.group_id);p=Ve.filter(L=>k.includes(L.id)).map(L=>L.name).join(", ")||"-"}else g=((v=Dt.find(h=>h.id===b.attribute_id))==null?void 0:v.name)||"-",p=((x=Dt.find(h=>h.id===y.attribute_id))==null?void 0:x.name)||"-";else if(o==="status"){const h=k=>{const L=$e.find(I=>I.event_id===t.id&&I.user_email===k.email),w=(L==null?void 0:L.status)||"未回答";return w==="出席"?1:w==="保留"||w==="未定"?2:w==="未回答"?3:w==="欠席"?4:5};g=h(b),p=h(y)}else if(o==="comment"){const h=k=>{const L=$e.find($=>$.event_id===t.id&&$.user_email===k.email);if(!L||!L.status||L.status==="未回答")return"";let w=L.comment||"",I="否";w.startsWith("[荷物車:可]")?(I="可",w=w.substring(8)):w.startsWith("[荷物車:否]")&&(I="否",w=w.substring(8));let E=[];return t.require_detailed_attendance&&(L.accompanying_persons&&E.push(`同伴: ${L.accompanying_persons}`),L.car_capacity&&L.car_capacity>0&&(E.push(`車出: 可[${L.car_capacity}人]`),E.push(`荷物車: ${I}`))),w.trim()&&E.push(`メモ: ${w.trim()}`),E.join(", ")};g=h(b),p=h(y)}else if(o==="updated_at"){const h=$e.find(L=>L.event_id===t.id&&L.user_email===b.email),k=$e.find(L=>L.event_id===t.id&&L.user_email===y.email);g=h?new Date(h.updated_at).getTime():0,p=k?new Date(k.updated_at).getTime():0}return g<p?i==="asc"?-1:1:g>p?i==="asc"?1:-1:0});const l=[["名前",a?"グループ":"属性","出欠ステータス","同伴者","車出し可否","乗車人数","荷物車対応","コメント","更新日時"]];r.forEach(b=>{var E;const y=b.name||b.email.split("@")[0];let g="-";if(a){const $=rt.filter(_=>_.user_email===b.email).map(_=>_.group_id);g=Ve.filter(_=>$.includes(_.id)).map(_=>_.name).join(", ")||"-"}else g=((E=Dt.find($=>$.id===b.attribute_id))==null?void 0:E.name)||"-";const p=$e.find($=>$.event_id===t.id&&$.user_email===b.email);let v=(p==null?void 0:p.status)||"未回答";v==="未定"&&(v="保留");let x=(p==null?void 0:p.comment)||"",h="否";x.startsWith("[荷物車:可]")?(h="可",x=x.substring(8)):x.startsWith("[荷物車:否]")&&(h="否",x=x.substring(8));const k=(p==null?void 0:p.accompanying_persons)||"",L=(p==null?void 0:p.car_capacity)||0,w=L>0?"可":"否",I=p?Zs(p.updated_at):"-";l.push([y,g,v,k,w,L,h,x,I])});const c=l.map(b=>b.map(window.escapeCSV).join(",")).join(`
`),u=new Blob([new Uint8Array([239,187,191]),c],{type:"text/csv;charset=utf-8;"}),m=document.createElement("a"),f=t.title.replace(/[\/\\?%*:|"<>]/g,"_");m.href=URL.createObjectURL(u),m.setAttribute("download",`参加者リスト_${f}_${window.att_statusFilter}.csv`),document.body.removeChild(m)};function Ia(e){if(!e||isNaN(e.getTime()))return"";const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0"),s=String(e.getHours()).padStart(2,"0"),r=String(e.getMinutes()).padStart(2,"0");return`${t}-${n}-${a}T${s}:${r}`}function yo(e){const t=e.split(/\r?\n/),n=[];let a=null,s=!1;const r=[];for(let o of t)o.startsWith(" ")||o.startsWith("	")?r.length>0&&(r[r.length-1]+=o.substring(1)):r.push(o);for(let o of r){const i=o.trim();if(i){if(i==="BEGIN:VEVENT")a={title:"",description:"",location:"",start:null,end:null,isAllDay:!1},s=!0;else if(i==="END:VEVENT")a&&n.push(a),s=!1,a=null;else if(s&&a){const d=i.indexOf(":");if(d===-1)continue;const l=i.substring(0,d),c=i.substring(d+1),u=l.split(";")[0],m=l.split(";").slice(1);if(u==="SUMMARY")a.title=$a(c);else if(u==="DESCRIPTION")a.description=$a(c);else if(u==="LOCATION")a.location=$a(c);else if(u==="DTSTART"){const f=m.some(b=>b.toUpperCase()==="VALUE=DATE");a.start=Bs(c,f),f&&(a.isAllDay=!0)}else if(u==="DTEND"){const f=m.some(b=>b.toUpperCase()==="VALUE=DATE");a.end=Bs(c,f)}}}}return n}function $a(e){return e.replace(/\\n/g,`
`).replace(/\\r/g,"\r").replace(/\\t/g,"	").replace(/\\,/g,",").replace(/\\;/g,";").replace(/\\\\/g,"\\")}function Bs(e,t){if(!e)return null;const n=parseInt(e.substring(0,4)),a=parseInt(e.substring(4,6))-1,s=parseInt(e.substring(6,8));if(t||e.indexOf("T")===-1)return new Date(n,a,s);const r=e.indexOf("T"),o=parseInt(e.substring(r+1,r+3)),i=parseInt(e.substring(r+3,r+5)),d=parseInt(e.substring(r+5,r+7))||0;return e.endsWith("Z")?new Date(Date.UTC(n,a,s,o,i,d)):new Date(n,a,s,o,i,d)}async function ho(e){const t=e.target.files[0];if(!t)return;j("ICSファイルを解析中...");const n=new FileReader;n.onload=async a=>{try{const s=a.target.result,r=yo(s);if(q(),r.length===0){alert("ICSファイルから有効な予定が見つかりませんでした。");return}xo(r)}catch(s){console.error(s),alert("ICSファイルの解析に失敗しました: "+s.message),q()}},n.readAsText(t),e.target.value=""}function xo(e){const t=document.getElementById("ics-import-list");if(!t)return;const n=document.getElementById("ics-import-count");n&&(n.textContent=e.length),t.innerHTML=e.map((r,o)=>{var y,g;const i=r.title||"",d=i.toLowerCase();let l=((y=qe[0])==null?void 0:y.name)||"練習";for(let p of qe)if(d.includes(p.name)){l=p.name;break}l===((g=qe[0])==null?void 0:g.name)&&(d.includes("試合")||d.includes("vs")||d.includes("戦")?qe.find(v=>v.name==="試合")&&(l="試合"):(d.includes("イベント")||d.includes("会")||d.includes("式")||d.includes("フェス"))&&qe.find(v=>v.name==="イベント")&&(l="イベント"));let c="";if(r.location){const p=qt.find(v=>v.name===r.location);p?c=p.name:c="custom"}const u=Ia(r.start),m=Ia(r.end||(r.start?new Date(r.start.getTime()+2*60*60*1e3):null));let f=r.start?new Date(r.start.getTime()-3*24*60*60*1e3):null;f&&f.setHours(12,0,0,0);const b=Ia(f);return`
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <select class="ics-row-category w-full border p-2 rounded-lg font-semibold text-sm bg-white focus:ring-2 focus:ring-blue-500">
                                ${qe.map(p=>`<option value="${p.name}" ${p.name===l?"selected":""}>${p.name}</option>`).join("")}
                            </select>
                        </div>
                        <div>
                            ...
                            <div class="flex gap-2">
                                <select class="ics-row-location-select w-1/2 border p-2 rounded-lg text-sm bg-white focus:ring-2 focus:ring-blue-500">
                                    ...
                                    ${qt.map(p=>`<option value="${p.name}" ${p.name===c?"selected":""}>${p.name}</option>`).join("")}
        ...
        `}).join("");const a=document.getElementById("ics-select-all");a&&(a.checked=!0,a.onclick=r=>{document.querySelectorAll(".ics-row-select").forEach(o=>o.checked=r.target.checked)});const s=document.getElementById("ics-import-modal");s&&s.classList.remove("hidden")}function Oa(){var e;(e=document.getElementById("ics-import-modal"))==null||e.classList.add("hidden")}async function vo(){const e=document.querySelectorAll(".ics-row"),t=[];if(e.forEach(n=>{var g,p,v,x,h,k,L,w,I,E;const a=n.querySelector(".ics-row-select");if(!a||!a.checked)return;const s=((g=n.querySelector(".ics-row-title"))==null?void 0:g.value)||"";if(!s)return;const r=((p=n.querySelector(".ics-row-category"))==null?void 0:p.value)||"",o=((v=n.querySelector(".ics-row-location"))==null?void 0:v.value)||"",i=((x=n.querySelector(".ics-row-start"))==null?void 0:x.value)||"",d=((h=n.querySelector(".ics-row-end"))==null?void 0:h.value)||"",l=((k=n.querySelector(".ics-row-allday"))==null?void 0:k.checked)||!1,c=[];n.querySelectorAll(".ics-row-group-cb:checked").forEach($=>{c.push($.value)});const u=((L=n.querySelector(".ics-row-req-att"))==null?void 0:L.checked)||!1,m=((w=n.querySelector(".ics-row-req-det"))==null?void 0:w.checked)||!1,f=((I=n.querySelector(".ics-row-deadline"))==null?void 0:I.value)||"",b=((E=n.querySelector(".ics-row-description"))==null?void 0:E.value)||"",y=$=>$?new Date($).toISOString():null;t.push({title:s,category:r,location:o,start_time:y(i),end_time:y(d),is_all_day:l,target_group_ids:c.length>0?c:null,requires_attendance:u,require_detailed_attendance:u?m:!1,attendance_deadline:u?y(f):null,description:b,created_by:F==null?void 0:F.email})}),t.length===0){alert("登録対象の予定が選択されていません。");return}j("予定データを登録中...");try{const{error:n}=await S.from("events").insert(t);if(n)throw n;await ae("IMPORT_ICS_EVENTS",`${t.length}件の予定をICSファイルから一括登録しました`),alert(`${t.length}件の予定を登録しました。`),Oa(),await sn(),Ge(),document.getElementById("list-container").classList.contains("hidden")||Bt()}catch(n){console.error(n),alert("予定の登録に失敗しました: "+n.message)}finally{q()}}const wo="modulepreload",Eo=function(e){return"/"+e},Ts={},_o=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),i=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(n.map(d=>{if(d=Eo(d),d in Ts)return;Ts[d]=!0;const l=d.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":wo,l||(u.as="script"),u.crossOrigin="",u.href=d,i&&u.setAttribute("nonce",i),document.head.appendChild(u),l)return new Promise((m,f)=>{u.addEventListener("load",m),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return s.then(o=>{for(const i of o||[])i.status==="rejected"&&r(i.reason);return t().catch(r)})};let As=!1,sr=[],rr=[],or=[],it=[],Ee={homeTeamNames:["ありんこアントス@A軍"],defaultFilterDate:{from:"",to:"",teamRegex:"",category:"",outcome:"all"}},Cs=!1,Ln={},Nt={},ka={},La={},Ma={batter:[],pitcher:[]},zt={batter:{key:"ops",order:"desc"},pitcher:{key:"era",order:"asc"}},dn={batter:{key:"ops",order:"desc"},pitcher:{key:"era",order:"asc"}},ht=null,gt={};async function Ra(){As||($o(),As=!0);const e=document.querySelector('button[data-tab="import-data"]');e&&(he==="admin"?e.classList.remove("hidden"):e.classList.add("hidden")),await ir()}function Io(e){const t=[];let n=[],a="",s=!1;for(let r=0;r<e.length;r++){const o=e[r];s?o==='"'?r+1<e.length&&e[r+1]==='"'?(a+='"',r++):s=!1:a+=o:o==='"'?s=!0:o===","?(n.push(a),a=""):o===`
`||o==="\r"?(n.push(a),t.push(n),n=[],a="",o==="\r"&&r+1<e.length&&e[r+1]===`
`&&r++):a+=o}return(a||n.length>0)&&(n.push(a),t.push(n)),t}function $o(){var t,n,a,s,r,o,i,d,l,c,u;let e=document.getElementById("dashboard-view");e||(e=document.createElement("div"),e.id="dashboard-view",e.className="hidden p-4 max-w-4xl mx-auto",e.innerHTML=`
        ...
        `,(t=document.getElementById("app-view"))==null||t.parentNode.appendChild(e),document.getElementById("btn-back-to-menu-dash").addEventListener("click",()=>{_o(()=>Promise.resolve().then(()=>hl),void 0).then(m=>m.switchAuthScreen("app-menu-view"))}),document.getElementById("btn-exec-csv-import").addEventListener("click",qo),(n=document.getElementById("btn-load-detail-data"))==null||n.addEventListener("click",Fo),document.querySelectorAll("#dashboard-tabs button").forEach(m=>{m.addEventListener("click",f=>{document.querySelectorAll("#dashboard-tabs button").forEach(y=>{y.classList.remove("text-blue-600","border-blue-600"),y.classList.add("text-gray-500","border-transparent")}),["team-summary","personal-summary","ranking","comparison","test-mode","settings","import-data","detail-analysis"].forEach(y=>{var g;return(g=document.getElementById(`tab-content-${y}`))==null?void 0:g.classList.add("hidden")});const b=f.currentTarget;b.classList.remove("text-gray-500","border-transparent"),b.classList.add("text-blue-600","border-blue-600"),document.getElementById(`tab-content-${b.dataset.tab}`).classList.remove("hidden")})}),document.querySelectorAll("button[data-ranking-tab]").forEach(m=>{m.addEventListener("click",f=>{document.querySelectorAll("button[data-ranking-tab]").forEach(y=>{y.classList.remove("text-blue-600","border-blue-600"),y.classList.add("text-gray-500","border-transparent")}),["batter","pitcher"].forEach(y=>document.getElementById(`ranking-content-${y}`).classList.add("hidden"));const b=f.currentTarget;b.classList.remove("text-gray-500","border-transparent"),b.classList.add("text-blue-600","border-blue-600"),document.getElementById(`ranking-content-${b.dataset.rankingTab}`).classList.remove("hidden")})}),document.querySelectorAll("#tab-content-ranking th[data-sort]").forEach(m=>{m.addEventListener("click",f=>{const b=f.currentTarget.dataset.role,y=f.currentTarget.dataset.sort;Mo(b,y)})}),document.getElementById("btn-apply-dashboard-filter").addEventListener("click",Ct),(a=document.getElementById("db-filter-outcome"))==null||a.addEventListener("change",Ct),(s=document.getElementById("db-filter-first-score"))==null||s.addEventListener("change",Ct),document.getElementById("btn-clear-dashboard-filter").addEventListener("click",()=>{document.getElementById("db-filter-date-from").value=Ee.defaultFilterDate.from||"",document.getElementById("db-filter-date-to").value=Ee.defaultFilterDate.to||"",document.getElementById("db-filter-team-regex").value=Ee.defaultFilterDate.teamRegex||"",document.getElementById("db-filter-category").value=Ee.defaultFilterDate.category||"";const m=document.getElementById("db-filter-outcome");m&&(m.value=Ee.defaultFilterDate.outcome||"all");const f=document.getElementById("db-filter-first-score");f&&(f.value=Ee.defaultFilterDate.firstScore||"all"),Ct()}),["ps-mode","ps-player","ps-role","ps-limit-games","ps-ma-unit","ps-ma-window"].forEach(m=>{var f;return(f=document.getElementById(m))==null?void 0:f.addEventListener("change",()=>{var p,v,x;const b=(p=document.getElementById("ps-ma-unit"))==null?void 0:p.value,y=document.getElementById("ps-ma-window-label");y&&(y.textContent=b==="ab"?"打数/登板":"試合");const g=((v=document.getElementById("ps-mode"))==null?void 0:v.value)==="single";(x=document.getElementById("ps-player-select-wrap"))==null||x.classList.toggle("hidden",!g),os()})}),(r=document.getElementById("btn-export-ps-csv"))==null||r.addEventListener("click",Po),(o=document.getElementById("btn-print-ps"))==null||o.addEventListener("click",()=>window.print()),["tm-role","tm-window"].forEach(m=>{var f;return(f=document.getElementById(m))==null?void 0:f.addEventListener("change",ja)}),(i=document.getElementById("tm-players-list"))==null||i.addEventListener("change",ja),(d=document.getElementById("comp-players-list"))==null||d.addEventListener("change",Fa),(l=document.getElementById("comp-role"))==null||l.addEventListener("change",m=>{Fa()}),(c=document.getElementById("btn-add-home-team"))==null||c.addEventListener("click",Ro),(u=document.getElementById("btn-save-default-date"))==null||u.addEventListener("click",async()=>{const m=document.getElementById("setting-default-date-from").value,f=document.getElementById("setting-default-date-to").value,b=document.getElementById("setting-default-team-regex").value.trim(),y=document.getElementById("setting-default-category").value.trim(),g={from:m,to:f,teamRegex:b,category:y};if(localStorage.setItem("ants_defaultFilterDate",JSON.stringify(g)),he==="admin"){j("デフォルトのフィルタ設定を保存中 (DB同期)...");try{const{error:k}=await S.from("dashboard_settings").upsert({key:"defaultFilterDate",value:g},{onConflict:"key"});if(k)throw k;alert("デフォルトのフィルタ設定を保存し、DBと同期しました。")}catch(k){console.error("Supabase sync failed",k),alert("DBへの同期に失敗しましたが、このブラウザには保存されました: "+k.message)}finally{q()}}else alert("デフォルトのフィルタ設定をこのブラウザに保存しました。");Ee.defaultFilterDate=g;const p=document.getElementById("db-filter-date-from"),v=document.getElementById("db-filter-date-to"),x=document.getElementById("db-filter-team-regex"),h=document.getElementById("db-filter-category");p&&(p.value=m),v&&(v.value=f),x&&(x.value=b),h&&(h.value=y),Ct()}))}async function ir(){j("成績データを読み込み中...");try{const[{data:e,error:t},{data:n,error:a},{data:s,error:r},{data:o,error:i},{data:d,error:l}]=await Promise.all([S.from("games").select("*").order("date",{ascending:!0}),S.from("batter_stats").select("*"),S.from("pitcher_stats").select("*"),S.from("players").select("*"),S.from("dashboard_settings").select("*")]);if(t)throw t;if(a)throw a;if(r)throw r;sr=e||[],rr=n||[],or=s||[],it=o||[];let c=["ありんこアントス@A軍"],u={from:"",to:"",teamRegex:"",category:"",outcome:"all"};if(d){const b=d.find(g=>g.key==="homeTeamNames");b&&b.value!==null&&b.value!==void 0&&(c=b.value);const y=d.find(g=>g.key==="defaultFilterDate");y&&y.value&&(u={from:y.value.from||"",to:y.value.to||"",teamRegex:y.value.teamRegex||"",category:y.value.category||"",outcome:y.value.outcome||"all"})}const m=localStorage.getItem("ants_homeTeamNames");if(m)try{c=JSON.parse(m)}catch(b){console.error("Failed to parse local homeTeamNames",b)}const f=localStorage.getItem("ants_defaultFilterDate");if(f)try{u=JSON.parse(f)}catch(b){console.error("Failed to parse local defaultFilterDate",b)}Ee.homeTeamNames=c,Ee.defaultFilterDate=u,is(),document.getElementById("setting-default-date-from").value=Ee.defaultFilterDate.from||"",document.getElementById("setting-default-date-to").value=Ee.defaultFilterDate.to||"",document.getElementById("setting-default-team-regex").value=Ee.defaultFilterDate.teamRegex||"",document.getElementById("setting-default-category").value=Ee.defaultFilterDate.category||"",Cs||(document.getElementById("btn-clear-dashboard-filter").click(),Cs=!0),Ct()}catch(e){console.error(e),alert("成績データの取得に失敗しました: "+e.message)}finally{q()}}function pt(e){if(!e)return!1;const t=e.trim();return t==="ありんこ"||t==="アントス"?!1:Ee.homeTeamNames.some(n=>{if(!n)return!1;const a=n.replace(/@.*$/,"").trim(),s=e.replace(/@.*$/,"").trim();try{if(new RegExp(n,"i").test(e)||new RegExp(a,"i").test(s))return!0}catch{}return e.includes(n)||n.includes(e)||a&&s&&(s.includes(a)||a.includes(s))})}function rs(e){const t=pt(e.team_first);let n=0,a=0;if(e.score&&typeof e.score=="string"){const o=e.score.match(/\d+/g);if(o&&o.length>=2){const i=parseInt(o[0],10),d=parseInt(o[1],10);return t?(n=i,a=d):(n=d,a=i),{tr:n,or:a,isAntsFirst:t}}}const s=parseInt(e.runs_first??e.score_first??0,10)||0,r=parseInt(e.runs_second??e.score_second??0,10)||0;return t?(n=s,a=r):(n=r,a=s),{tr:n,or:a,isAntsFirst:t}}function ko(e){const t=pt(e.team_first);if(e.first_score_team)return pt(e.first_score_team)?"scored":"conceded";if(e.first_scored!==void 0&&e.first_scored!==null){if(e.first_scored==="home"||e.first_scored===!0||e.first_scored===1)return"scored";if(e.first_scored==="opp"||e.first_scored===!1||e.first_scored===0)return"conceded"}const n=e.inning_scores||e.score_detail||e.innings;if(n&&typeof n=="string"&&n.includes("|")){const[r,o]=n.split("|"),i=r.split(/[,-]/).map(c=>parseInt(c.trim(),10)||0),d=o.split(/[,-]/).map(c=>parseInt(c.trim(),10)||0),l=Math.max(i.length,d.length);for(let c=0;c<l;c++){const u=i[c]||0,m=d[c]||0;if(u>0&&m===0)return t?"scored":"conceded";if(m>0&&u===0)return t?"conceded":"scored";if(u>0&&m>0)return t?"scored":"conceded"}}const{tr:a,or:s}=rs(e);return a===0&&s===0?"unknown":a>0&&s===0?"scored":s>0&&a===0?"conceded":t?a>0?"scored":"conceded":s>0?"conceded":"scored"}let En={games:[],bStats:[],pStats:[]};function Ct(){var p,v;const e=document.getElementById("db-filter-date-from").value,t=document.getElementById("db-filter-date-to").value,n=document.getElementById("db-filter-team-regex").value,a=document.getElementById("db-filter-category").value,s=((p=document.getElementById("db-filter-outcome"))==null?void 0:p.value)||"all",r=((v=document.getElementById("db-filter-first-score"))==null?void 0:v.value)||"all";let o=null;if(n)try{o=new RegExp(n,"i")}catch{}const i=a?a.split(",").map(x=>x.trim()).filter(x=>x):[],d=sr.filter(x=>{const h=(x.team_first||"").trim(),k=(x.team_second||"").trim(),L=(x.title||"")+(x.category||"");if(h==="ありんこ"||h==="アントス"||k==="ありんこ"||k==="アントス"||L.includes("紅白")||h.includes("紅白")||k.includes("紅白"))return!1;const w=pt(x.team_first),I=pt(x.team_second);if(w&&I||!w&&!I)return!1;const E=x.date?x.date.split("T")[0]:"";if(e&&E<e||t&&E>t||i.length>0&&!i.includes(x.category))return!1;if(o){const $=o.test(x.team_first),_=o.test(x.team_second);if(!$&&!_)return!1}if(s!=="all"){const{tr:$,or:_}=rs(x);if(s==="win"&&$<=_||s==="loss"&&$>=_||s==="draw"&&$!==_)return!1}if(r!=="all"){const $=ko(x);if(r==="scored"&&$!=="scored"||r==="conceded"&&$!=="conceded")return!1}return!0}),l=new Set(d.map(x=>x.id)),c=rr.filter(x=>l.has(x.game_id)),u=or.filter(x=>l.has(x.game_id));En={games:d,bStats:c,pStats:u};const m=new Set;c.forEach(x=>m.add(x.player_id)),u.forEach(x=>m.add(x.player_id));const f=it.filter(x=>m.has(x.id)).sort((x,h)=>x.name.localeCompare(h.name)),b=document.getElementById("ps-player");if(b){const x=b.value;b.innerHTML=f.map(h=>`<option value="${h.id}">${h.name}</option>`).join(""),x&&m.has(parseInt(x))&&(b.value=x)}const y=document.getElementById("comp-players-list");if(y){const x=new Set(Array.from(document.querySelectorAll(".comp-player-cb:checked")).map(h=>h.value));y.innerHTML=f.map(h=>`<label class="flex items-center space-x-1 cursor-pointer"><input type="checkbox" value="${h.id}" class="comp-player-cb rounded text-blue-600" ${x.has(String(h.id))?"checked":""}><span>${h.name}</span></label>`).join("")}const g=document.getElementById("tm-players-list");if(g){const x=new Set(Array.from(document.querySelectorAll(".tm-player-cb:checked")).map(h=>h.value));g.innerHTML=f.map(h=>`<label class="flex items-center space-x-1 cursor-pointer"><input type="checkbox" value="${h.id}" class="tm-player-cb rounded text-blue-600" ${x.has(String(h.id))?"checked":""}><span>${h.name}</span></label>`).join("")}Lo(d,c,u),Oo(),os(),Fa(),ja()}function Lo(e,t,n){document.getElementById("summary-games").textContent=e.length;const a=t.reduce((c,u)=>c+(u.at_bats||0),0),s=t.reduce((c,u)=>c+(u.hits||0),0),r=a>0?(s/a).toFixed(3).replace(/^0/,""):".000";document.getElementById("summary-avg").textContent=r;const o=t.reduce((c,u)=>c+(u.runs||0),0);document.getElementById("summary-runs").textContent=o;const i=n.reduce((c,u)=>c+(u.earned_runs||0),0),d=n.reduce((c,u)=>c+(u.outs||0),0),l=d>0?(i*7/(d/3)).toFixed(2):"0.00";document.getElementById("summary-era").textContent=l,So(e,t,n)}let Ds=!1;function On(){return Ds||window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js",n.onload=()=>{Ds=!0,e()},n.onerror=t,document.head.appendChild(n)})}async function So(e,t,n){await On(),Object.values(Ln).forEach(I=>I.destroy()),Ln={};const a={};e.forEach(I=>{const E=I.date?I.date.split("T")[0]:"";if(!E)return;const $=E.substring(0,7);a[$]||(a[$]={atBats:0,hits:0,runs:0,strikeOuts:0,hitsAllowed:0,walksAllowed:0,strikes:0,pitchCount:0,earnedRuns:0,outs:0})}),t.forEach(I=>{const E=e.find(_=>_.id===I.game_id);if(!E||!E.date)return;const $=E.date.split("T")[0].substring(0,7);a[$]&&(a[$].atBats+=I.at_bats||0,a[$].hits+=I.hits||0,a[$].runs+=I.runs||0)}),n.forEach(I=>{const E=e.find(_=>_.id===I.game_id);if(!E||!E.date)return;const $=E.date.split("T")[0].substring(0,7);a[$]&&(a[$].strikeOuts+=I.strike_outs||0,a[$].hitsAllowed+=I.hits_allowed||0,a[$].walksAllowed+=I.walks_allowed||0,a[$].strikes+=I.strikes||0,a[$].pitchCount+=I.pitch_count||0,a[$].earnedRuns+=I.earned_runs||0,a[$].outs+=I.outs||0)});const s=Object.keys(a).sort();let r=0,o=0,i=0,d=0;const l=[],c=[],u=[],m=[],f=[],b=[],y=[],g=[];s.forEach(I=>{r+=a[I].atBats,o+=a[I].hits,l.push(r>0?o/r:0),c.push(a[I].runs),u.push(a[I].strikeOuts),m.push(a[I].hitsAllowed),f.push(a[I].walksAllowed),b.push(a[I].pitchCount>0?(a[I].strikes/a[I].pitchCount*100).toFixed(1):0);const E=a[I].earnedRuns,_=a[I].outs/3;g.push(_>0?E*7/_:0),i+=a[I].earnedRuns,d+=a[I].outs;const C=d/3;y.push(C>0?i*7/C:0)}),Ln.batting=new window.Chart(document.getElementById("chart-batting-monthly").getContext("2d"),{type:"bar",data:{labels:s,datasets:[{label:"月間得点",type:"bar",data:c,backgroundColor:"rgba(75, 192, 192, 0.6)",yAxisID:"y"},{label:"累積打率",type:"line",data:l,borderColor:"rgba(255, 99, 132, 1)",yAxisID:"y1"}]},options:{responsive:!0,scales:{y:{position:"left",beginAtZero:!0},y1:{position:"right",beginAtZero:!0,min:0,max:1}}}}),Ln.pitching=new window.Chart(document.getElementById("chart-pitching-monthly").getContext("2d"),{type:"bar",data:{labels:s,datasets:[{label:"奪三振",data:u,backgroundColor:"rgba(54, 162, 235, 0.6)"},{label:"被安打",data:m,backgroundColor:"rgba(255, 159, 64, 0.6)"},{label:"与四死球",data:f,backgroundColor:"rgba(255, 205, 86, 0.6)"},{label:"S率(%)",type:"line",data:b,borderColor:"rgba(153, 102, 255, 1)",yAxisID:"y1"},{label:"累積防御率",type:"line",data:y,borderColor:"rgba(255, 99, 132, 1)",yAxisID:"y2"},{label:"月別防御率",type:"line",data:g,borderColor:"rgba(75, 192, 192, 1)",borderDash:[5,5],yAxisID:"y2"}]},options:{responsive:!0,scales:{y:{position:"left",beginAtZero:!0},y1:{position:"right",beginAtZero:!0,min:0,max:100,grid:{drawOnChartArea:!1}},y2:{position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1}}}}});const p=[],v=[],x=[],h=[],k=[];let L=0,w=0;e.forEach((I,E)=>{const $=I.date?I.date.split("T")[0]:"",{tr:_,or:C,isAntsFirst:M}=rs(I),N=M?I.team_first:I.team_second,P=M?I.team_second:I.team_first,U=I.title||I.category||"試合";k.push({date:$,title:U,myTeam:N||"自チーム",oppTeam:P||"相手チーム",tr:_,or:C,isAntsFirst:M}),v.push(_),x.push(-C),_>C&&L++,w++,h.push(w>0?(L/w*100).toFixed(1):0),p.push([$?$.substring(5):`G${E+1}`,P||""])}),Ln.games=new window.Chart(document.getElementById("chart-games-wl").getContext("2d"),{type:"bar",data:{labels:p,datasets:[{label:"得点",data:v,backgroundColor:"rgba(75, 192, 192, 0.8)"},{label:"失点",data:x,backgroundColor:"rgba(255, 99, 132, 0.8)"},{label:"累積勝率(%)",type:"line",data:h,borderColor:"rgba(255, 205, 86, 1)",yAxisID:"y1"}]},options:{responsive:!0,plugins:{tooltip:{callbacks:{title:function(I){if(!I.length)return"";const E=I[0].dataIndex,$=k[E];return $?`${$.date} 【${$.title}】
${$.myTeam} vs ${$.oppTeam}`:""},label:function(I){const E=I.dataIndex,$=k[E],_=I.dataset.label||"";return _==="得点"?`得点 (${($==null?void 0:$.myTeam)||"自チーム"}): ${I.raw} 点`:_==="失点"?`失点 (${($==null?void 0:$.oppTeam)||"相手チーム"}): ${Math.abs(I.raw)} 点`:_==="累積勝率(%)"?`累積勝率: ${I.raw} %`:`${_}: ${I.raw}`}}}},scales:{x:{stacked:!0,ticks:{font:{size:10}}},y:{stacked:!0,position:"left"},y1:{position:"right",beginAtZero:!0,min:0,max:100}}}})}function kt(e){let t=0,n=0,a=0,s=0,r=0,o=0,i=0,d=0,l=0,c=0,u=0,m=0,f=0,b=0,y=0;e.forEach(w=>{const I=w.plate_appearances||0,E=w.at_bats||0,$=w.hits||0,_=w.doubles||0,C=w.triples||0,M=w.home_runs||0,N=w.walks||0,P=w.hit_by_pitch||0,U=w.strike_outs||w.strikeouts||0,O=w.sacrifice_flies||w.sac_flies||0,B=w.sacrifice_hits||w.sac_bunts||0,A=w.runs_batted_in||0,T=w.runs||0,D=w.stolen_bases||0;t+=I,n+=E,a+=$,m+=_,f+=C,u+=M,d+=N,l+=P,c+=U,b+=O,y+=B,r+=A,o+=T,i+=D;const H=(w.singles!==void 0?w.singles:Math.max(0,$-_-C-M))*1+_*2+C*3+M*4,W=w.total_bases&&w.total_bases>H?w.total_bases:H;s+=W});const g=n>0?a/n:0,p=n+d+l+b,v=p>0?(a+d+l)/p:t>0?(a+d+l)/t:0,x=n>0?s/n:0,h=v+x,k=a+d+l,L=k>0?o/k:0;return{pa:t,ab:n,h:a,doubles:m,triples:f,hr:u,tb:s,sf:b,sh:y,bb:d,hbp:l,rbi:r,r:o,sb:i,so:c,ob:k,avg:g,obp:v,slg:x,ops:h,runRate:L,avgStr:g.toFixed(3).replace(/^0/,""),obpStr:v.toFixed(3).replace(/^0/,""),slgStr:x.toFixed(3).replace(/^0/,""),opsStr:h.toFixed(3),runRateStr:k>0?(L*100).toFixed(1)+"%":"0.0%",bbRate:t>0?(d+l)/t:0,soRate:t>0?c/t:0}}function Lt(e){let t=0,n=0,a=0,s=0,r=0,o=0,i=0,d=0,l=0,c=0;e.forEach(g=>{t+=g.outs||0,n+=g.earned_runs||0,a+=g.hits_allowed||0,s+=(g.walks_allowed||0)+(g.hit_batters||0),r+=g.strike_outs||0,o+=g.batters_faced||0,i+=g.pitch_count||0,d+=g.strikes||0,l+=g.wins||0,c+=g.losses||0});const u=t/3,m=u>0?n*7/u:0,f=u>0?(a+s)/u:0,b=u>0?r*7/u:0,y=u>0?s*7/u:0;return{outs:t,er:n,h:a,bb:s,so:r,bf:o,pc:i,st:d,wins:l,losses:c,era:m,whip:f,k7:b,bb7:y,eraStr:m.toFixed(2),whipStr:f.toFixed(2),k7Str:b.toFixed(2),bb7Str:y.toFixed(2),kRate:o>0?r/o:0,bbRate:o>0?s/o:0,kbb:s>0?r/s:r>0?99.9:0,sRate:i>0?d/i:0}}async function os(){var d,l,c,u,m,f;await On();const e=((d=document.getElementById("ps-mode"))==null?void 0:d.value)||"single",t=(l=document.getElementById("ps-player"))==null?void 0:l.value,n=((c=document.getElementById("ps-role"))==null?void 0:c.value)||"batter",a=((u=document.getElementById("ps-limit-games"))==null?void 0:u.value)||"5",s=((m=document.getElementById("ps-ma-unit"))==null?void 0:m.value)||"ab",r=parseInt(((f=document.getElementById("ps-ma-window"))==null?void 0:f.value)||"10",10),o=document.getElementById("ps-single-container"),i=document.getElementById("ps-all-container");e==="single"?(o==null||o.classList.remove("hidden"),i==null||i.classList.add("hidden"),t&&Bo(t,n,a,s,r)):(o==null||o.classList.add("hidden"),i==null||i.classList.remove("hidden"),No(n,a,s,r))}function Bo(e,t,n,a,s){var y;const{games:r,bStats:o,pStats:i}=En,d=((y=it.find(g=>g.id==e))==null?void 0:y.name)||"選手",c=(t==="batter"?o:i).filter(g=>g.player_id==e).map(g=>{const p=r.find(v=>v.id===g.game_id);return{date:(p==null?void 0:p.date)||"",game:p,stats:g}}).filter(g=>g.date).sort((g,p)=>g.date.localeCompare(p.date)),u=t==="batter"?kt(c.map(g=>g.stats)):Lt(c.map(g=>g.stats));let m=[...c];if(n!=="all"){const g=parseInt(n,10);m.length>g&&(m=m.slice(m.length-g))}const f=t==="batter"?kt(m.map(g=>g.stats)):Lt(m.map(g=>g.stats));To(d,t,f,u,m);const b=dr(m,t,a,s);Ao(d,t,m),Co(d,t,b,a,s),Do(t,m)}function To(e,t,n,a,s){const r=document.getElementById("ps-highlight-cards");if(r)if(t==="batter"){const o=n.avg-a.avg,i=(o>=0?"+":"")+o.toFixed(3).replace(/^0/,""),d=o>=.03,l=o<=-.05,c=d?"🔥 好調":l?"❄️ 不調":"⚖️ 安定",u=d?"bg-red-100 text-red-700 border-red-200":l?"bg-blue-100 text-blue-700 border-blue-200":"bg-gray-100 text-gray-700 border-gray-200";let m=0;for(let f=s.length-1;f>=0;f--){const b=s[f].stats.hits||0,y=s[f].stats.at_bats||0;if(b>0)m++;else if(y>0)break}r.innerHTML=`
        ...
        `}}function dr(e,t,n,a){var r,o,i,d,l,c;const s=[];if(e.length===0)return s;if(n==="game")for(let u=0;u<e.length;u++){const m=Math.max(0,u-a+1),f=e.slice(m,u+1),b=f.map(v=>v.stats),y=t==="batter"?kt(b):Lt(b),g=e[u],p=pt((r=g.game)==null?void 0:r.team_first)?(o=g.game)==null?void 0:o.team_second:(i=g.game)==null?void 0:i.team_first;s.push({label:`${g.date.substring(5)} vs ${p||""}`,date:g.date,windowSpan:`${m+1}〜${u+1}試合目 (${f.length}試合)`,calc:y,stats:b})}else for(let u=0;u<e.length;u++){let m=0;const f=[];for(let v=u;v>=0;v--){f.unshift(e[v]);const x=t==="batter"?e[v].stats.at_bats||0:1;if(m+=x,m>=a)break}const b=f.map(v=>v.stats),y=t==="batter"?kt(b):Lt(b),g=e[u],p=pt((d=g.game)==null?void 0:d.team_first)?(l=g.game)==null?void 0:l.team_second:(c=g.game)==null?void 0:c.team_first;s.push({label:`${g.date.substring(5)} vs ${p||""}`,date:g.date,windowSpan:t==="batter"?`直近 ${y.ab} 打数`:`直近 ${f.length} 登板`,calc:y,stats:b})}return s}function Ao(e,t,n){Nt.rawGraph&&Nt.rawGraph.destroy();const a=document.getElementById("chart-ps-raw-stats");if(!a||n.length===0)return;const s=[],r=[];let o=[];n.forEach(i=>{var c,u,m;o.push(i.stats);const d=pt((c=i.game)==null?void 0:c.team_first)?(u=i.game)==null?void 0:u.team_second:(m=i.game)==null?void 0:m.team_first;s.push(`${i.date.substring(5)} vs ${d||""}`);const l=t==="batter"?kt(o):Lt(o);r.push(l)}),t==="batter"?Nt.rawGraph=new window.Chart(a.getContext("2d"),{type:"line",data:{labels:s,datasets:[{label:"累積打率",data:r.map(i=>i.avg),borderColor:"#ef4444",backgroundColor:"#ef4444",tension:.2},{label:"累積出塁率",data:r.map(i=>i.obp),borderColor:"#3b82f6",backgroundColor:"#3b82f6",tension:.2},{label:"累積OPS",data:r.map(i=>i.ops),borderColor:"#8b5cf6",backgroundColor:"#8b5cf6",borderDash:[4,4],tension:.2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"top"}},scales:{y:{min:0,ticks:{font:{size:10}}},x:{ticks:{font:{size:10},maxRotation:45}}}}}):Nt.rawGraph=new window.Chart(a.getContext("2d"),{type:"line",data:{labels:s,datasets:[{label:"累積防御率",data:r.map(i=>i.era),borderColor:"#ef4444",backgroundColor:"#ef4444",tension:.2},{label:"累積WHIP",data:r.map(i=>i.whip),borderColor:"#3b82f6",backgroundColor:"#3b82f6",tension:.2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"top"}},scales:{y:{min:0,ticks:{font:{size:10}}},x:{ticks:{font:{size:10},maxRotation:45}}}}})}function Co(e,t,n,a,s){const r=document.getElementById("ps-ma-graph-subtitle");r&&(r.textContent=`(${e} - 直近${s}${a==="ab"?"打数/登板":"試合"}移動平均)`),Nt.maGraph&&Nt.maGraph.destroy();const o=n.map(d=>d.label),i=document.getElementById("chart-ps-moving-avg");i&&(t==="batter"?Nt.maGraph=new window.Chart(i.getContext("2d"),{type:"line",data:{labels:o,datasets:[{label:"移動平均 打率",data:n.map(d=>d.calc.avg),borderColor:"#ef4444",backgroundColor:"#ef4444",tension:.2},{label:"移動平均 出塁率",data:n.map(d=>d.calc.obp),borderColor:"#3b82f6",backgroundColor:"#3b82f6",tension:.2},{label:"移動平均 OPS",data:n.map(d=>d.calc.ops),borderColor:"#8b5cf6",backgroundColor:"#8b5cf6",borderDash:[4,4],tension:.2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"top"}},scales:{y:{min:0,ticks:{font:{size:10}}},x:{ticks:{font:{size:10},maxRotation:45}}}}}):Nt.maGraph=new window.Chart(i.getContext("2d"),{type:"line",data:{labels:o,datasets:[{label:"移動平均 防御率",data:n.map(d=>d.calc.era),borderColor:"#ef4444",backgroundColor:"#ef4444",tension:.2},{label:"移動平均 WHIP",data:n.map(d=>d.calc.whip),borderColor:"#3b82f6",backgroundColor:"#3b82f6",tension:.2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"top"}},scales:{y:{min:0,ticks:{font:{size:10}}},x:{ticks:{font:{size:10},maxRotation:45}}}}}))}function Do(e,t){const n=document.getElementById("ps-game-thead"),a=document.getElementById("ps-game-tbody"),s=document.getElementById("ps-game-count-label");if(!n||!a)return;s&&(s.textContent=`対象全 ${t.length} 試合（最新順）`);const r=[...t].reverse();e==="batter"?(n.innerHTML=`
            <tr>
        ...
        `,a.innerHTML=r.map(o=>{var U,O,B;const i=o.stats,d=pt((U=o.game)==null?void 0:U.team_first)?(O=o.game)==null?void 0:O.team_second:(B=o.game)==null?void 0:B.team_first,l=i.plate_appearances||0,c=i.at_bats||0,u=i.hits||0,m=i.doubles||0,f=i.triples||0,b=i.home_runs||0,y=i.singles!==void 0?i.singles:Math.max(0,u-m-f-b),g=i.runs_batted_in||0,p=i.runs||0,v=i.walks||0,x=i.hit_by_pitch||0,h=i.strikeouts||i.strike_outs||0,k=i.sacrifice_flies||i.sac_flies||0,L=(i.sacrifice_hits||i.sac_bunts||0)+k,w=i.stolen_bases||0,I=i.errors||0,E=c>0?(u/c).toFixed(3).replace(/^0/,""):".000",$=c+v+x+k,_=$>0?(u+v+x)/$:l>0?(u+v+x)/l:0;_.toFixed(3).replace(/^0/,"");const C=y+m*2+f*3+b*4,M=i.total_bases&&i.total_bases>C?i.total_bases:C,N=c>0?M/c:0;N.toFixed(3).replace(/^0/,"");const P=(_+N).toFixed(3);return`
        ...
        `,a.innerHTML=r.map(o=>{var w,I,E;const i=o.stats,d=pt((w=o.game)==null?void 0:w.team_first)?(I=o.game)==null?void 0:I.team_second:(E=o.game)==null?void 0:E.team_first,l=i.outs||0,c=`${Math.floor(l/3)}${l%3!==0?"."+l%3:""}`,u=i.pitch_count||0,m=i.strikes||0,f=i.hits_allowed||0,b=i.home_runs_allowed||0,y=i.walks_allowed||0,g=i.hit_batters||0,p=i.strike_outs||0,v=i.runs_allowed||0,x=i.earned_runs||0,h=l/3,k=h>0?(x*7/h).toFixed(2):"0.00",L=h>0?((f+y)/h).toFixed(2):"0.00";return`
            ...
            `}).join(""))}function No(e,t,n,a){const s=document.getElementById("ps-all-title"),r=document.getElementById("ps-all-subtitle"),o=document.getElementById("ps-all-thead"),i=document.getElementById("ps-all-tbody");if(!o||!i)return;const{games:d,bStats:l,pStats:c}=En,u=t==="all"?"全試合":`直近 ${t} 試合`;s&&(s.textContent=`👥 全選手成績一覧 (${e==="batter"?"打撃":"投手"})`),r&&(r.textContent=`対象: ${u} / 移動平均: 直近${a}${n==="ab"?"打数/登板":"試合"} (各列クリックでソート)`);const m=new Set;l.forEach(p=>m.add(p.player_id)),c.forEach(p=>m.add(p.player_id));const b=it.filter(p=>m.has(p.id)).sort((p,v)=>p.name.localeCompare(v.name)).map(p=>{let h=[...(e==="batter"?l:c).filter(I=>I.player_id==p.id).map(I=>{const E=d.find($=>$.id===I.game_id);return{date:(E==null?void 0:E.date)||"",game:E,stats:I}}).filter(I=>I.date).sort((I,E)=>I.date.localeCompare(E.date))];if(t!=="all"){const I=parseInt(t,10);h.length>I&&(h=h.slice(h.length-I))}const k=e==="batter"?kt(h.map(I=>I.stats)):Lt(h.map(I=>I.stats)),L=dr(h,e,n,a),w=L.length>0?L[L.length-1].calc:k;return{player:p,name:p.name,gameCount:h.length,calcPeriod:k,latestMa:w,ab:k.ab,h:k.h,hr:k.hr,rbi:k.rbi,r:k.r,bb:k.bb+k.hbp,avg:k.avg,obp:k.obp,slg:k.slg,ops:k.ops,runRate:k.runRate,maAvg:w.avg,maOps:w.ops,outs:k.outs,so:k.so,pBb:k.bb,wins:k.wins,losses:k.losses,era:k.era,whip:k.whip,maEra:w.era,maWhip:w.whip}}),y=dn[e];b.sort((p,v)=>{let x=p[y.key],h=v[y.key];return x===void 0&&(x=0),h===void 0&&(h=0),typeof x=="string"?y.order==="asc"?x.localeCompare(h):h.localeCompare(x):y.order==="asc"?x-h:h-x});const g=p=>y.key===p?y.order==="asc"?" ▲":" ▼":"";e==="batter"?(o.innerHTML=`
            <tr>
...
$2`));const i=Io(o);if(i.length<2)return alert("データが空かフォーマットが不正です。");j("データベースへ保存中..."),n.classList.add("hidden");try{const d=new Map,l=new Map,c=[];for(let y=1;y<i.length;y++){const g=i[y];if(g.length<30)continue;const p=parseInt(g[0]),v=parseInt(g[3]);if(isNaN(p)||isNaN(v))continue;d.set(p,{id:p,name:g[1]||"不明",uniform_number:g[2]||null});let x=null;if(g[4]&&g[4].trim()){const k=g[4].trim().replace(/\//g,"-"),L=new Date(k);if(isNaN(L.getTime())){const w=k.split("-");if(w.length===3){const I=parseInt(w[0],10),E=parseInt(w[1],10),$=parseInt(w[2],10);!isNaN(I)&&!isNaN(E)&&!isNaN($)&&(x=`${I}-${String(E).padStart(2,"0")}-${String($).padStart(2,"0")}`)}}else{const w=L.getFullYear(),I=String(L.getMonth()+1).padStart(2,"0"),E=String(L.getDate()).padStart(2,"0");x=`${w}-${I}-${E}`}}l.set(v,{id:v,date:x,team_first:g[5]||null,score:g[6]||null,team_second:g[7]||null,title:g[8]||null,category:g[9]||null,stadium:g[10]||null});const h={player_id:p,game_id:v};t==="batter"?["plate_appearances","at_bats","runs","hits","doubles","triples","home_runs","total_bases","runs_batted_in","stolen_bases","caught_stealing","sacrifice_hits","sacrifice_flies","walks","hit_by_pitch","strike_outs","left_on_base","double_plays","scoring_position_at_bats","scoring_position_hits","go","fo"].forEach((L,w)=>h[L]=parseInt(g[11+w])||0):t==="pitcher"&&["is_starter","wins","losses","saves","holds","qs","outs","pitch_count","strikes","batters_faced","at_bats","hits_allowed","home_runs_allowed","walks_allowed","hit_batters","strike_outs","runs_allowed","earned_runs","wild_pitches","balks","sacrifice_hits_allowed","sacrifice_flies_allowed","go","fo"].forEach((L,w)=>h[L]=parseInt(g[11+w])||0),c.push(h)}const{error:u}=await S.from("players").upsert(Array.from(d.values()));if(u)throw u;const{error:m}=await S.from("games").upsert(Array.from(l.values()));if(m)throw m;const f=t==="batter"?"batter_stats":"pitcher_stats",{error:b}=await S.from(f).upsert(c,{onConflict:"player_id, game_id"});if(b)throw b;await ae("IMPORT_CSV",`成績データ(${t==="batter"?"打者":"投手"})を${c.length}件インポートしました`),n.textContent=`成功: ${c.length} 件のデータをインポートしました。`,n.className="mt-4 text-sm font-bold text-green-600",n.classList.remove("hidden"),e.value="",ir()}catch(d){n.textContent=`エラー: ${d.message}`,n.className="mt-4 text-sm font-bold text-red-600",n.classList.remove("hidden")}finally{q()}},s.readAsText(a)}function Fo(){const e=document.getElementById("detail-analysis-file");if(!e||!e.files||e.files.length===0){alert("ファイルを選択してください。");return}const t=e.files[0],n=new FileReader;n.onload=function(a){try{const s=JSON.parse(a.target.result),r=s.cat&&Array.isArray(s.cat)?s.cat.length:0,o=s.sys&&Array.isArray(s.sys)?s.sys.length:0;let i="なし",d=0;if(s.sys){const c=s.sys.find(m=>m.ke==="sysdata23");if(c&&c.va)try{const m=JSON.parse(c.va);m&&m.pcl&&(i=`${m.pcl.length} 件のイベント`)}catch{i="解析失敗"}const u=s.sys.find(m=>m.ke==="sysdata12");u&&u.va&&(d=u.va.split(",").length)}if(ht=jo(s),!ht){alert("詳細データのパースに失敗しました。sysdata23 が見つかりません。");return}document.getElementById("detail-stats-cat-count").textContent=r,document.getElementById("detail-stats-sys-count").textContent=o,document.getElementById("detail-stats-has-pcl").textContent=i,document.getElementById("detail-stats-ground-count").textContent=d;const l=["<strong>イニング別の詳細スコア分析</strong>: イニングごとの詳細なプレイ記録から得点パターン（何回の攻撃が得点に結びつきやすいか、どのようなアウトの取られ方をしているか）を可視化しました。","<strong>打撃イベント分析（アウトの種類・打球方向）</strong>: プレイログの「サードゴロ」「レフトヒット」などの実況テキストをパースし、各打者の打球方向やアウトの種類の割合を集計しました。","<strong>走塁・盗塁成否分析</strong>: プレイログから「盗塁成功」「盗塁失敗」などのイベントを検出し、選手ごとの走塁成功率やシチュエーションごとの傾向を分析しました。","<strong>エラー発生状況の分析</strong>: 実況テキストに含まれる送球エラーや落球などのキーワードから、守備位置ごとのエラー数やエラーの起こりやすいタイミングを特定しました。","<strong>連続打席・チャンス時の打撃結果</strong>: ランナーがいる場面での打撃内容や、打席ごとの一球単位のボールカウント（ストライク・ボール推移）に応じた結果の相関関係を分析しました。"];document.getElementById("detail-analysis-suggestions").innerHTML=l.map(c=>`<li>${c}</li>`).join(""),document.getElementById("detail-analysis-result").classList.remove("hidden"),document.getElementById("detail-analysis-dashboard").classList.remove("hidden"),Ho()}catch(s){console.error(s),alert("JSONデータのパースに失敗しました。ファイルの形式が正しいか確認してください。")}},n.readAsText(t)}function jo(e){const t=e.sys?e.sys.find(i=>i.ke==="sysdata23"):null;if(!t||!t.va)return null;let n=[];try{n=JSON.parse(t.va).pcl||[]}catch(i){return console.error("Failed to parse sysdata23.va",i),null}const a={innings:{},batters:{},steals:{},errors:{byInning:{},byPosition:{},byPlayer:{}},counts:{}};let s="1回表",r=null;const o=i=>[2,3,4,5,6,7].includes(i);return n.forEach(i=>{const d=i.rnr,l=i.ball,c=i.strk;i.codes&&i.codes.forEach(u=>{if(!u.pli||!u.pli.sPlay)return;const m=u.pli.sPlay.trim(),f=u.cd||"",b=m.match(/^(\d+回(?:表|ｳﾗ|裏))/);b&&(s=b[1],a.innings[s]||(a.innings[s]={runs:0,outs:{strikeout:0,groundout:0,flyout:0,other:0}}));const y=m.match(/^\d+番(.+?)(?:#\d+)?$/);if(y&&(r=y[1].trim(),a.batters[r]||(a.batters[r]={pa:0,ab:0,hits:0,strikeout:0,walk:0,groundout:0,flyout:0,otherout:0,rbi:0,chances:{pa:0,hits:0,rbi:0},directions:{left:0,center:0,right:0,inner:0,other:0},counts:{}}),a.batters[r].pa++,o(d)&&a.batters[r].chances.pa++),(m.includes("生還")||m.includes("本塁生還")||m.includes("ホームイン"))&&(a.innings[s]&&a.innings[s].runs++,r&&(a.batters[r].rbi++,o(d)&&a.batters[r].chances.rbi++)),m.includes("盗塁")){const g=m.match(/(?:ランナー|打者)(.+?)(?:\d+塁|本塁|$)/);if(g){const p=g[1].replace(/\d+$/,"").trim();p&&p!=="打者"&&(a.steals[p]||(a.steals[p]={attempts:0,success:0,fail:0}),a.steals[p].attempts++,m.includes("失敗")||m.includes("アウト")?a.steals[p].fail++:a.steals[p].success++)}}if(m.includes("エラー")||m.includes("失策")||m.includes("ファンブル")||m.includes("後逸")||m.includes("暴投")||m.includes("捕逸")){a.errors.byInning[s]=(a.errors.byInning[s]||0)+1;const g=m.match(/(ピッチャー|キャッチャー|ファースト|セカンド|サード|ショート|レフト|センター|ライト)/);g?a.errors.byPosition[g[1]]=(a.errors.byPosition[g[1]]||0)+1:a.errors.byPosition.その他=(a.errors.byPosition.その他||0)+1,it.forEach(p=>{p.name&&m.includes(p.name)&&(a.errors.byPlayer[p.name]||(a.errors.byPlayer[p.name]=[]),a.errors.byPlayer[p.name].push({inning:s,play:m}))})}if(r){const g=a.batters[r];if(f.startsWith("H")||f.startsWith("Go")||f.startsWith("Fo")||f.startsWith("Ko")||f.startsWith("Bb")){const v=`${l}-${c}`;a.counts[v]||(a.counts[v]={pa:0,hits:0}),a.counts[v].pa++,f.startsWith("H")&&a.counts[v].hits++,g.counts[v]||(g.counts[v]={pa:0,hits:0}),g.counts[v].pa++,f.startsWith("H")&&g.counts[v].hits++}m.includes("ヒット")||m.includes("安打")||m.includes("ツーベース")||m.includes("スリーベース")||m.includes("ホームラン")||m.includes("本塁打")?(g.hits++,g.ab++,o(d)&&g.chances.hits++,m.includes("レフト")?g.directions.left++:m.includes("センター")?g.directions.center++:m.includes("ライト")?g.directions.right++:m.includes("内野")?g.directions.inner++:g.directions.other++):m.includes("フォアボール")||m.includes("デッドボール")||m.includes("四球")||m.includes("死球")?g.walk++:m.includes("三振")?(g.strikeout++,g.ab++,a.innings[s]&&a.innings[s].outs.strikeout++):m.includes("ゴロ")?(g.groundout++,g.ab++,a.innings[s]&&a.innings[s].outs.groundout++,m.includes("サード")||m.includes("ショート")?g.directions.left++:m.includes("セカンド")||m.includes("ファースト")?g.directions.right++:g.directions.inner++):m.includes("フライ")||m.includes("ライナー")?(g.flyout++,g.ab++,a.innings[s]&&a.innings[s].outs.flyout++,m.includes("レフト")?g.directions.left++:m.includes("センター")?g.directions.center++:m.includes("ライト")?g.directions.right++:g.directions.inner++):m.includes("アウト")&&(m.includes("打者")||m.includes("バッター"))&&(g.otherout++,g.ab++,a.innings[s]&&a.innings[s].outs.other++)}})}),a}function Ho(){if(!ht)return;const e=document.getElementById("detail-player-select");if(e){const t=it.map(a=>a.name.trim()),n=Object.keys(ht.batters).filter(a=>t.some(s=>a.includes(s)||s.includes(a))).sort();if(n.length===0){e.innerHTML='<option value="">該当する選手がいません</option>';return}e.innerHTML=n.map(a=>`<option value="${a}">${a}</option>`).join(""),e.onchange=function(a){Ns(a.target.value)},Ns(n[0])}}async function Ns(e){if(!ht||!e)return;await On();const t=ht.batters[e]||{pa:0,ab:0,hits:0,strikeout:0,walk:0,groundout:0,flyout:0,otherout:0,rbi:0,chances:{pa:0,hits:0},directions:{left:0,center:0,right:0,inner:0,other:0},counts:{}};document.getElementById("stat-p-hits").textContent=t.hits,document.getElementById("stat-p-strikeouts").textContent=t.strikeout,document.getElementById("stat-p-groundouts").textContent=t.groundout,document.getElementById("stat-p-flyouts").textContent=t.flyout,document.getElementById("stat-p-walks").textContent=t.walk||0,document.getElementById("stat-p-others").textContent=t.otherout;const n=t.ab||t.pa-(t.walk||0),a=n>0?t.hits/n:0;document.getElementById("stat-p-avg").textContent=a===1?"1.000":a.toFixed(3).substring(1),gt.playerBattingResult&&gt.playerBattingResult.destroy();const s=document.getElementById("chart-detail-player-batting-result").getContext("2d");gt.playerBattingResult=new window.Chart(s,{type:"doughnut",data:{labels:["安打","三振","ゴロ","フライ","四死球","他"],datasets:[{data:[t.hits,t.strikeout,t.groundout,t.flyout,t.walk||0,t.otherout],backgroundColor:["#10B981","#EF4444","#FBBF24","#3B82F6","#6366F1","#9CA3AF"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}),gt.playerDirection&&gt.playerDirection.destroy();const r=[t.directions.left,t.directions.center,t.directions.right,t.directions.inner,t.directions.other],o=document.getElementById("chart-detail-player-direction").getContext("2d");gt.playerDirection=new window.Chart(o,{type:"doughnut",data:{labels:["レフト","センター","ライト","内野","その他"],datasets:[{data:r,backgroundColor:["#EC4899","#3B82F6","#14B8A6","#F59E0B","#8B5CF6"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",labels:{boxWidth:10,font:{size:10}}}}}});const i=t.chances.pa,d=t.chances.hits,l=i>0?d/i:0;document.getElementById("stat-p-chance-avg").textContent=l===1?"1.000":l.toFixed(3).substring(1),document.getElementById("stat-p-chance-detail").textContent=`${i}打席 ${d}安打`,document.getElementById("stat-p-rbi").textContent=t.rbi;let c={attempts:0,success:0};const u=Object.keys(ht.steals).find(h=>e.includes(h)||h.includes(e));u&&(c=ht.steals[u]);const m=c.attempts>0?c.success/c.attempts*100:0;document.getElementById("stat-p-steal-rate").textContent=m.toFixed(1)+"%",document.getElementById("stat-p-steal-detail").textContent=`成功 ${c.success} / 企図 ${c.attempts}`;const f=ht.errors.byPlayer[e]||[];document.getElementById("stat-p-errors-count").textContent=`${f.length} 件`;const b=document.getElementById("stat-p-errors-detail");b&&(f.length===0?b.innerHTML='<div class="text-gray-400 text-center py-2">期間内エラーの記録はありません</div>':b.innerHTML=f.map(h=>`
            ...
            `).join(""));const y=t.counts||{},g=["0-0","1-0","2-0","3-0","0-1","1-1","2-1","3-1","0-2","1-2","2-2","3-2"],p=g.map(h=>y[h]?y[h].pa:0),v=g.map(h=>y[h]?y[h].hits:0);gt.playerCount&&gt.playerCount.destroy();const x=document.getElementById("chart-detail-player-count").getContext("2d");gt.playerCount=new window.Chart(x,{type:"bar",data:{labels:g.map(h=>h+" count"),datasets:[{label:"打席数",data:p,backgroundColor:"rgba(99, 102, 241, 0.6)"},{label:"安打数",data:v,backgroundColor:"rgba(16, 185, 129, 0.8)"}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{y:{beginAtZero:!0,ticks:{stepSize:1}}}}})}let Pe=[],De="team_default",_t=[],be=[],Ae=[],Fe="",zn=null;function rn(){return Pe.find(e=>e.id===De)||Pe[0]||{id:"team_default",name:"ありんこアントス (A軍)"}}function Mn(){return be.filter(e=>(e.teamId||"team_default")===De)}function Uo(){if(!zn){const e=rn();zn={id:"",name:"新規配置データ",teamId:De,mode:ee,basePositions:{},customSubstitutions:[],battingOrder:{},headerInfo:{date:"",tournament:"",teamHome:e.name||"ありんこアントス",teamVisitor:"",manager:"",captain:"",scorer:"",stadium:"",time:""}}}return zn}function we(){return Ae.find(e=>e.id===Fe)||Uo()}let _e=null,fe=null,ee=9;const vt={p:"投手",c:"捕手","1b":"一塁手","2b":"二塁手","3b":"三塁手",ss:"遊撃手",lf:"左翼手",cf:"中堅手",rf:"右翼手",dh:"指名打者"},mn={p:"1",c:"2","1b":"3","2b":"4","3b":"5",ss:"6",lf:"7",cf:"8",rf:"9",dh:"DH"},Vo={1:"p",2:"c",3:"1b",4:"2b",5:"3b",6:"ss",7:"lf",8:"cf",9:"rf",10:"dh",d:"dh",dh:"dh",DH:"dh"},dt=["p","c","1b","2b","3b","ss","lf","cf","rf"],lt=["p","c","1b","2b","3b","ss","lf","cf","rf","dh"];async function Jn(){try{if(ki(),await Go(),jt(),pa(),_n(),Ae.length>0){Fe=Ae[0].id;const e=document.getElementById("sim-pattern-select");e&&(e.value=Fe);const t=we();t&&(ee=t.mode||9,t.teamId&&Pe.some(n=>n.id===t.teamId)&&(De=t.teamId,jt()))}Ht(),ea("setup"),Oe(),me()}catch(e){console.error("Fatal initialization error:",e),alert(`アプリケーションの初期化中にエラーが発生しました。
詳細: `+e.message)}}async function Go(){Pe=[{id:"team_default",name:"ありんこアントス (A軍)"},{id:"team_b",name:"ありんこアントス (B軍・ジュニア)"}],De=Pe[0].id,_t=[],be=[{id:"p1",name:"とあ",number:"2",teamId:"team_default"},{id:"p2",name:"そうま",number:"10",teamId:"team_default"},{id:"p3",name:"あきと",number:"3",teamId:"team_default"},{id:"p4",name:"ゆうき",number:"4",teamId:"team_default"},{id:"p5",name:"あいのすけ",number:"1",teamId:"team_default"},{id:"p6",name:"けんせい",number:"6",teamId:"team_default"},{id:"p7",name:"りゅうと",number:"7",teamId:"team_default"},{id:"p8",name:"ながまさ",number:"8",teamId:"team_default"},{id:"p9",name:"そうすけ",number:"9",teamId:"team_default"},{id:"p10",name:"たいち",number:"5",teamId:"team_default"}],Ae=[]}async function ds(){return null}async function lr(){return null}async function ma(e,t=!1){return null}async function Xn(e,t=!1){return null}async function je(e){e&&(await Xn(),_n())}function jt(){const e=document.getElementById("sim-team-select"),t=document.getElementById("new-sim-team"),n=document.getElementById("sim-current-team-label"),a=rn();n&&(n.textContent=`[${a.name}]`),e&&(e.innerHTML="",Pe.forEach(s=>{const r=document.createElement("option");r.value=s.id,r.textContent=s.name,e.appendChild(r)}),e.value=De),t&&(t.innerHTML="",Pe.forEach(s=>{const r=document.createElement("option");r.value=s.id,r.textContent=s.name,t.appendChild(r)}),t.value=De)}function pa(){const e=document.getElementById("sim-template-select-inline"),t=document.getElementById("new-sim-template");e&&(e.innerHTML='<option value="">(選択して適用)</option>',_t.forEach(n=>{const a=document.createElement("option");a.value=n.id,a.textContent=n.name,e.appendChild(a)})),t&&(t.innerHTML='<option value="">(未配置から開始)</option>',_t.forEach(n=>{const a=document.createElement("option");a.value=n.id,a.textContent=n.name,t.appendChild(a)}))}async function Wo(e="",t=null,n=null,a=null){const s="pat_"+Date.now(),r=t||De,o=Pe.find(m=>m.id===r)||rn();let i={},d={},l=a!==null?a:ee;if(n){const m=_t.find(f=>f.id===n);m&&(i=JSON.parse(JSON.stringify(m.basePositions||{})),d=JSON.parse(JSON.stringify(m.battingOrder||{})),l=m.mode||l)}ee=l,De=r;const c={id:s,name:e||"新規データ",teamId:r,mode:ee,basePositions:i,customSubstitutions:[],battingOrder:d,headerInfo:{date:"",tournament:"",teamHome:o.name||"ありんこアントス",teamVisitor:"",manager:"",captain:"",scorer:"",stadium:"",time:""}};Ae.unshift(c),Fe=s,await je(c),jt(),Ht(),_n();const u=document.getElementById("sim-pattern-select");u&&(u.value=s)}function _n(){const e=document.getElementById("sim-pattern-select");e&&(e.innerHTML='<option value="">選択してください...</option>',Ae.forEach(t=>{const n=document.createElement("option");n.value=t.id;const a=t.isSynced===!1?" (未同期)":"",s=Pe.find(o=>o.id===t.teamId),r=s?`[${s.name}] `:"";n.textContent=r+t.name+a,e.appendChild(n)}),Fe&&(e.value=Fe))}function Ht(){const e=document.getElementById("btn-sim-mode-9"),t=document.getElementById("btn-sim-mode-10");ee===9?(e.className="px-3 py-1.5 text-xs font-bold bg-amber-600 text-white transition",t.className="px-3 py-1.5 text-xs font-bold bg-white text-gray-700 border-l hover:bg-gray-50 transition"):(e.className="px-3 py-1.5 text-xs font-bold bg-white text-gray-700 transition",t.className="px-3 py-1.5 text-xs font-bold bg-amber-600 text-white border-l hover:bg-gray-50 transition")}function Rn(e){const t={...e.basePositions||{}},n=ee===9?dt:lt;return Object.keys(t).forEach(s=>{n.includes(s)||delete t[s]}),(e.customSubstitutions||[]).filter(s=>s.active).forEach(s=>{if(s.type==="swap"){const{pos1:r,pos2:o}=s.details;if(n.includes(r)&&n.includes(o)){const i=t[r];t[r]=t[o],t[o]=i}}else if(s.type==="sub"){const{outPlayerId:r,inPlayerId:o,pos:i}=s.details;if(r){const d=Object.keys(t).find(l=>t[l]===r);d&&(t[d]=o)}else i&&n.includes(i)&&(t[i]=o)}else if(s.type==="rotation"){const o=s.details.positions.filter(i=>n.includes(i));if(o.length>1){const i=o.map(d=>t[d]);for(let d=0;d<o.length;d++){const l=i[(d-1+o.length)%o.length];t[o[d]]=l}}}}),t}function qn(e){const t=new Set;return(e.customSubstitutions||[]).filter(a=>a.active).forEach(a=>{a.type==="sub"&&a.details.outPlayerId&&t.add(a.details.outPlayerId)}),t}function yn(e){e.battingOrder||(e.battingOrder={});const t=ee===9?dt:lt,n=e.basePositions||{},a=new Set;t.forEach(i=>{n[i]&&a.add(n[i])}),Object.keys(e.battingOrder).forEach(i=>{const d=e.battingOrder[i];a.has(d)||delete e.battingOrder[i]});const s=new Set(Object.values(e.battingOrder)),r=[];a.forEach(i=>{s.has(i)||r.push(i)});const o=t.length;for(let i=1;i<=o&&r.length!==0;i++)if(!e.battingOrder[i]){const d=r.shift();e.battingOrder[i]=d}}function me(){const e=we();if(!e)return;const t=Rn(e),n=qn(e),a=new Set(Object.values(t).filter(Boolean));yn(e),zo(a,n),Jo(a,n),Yo(t,e),Ko(e),Qo(e),Zo(e)}function zo(e,t){const n=document.getElementById("sim-players-list"),a=document.getElementById("sim-player-count");if(!n)return;n.innerHTML="";const s=Mn();if(a&&(a.textContent=`${s.length} 人`),s.length===0){n.innerHTML='<span class="text-xs text-gray-400 p-2">このチームに登録されている選手がいません。</span>';return}s.forEach(r=>{const o=e.has(r.id),i=t.has(r.id),d=_e===r.id&&fe==="players-list",l=document.createElement("div");l.className=`sim-player-badge ${o?"assigned":""} ${i?"retired":""} ${d?"selected":""}`,l.setAttribute("data-player-id",r.id),!o&&!i&&(l.setAttribute("draggable","true"),l.addEventListener("dragstart",cr));const c=r.number?`#${r.number} `:"";l.innerHTML=`
            <span>${c}${ge(r.name)}${i?" (交代済)":""}</span>
            <span class="sim-player-delete-btn" data-player-id="${r.id}">×</span>
        `,l.addEventListener("click",u=>{if(u.target.classList.contains("sim-player-delete-btn")){bi(r.id);return}o||i||mr(r.id,"players-list")}),n.appendChild(l)})}function Jo(e,t){const n=document.getElementById("sim-bench-list");if(!n)return;n.innerHTML="";const s=Mn().filter(r=>!e.has(r.id)&&!t.has(r.id));if(s.length===0){n.innerHTML='<span class="text-xs text-gray-400 p-1">控え選手はいません。</span>';return}s.forEach(r=>{const o=_e===r.id&&fe==="bench",i=document.createElement("div");i.className=`sim-player-badge sim-bench-badge ${o?"selected":""}`,i.setAttribute("data-player-id",r.id),i.setAttribute("draggable","true");const d=r.number?`#${r.number} `:"";i.innerHTML=`<span>${d}${ge(r.name)}</span>`,i.addEventListener("dragstart",cr),i.addEventListener("click",()=>{mr(r.id,"bench")}),n.appendChild(i)})}function Yo(e,t){const n=document.getElementById("sim-field-positions");if(!n)return;n.innerHTML="",(ee===9?dt:lt).forEach(s=>{const r=e[s],o=be.find(u=>u.id===r),i=(t.basePositions||{})[s]!==r&&r,d=_e&&fe===s,l=document.createElement("div");l.className=`sim-pos-slot pos-${s} ${d?"swap-selected":""}`,l.setAttribute("data-position",s),l.addEventListener("dragover",ni),l.addEventListener("dragleave",ai),l.addEventListener("drop",si),l.addEventListener("click",()=>{ri(s)});const c=o&&o.number?`#${o.number} `:"";l.innerHTML=`
            <div class="sim-pos-title">${vt[s]}</div>
            <div class="sim-pos-player ${i?"player-changed":""}">
                ${o?c+ge(o.name):'<span class="text-gray-300 text-xs font-normal">未配置</span>'}
            </div>
        `,n.appendChild(l)})}function Ko(e){const t=document.getElementById("sim-batting-order-list");if(!t)return;t.innerHTML="";const n=ee===9?dt:lt,a=n.length,s=e.basePositions||{},r={};n.forEach(o=>{const i=s[o];i&&(r[i]=o)});for(let o=1;o<=a;o++){const i=e.battingOrder[o],d=i?be.find(g=>g.id===i):null,l=d?r[d.id]:null,c=l?vt[l]:"未配置",u=document.createElement("div");d?u.className="flex items-center justify-between bg-amber-50/50 border border-amber-100 rounded-lg p-2 text-xs transition-colors duration-150":u.className="flex items-center justify-between bg-gray-50/50 border border-dashed border-gray-200 rounded-lg p-2 text-xs text-gray-400 transition-colors duration-150";const m=document.createElement("div");m.className="flex items-center gap-1 shrink-0";const f=document.createElement("button");f.className="px-2 py-1 bg-amber-100 hover:bg-amber-200 disabled:opacity-30 disabled:cursor-not-allowed text-amber-900 font-bold rounded text-[10px] leading-none transition shadow-sm",f.textContent="▲",o===1&&(f.disabled=!0),f.addEventListener("click",()=>Ps(o,"up"));const b=document.createElement("button");b.className="px-2 py-1 bg-amber-100 hover:bg-amber-200 disabled:opacity-30 disabled:cursor-not-allowed text-amber-900 font-bold rounded text-[10px] leading-none transition shadow-sm",b.textContent="▼",o===a&&(b.disabled=!0),b.addEventListener("click",()=>Ps(o,"down")),m.appendChild(f),m.appendChild(b);let y="";if(d){const g=d.number?`#${d.number} `:"";y=`
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-bold text-gray-800">${g}${ge(d.name)}</span>
                </div>
                <div class="flex items-center gap-2">
            ...
            `;u.innerHTML=y,u.appendChild(m),t.appendChild(u)}}async function Ps(e,t){const n=we();if(!n)return;n.battingOrder||(n.battingOrder={});const a=t==="up"?e-1:e+1,r=(ee===9?dt:lt).length;if(a<1||a>r)return;const o=n.battingOrder[e],i=n.battingOrder[a];o&&i?(n.battingOrder[e]=i,n.battingOrder[a]=o):o?(n.battingOrder[a]=o,delete n.battingOrder[e]):i&&(n.battingOrder[e]=i,delete n.battingOrder[a]),await je(n),me()}function ls(e,t,n){if(!e)return{code:"",desc:"",fullDesc:""};if(e.type==="sub"){const{outPlayerId:a,inPlayerId:s}=e.details,r=be.find(y=>y.id===a),o=be.find(y=>y.id===s),i=r?r.name:"不明",d=o?o.name:"不明",l=Object.keys(t).find(y=>t[y]===a),c=l&&mn[l]||"",u=l?vt[l]||"":"選手",m=c?`交代 (${c})`:"交代",f=n?`<span class="font-bold text-amber-900">${ge(i)}</span>に代わって<span class="font-bold text-amber-900">${ge(d)}</span>`:`${i}に代わって${d}`,b=`${u}の${i}に代わりまして、${d}が入ります。`;return{code:m,desc:f,fullDesc:b}}else if(e.type==="rotation"){const a=e.details.positions||[],r=a.map(l=>mn[l]||l).join("-"),o=[];for(let l=0;l<a.length-1;l++){const c=a[l],u=a[l+1],m=t[c],f=be.find(b=>b.id===m);if(f){const b=n?`<span class="font-bold text-amber-900">${ge(f.name)}</span>`:f.name;o.push(`${b}が${vt[u]}`)}}const i=o.join("、"),d=i?`${i}へ。`:"ポジション交代";return{code:r,desc:i,fullDesc:d}}else if(e.type==="swap"){const{pos1:a,pos2:s}=e.details,r=t[a],o=t[s],i=be.find(v=>v.id===r),d=be.find(v=>v.id===o),l=mn[a]||a,c=mn[s]||s,u=vt[a]||"",m=vt[s]||"",f=i?i.name:"未配置",b=d?d.name:"未配置",y=`${l}⇔${c}`,g=n?`<span class="font-bold text-amber-900">${ge(f)}</span>と<span class="font-bold text-amber-900">${ge(b)}</span>の入れ替え`:`${f}と${b}の入れ替え`,p=`${u}の${f}と${m}の${b}が入れ替わります。`;return{code:y,desc:g,fullDesc:p}}return{code:"",desc:"",fullDesc:""}}function Qo(e){const t=document.getElementById("sim-sub-rules-list");if(!t)return;t.innerHTML="";const n=e.customSubstitutions||[];if(n.length===0){t.innerHTML='<p class="text-xs text-gray-400 text-center py-4">登録された交代はありません。</p>';return}const a=ee===9?dt:lt;let s={...e.basePositions||{}};n.forEach(r=>{const o=ls(r,s,!0);if(r.active){if(r.type==="swap"){const{pos1:l,pos2:c}=r.details;if(a.includes(l)&&a.includes(c)){const u=s[l];s[l]=s[c],s[c]=u}}else if(r.type==="sub"){const{outPlayerId:l,inPlayerId:c,pos:u}=r.details;if(l){const m=Object.keys(s).find(f=>s[f]===l);m&&(s[m]=c)}else u&&a.includes(u)&&(s[u]=c)}else if(r.type==="rotation"){const c=r.details.positions.filter(u=>a.includes(u));if(c.length>1){const u=c.map(m=>s[m]);for(let m=0;m<c.length;m++){const f=u[(m-1+c.length)%c.length];s[c[m]]=f}}}}const i=document.createElement("div");i.className=`sub-rule-card ${r.active?"active":""}`;const d=r.name?`<span class="text-[10px] font-bold text-amber-800 bg-amber-50 px-1.5 py-0.5 rounded leading-none inline-block mb-1 border border-amber-200/50">${ge(r.name)}</span>`:"";i.innerHTML=`
            <div class="flex items-center gap-2">
        ...
        `,i.querySelector('input[type="checkbox"]').addEventListener("change",l=>{Xo(r.id,l.target.checked)}),i.querySelector(".btn-delete-rule").addEventListener("click",()=>{ti(r.id)}),t.appendChild(i)})}function Zo(e){const t=document.getElementById("sim-announcement-logs");if(!t)return;t.innerHTML="";const n=(e.customSubstitutions||[]).filter(r=>r.active);if(n.length===0){t.innerHTML='<p class="text-xs text-gray-400 text-center py-2">適用中の交代はありません（基本配置のままです）。</p>';return}const a=ee===9?dt:lt;let s={...e.basePositions||{}};n.forEach(r=>{const o=ls(r,s,!1);if(r.type==="swap"){const{pos1:l,pos2:c}=r.details;if(a.includes(l)&&a.includes(c)){const u=s[l];s[l]=s[c],s[c]=u}}else if(r.type==="sub"){const{outPlayerId:l,inPlayerId:c,pos:u}=r.details;if(l){const m=Object.keys(s).find(f=>s[f]===l);m&&(s[m]=c)}else u&&a.includes(u)&&(s[u]=c)}else if(r.type==="rotation"){const c=r.details.positions.filter(u=>a.includes(u));if(c.length>1){const u=c.map(m=>s[m]);for(let m=0;m<c.length;m++){const f=u[(m-1+c.length)%c.length];s[c[m]]=f}}}const i=r.name?`【${ge(r.name)}】`:"",d=document.createElement("div");d.className="announcement-item",d.innerHTML=`
        ...
        `,t.appendChild(d)})}function Oe(){const e=we();if(!e)return;const t=ee===9?dt:lt,n=document.getElementById("sub-player-out"),a=document.getElementById("sub-player-in"),s=Rn(e),r=new Set(Object.values(s).filter(Boolean)),o=qn(e);if(n&&(n.innerHTML="",t.forEach(d=>{var c;const l=s[d];if(l){const u=((c=be.find(f=>f.id===l))==null?void 0:c.name)||"未配置",m=document.createElement("option");m.value=l,m.textContent=`${u} (${vt[d]})`,n.appendChild(m)}})),a){a.innerHTML="";const l=Mn().filter(c=>!r.has(c.id)&&!o.has(c.id));l.length===0?a.innerHTML='<option value="">控え選手なし</option>':l.forEach(c=>{const u=document.createElement("option");u.value=c.id,u.textContent=c.name,a.appendChild(u)})}const i=document.getElementById("rot-input-text");i&&(i.value="")}async function Xo(e,t){const n=we();if(!n)return;const a=n.customSubstitutions.find(s=>s.id===e);a&&(a.active=t,await je(n),Oe(),me())}async function ei(){const e=we();if(!e)return;const t=document.getElementById("rule-type-select"),n=t?t.value:"rotation";let a={};if(n==="sub"){const d=document.getElementById("sub-player-out").value,l=document.getElementById("sub-player-in").value;if(!d){alert("退く選手を選択してください。");return}if(!l){alert("入る控え選手を選択してください。");return}a={outPlayerId:d,inPlayerId:l}}else if(n==="rotation"){const d=document.getElementById("rot-input-text"),l=d?d.value.trim():"";if(!l){alert("交代ルートを入力してください（例: 1-3-1）。");return}if(!/^[0-9a-zA-Z]+(-[0-9a-zA-Z]+)*$/.test(l)){alert("入力形式が正しくありません。半角数字・英字とハイフンで入力してください（例: 1-3-1）。");return}const c=l.split("-").filter(Boolean);if(c.length<2){alert("交代には最低2つのポジションが必要です（例: 1-3）。");return}const u=ee===9?dt:lt,m=[];for(const f of c){const b=Vo[f];if(!b){alert(`無効なポジション番号「${f}」が含まれています。1〜9またはDHを指定してください。`);return}if(!u.includes(b)){alert(`ポジション「${f}」(${vt[b]||b})は、現在の守備モード（DH${ee===10?"あり":"なし"}）では使用できません。`);return}m.push(b)}for(let f=0;f<m.length-1;f++)if(m[f]===m[f+1]){alert("隣り合うポジションに同じものを指定することはできません（例: 1-1-3 は不可）。");return}a={positions:m}}const s=document.getElementById("rule-name-input"),r=s?s.value.trim():"",o={id:"rule_"+Date.now(),name:r,type:n,active:!1,details:a};e.customSubstitutions||(e.customSubstitutions=[]),e.customSubstitutions.push(o),await je(e),s&&(s.value="");const i=document.getElementById("rot-input-text");i&&(i.value=""),Oe(),me(),ea("subrules")}async function ti(e){const t=we();t&&(t.customSubstitutions=t.customSubstitutions.filter(n=>n.id!==e),await je(t),Oe(),me())}function ea(e){const t=document.getElementById("tab-btn-setup"),n=document.getElementById("tab-btn-subrules"),a=document.getElementById("panel-setup"),s=document.getElementById("panel-subrules");e==="setup"?(t.className="flex-1 py-2 px-3 text-center text-sm font-bold bg-amber-600 text-white transition",n.className="flex-1 py-2 px-3 text-center text-sm font-bold bg-white text-gray-700 border-l hover:bg-gray-50 transition",a.classList.remove("hidden"),s.classList.add("hidden")):(t.className="flex-1 py-2 px-3 text-center text-sm font-bold bg-white text-gray-700 transition",n.className="flex-1 py-2 px-3 text-center text-sm font-bold bg-amber-600 text-white border-l hover:bg-gray-50 transition font-bold",a.classList.add("hidden"),s.classList.remove("hidden"))}function cr(e){const t=e.currentTarget.getAttribute("data-player-id");e.dataTransfer.setData("text/plain",t);let n="bench";e.currentTarget.parentNode.id==="sim-players-list"&&(n="players-list"),e.dataTransfer.setData("source-pos",n)}function ni(e){e.preventDefault(),e.currentTarget.classList.add("drag-over")}function ai(e){e.currentTarget.classList.remove("drag-over")}function si(e){e.preventDefault(),e.currentTarget.classList.remove("drag-over");const t=e.dataTransfer.getData("text/plain"),n=e.currentTarget.getAttribute("data-position");!t||!n||ur(t,n)}async function ur(e,t){const n=we();if(!n)return;n.basePositions||(n.basePositions={});let a=null;Object.keys(n.basePositions).forEach(r=>{n.basePositions[r]===e&&(a=r)});const s=n.basePositions[t];a&&(n.basePositions[a]=s),n.basePositions[t]=e,yn(n),await je(n),_e=null,fe=null,Oe(),me()}function mr(e,t){_e===e&&fe===t?(_e=null,fe=null):(_e=e,fe=t),me()}async function ri(e){const t=we();if(!t)return;t.basePositions||(t.basePositions={});const n=t.basePositions[e];if(_e)if(fe!=="players-list"&&fe!=="bench"){const a=t.basePositions[fe];t.basePositions[fe]=n,t.basePositions[e]=a,yn(t),await je(t),_e=null,fe=null,Oe(),me()}else ur(_e,e);else n&&(_e=n,fe=e,me())}async function oi(e){const t=we();t&&(t.basePositions||(t.basePositions={}),t.basePositions[e]=null,yn(t),await je(t),_e=null,fe=null,Oe(),me())}async function ii(){const e=prompt(`新しいチーム名を入力してください:
(例: ありんこアントス (B軍), ジュニア選抜など)`);if(!e||!e.trim())return;const t=e.trim();if(Pe.some(a=>a.name===t)){alert("同じ名前のチームが既に存在します。");return}const n={id:"team_"+Date.now(),name:t};Pe.push(n),De=n.id,await ds(),jt(),me()}async function di(){const e=rn(),t=prompt("チーム名を変更してください:",e.name);if(!t||!t.trim())return;const n=t.trim();if(n!==e.name){if(Pe.some(a=>a.id!==e.id&&a.name===n)){alert("同じ名前のチームが既に存在します。");return}e.name=n,await ds(),jt(),_n(),me()}}async function li(){if(Pe.length<=1){alert("登録チームが1つのみのため、削除できません。");return}const e=rn(),t=Mn();let n=`チーム「${e.name}」を削除しますか？`;if(t.length>0&&(n+=`
※このチームに登録されている ${t.length} 名の選手データも削除されます。`),!confirm(n))return;const a=new Set(t.map(s=>s.id));be=be.filter(s=>!a.has(s.id));for(const s of t)await ma(s,!0);Pe=Pe.filter(s=>s.id!==e.id),De=Pe[0].id,await ds(),jt(),me()}function ci(e){De=e.target.value;const t=document.getElementById("sim-current-team-label"),n=rn();t&&(t.textContent=`[${n.name}]`),_e=null,fe=null,Oe(),me()}async function ui(){const e=we();if(!e)return;const t=e.name?`${e.name}の基本形`:"基本配置パターン",n=prompt(`初期パターン（テンプレート）の登録名を入力してください:
(例: A軍 守備基本形、10人制DH基本配置など)`,t);if(!n||!n.trim())return;const a=n.trim(),s={id:"tmpl_"+Date.now(),name:a,mode:ee,basePositions:JSON.parse(JSON.stringify(e.basePositions||{})),battingOrder:JSON.parse(JSON.stringify(e.battingOrder||{}))};_t.push(s),await lr(),pa(),alert(`初期パターン「${a}」を登録しました。
新規作成時や初期パターンセレクタからいつでも適用できます。`)}async function mi(e){if(!e)return;const t=_t.find(s=>s.id===e);if(!t)return;if(!confirm(`初期パターン「${t.name}」を現在のグラウンドに適用しますか？
（現在のスタメン配置・打順が上書きされます）`)){const s=document.getElementById("sim-template-select-inline");s&&(s.value="");return}const n=we();n&&(n.basePositions=JSON.parse(JSON.stringify(t.basePositions||{})),n.battingOrder=JSON.parse(JSON.stringify(t.battingOrder||{})),t.mode&&(n.mode=t.mode,ee=t.mode,Ht()),await je(n));const a=document.getElementById("sim-template-select-inline");a&&(a.value=""),Oe(),me()}async function pi(){const e=document.getElementById("sim-template-select-inline"),t=e?e.value:"";if(!t){alert("削除したい初期パターンを選択してください。");return}const n=_t.find(a=>a.id===t);n&&confirm(`初期パターン「${n.name}」を削除しますか？`)&&(_t=_t.filter(a=>a.id!==t),await lr(),pa(),alert(`初期パターン「${n.name}」を削除しました。`))}function gi(){const e=document.getElementById("sim-new-modal");if(!e)return;jt(),pa();const t=document.getElementById("new-sim-name");if(t){const r=new Date,o=`${r.getFullYear()}/${String(r.getMonth()+1).padStart(2,"0")}/${String(r.getDate()).padStart(2,"0")}`;t.value=`${o} 練習試合`}const n=document.getElementById("new-sim-team");n&&(n.value=De);const a=document.getElementById("new-sim-template");a&&(a.value="");const s=document.querySelector(`input[name="new-sim-dh-mode"][value="${ee}"]`);s&&(s.checked=!0),e.classList.remove("hidden")}function Ha(){const e=document.getElementById("sim-new-modal");e&&e.classList.add("hidden")}async function fi(){const e=document.getElementById("new-sim-name"),t=document.getElementById("new-sim-team"),n=document.getElementById("new-sim-template"),a=document.querySelector('input[name="new-sim-dh-mode"]:checked'),s=e?e.value.trim():"",r=t?t.value:De,o=n?n.value:null,i=a?parseInt(a.value,10):9;if(!s){alert("シミュレーションデータ名を入力してください。");return}await Wo(s,r,o,i),Ha(),Oe(),me()}async function Sa(){const e=document.getElementById("sim-new-player-input"),t=document.getElementById("sim-new-player-number");if(!e)return;const n=e.value.trim(),a=t?t.value.trim():"";if(!n)return;if(Mn().some(o=>o.name===n)){alert("このチームには同じフルネームの選手が既に登録されています。");return}const r={id:"p_"+Date.now()+"_"+Math.random().toString(36).substr(2,5),name:n,number:a,teamId:De};be.push(r),await ma(),e.value="",t&&(t.value=""),Oe(),me()}async function bi(e){const t=be.find(n=>n.id===e);if(t&&confirm(`選手「${t.name}」を削除しますか？
（データベースの全データ配置・交代設定からも削除されます）`)){be=be.filter(n=>n.id!==e),await ma(t,!0);for(const n of Ae){let a=!1;if(n.basePositions||(n.basePositions={}),Object.keys(n.basePositions).forEach(s=>{n.basePositions[s]===e&&(n.basePositions[s]=null,a=!0)}),n.battingOrder&&Object.keys(n.battingOrder).forEach(s=>{n.battingOrder[s]===e&&(delete n.battingOrder[s],a=!0)}),n.customSubstitutions){const s=n.customSubstitutions.length;n.customSubstitutions=n.customSubstitutions.filter(r=>r.type==="sub"?r.details.outPlayerId!==e&&r.details.inPlayerId!==e:!0),n.customSubstitutions.length!==s&&(a=!0)}a&&await je(n)}_e===e&&(_e=null,fe=null),Oe(),me()}}async function yi(){const e=document.getElementById("sim-pattern-select");if(!e)return;const t=e.value;let n=!1,a=null,s="";const r=we();if(t){const o=e.options[e.selectedIndex];confirm(`現在「${o.text}」が選択されています。
このデータに上書き保存しますか？
（「キャンセル」を選ぶと新規保存になります）`)&&(n=!0,s=o.text,a=t)}if(!n){const o=r?r.name:"新規配置データ",i=prompt("保存名を入力してください：",o);if(!i)return;if(s=i.trim(),!s){alert("有効な保存名を入力してください。");return}}try{if(n&&a){if(r){r.name=s,r.teamId=De,r.mode=ee,r.updated_at=new Date().toISOString();const i=await Xn(r);if(i)throw i;const d=Ae.findIndex(l=>l.id===r.id);d>0&&(Ae.splice(d,1),Ae.unshift(r)),alert(`データ「${s}」を上書き保存しました。`)}}else{const i="pat_"+Date.now(),d=rn(),l=new Date().toISOString(),c={id:i,name:s,teamId:De,mode:ee,created_at:l,updated_at:l,basePositions:r?{...r.basePositions||{}}:{},customSubstitutions:r?JSON.parse(JSON.stringify(r.customSubstitutions||[])):[],battingOrder:r?{...r.battingOrder||{}}:{},headerInfo:r?JSON.parse(JSON.stringify(r.headerInfo||{})):{date:"",tournament:"",teamHome:d.name||"ありんこアントス",teamVisitor:"",manager:"",captain:"",scorer:"",stadium:"",time:""}};Ae.unshift(c),Fe=i;const u=await Xn(c);if(u)throw u;alert(`データ「${s}」を保存しました。`)}_n();const o=document.getElementById("sim-pattern-select");o&&(o.value=Fe),me()}catch(o){console.error("Save pattern error:",o),alert(`保存に失敗しました。
エラー詳細: ${o.message||o}`)}}async function hi(){const e=we();if(!e||!e.id){alert("削除する配置データが選択されていません。");return}if(!confirm(`配置データ「${e.name}」を削除しますか？
（データベースから削除されます）`))return;Ae=Ae.filter(n=>n.id!==Fe);const t=await Xn(e,!0);Ae.length>0?Fe=Ae[0].id:Fe="",_n(),alert(t?`データ「${e.name}」のデータベースからの削除に失敗しました。
エラー詳細: ${t.message||t}`:`データ「${e.name}」を削除しました。`),_e=null,fe=null,Ht(),Oe(),me()}async function xi(e){const t=e.target.value;if(!t)Fe="",zn=null,_e=null,fe=null,me();else{Fe=t;const n=we();n&&(ee=n.mode||9,n.teamId&&Pe.some(a=>a.id===n.teamId)&&(De=n.teamId,jt())),_e=null,fe=null,Ht(),Oe(),me()}}function vi(){const e=we();if(!e)return;const t=Rn(e),n=qn(e),a=e.headerInfo||{};document.getElementById("member-input-date").value=a.date||"",document.getElementById("member-input-tournament").value=a.tournament||"",document.getElementById("member-input-team-home").value=a.teamHome||"ありんこアントス",document.getElementById("member-input-team-visitor").value=a.teamVisitor||"",document.getElementById("member-input-manager").value=a.manager||"",document.getElementById("member-input-captain").value=a.captain||"",document.getElementById("member-input-scorer").value=a.scorer||"",document.getElementById("member-input-stadium").value=a.stadium||"",document.getElementById("member-input-time").value=a.time||"",pr(e,t,n);const s=document.getElementById("sim-member-modal");s&&s.classList.remove("hidden")}function wi(){const e=we();if(!e)return;e.headerInfo||(e.headerInfo={}),e.headerInfo.date=document.getElementById("member-input-date").value.trim(),e.headerInfo.tournament=document.getElementById("member-input-tournament").value.trim(),e.headerInfo.teamHome=document.getElementById("member-input-team-home").value.trim(),e.headerInfo.teamVisitor=document.getElementById("member-input-team-visitor").value.trim(),e.headerInfo.manager=document.getElementById("member-input-manager").value.trim(),e.headerInfo.captain=document.getElementById("member-input-captain").value.trim(),e.headerInfo.scorer=document.getElementById("member-input-scorer").value.trim(),e.headerInfo.stadium=document.getElementById("member-input-stadium").value.trim(),e.headerInfo.time=document.getElementById("member-input-time").value.trim(),je(e);const t=Rn(e),n=qn(e);pr(e,t,n)}function pr(e,t,n){const a=ee===9?dt:lt,s=e.headerInfo||{};let r=`【 メンバー表 (Ants) 】
...
`,r+=`◆ スターティングメンバー (打順順)
`;const o=a.length,i=e.basePositions||{},d={};a.forEach(f=>{const b=i[f];b&&(d[b]=f)});for(let f=1;f<=o;f++){const b=e.battingOrder[f];if(b){const y=be.find(p=>p.id===b),g=d[b];if(y&&g){const p=mn[g],v=y.number?` [#${y.number}]`:"";r+=`${f}. [${p}] ${vt[g]} : ${y.name}${v}
`}}}r+=`
◆ 控え選手 (ベンチ)
`;const l=new Set(Object.values(t).filter(Boolean)),c=be.filter(f=>!l.has(f.id)&&!n.has(f.id));c.length===0?r+=`(なし)
...
`;else{let f={...e.basePositions||{}};u.forEach((b,y)=>{const g=ls(b,f,!1);if(r+=`${y+1}. [${g.code}] ${g.fullDesc}
`,b.type==="swap"){const{pos1:p,pos2:v}=b.details,x=f[p];f[p]=f[v],f[v]=x}else if(b.type==="sub"){const{outPlayerId:p,inPlayerId:v}=b.details,x=Object.keys(f).find(h=>f[h]===p);x&&(f[x]=v)}else if(b.type==="rotation"){const p=b.details.positions,v=p.map(x=>f[x]);for(let x=0;x<p.length;x++){const h=v[(x-1+p.length)%p.length];f[p[x]]=h}}})}const m=document.getElementById("sim-member-text");m&&(m.value=r)}function Ei(){const e=document.getElementById("sim-member-text");e&&(e.select(),document.execCommand("copy"),alert("メンバー表をクリップボードにコピーしました！"))}function Os(){const e=document.getElementById("sim-member-modal");e&&e.classList.add("hidden")}function _i(){const e=we();if(!e)return;const t=Rn(e),n=qn(e),a=ee===9?dt:lt,s=e.headerInfo||{},r=e.basePositions||{},o={};a.forEach(b=>{const y=r[b];y&&(o[y]=b)});const i=a.length,d=[];for(let b=1;b<=i;b++){const y=e.battingOrder[b];if(y){const g=be.find(v=>v.id===y),p=o[y];g&&p&&d.push({order:b,posNum:mn[p],name:g.name,number:g.number||""})}}for(;d.length<9;)d.push({order:d.length+1,posNum:"",name:"",number:""});const l=new Set(Object.values(t).filter(Boolean)),c=be.filter(b=>!l.has(b.id)&&!n.has(b.id)),u=[];for(let b=0;b<6;b++){const y=b*2,g=b*2+1,p=c[y],v=c[g];u.push({leftName:p?p.name:"",leftNumber:p&&p.number||"",rightName:v?v.name:"",rightNumber:v&&v.number||""})}let m="";for(let b=1;b<=4;b++){let y="";d.forEach(x=>{y+=`
                <tr>
            ...
            `}),ee===10&&d.length<10&&(y+='<tr><td class="cell-order">10</td><td class="cell-pos"></td><td class="cell-name"></td><td class="cell-number"></td></tr>');const g=ee===10?11:10,p=d.length;for(let x=p;x<g;x++)y+='<tr><td class="cell-order"></td><td class="cell-pos"></td><td class="cell-name"></td><td class="cell-number"></td></tr>';let v="";u.forEach(x=>{v+=`
                <tr>
    ...
    `),f.document.close()}function Ii(){const e=we();if(!e)return;const t={version:"ants-sim-3.0",players:be,pattern:e},n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),a=URL.createObjectURL(n),s=document.createElement("a");s.href=a,s.download=`ants_positions_${e.name.replace(/[\s/\\?%*:|"<>\.]/g,"_")}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(a)}function $i(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=async function(a){try{const s=JSON.parse(a.target.result);if(s.version!=="ants-sim-3.0"&&s.version!=="ants-sim-2.0"&&s.version!=="ants-sim-1.0"){alert("ファイル形式が正しくありません。");return}if(confirm(`インポートを実行しますか？
※既存の選手リストと配置データがマージ/追加されます。`)){for(const r of s.players)be.some(o=>o.id===r.id||o.name===r.name)||(be.push(r),await ma(r));if(s.version==="ants-sim-3.0"){const r=s.pattern;r.id="pat_"+Date.now(),r.name=r.name+" (インポート)",Ae.push(r),Fe=r.id,ee=r.mode,await je(r)}else if(s.version==="ants-sim-2.0"){const r=s.pattern;r.id="pat_"+Date.now(),r.name=r.name+" (インポート)",r.mode=r.mode||9,r.battingOrder={},r.headerInfo={},Ae.push(r),Fe=r.id,ee=r.mode,await je(r)}else{const r=s.pattern,o=r.innings&&r.innings[0]?r.innings[0].positions:{},i={id:"pat_"+Date.now(),name:r.name+" (旧移行)",mode:r.mode||9,basePositions:o,customSubstitutions:[],battingOrder:{},headerInfo:{}};Ae.push(i),Fe=i.id,ee=i.mode,await je(i)}Ht(),Oe(),me(),alert("インポートが完了しました。")}}catch(s){console.error(s),alert("ファイルの読み込みに失敗しました。")}e.target.value=""},n.readAsText(t)}function ki(){var s,r,o,i,d,l,c,u,m,f,b,y,g,p,v,x,h,k,L,w,I,E,$,_,C,M,N,P,U,O,B,A,T;const e=document.getElementById("btn-toggle-players-panel"),t=document.getElementById("players-panel-content"),n=document.getElementById("icon-toggle-players");e&&t&&n&&(e.addEventListener("click",()=>{const G=t.classList.toggle("hidden");n.textContent=G?"▼":"▲",localStorage.setItem("ants_sim_players_panel_collapsed",G?"true":"false")}),localStorage.getItem("ants_sim_players_panel_collapsed")==="true"&&(t.classList.add("hidden"),n.textContent="▼")),(s=document.getElementById("tab-btn-setup"))==null||s.addEventListener("click",()=>ea("setup")),(r=document.getElementById("tab-btn-subrules"))==null||r.addEventListener("click",()=>ea("subrules")),(o=document.getElementById("rule-type-select"))==null||o.addEventListener("change",D=>{const G=D.target.value;document.getElementById("form-sub").classList.add("hidden"),document.getElementById("form-rotation").classList.add("hidden"),G==="sub"?document.getElementById("form-sub").classList.remove("hidden"):G==="rotation"&&document.getElementById("form-rotation").classList.remove("hidden")}),(i=document.getElementById("btn-export-member-table"))==null||i.addEventListener("click",vi),(d=document.getElementById("btn-copy-member-text"))==null||d.addEventListener("click",Ei),(l=document.getElementById("btn-close-member-modal"))==null||l.addEventListener("click",Os),(c=document.getElementById("btn-close-member-modal-footer"))==null||c.addEventListener("click",Os),(u=document.getElementById("btn-print-member-table"))==null||u.addEventListener("click",_i),["member-input-date","member-input-tournament","member-input-team-home","member-input-team-visitor","member-input-manager","member-input-captain","member-input-scorer","member-input-stadium","member-input-time"].forEach(D=>{var G;(G=document.getElementById(D))==null||G.addEventListener("input",wi)}),(m=document.getElementById("btn-create-sub-rule"))==null||m.addEventListener("click",ei),(f=document.getElementById("btn-add-sim-player"))==null||f.addEventListener("click",Sa),(b=document.getElementById("sim-new-player-input"))==null||b.addEventListener("keypress",D=>{D.key==="Enter"&&Sa()}),(y=document.getElementById("sim-new-player-number"))==null||y.addEventListener("keypress",D=>{D.key==="Enter"&&Sa()}),(g=document.getElementById("sim-team-select"))==null||g.addEventListener("change",ci),(p=document.getElementById("btn-add-sim-team"))==null||p.addEventListener("click",ii),(v=document.getElementById("btn-edit-sim-team"))==null||v.addEventListener("click",di),(x=document.getElementById("btn-delete-sim-team"))==null||x.addEventListener("click",li),(h=document.getElementById("sim-template-select-inline"))==null||h.addEventListener("change",D=>mi(D.target.value)),(k=document.getElementById("btn-save-as-template"))==null||k.addEventListener("click",ui),(L=document.getElementById("btn-delete-template"))==null||L.addEventListener("click",pi),(w=document.getElementById("btn-open-new-sim-modal"))==null||w.addEventListener("click",gi),(I=document.getElementById("btn-close-new-sim-modal"))==null||I.addEventListener("click",Ha),(E=document.getElementById("btn-close-new-sim-modal-footer"))==null||E.addEventListener("click",Ha),($=document.getElementById("btn-create-new-sim"))==null||$.addEventListener("click",fi),(_=document.getElementById("sim-pattern-select"))==null||_.addEventListener("change",xi),(C=document.getElementById("btn-save-sim-pattern"))==null||C.addEventListener("click",yi),(M=document.getElementById("btn-delete-sim-pattern"))==null||M.addEventListener("click",hi),(N=document.getElementById("btn-sim-mode-9"))==null||N.addEventListener("click",async()=>{if(ee!==9){ee=9,Ht();const D=we();D&&(D.mode=9,yn(D),await je(D)),Oe(),me()}}),(P=document.getElementById("btn-sim-mode-10"))==null||P.addEventListener("click",async()=>{if(ee!==10){ee=10,Ht();const D=we();D&&(D.mode=10,yn(D),await je(D)),Oe(),me()}}),(U=document.getElementById("btn-export-sim"))==null||U.addEventListener("click",Ii),(O=document.getElementById("import-sim-input"))==null||O.addEventListener("change",$i),(B=document.getElementById("btn-back-to-menu-sim"))==null||B.addEventListener("click",()=>{_e=null,fe=null,Q("app-menu-view")}),(A=document.getElementById("btn-logout-sim"))==null||A.addEventListener("click",()=>{var D;(D=document.getElementById("btn-logout"))==null||D.click()}),(T=document.getElementById("sim-bench-list"))==null||T.addEventListener("click",D=>{D.target.id==="sim-bench-list"&&_e&&fe!=="players-list"&&fe!=="bench"&&oi(fe)})}function ge(e){return typeof e!="string"?"":e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]||t)}let gr=null,Pt=null,Xt=!1;const en="ants_surveys_v1",gn="ants_survey_responses_v1";let te=[],pe=[];const Ms=[{id:"survey_sample_1",title:"【夏季合宿】参加日程調整 & お弁当・合宿Tシャツ注文とりまとめ",description:`少年野球チーム Arinko Ants 夏季合宿（8月開催）の出欠日程および備品・お弁当の事前注文確認です。
**1回の送信で、保護者様ご本人と選手（兄弟含む）全員分の出欠・注文をまとめてご登録いただけます。**
ご不明な点がありましたら役員までお問い合わせください。`,status:"active",deadline:"2026-07-20 23:59",public_results:!0,enable_schedule:!0,schedule_options:["8/8(土) 午前 (練習・遠征)","8/8(土) 午後 (練習試合・BBQ)","8/8(土) 宿泊","8/9(日) 終日 (紅白戦・グラウンド納め)"],enable_family:!0,enable_orders:!0,order_items:[{id:"item_lunch_sat",name:"8/8(土) 選手・保護者弁当",price:650,max:10},{id:"item_lunch_sun",name:"8/9(日) 選手・保護者弁当",price:650,max:10},{id:"item_tshirt",name:"合宿記念チームTシャツ",price:2200,max:5},{id:"item_cap",name:" Ants オリジナル冷感タオル",price:800,max:5}],questions:[{id:"q_attendance",type:"single",title:"合宿全体の参加可否をお選びください",required:!0,options:[{label:"参加する（部分参加含む）",skip_to:null},{label:"不参加（全日程）",skip_to:"q_remarks"}],help:"不参加を選択された場合、日程詳細およびお弁当等の注文設問はスキップされます。"},{id:"q_transport",type:"single",title:"現地までの移動手段について",required:!1,options:[{label:"配車（チーム車）を利用希望",skip_to:null},{label:"自車で現地直行（他メンバー同乗可）",skip_to:null},{label:"自車で現地直行（家族のみ）",skip_to:null}],help:""},{id:"q_remarks",type:"text",title:"特記事項・アレルギー・連絡事項など",required:!1,options:[],help:"食物アレルギーや遅刻・早退のご予定等があればご記入ください。"}],created_by:"役員会",created_at:"2026-06-01",updated_at:"2026-06-01"}],Rs=[{id:"resp_sample_1",survey_id:"survey_sample_1",respondent_name:"菱沼 (保護者)",family_members:[{name:"菱沼 健一 (保護者・指導者)",role:"保護者"},{name:"菱沼 翔太 (6年・主将)",role:"選手"}],schedules:{"8/8(土) 午前 (練習・遠征)":"○","8/8(土) 午後 (練習試合・BBQ)":"○","8/8(土) 宿泊":"○","8/9(日) 終日 (紅白戦・グラウンド納め)":"○"},answers:{q_attendance:"参加する（部分参加含む）",q_transport:"自車で現地直行（他メンバー同乗可）",q_remarks:"車出し可能です。道具車としても利用できます。"},orders:{item_lunch_sat:2,item_lunch_sun:2,item_tshirt:1,item_cap:2},total_amount:6400,created_at:"2026-06-02 10:15"}];async function Li({supabaseClient:e,currentUser:t,currentUserRole:n,canManageInfo:a=null}){gr=e,Pt=t,a!==null?Xt=a:Xt=n==="admin"||(t==null?void 0:t.can_edit_info)===!0||n==="leader"&&(t==null?void 0:t.can_edit_info)!==!1,await Ua(),Xt&&Si(),hr(),on()}async function Si(){const e=In();if(e)try{const t=localStorage.getItem(en);if(t){const n=JSON.parse(t);Array.isArray(n)&&n.length>0&&(await e.from("master_data").upsert({key:"ANTS_SURVEYS",data:n}),console.log("Auto-synced surveys to master_data:",n.length))}}catch(t){console.warn("Auto-sync surveys to DB failed:",t)}}function In(){return gr||window.supabaseClient||null}async function Ua(){let e=!1,t=!1;const n=In();if(n){try{const{data:a,error:s}=await n.from("surveys").select("*").order("created_at",{ascending:!1});!s&&a&&a.length>0&&(te=a,e=!0)}catch(a){console.warn("Supabase surveys load failed, trying master_data fallback:",a)}if(!e)try{const{data:a,error:s}=await n.from("master_data").select("data").eq("key","ANTS_SURVEYS");!s&&a&&a.length>0&&Array.isArray(a[0].data)&&a[0].data.length>0&&(te=a[0].data,e=!0)}catch(a){console.warn("Supabase master_data ANTS_SURVEYS load skipped:",a)}try{const{data:a,error:s}=await n.from("survey_responses").select("*").order("created_at",{ascending:!1});!s&&a&&a.length>0&&(pe=a,t=!0)}catch(a){console.warn("Supabase survey_responses load failed, trying master_data fallback:",a)}if(!t)try{const{data:a,error:s}=await n.from("master_data").select("data").eq("key","ANTS_SURVEY_RESPONSES");!s&&a&&a.length>0&&Array.isArray(a[0].data)&&(pe=a[0].data,t=!0)}catch(a){console.warn("Supabase master_data ANTS_SURVEY_RESPONSES load skipped:",a)}}if(e)try{localStorage.setItem(en,JSON.stringify(te))}catch{}else try{const a=localStorage.getItem(en);a?te=JSON.parse(a):(te=[...Ms],localStorage.setItem(en,JSON.stringify(te)))}catch{te=[...Ms]}if(t)try{localStorage.setItem(gn,JSON.stringify(pe))}catch{}else try{const a=localStorage.getItem(gn);a?pe=JSON.parse(a):(pe=[...Rs],localStorage.setItem(gn,JSON.stringify(pe)))}catch{pe=[...Rs]}}async function fr(e,t=!1){const n=te.findIndex(s=>s.id===e.id);n>=0?te[n]=e:te.unshift(e);try{localStorage.setItem(en,JSON.stringify(te))}catch(s){console.error(s)}const a=In();if(a){try{t?await a.from("surveys").insert([e]):await a.from("surveys").update(e).eq("id",e.id)}catch(s){console.warn("Supabase survey table save skipped:",s)}try{await a.from("master_data").upsert({key:"ANTS_SURVEYS",data:te})}catch(s){console.warn("Supabase master_data ANTS_SURVEYS upsert failed:",s)}}}async function Bi(e){te=te.filter(n=>n.id!==e),pe=pe.filter(n=>n.survey_id!==e);try{localStorage.setItem(en,JSON.stringify(te)),localStorage.setItem(gn,JSON.stringify(pe))}catch(n){console.error(n)}const t=In();if(t){try{await t.from("survey_responses").delete().eq("survey_id",e),await t.from("surveys").delete().eq("id",e)}catch{}try{await t.from("master_data").upsert({key:"ANTS_SURVEYS",data:te}),await t.from("master_data").upsert({key:"ANTS_SURVEY_RESPONSES",data:pe})}catch{}}}async function Ti(e){const t=pe.findIndex(s=>s.id===e.id),n=t>=0;n?pe[t]=e:pe.unshift(e);try{localStorage.setItem(gn,JSON.stringify(pe))}catch(s){console.error(s)}const a=In();if(a){try{n?await a.from("survey_responses").update(e).eq("id",e.id):await a.from("survey_responses").insert([e])}catch(s){console.warn("Supabase survey_responses table save skipped:",s)}try{await a.from("master_data").upsert({key:"ANTS_SURVEY_RESPONSES",data:pe})}catch(s){console.warn("Supabase master_data ANTS_SURVEY_RESPONSES upsert failed:",s)}}}async function Ai(e){pe=pe.filter(n=>n.id!==e);try{localStorage.setItem(gn,JSON.stringify(pe))}catch(n){console.error(n)}const t=In();if(t){try{await t.from("survey_responses").delete().eq("id",e)}catch{}try{await t.from("master_data").upsert({key:"ANTS_SURVEY_RESPONSES",data:pe})}catch{}}hn&&fa(hn.id),on()}function on(){const e=document.getElementById("info-surveys-container"),t=document.getElementById("info-surveys-empty"),n=document.getElementById("btn-survey-new");if(e){if(n&&(Xt?n.classList.remove("hidden"):n.classList.add("hidden")),te.length===0){e.innerHTML="",t&&t.classList.remove("hidden");return}t&&t.classList.add("hidden"),e.innerHTML=te.map(a=>{const s=pe.filter(l=>l.survey_id===a.id),r=s.length,o=s.reduce((l,c)=>l+(Number(c.total_amount)||0),0);let i="";a.status==="active"?i='<span class="px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800 border border-emerald-200">🟢 受付中</span>':a.status==="closed"?i='<span class="px-2.5 py-0.5 rounded-full text-xs font-bold bg-gray-100 text-gray-700 border border-gray-200">⚪ 締切済み</span>':i='<span class="px-2.5 py-0.5 rounded-full text-xs font-bold bg-amber-100 text-amber-800 border border-amber-200">🟡 下書き</span>';const d=[];return a.enable_schedule&&d.push("📅 日程調整"),a.enable_family&&d.push("👨‍👩‍👧 家族一括"),a.enable_orders&&d.push("🛒 注文集計"),`
        ...
        `}).join(""),e.querySelectorAll(".btn-survey-respond").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id");fn(s)})}),e.querySelectorAll(".btn-survey-share").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id");Pi(s)})}),e.querySelectorAll(".btn-survey-results").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id");fa(s)})}),Xt&&(e.querySelectorAll(".btn-survey-duplicate").forEach(a=>{a.addEventListener("click",async()=>{const s=a.getAttribute("data-id");await Ci(s)})}),e.querySelectorAll(".btn-survey-edit").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id"),r=te.find(o=>o.id===s);r&&br(r)})}),e.querySelectorAll(".btn-survey-delete").forEach(a=>{a.addEventListener("click",async()=>{const s=a.getAttribute("data-id"),r=te.find(o=>o.id===s);r&&confirm(`アンケート「${r.title}」と、そのすべての回答データを削除しますか？`)&&(await Bi(s),on())})}))}}async function Ci(e){const t=te.find(s=>s.id===e);if(!t)return;const n=`survey_${Date.now()}`,a=JSON.parse(JSON.stringify(t));if(a.id=n,a.title=`(複製) ${t.title}`,a.created_at=new Date().toISOString(),a.status=t.status||"active",a.questions&&Array.isArray(a.questions)){const s={};a.questions.forEach((r,o)=>{const i=r.id,d=`q_${Date.now()}_${o+1}`;s[i]=d,r.id=d}),a.questions.forEach(r=>{r.options&&Array.isArray(r.options)&&r.options.forEach(o=>{o.skip_to&&s[o.skip_to]&&(o.skip_to=s[o.skip_to])})})}a.order_items&&Array.isArray(a.order_items)&&a.order_items.forEach((s,r)=>{s.id=`item_${Date.now()}_${r+1}`}),await fr(a,!0),on(),alert(`アンケート「${a.title}」を作成（複製）しました！`)}function Di(e){try{const t={id:e.id,title:e.title,description:e.description,deadline:e.deadline,public_results:e.public_results,enable_schedule:e.enable_schedule,schedule_options:e.schedule_options,enable_family:e.enable_family,enable_orders:e.enable_orders,order_items:e.order_items,questions:e.questions},n=JSON.stringify(t);return btoa(encodeURIComponent(n).replace(/%([0-9A-F]{2})/g,(a,s)=>String.fromCharCode("0x"+s)))}catch(t){return console.warn("Survey encode error:",t),""}}function Ni(e){if(!e)return null;try{let t=decodeURIComponent(e).trim();t=t.replace(/ /g,"+"),t=t.replace(/-/g,"+").replace(/_/g,"/");const n=t.length%4;n===2?t+="==":n===3?t+="=":n===1&&(t+="===");const a=atob(t),s=decodeURIComponent(Array.prototype.map.call(a,r=>"%"+("00"+r.charCodeAt(0).toString(16)).slice(-2)).join(""));return JSON.parse(s)}catch(t){return console.warn("Survey decode error:",t),null}}function Pi(e){const t=te.find(a=>a.id===e);let n=`${window.location.origin}${window.location.pathname}#survey-${e}`;if(t){const a=Di(t);a&&(n+=`&d=${a}`)}navigator.clipboard.writeText(n).then(()=>{alert(`アンケート回答用URLをコピーしました！
どの端末・Safari・LINEでも確実に開くURLです。

${n}`)}).catch(()=>{prompt("アンケート回答用URL:",n)})}let pn=null,K=[],Ot=[],xt=[];function br(e=null){const t=document.getElementById("modal-survey-editor");if(!t)return;pn=e?e.id:null,document.getElementById("survey-editor-modal-title").textContent=e?"アンケートの編集":"新規アンケート作成",document.getElementById("input-survey-title").value=e?e.title:"",document.getElementById("input-survey-desc").value=e&&e.description||"",document.getElementById("select-survey-status").value=e?e.status:"active",document.getElementById("input-survey-deadline").value=e&&e.deadline||"";const n=document.getElementById("chk-survey-enable-schedule"),a=document.getElementById("chk-survey-enable-family"),s=document.getElementById("chk-survey-enable-orders"),r=document.getElementById("chk-survey-public-results");n.checked=e?!!e.enable_schedule:!0,a.checked=e?!!e.enable_family:!0,s.checked=e?!!e.enable_orders:!1,r&&(r.checked=e?e.public_results!==!1:!0),Ot=e&&e.schedule_options?[...e.schedule_options]:["7/18(土) 午前","7/18(土) 午後","7/19(日) 終日"],xt=e&&e.order_items?JSON.parse(JSON.stringify(e.order_items)):[{id:`item_${Date.now()}_1`,name:"選手用お弁当",price:600,max:10},{id:`item_${Date.now()}_2`,name:"保護者用お弁当",price:700,max:10}],K=e&&e.questions?JSON.parse(JSON.stringify(e.questions)):[],ga(),us(),bt(),Wa(),t.classList.remove("hidden")}function Va(){const e=document.getElementById("modal-survey-editor");e&&e.classList.add("hidden"),pn=null}function Vn(e){const t=e.getFullYear(),n=e.getMonth()+1,a=e.getDate(),s=e.getDay();if(n===1&&a===1)return"元日";if(n===2&&a===11)return"建国記念の日";if(n===2&&a===23)return"天皇誕生日";if(n===4&&a===29)return"昭和の日";if(n===5&&a===3)return"憲法記念日";if(n===5&&a===4)return"みどりの日";if(n===5&&a===5)return"こどもの日";if(n===8&&a===11)return"山の日";if(n===11&&a===3)return"文化の日";if(n===11&&a===23)return"勤労感謝の日";if(s===1){const r=Math.floor((a-1)/7)+1;if(n===1&&r===2)return"成人の日";if(n===7&&r===3)return"海の日";if(n===9&&r===3)return"敬老の日";if(n===10&&r===2)return"スポーツの日"}if(n===3){const r=Math.floor(20.8431+.242194*(t-1980)-Math.floor((t-1980)/4));if(a===r)return"春分の日"}if(n===9){const r=Math.floor(23.2488+.242194*(t-1980)-Math.floor((t-1980)/4));if(a===r)return"秋分の日"}return null}function cs(e){const t=Vn(e);if(t)return{isHoliday:!0,name:t};const n=e.getFullYear(),a=e.getMonth(),s=e.getDate(),r=e.getDay();let o=new Date(n,a,s-1);for(;Vn(o);){if(o.getDay()===0)return{isHoliday:!0,name:"振替休日"};o.setDate(o.getDate()-1)}if(r!==0){const i=new Date(n,a,s-1),d=new Date(n,a,s+1);if(Vn(i)&&Vn(d))return{isHoliday:!0,name:"国民の休日"}}return null}let ce={targetType:null,targetQIdx:null,viewYear:new Date().getFullYear(),viewMonth:new Date().getMonth(),selectedDates:new Set};function yr(e,t=null){ce.targetType=e,ce.targetQIdx=t;const n=new Date;ce.viewYear=n.getFullYear(),ce.viewMonth=n.getMonth(),ce.selectedDates.clear(),Yt();const a=document.getElementById("modal-survey-date-picker");a&&a.classList.remove("hidden")}function Ga(){const e=document.getElementById("modal-survey-date-picker");e&&e.classList.add("hidden")}function Yt(){const e=document.getElementById("dp-current-month-label"),t=document.getElementById("dp-calendar-grid"),n=document.getElementById("dp-selected-count-badge"),a=document.getElementById("btn-apply-date-picker");if(!t)return;const{viewYear:s,viewMonth:r,selectedDates:o}=ce;e&&(e.textContent=`${s}年 ${r+1}月`),n&&(n.textContent=`${o.size} 日選択中`),a&&(a.disabled=o.size===0);const i=new Date(s,r,1).getDay(),d=new Date(s,r+1,0).getDate();let l="";for(let c=0;c<i;c++)l+='<div class="h-11 border border-transparent rounded-lg"></div>';for(let c=1;c<=d;c++){const u=new Date(s,r,c),m=u.getDay(),f=`${s}-${String(r+1).padStart(2,"0")}-${String(c).padStart(2,"0")}`,b=o.has(f),y=cs(u);let g="",p="";b?(g="bg-teal-600 text-white font-bold shadow-xs",y&&(p=`<span class="text-[9px] block leading-tight truncate px-0.5 text-teal-100">${X(y.name)}</span>`)):y?(g="text-red-600 bg-red-50/70 hover:bg-red-100 font-bold border-red-100",p=`<span class="text-[9px] block leading-tight truncate px-0.5 text-red-600 font-bold">${X(y.name)}</span>`):m===0?g="text-red-500 hover:bg-red-50 font-bold":m===6?g="text-blue-600 hover:bg-blue-50 font-bold":g="text-gray-800 hover:bg-gray-100",l+=`
            <button type="button" class="dp-day-cell h-11 p-1 flex flex-col items-center justify-between rounded-lg border border-gray-100 transition cursor-pointer text-xs ${g}" data-date="${f}">
                <span class="text-xs font-bold leading-none">${c}</span>
                ${p}
            </button>
        `}t.innerHTML=l,t.querySelectorAll(".dp-day-cell").forEach(c=>{c.addEventListener("click",()=>{const u=c.getAttribute("data-date");o.has(u)?o.delete(u):o.add(u),Yt()})})}function Oi(){const e=new Date(ce.viewYear,ce.viewMonth+1,0).getDate();for(let t=1;t<=e;t++){const n=new Date(ce.viewYear,ce.viewMonth,t),a=n.getDay(),s=cs(n);if(a===0||a===6||s){const r=`${ce.viewYear}-${String(ce.viewMonth+1).padStart(2,"0")}-${String(t).padStart(2,"0")}`;ce.selectedDates.add(r)}}Yt()}function Mi(){var i;const{targetType:e,targetQIdx:t,selectedDates:n}=ce;if(n.size===0)return;const a=((i=document.querySelector('input[name="dp-format"]:checked'))==null?void 0:i.value)||"simple",s=["日","月","火","水","木","金","土"],r=Array.from(n).sort(),o=[];if(r.forEach(d=>{const[l,c,u]=d.split("-").map(Number),m=new Date(l,c-1,u),f=s[m.getDay()],y=cs(m)?`${f}・祝`:f;a==="time_slots"?(o.push(`${c}/${u}(${y}) 午前`),o.push(`${c}/${u}(${y}) 午後`),o.push(`${c}/${u}(${y}) 終日`)):a==="with_year"?o.push(`${l}/${String(c).padStart(2,"0")}/${String(u).padStart(2,"0")}(${y})`):a==="kanji"?o.push(`${c}月${u}日(${y})`):o.push(`${c}/${u}(${y})`)}),e==="schedule")Ot.push(...o),ga();else if(e==="question"&&t!==null){K[t].options||(K[t].options=[]);const d=K[t].options;d.length===2&&d[0].label==="選択肢 1"&&d[1].label==="選択肢 2"?K[t].options=o.map(c=>({label:c,skip_to:null})):o.forEach(c=>{K[t].options.push({label:c,skip_to:null})}),bt()}Ga()}function Wa(){var s,r;const e=(s=document.getElementById("chk-survey-enable-schedule"))==null?void 0:s.checked,t=(r=document.getElementById("chk-survey-enable-orders"))==null?void 0:r.checked,n=document.getElementById("editor-schedule-section"),a=document.getElementById("editor-orders-section");n&&(n.style.display=e?"block":"none"),a&&(a.style.display=t?"block":"none")}function ga(){const e=document.getElementById("editor-schedule-list");e&&(e.innerHTML=Ot.map((t,n)=>`
    ...
    `).join(""),e.querySelectorAll(".input-order-name").forEach(t=>{t.addEventListener("input",n=>{const a=Number(n.target.getAttribute("data-index"));xt[a].name=n.target.value})}),e.querySelectorAll(".input-order-price").forEach(t=>{t.addEventListener("input",n=>{const a=Number(n.target.getAttribute("data-index"));xt[a].price=Number(n.target.value)||0})}),e.querySelectorAll(".input-order-max").forEach(t=>{t.addEventListener("input",n=>{const a=Number(n.target.getAttribute("data-index"));xt[a].max=Number(n.target.value)||10})}),e.querySelectorAll(".btn-del-order-item").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-index"));xt.splice(n,1),us()})}))}function bt(){const e=document.getElementById("editor-questions-list");if(e){if(K.length===0){e.innerHTML='<p class="text-xs text-gray-400 py-3 text-center border border-dashed rounded-lg">設問がありません。「＋ 設問を追加」ボタンで追加してください。</p>';return}e.innerHTML=K.map((t,n)=>{const a=K.filter((s,r)=>r>n);return`
        ...
        `}).join(""),e.querySelectorAll(".input-q-title").forEach(t=>{t.addEventListener("input",n=>{const a=Number(n.target.getAttribute("data-q-index"));K[a].title=n.target.value})}),e.querySelectorAll(".input-q-help").forEach(t=>{t.addEventListener("input",n=>{const a=Number(n.target.getAttribute("data-q-index"));K[a].help=n.target.value})}),e.querySelectorAll(".select-q-type").forEach(t=>{t.addEventListener("change",n=>{const a=Number(n.target.getAttribute("data-q-index"));K[a].type=n.target.value,(!K[a].options||K[a].options.length===0)&&(K[a].options=[{label:"選択肢 1",skip_to:null},{label:"選択肢 2",skip_to:null}]),bt()})}),e.querySelectorAll(".chk-q-req").forEach(t=>{t.addEventListener("change",n=>{const a=Number(n.target.getAttribute("data-q-index"));K[a].required=n.target.checked})}),e.querySelectorAll(".btn-del-q").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-q-index"));K.splice(n,1),bt()})}),e.querySelectorAll(".btn-move-q-up").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-q-index"));if(n>0){const a=K[n];K[n]=K[n-1],K[n-1]=a,bt()}})}),e.querySelectorAll(".btn-move-q-down").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-q-index"));if(n<K.length-1){const a=K[n];K[n]=K[n+1],K[n+1]=a,bt()}})}),e.querySelectorAll(".btn-add-opt").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-q-index"));K[n].options||(K[n].options=[]),K[n].options.push({label:`選択肢 ${K[n].options.length+1}`,skip_to:null}),bt()})}),e.querySelectorAll(".btn-add-date-opt").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-q-index"));yr("question",n)})}),e.querySelectorAll(".input-opt-label").forEach(t=>{t.addEventListener("input",n=>{const a=Number(n.target.getAttribute("data-q-index")),s=Number(n.target.getAttribute("data-opt-index"));K[a].options[s].label=n.target.value})}),e.querySelectorAll(".select-opt-skip").forEach(t=>{t.addEventListener("change",n=>{const a=Number(n.target.getAttribute("data-q-index")),s=Number(n.target.getAttribute("data-opt-index"));K[a].options[s].skip_to=n.target.value||null})}),e.querySelectorAll(".btn-del-opt").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-q-index")),a=Number(t.getAttribute("data-opt-index"));K[n].options.splice(a,1),bt()})})}}async function Ri(){var u,m,f,b,y,g,p,v,x;const e=(u=document.getElementById("input-survey-title"))==null?void 0:u.value.trim();if(!e){alert("アンケートのタイトルを入力してください");return}const t=((m=document.getElementById("input-survey-desc"))==null?void 0:m.value.trim())||"",n=((f=document.getElementById("select-survey-status"))==null?void 0:f.value)||"active",a=((b=document.getElementById("input-survey-deadline"))==null?void 0:b.value.trim())||"",s=((y=document.getElementById("chk-survey-enable-schedule"))==null?void 0:y.checked)||!1,r=((g=document.getElementById("chk-survey-enable-family"))==null?void 0:g.checked)||!1,o=((p=document.getElementById("chk-survey-enable-orders"))==null?void 0:p.checked)||!1,i=((v=document.getElementById("chk-survey-public-results"))==null?void 0:v.checked)??!0,d=!pn,l=new Date().toISOString().split("T")[0],c={id:pn||`survey_${Date.now()}`,title:e,description:t,status:n,deadline:a,public_results:i,enable_schedule:s,schedule_options:s?Ot.filter(h=>h.trim()):[],enable_family:r,enable_orders:o,order_items:o?xt.filter(h=>h.name.trim()):[],questions:K,created_by:(Pt==null?void 0:Pt.name)||"管理者",created_at:pn&&((x=te.find(h=>h.id===pn))==null?void 0:x.created_at)||l,updated_at:l};await fr(c,d),Va(),on()}let hn=null;function fa(e,t=!1){const n=document.getElementById("modal-survey-results");if(!n)return;const a=te.find(i=>i.id===e);if(!a)return;hn=a;const s=pe.filter(i=>i.survey_id===e),r=t||!Xt;document.getElementById("results-survey-title").textContent=a.title,document.getElementById("results-survey-subtitle").textContent=`回答数: ${s.length}件 | 締切: ${a.deadline||"なし"}${r?" (閲覧モード)":""}`;const o=document.getElementById("btn-export-survey-csv");o&&(r?o.classList.add("hidden"):o.classList.remove("hidden")),Fi(a,s),ji(a,s),Hi(a,s),Ui(a,s),Vi(a,s,r),n.classList.remove("hidden")}function qi(){const e=document.getElementById("modal-survey-results");e&&e.classList.add("hidden"),hn=null}function Fi(e,t){const n=t.length;let a=0;t.forEach(o=>{o.family_members&&o.family_members.length>0?a+=o.family_members.length:a+=1});const s=t.reduce((o,i)=>o+(Number(i.total_amount)||0),0),r=document.getElementById("results-summary-cards");r&&(r.innerHTML=`
    ...
    `)}function ji(e,t){const n=document.getElementById("results-schedule-container");if(!n)return;if(!e.enable_schedule||!e.schedule_options||e.schedule_options.length===0){n.classList.add("hidden");return}n.classList.remove("hidden");const a={};e.schedule_options.forEach(r=>{a[r]={ok:[],maybe:[],ng:[]}}),t.forEach(r=>{const o=r.respondent_name||"無名";r.schedules&&Object.entries(r.schedules).forEach(([i,d])=>{a[i]&&(d==="○"||d==="ok"?a[i].ok.push(o):d==="△"||d==="maybe"?a[i].maybe.push(o):(d==="×"||d==="ng")&&a[i].ng.push(o))})});const s=document.getElementById("results-schedule-tbody");s&&(s.innerHTML=e.schedule_options.map(r=>{const o=a[r],i=o.ok.join("、 ");return`
        ...
        `}).join(""))}function Ui(e,t){const n=document.getElementById("results-questions-list");if(n){if(!e.questions||e.questions.length===0){n.innerHTML='<p class="text-xs text-gray-400">設問はありません</p>';return}n.innerHTML=e.questions.map((a,s)=>{const r=t.map(o=>o.answers&&o.answers[a.id]).filter(o=>o!=null&&o!=="");if(a.type==="single"||a.type==="multiple"){const o={};(a.options||[]).forEach(d=>o[d.label]=0),o["(未回答)"]=0,r.forEach(d=>{Array.isArray(d)?d.forEach(l=>{o[l]=(o[l]||0)+1}):o[d]!==void 0?o[d]+=1:o[d]=(o[d]||0)+1});const i=t.length;return`
...
`),r=new Blob([new Uint8Array([239,187,191]),s],{type:"text/csv;charset=utf-8;"}),o=document.createElement("a");o.href=URL.createObjectURL(r);const i=new Date().toISOString().split("T")[0];o.download=`survey_${e.id}_${i}.csv`,o.click()}let Tn=null,wt=[],ta=null;async function fn(e,t=null,n=null){var d;(d=document.getElementById("loading-overlay"))==null||d.classList.add("hidden");const a=document.getElementById("loading-detail-text");a&&(a.style.opacity="0"),["auth-view","signup-view","password-reset-view","password-update-view","app-menu-view","app-view","attendance-view","view-users","dashboard-view","dashboard-settings","position-simulator-view","info-view"].forEach(l=>{const c=document.getElementById(l);c&&c.classList.add("hidden")});const s=document.getElementById("survey-respond-view");s&&s.classList.remove("hidden");const r=document.getElementById("survey-respond-form-container"),o=document.getElementById("survey-respond-error-container"),i=document.getElementById("survey-respond-success-container");i&&i.classList.add("hidden");try{if(hr(),(!te||te.length===0)&&await Ua(),!n){const y=window.location.hash||"",g=window.location.search||"",p=(y+"&"+g).match(/[?&#]d=([^&]+)/);p&&p[1]&&(n=p[1])}let l=te.find(y=>y.id===e);if(!l&&n)try{const y=Ni(n);if(y&&(y.id===e||!e)){l=y,te.unshift(l);try{localStorage.setItem(en,JSON.stringify(te))}catch{}}}catch(y){console.warn("Embedded survey restore failed:",y)}if(l||(await Ua(),l=te.find(y=>y.id===e)),!l&&e)try{const y=decodeURIComponent(e).trim();l=te.find(g=>g.id===y)}catch{}if(!l){if(r&&r.classList.add("hidden"),o){o.classList.remove("hidden");const y=document.getElementById("survey-respond-error-title"),g=document.getElementById("survey-respond-error-desc");y&&(y.textContent="アンケートが見つかりませんでした"),g&&(g.innerHTML=`指定されたアンケート（ID: <span class="font-mono font-bold">${e||"未指定"}</span>）が存在しないか、URLが正しくない可能性があります。<br>最新のアンケートURLをご確認ください。`)}return}o&&o.classList.add("hidden"),r&&r.classList.remove("hidden"),Tn=l,wt=[];let c=null;t&&(c=pe.find(y=>y.id===t));const u=document.getElementById("respond-edit-mode-banner"),m=document.getElementById("btn-submit-survey-response");c?(ta=c.id,u&&u.classList.remove("hidden"),m&&(m.textContent="回答を更新する")):(ta=null,u&&u.classList.add("hidden"),m&&(m.textContent="回答を送信する")),document.getElementById("respond-survey-title").textContent=l.title,document.getElementById("respond-survey-desc").innerHTML=l.description?l.description.replace(/\n/g,"<br>"):"",document.getElementById("respond-survey-deadline").textContent=l.deadline?`回答期限: ${l.deadline}`:"";const f=document.getElementById("btn-view-public-results");f&&(l.public_results!==!1?(f.classList.remove("hidden"),f.onclick=()=>fa(l.id,!0)):f.classList.add("hidden"));const b=document.getElementById("input-respondent-name");b&&(c?b.value=c.respondent_name||"":b.value=Pt&&Pt.name?Pt.name:""),c&&c.family_members?wt=JSON.parse(JSON.stringify(c.family_members)):wt=[],ms(l),Wi(l,c?c.schedules:null),zi(l,c?c.answers:null),Yi(l,c?c.orders:null),window.scrollTo({top:0,behavior:"smooth"})}catch(l){if(console.error("Error in openSurveyResponsePage:",l),r&&r.classList.add("hidden"),o){o.classList.remove("hidden");const c=document.getElementById("survey-respond-error-title"),u=document.getElementById("survey-respond-error-desc");c&&(c.textContent="エラーが発生しました"),u&&(u.innerHTML=`アンケートの読み込み中にエラーが発生しました。<br><span class="text-xs text-red-500 font-mono">${l.message||l}</span>`)}}}function ms(e){const t=document.getElementById("respond-family-section");if(!t)return;if(!e.enable_family){t.classList.add("hidden");return}t.classList.remove("hidden");const n=document.getElementById("respond-family-list");n&&(n.innerHTML=wt.map((a,s)=>`
    ...
    `).join(""),n.querySelectorAll(".input-fam-name").forEach(a=>{a.addEventListener("input",s=>{const r=Number(s.target.getAttribute("data-index"));wt[r].name=s.target.value})}),n.querySelectorAll(".select-fam-role").forEach(a=>{a.addEventListener("change",s=>{const r=Number(s.target.getAttribute("data-index"));wt[r].role=s.target.value})}),n.querySelectorAll(".btn-del-fam").forEach(a=>{a.addEventListener("click",()=>{const s=Number(a.getAttribute("data-index"));wt.splice(s,1),ms(e)})}))}function Wi(e,t=null){const n=document.getElementById("respond-schedule-section");if(!n)return;if(!e.enable_schedule||!e.schedule_options||e.schedule_options.length===0){n.classList.add("hidden");return}n.classList.remove("hidden");const a=document.getElementById("respond-schedule-list");a&&(a.innerHTML=e.schedule_options.map((s,r)=>{const o=t&&t[s]?t[s]:"○";return`
        ...
        `}).join(""),a.querySelectorAll('input[type="radio"].q-opt-radio').forEach(s=>{s.addEventListener("change",()=>{qs(e)})}),qs(e))}function Ji(e,t=void 0){if(e.type==="single")return(e.options||[]).map((n,a)=>{const s=t!==void 0?t===n.label:a===0;return`
        ...
        `}}function qs(e){if(!e.questions)return;let t=new Set;e.questions.forEach((n,a)=>{if(n.type==="single"){const s=document.querySelector(`input[name="respond_ans_${n.id}"]:checked`);if(s){const r=s.getAttribute("data-skip-to");if(r==="__END__")for(let o=a+1;o<e.questions.length;o++)t.add(e.questions[o].id);else if(r){const o=e.questions.findIndex(i=>i.id===r);if(o>a)for(let i=a+1;i<o;i++)t.add(e.questions[i].id)}}}}),e.questions.forEach(n=>{var s,r;const a=document.getElementById(`respond-q-block-${n.id}`);if(a)if(t.has(n.id)){if(a.classList.add("opacity-40","bg-gray-100","pointer-events-none"),!a.querySelector(".skip-badge")){const i=document.createElement("span");i.className="skip-badge text-[10px] bg-gray-300 text-gray-700 font-bold px-1.5 py-0.5 rounded ml-2",i.textContent="スキップされました",(s=a.querySelector("h4"))==null||s.appendChild(i)}}else a.classList.remove("opacity-40","bg-gray-100","pointer-events-none"),(r=a.querySelector(".skip-badge"))==null||r.remove()})}function Yi(e,t=null){const n=document.getElementById("respond-orders-section");if(!n)return;if(!e.enable_orders||!e.order_items||e.order_items.length===0){n.classList.add("hidden");return}n.classList.remove("hidden");const a=document.getElementById("respond-orders-list");a&&(a.innerHTML=e.order_items.map(s=>{const r=t&&t[s.id]!==void 0?Number(t[s.id]):0;return`
        ...
        `}).join(""),a.querySelectorAll(".select-order-qty").forEach(s=>{s.addEventListener("change",Fs)}),Fs())}function Fs(){let e=0;document.querySelectorAll(".select-order-qty").forEach(n=>{const a=Number(n.value)||0,s=Number(n.getAttribute("data-price"))||0;e+=a*s});const t=document.getElementById("respond-orders-total-amount");t&&(t.textContent=`¥${e.toLocaleString()}`)}async function Ki(){var x,h,k,L;if(!Tn)return;const e=Tn,t=(x=document.getElementById("input-respondent-name"))==null?void 0:x.value.trim();if(!t){alert("保護者氏名（選手氏名）を入力してください"),(h=document.getElementById("input-respondent-name"))==null||h.focus();return}const n={};e.enable_schedule&&e.schedule_options&&e.schedule_options.forEach((w,I)=>{const E=document.querySelector(`input[name="respond_sched_${I}"]:checked`);E&&(n[w]=E.value)});const a={};let s=!1;if(e.questions&&e.questions.forEach(w=>{var $;const I=document.getElementById(`respond-q-block-${w.id}`);if(!(I&&I.classList.contains("opacity-40")))if(w.type==="single"){const _=document.querySelector(`input[name="respond_ans_${w.id}"]:checked`);_?a[w.id]=_.value:w.required&&(s=!0)}else if(w.type==="multiple"){const _=Array.from(document.querySelectorAll(`input[name="respond_ans_${w.id}"]:checked`)).map(C=>C.value);a[w.id]=_,w.required&&_.length===0&&(s=!0)}else{const _=($=document.querySelector(`textarea[name="respond_ans_${w.id}"]`))==null?void 0:$.value.trim();a[w.id]=_||"",w.required&&!_&&(s=!0)}}),s){alert("必須の設問に回答してください。");return}const r={};let o=0;e.enable_orders&&e.order_items&&document.querySelectorAll(".select-order-qty").forEach(w=>{const I=w.getAttribute("data-item-id"),E=Number(w.value)||0,$=Number(w.getAttribute("data-price"))||0;r[I]=E,o+=E*$});const i=!!ta,d=ta||`resp_${Date.now()}`,l=new Date,c=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}-${String(l.getDate()).padStart(2,"0")} ${String(l.getHours()).padStart(2,"0")}:${String(l.getMinutes()).padStart(2,"0")}`,u={id:d,survey_id:e.id,respondent_name:t,family_members:wt.filter(w=>w.name.trim()),schedules:n,answers:a,orders:r,total_amount:o,created_at:c};await Ti(u);const m=`${window.location.origin}${window.location.pathname}#survey-${e.id}&response=${u.id}`,f=document.getElementById("input-edit-response-url");f&&(f.value=m);const b=document.getElementById("btn-copy-edit-url");b&&(b.onclick=()=>{navigator.clipboard.writeText(m).then(()=>{alert(`回答修正用URLをコピーしました！
後から回答を変更する場合は、このURLから修正できます。`)}).catch(()=>{prompt("以下のURLをコピーしてください:",m)})});const y=document.getElementById("btn-re-edit-response");y&&(y.onclick=()=>{fn(e.id,u.id)});const g=document.getElementById("btn-view-results-from-success");g&&(e.public_results!==!1?(g.classList.remove("hidden"),g.onclick=()=>fa(e.id,!0)):g.classList.add("hidden"));const p=document.getElementById("survey-respond-success-title"),v=document.getElementById("survey-respond-success-desc");p&&(p.textContent=i?"回答を更新しました！":"回答を受け付けました！"),v&&(v.innerHTML=i?"回答内容の変更が正常に保存されました。<br>内容は役員・担当者へ最新状態で共有されます。":"ご回答いただきありがとうございました。<br>内容は役員・担当者へ共有されます。"),(k=document.getElementById("survey-respond-form-container"))==null||k.classList.add("hidden"),(L=document.getElementById("survey-respond-success-container"))==null||L.classList.remove("hidden"),window.scrollTo({top:0,behavior:"smooth"})}function X(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}let js=!1;function hr(){var e,t,n,a,s,r,o,i,d,l,c,u,m,f,b,y,g,p,v,x,h,k,L,w,I;js||(js=!0,(e=document.getElementById("btn-survey-new"))==null||e.addEventListener("click",()=>br()),(t=document.getElementById("chk-survey-enable-schedule"))==null||t.addEventListener("change",Wa),(n=document.getElementById("chk-survey-enable-orders"))==null||n.addEventListener("change",Wa),(a=document.getElementById("btn-add-sched-opt"))==null||a.addEventListener("click",()=>{Ot.push(`候補日 ${Ot.length+1}`),ga()}),(s=document.getElementById("btn-open-date-picker-sched"))==null||s.addEventListener("click",()=>{yr("schedule")}),(r=document.getElementById("btn-close-date-picker"))==null||r.addEventListener("click",Ga),(o=document.getElementById("btn-cancel-date-picker"))==null||o.addEventListener("click",Ga),(i=document.getElementById("btn-dp-prev-month"))==null||i.addEventListener("click",()=>{ce.viewMonth--,ce.viewMonth<0&&(ce.viewMonth=11,ce.viewYear--),Yt()}),(d=document.getElementById("btn-dp-next-month"))==null||d.addEventListener("click",()=>{ce.viewMonth++,ce.viewMonth>11&&(ce.viewMonth=0,ce.viewYear++),Yt()}),(l=document.getElementById("btn-dp-today"))==null||l.addEventListener("click",()=>{const E=new Date;ce.viewYear=E.getFullYear(),ce.viewMonth=E.getMonth(),Yt()}),(c=document.getElementById("btn-dp-select-weekends"))==null||c.addEventListener("click",Oi),(u=document.getElementById("btn-dp-clear-all"))==null||u.addEventListener("click",()=>{ce.selectedDates.clear(),Yt()}),(m=document.getElementById("btn-apply-date-picker"))==null||m.addEventListener("click",Mi),(f=document.getElementById("btn-add-order-item"))==null||f.addEventListener("click",()=>{xt.push({id:`item_${Date.now()}`,name:`注文品目 ${xt.length+1}`,price:500,max:10}),us()}),(b=document.getElementById("btn-add-question"))==null||b.addEventListener("click",()=>{K.push({id:`q_${Date.now()}`,type:"single",title:`設問 ${K.length+1}`,required:!1,options:[{label:"選択肢 1",skip_to:null},{label:"選択肢 2",skip_to:null}],help:""}),bt()}),(y=document.getElementById("btn-save-survey"))==null||y.addEventListener("click",Ri),(g=document.getElementById("btn-close-survey-editor"))==null||g.addEventListener("click",Va),(p=document.getElementById("btn-cancel-survey-editor"))==null||p.addEventListener("click",Va),(v=document.getElementById("btn-close-survey-results"))==null||v.addEventListener("click",qi),(x=document.getElementById("btn-export-survey-csv"))==null||x.addEventListener("click",Gi),(h=document.getElementById("btn-respond-add-family"))==null||h.addEventListener("click",()=>{wt.push({name:"",role:"選手"}),Tn&&ms(Tn)}),(k=document.getElementById("btn-submit-survey-response"))==null||k.addEventListener("click",Ki),(L=document.getElementById("btn-back-from-survey-respond"))==null||L.addEventListener("click",()=>{if(Pt){const E=document.getElementById("survey-respond-view");E&&E.classList.add("hidden");const $=document.getElementById("info-view");$&&$.classList.remove("hidden"),on()}else{const E=document.getElementById("survey-respond-view");E&&E.classList.add("hidden");const $=document.getElementById("auth-view");$&&$.classList.remove("hidden")}}),(w=document.getElementById("btn-survey-error-reload"))==null||w.addEventListener("click",()=>{window.location.reload()}),(I=document.getElementById("btn-survey-error-home"))==null||I.addEventListener("click",()=>{window.location.href=window.location.pathname}))}let Ce=null,Je=null,za="user",St=!1,ot="docs",Ne=[],Te=[],na="すべて",aa="すべて",An="",tn="";const sa="ants_info_documents_v1",ra="ants_info_links_v1",xr="ants_info_top_md_v1",Qi=`## 🐜 Arinko Ants チーム情報 &amp; ドキュメントポータル
...
`,Hs=[{id:"doc-manual-dispatch",title:"配車調整機能 利用者マニュアル",category:"配車マニュアル",summary:"少年野球チーム「Arinko Ants」の活動におけるイベント配車の自動作成・手動微調整・LINE案内出力までの全体操作マニュアルです。",content:`# 配車調整機能 利用者マニュアル
...
- [ ] **終了時**:
  ...
  - [ ] ゴミの持ち帰り確認
  - [ ] 倉庫施錠および学校鍵の返却`,files:[],created_by:"父母会",updated_at:"2026-04-01"}],Us=[{id:"link-official-site",title:"Arinko Ants 公式ホームページ",url:"https://arinkoants.sakura.ne.jp/",category:"公式・連盟",description:"チームの公式Webサイト。チーム紹介、選手募集案内、活動予定などが掲載されています。",icon:"🐜",display_order:1},{id:"link-google-calendar",title:"チーム活動予定 Googleカレンダー",url:"https://calendar.google.com/",category:"スケジュール・連絡",description:"練習日、遠征試合、大会スケジュールが登録されているGoogleカレンダーです。",icon:"📅",display_order:2},{id:"link-nagareyama-league",title:"流山市少年野球連盟 公式サイト",url:"http://nagareyama-baseball.jp/",category:"公式・連盟",description:"市内大会の組み合わせトーナメント表、試合日程、グラウンド規程などが確認できます。",icon:"⚾",display_order:3},{id:"link-chiba-league",title:"千葉県少年野球連盟",url:"http://chiba-baseball.jp/",category:"公式・連盟",description:"千葉県大会の要項、大会結果、競技規則の最新情報が掲載されています。",icon:"🏆",display_order:4},{id:"link-ground-map",title:"主な活動グラウンド案内 (Google Maps)",url:"https://maps.google.com/",category:"グラウンド・施設",description:"ホームグラウンド（東小学校）および近隣の流山市内グラウンドへのアクセス地図一覧です。",icon:"📍",display_order:5},{id:"link-weather-forecast",title:"流山市のピンポイント天気予報 (tenki.jp)",url:"https://tenki.jp/forecast/3/15/4510/12220/",category:"便利ツール",description:"当日の雨雲レーダー、1時間ごとの降水確率、風速、WBGT（熱中症指数）を確認できます。",icon:"☀️",display_order:6},{id:"link-baseball-rules",title:"公認野球規則 & 少年野球特別規則",url:"https://japan-baseball.jp/",category:"便利ツール",description:"全日本軟式野球連盟（JSBB）による少年野球特別規程および公認野球規則の解説です。",icon:"📖",display_order:7}],vr=["すべて","配車マニュアル","チーム運営・規約","野球ルール・スコア","その他"],wr=["すべて","公式・連盟","グラウンド・施設","スケジュール・連絡","便利ツール","その他"];async function Yn({supabaseClient:e,currentUser:t,currentUserRole:n}){Ce=e,Je=t,za=n,St=n==="admin"||(t==null?void 0:t.can_edit_info)===!0||n==="leader"&&(t==null?void 0:t.can_edit_info)!==!1,Zi(),await Xi(),await Li({supabaseClient:Ce,currentUser:Je,currentUserRole:za,canManageInfo:St}),yd(),Ir(),$r()}function Zi(){document.querySelectorAll(".info-admin-only").forEach(n=>{St?n.classList.remove("hidden"):n.classList.add("hidden")});const t=document.getElementById("info-user-role-badge");t&&(za==="admin"?(t.className="px-2.5 py-0.5 text-xs font-bold rounded-full bg-purple-100 text-purple-700 border border-purple-200",t.textContent="管理者 (編集可)"):St?(t.className="px-2.5 py-0.5 text-xs font-bold rounded-full bg-teal-100 text-teal-700 border border-teal-200",t.textContent="編集可"):(t.className="px-2.5 py-0.5 text-xs font-bold rounded-full bg-gray-100 text-gray-700 border border-gray-200",t.textContent="閲覧専用"))}async function Xi(){let e=!1,t=!1,n=!1;if(Ce){try{const{data:a,error:s}=await Ce.from("info_documents").select("*").order("updated_at",{ascending:!1});!s&&a&&a.length>0&&(Ne=a,e=!0)}catch(a){console.warn("Supabase info_documents select failed:",a)}try{const{data:a,error:s}=await Ce.from("info_links").select("*").order("display_order",{ascending:!0});!s&&a&&a.length>0&&(Te=a,t=!0)}catch(a){console.warn("Supabase info_links select failed:",a)}try{const{data:a,error:s}=await Ce.from("info_pages").select("*").eq("id","top_announcement").single();!s&&a&&a.content&&(tn=a.content,n=!0)}catch(a){console.warn("Supabase info_pages select failed:",a)}}if(!e)try{const a=localStorage.getItem(sa);a?Ne=JSON.parse(a):(Ne=[...Hs],localStorage.setItem(sa,JSON.stringify(Ne)))}catch{Ne=[...Hs]}if(!t)try{const a=localStorage.getItem(ra);a?Te=JSON.parse(a):(Te=[...Us],localStorage.setItem(ra,JSON.stringify(Te)))}catch{Te=[...Us]}if(!n){const a=localStorage.getItem(xr);tn=a!==null?a:Qi}}async function Er(e,t=!1){const n=Ne.findIndex(a=>a.id===e.id);n>=0?Ne[n]=e:Ne.unshift(e);try{localStorage.setItem(sa,JSON.stringify(Ne))}catch(a){console.error(a)}if(Ce)try{t?await Ce.from("info_documents").insert([e]):await Ce.from("info_documents").update(e).eq("id",e.id)}catch(a){console.warn("Supabase document save failed:",a)}}async function ed(e){Ne=Ne.filter(t=>t.id!==e);try{localStorage.setItem(sa,JSON.stringify(Ne))}catch(t){console.error(t)}if(Ce)try{await Ce.from("info_documents").delete().eq("id",e)}catch(t){console.warn("Supabase document delete failed:",t)}}async function _r(e,t=!1){const n=Te.findIndex(a=>a.id===e.id);n>=0?Te[n]=e:Te.push(e);try{localStorage.setItem(ra,JSON.stringify(Te))}catch(a){console.error(a)}if(Ce)try{t?await Ce.from("info_links").insert([e]):await Ce.from("info_links").update(e).eq("id",e.id)}catch(a){console.warn("Supabase link save failed:",a)}}async function td(e){Te=Te.filter(t=>t.id!==e);try{localStorage.setItem(ra,JSON.stringify(Te))}catch(t){console.error(t)}if(Ce)try{await Ce.from("info_links").delete().eq("id",e)}catch(t){console.warn("Supabase link delete failed:",t)}}async function nd(e){tn=e;try{localStorage.setItem(xr,e)}catch(t){console.error(t)}if(Ce)try{await Ce.from("info_pages").upsert([{id:"top_announcement",content:e,updated_at:new Date().toISOString(),updated_by:(Je==null?void 0:Je.name)||"管理者"}])}catch(t){console.warn("Supabase top_announcement save failed:",t)}Ir()}function Ir(){const e=document.getElementById("info-top-announcement-rendered"),t=document.getElementById("info-top-announcement-wrap");!e||!t||(tn&&tn.trim()?(t.classList.remove("hidden"),e.innerHTML=ba(tn)):t.classList.add("hidden"))}function $r(){kr(),ot==="docs"?$n():ot==="surveys"?on():kn()}function kr(){const e=document.getElementById("info-category-filters");if(!e)return;if(ot==="surveys"){e.classList.add("hidden");return}e.classList.remove("hidden");const t=ot==="docs"?vr:wr,n=ot==="docs"?na:aa;e.innerHTML=t.map(a=>`<button class="info-cat-btn px-3.5 py-1.5 text-xs rounded-full transition-all cursor-pointer ${n===a?"bg-teal-600 text-white shadow-sm font-bold":"bg-white text-gray-600 hover:bg-gray-100 border border-gray-200"}" data-category="${a}">${a}</button>`).join(""),e.querySelectorAll(".info-cat-btn").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-category");ot==="docs"?(na=s,$n()):(aa=s,kn()),kr()})})}function $n(){const e=document.getElementById("info-docs-container"),t=document.getElementById("info-docs-empty");if(!e)return;let n=Ne;if(na!=="すべて"&&(n=n.filter(a=>a.category===na)),An.trim()){const a=An.toLowerCase().trim();n=n.filter(s=>s.title&&s.title.toLowerCase().includes(a)||s.summary&&s.summary.toLowerCase().includes(a)||s.content&&s.content.toLowerCase().includes(a)||s.category&&s.category.toLowerCase().includes(a))}if(n.length===0){e.innerHTML="",t&&t.classList.remove("hidden");return}t&&t.classList.add("hidden"),e.innerHTML=n.map(a=>{const s=ps(a.category),r=a.files?a.files.length:0;return`
            <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm hover:shadow-md transition-all p-5 flex flex-col justify-between group">
                <div>
                    ...
                    <p class="text-xs text-gray-600 line-clamp-3 mb-3 leading-relaxed">
                        ${Ke(a.summary||a.content.slice(0,100))}
                    </p>
                    ${r>0?`
        ...
        `}).join(""),e.querySelectorAll(".btn-view-doc").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id"),r=Ne.find(o=>o.id===s);r&&rd(r)})}),St&&(e.querySelectorAll(".btn-duplicate-doc").forEach(a=>{a.addEventListener("click",async()=>{const s=a.getAttribute("data-id");await ad(s)})}),e.querySelectorAll(".btn-edit-doc").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id"),r=Ne.find(o=>o.id===s);r&&Lr(r)})}),e.querySelectorAll(".btn-delete-doc").forEach(a=>{a.addEventListener("click",async()=>{const s=a.getAttribute("data-id"),r=Ne.find(o=>o.id===s);r&&confirm(`ドキュメント「${r.title}」を削除しますか？`)&&(await ed(s),$n())})}))}async function ad(e){const t=Ne.find(a=>a.id===e);if(!t)return;const n=JSON.parse(JSON.stringify(t));n.id=`doc_${Date.now()}`,n.title=`(複製) ${t.title}`,n.created_at=new Date().toISOString(),n.updated_at=new Date().toISOString(),n.author_name=(Je==null?void 0:Je.name)||"管理者",await Er(n,!0),$n(),alert(`ドキュメント「${n.title}」を作成（複製）しました！`)}function kn(){const e=document.getElementById("info-links-container"),t=document.getElementById("info-links-empty");if(!e)return;let n=Te;if(aa!=="すべて"&&(n=n.filter(a=>a.category===aa)),An.trim()){const a=An.toLowerCase().trim();n=n.filter(s=>s.title&&s.title.toLowerCase().includes(a)||s.description&&s.description.toLowerCase().includes(a)||s.url&&s.url.toLowerCase().includes(a)||s.category&&s.category.toLowerCase().includes(a))}if(n.length===0){e.innerHTML="",t&&t.classList.remove("hidden");return}t&&t.classList.add("hidden"),e.innerHTML=n.map(a=>{const s=ps(a.category),r=a.icon||"🔗",o=a.url?a.url.replace(/^https?:\/\//,"").replace(/\/$/,""):"";return`
            <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm hover:shadow-md transition-all p-5 flex flex-col justify-between group">
                <div>
                    <div class="flex items-center justify-between gap-2 mb-3">
                    ...
                    <p class="text-xs text-gray-400 font-mono mb-2 truncate" title="${Ke(a.url)}">
                        ${Ke(o)}
                    </p>
                    <p class="text-xs text-gray-600 leading-relaxed mb-4 line-clamp-3">
                        ${Ke(a.description||"説明はありません")}
                    </p>
                </div>
                <div class="pt-3 border-t border-gray-100 flex items-center justify-between">
                    <a href="${Ke(a.url)}" target="_blank" rel="noopener noreferrer" 
        ...
        `}).join(""),St&&(e.querySelectorAll(".btn-duplicate-link").forEach(a=>{a.addEventListener("click",async()=>{const s=a.getAttribute("data-id");await sd(s)})}),e.querySelectorAll(".btn-edit-link").forEach(a=>{a.addEventListener("click",()=>{const s=a.getAttribute("data-id"),r=Te.find(o=>o.id===s);r&&Sr(r)})}),e.querySelectorAll(".btn-delete-link").forEach(a=>{a.addEventListener("click",async()=>{const s=a.getAttribute("data-id"),r=Te.find(o=>o.id===s);r&&confirm(`リンク「${r.title}」を削除しますか？`)&&(await td(s),kn())})}))}async function sd(e){const t=Te.find(a=>a.id===e);if(!t)return;const n=JSON.parse(JSON.stringify(t));n.id=`link_${Date.now()}`,n.title=`(複製) ${t.title}`,n.created_at=new Date().toISOString(),n.display_order=(t.display_order||0)+1,await _r(n,!0),kn(),alert(`リンク「${n.title}」を作成（複製）しました！`)}function ps(e){switch(e){case"配車マニュアル":return"bg-blue-100 text-blue-800 border border-blue-200";case"チーム運営・規約":return"bg-amber-100 text-amber-800 border border-amber-200";case"野球ルール・スコア":return"bg-green-100 text-green-800 border border-green-200";case"公式・連盟":return"bg-purple-100 text-purple-800 border border-purple-200";case"グラウンド・施設":return"bg-emerald-100 text-emerald-800 border border-emerald-200";case"スケジュール・連絡":return"bg-sky-100 text-sky-800 border border-sky-200";case"便利ツール":return"bg-indigo-100 text-indigo-800 border border-indigo-200";default:return"bg-gray-100 text-gray-700 border border-gray-200"}}let oa=null;function rd(e){const t=document.getElementById("modal-info-doc-reader");if(!t)return;oa=e,document.getElementById("reader-doc-title").textContent=e.title,document.getElementById("reader-doc-category").textContent=e.category||"その他",document.getElementById("reader-doc-category").className=`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${ps(e.category)}`,document.getElementById("reader-doc-updated").textContent=`最終更新: ${e.updated_at||"-"} (作成: ${e.created_by||"チーム"})`;const n=document.getElementById("reader-doc-files-container"),a=document.getElementById("reader-doc-files-list");n&&a&&(e.files&&e.files.length>0?(n.classList.remove("hidden"),a.innerHTML=e.files.map(r=>`
                <a href="${r.dataUrl||"#"}" download="${Ke(r.name)}" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-100 hover:bg-teal-50 text-gray-700 hover:text-teal-700 border border-gray-200 text-xs font-bold transition">
                    <span>📎</span>
                    <span>${Ke(r.name)}</span>
                    <span class="text-[10px] text-gray-400 font-normal">(${Math.round((r.size||0)/1024)}KB)</span>
                </a>
            `).join("")):(n.classList.add("hidden"),a.innerHTML=""));const s=document.getElementById("reader-doc-content");s&&(s.innerHTML=ba(e.content||"",!0),fs(s)),t.classList.remove("hidden")}function od(){const e=document.getElementById("modal-info-doc-reader");e&&e.classList.add("hidden"),oa=null}function id(){if(!oa)return;const e=oa,t=new Blob([e.content||""],{type:"text/markdown;charset=utf-8;"}),n=document.createElement("a");n.href=URL.createObjectURL(t),n.download=`${e.title||"document"}.md`,n.click()}let ia=null,nn=[];function Lr(e=null){const t=document.getElementById("modal-info-doc-editor");if(!t)return;ia=e?e.id:null,nn=e&&e.files?JSON.parse(JSON.stringify(e.files)):[],document.getElementById("doc-editor-modal-title").textContent=e?"ドキュメントの編集":"新規ドキュメント作成",document.getElementById("input-doc-title").value=e?e.title:"",document.getElementById("input-doc-summary").value=e&&e.summary||"",document.getElementById("input-doc-content").value=e?e.content:"";const n=document.getElementById("select-doc-category");n.innerHTML=vr.filter(a=>a!=="すべて").map(a=>`<option value="${a}" ${e&&e.category===a?"selected":""}>${a}</option>`).join(""),gs(),Ya("write"),t.classList.remove("hidden")}function Ja(){const e=document.getElementById("modal-info-doc-editor");e&&e.classList.add("hidden"),ia=null,nn=[]}function gs(){const e=document.getElementById("doc-editor-files-list");if(e){if(nn.length===0){e.innerHTML='<span class="text-xs text-gray-400">添付ファイルはありません</span>';return}e.innerHTML=nn.map((t,n)=>`
        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-gray-100 border border-gray-200 text-xs text-gray-700">
            <span>📎 ${Ke(t.name)} (${Math.round((t.size||0)/1024)}KB)</span>
            <button class="btn-del-file text-red-500 hover:text-red-700 font-bold ml-1" data-index="${n}">✕</button>
        </div>
    `).join(""),e.querySelectorAll(".btn-del-file").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.getAttribute("data-index"));nn.splice(n,1),gs()})})}}function dd(e){Array.from(e).forEach(t=>{if(t.size>5*1024*1024){alert(`ファイル「${t.name}」が5MBを超えているため添付できません。`);return}const n=new FileReader;n.onload=a=>{nn.push({name:t.name,size:t.size,type:t.type,dataUrl:a.target.result}),gs()},n.readAsDataURL(t)})}function ld(e){if(!e)return;const t=new FileReader;t.onload=n=>{const a=n.target.result,s=document.getElementById("input-doc-title"),r=document.getElementById("input-doc-content");s&&(!s.value||s.value.trim()==="")&&(s.value=e.name.replace(/\.md$/i,"")),r&&(r.value=a)},t.readAsText(e)}function Ya(e){const t=document.getElementById("btn-doc-tab-write"),n=document.getElementById("btn-doc-tab-preview"),a=document.getElementById("input-doc-content"),s=document.getElementById("doc-preview-content");e==="write"?(t==null||t.classList.add("bg-white","text-teal-700","shadow-xs"),t==null||t.classList.remove("text-gray-500"),n==null||n.classList.remove("bg-white","text-teal-700","shadow-xs"),n==null||n.classList.add("text-gray-500"),a==null||a.classList.remove("hidden"),s==null||s.classList.add("hidden")):(n==null||n.classList.add("bg-white","text-teal-700","shadow-xs"),n==null||n.classList.remove("text-gray-500"),t==null||t.classList.remove("bg-white","text-teal-700","shadow-xs"),t==null||t.classList.add("text-gray-500"),a==null||a.classList.add("hidden"),s==null||s.classList.remove("hidden"),s&&a&&(s.innerHTML=ba(a.value||"*本文が入力されていません*"),fs(s)))}async function cd(){var i,d,l,c;const e=(i=document.getElementById("input-doc-title"))==null?void 0:i.value.trim(),t=(d=document.getElementById("select-doc-category"))==null?void 0:d.value,n=(l=document.getElementById("input-doc-summary"))==null?void 0:l.value.trim(),a=(c=document.getElementById("input-doc-content"))==null?void 0:c.value.trim();if(!e){alert("タイトルを入力してください");return}if(!a){alert("本文を入力してください");return}const s=new Date().toISOString().split("T")[0],r=!ia,o={id:ia||`doc_${Date.now()}`,title:e,category:t,summary:n||a.slice(0,100),content:a,files:nn,created_by:(Je==null?void 0:Je.name)||"管理者",updated_at:s};await Er(o,r),Ja(),$n()}function ud(){const e=document.getElementById("modal-info-top-editor");if(!e)return;const t=document.getElementById("input-info-top-content");t&&(t.value=tn),Qa("write"),e.classList.remove("hidden")}function Ka(){const e=document.getElementById("modal-info-top-editor");e&&e.classList.add("hidden")}function Qa(e){const t=document.getElementById("btn-top-tab-write"),n=document.getElementById("btn-top-tab-preview"),a=document.getElementById("input-info-top-content"),s=document.getElementById("top-preview-content");e==="write"?(t==null||t.classList.add("bg-white","text-teal-700","shadow-xs"),t==null||t.classList.remove("text-gray-500"),n==null||n.classList.remove("bg-white","text-teal-700","shadow-xs"),n==null||n.classList.add("text-gray-500"),a==null||a.classList.remove("hidden"),s==null||s.classList.add("hidden")):(n==null||n.classList.add("bg-white","text-teal-700","shadow-xs"),n==null||n.classList.remove("text-gray-500"),t==null||t.classList.remove("bg-white","text-teal-700","shadow-xs"),t==null||t.classList.add("text-gray-500"),a==null||a.classList.add("hidden"),s==null||s.classList.remove("hidden"),s&&a&&(s.innerHTML=ba(a.value||"*内容が入力されていません*"),fs(s)))}async function md(){var t;const e=(t=document.getElementById("input-info-top-content"))==null?void 0:t.value;await nd(e),Ka()}let Sn=null;function Sr(e=null){const t=document.getElementById("modal-info-link-editor");if(!t)return;Sn=e?e.id:null,document.getElementById("link-editor-modal-title").textContent=e?"リンクの編集":"新規リンク追加",document.getElementById("input-link-title").value=e?e.title:"",document.getElementById("input-link-url").value=e?e.url:"",document.getElementById("input-link-desc").value=e&&e.description||"",document.getElementById("input-link-icon").value=e&&e.icon||"🔗";const n=document.getElementById("select-link-category");n.innerHTML=wr.filter(a=>a!=="すべて").map(a=>`<option value="${a}" ${e&&e.category===a?"selected":""}>${a}</option>`).join(""),t.classList.remove("hidden")}function Za(){const e=document.getElementById("modal-info-link-editor");e&&e.classList.add("hidden"),Sn=null}async function pd(){var i,d,l,c,u,m;const e=(i=document.getElementById("input-link-title"))==null?void 0:i.value.trim(),t=(d=document.getElementById("input-link-url"))==null?void 0:d.value.trim(),n=(l=document.getElementById("select-link-category"))==null?void 0:l.value,a=(c=document.getElementById("input-link-desc"))==null?void 0:c.value.trim(),s=((u=document.getElementById("input-link-icon"))==null?void 0:u.value.trim())||"🔗";if(!e){alert("タイトルを入力してください");return}if(!t){alert("URLを入力してください");return}if(!t.startsWith("http://")&&!t.startsWith("https://")){alert("URLは http:// または https:// から入力してください");return}const r=!Sn,o={id:Sn||`link_${Date.now()}`,title:e,url:t,category:n,description:a,icon:s,display_order:r?Te.length+1:((m=Te.find(f=>f.id===Sn))==null?void 0:m.display_order)||1,created_by:(Je==null?void 0:Je.name)||"管理者",updated_at:new Date().toISOString().split("T")[0]};await _r(o,r),Za(),kn()}const Br=`-- ==========================================
...
`;function gd(){const e=document.getElementById("modal-info-sql");if(!e)return;const t=document.getElementById("info-sql-code");t&&(t.textContent=Br),e.classList.remove("hidden")}function fd(){const e=document.getElementById("modal-info-sql");e&&e.classList.add("hidden")}function bd(){navigator.clipboard.writeText(Br).then(()=>{alert(`SQL文をクリップボードにコピーしました！
Supabase Dashboardの「SQL Editor」で実行してください。`)}).catch(e=>{console.error("Copy failed:",e)})}let Vs=!1;function yd(){var m,f,b,y,g,p,v,x,h,k,L,w,I,E,$,_,C,M,N;if(Vs)return;Vs=!0;const e=document.getElementById("tab-info-docs"),t=document.getElementById("tab-info-surveys"),n=document.getElementById("tab-info-links"),a=document.getElementById("view-info-docs"),s=document.getElementById("view-info-surveys"),r=document.getElementById("view-info-links"),o=document.getElementById("btn-info-new"),i=document.getElementById("btn-survey-new");function d(P){ot=P,[e,t,n].forEach(U=>{U&&(U.className="px-4 py-2 font-bold text-gray-500 hover:text-gray-700 border-b-2 border-transparent transition-colors flex items-center space-x-2 cursor-pointer")}),[a,s,r].forEach(U=>U==null?void 0:U.classList.add("hidden")),P==="docs"?(e.className="px-4 py-2 font-bold text-teal-600 border-b-2 border-teal-600 transition-colors flex items-center space-x-2 cursor-pointer",a==null||a.classList.remove("hidden"),o&&(o.classList.remove("hidden"),o.textContent="＋ 新規ドキュメント"),i&&i.classList.add("hidden")):P==="surveys"?(t.className="px-4 py-2 font-bold text-teal-600 border-b-2 border-teal-600 transition-colors flex items-center space-x-2 cursor-pointer",s==null||s.classList.remove("hidden"),o&&o.classList.add("hidden"),i&&St&&i.classList.remove("hidden")):(n.className="px-4 py-2 font-bold text-teal-600 border-b-2 border-teal-600 transition-colors flex items-center space-x-2 cursor-pointer",r==null||r.classList.remove("hidden"),o&&(o.classList.remove("hidden"),o.textContent="＋ 新規リンク"),i&&i.classList.add("hidden")),$r()}e==null||e.addEventListener("click",()=>d("docs")),t==null||t.addEventListener("click",()=>d("surveys")),n==null||n.addEventListener("click",()=>d("links"));const l=document.getElementById("input-info-search");l==null||l.addEventListener("input",P=>{An=P.target.value,ot==="docs"?$n():ot==="links"&&kn()}),o==null||o.addEventListener("click",()=>{ot==="docs"?Lr():ot==="links"&&Sr()}),(m=document.getElementById("btn-edit-top-announcement"))==null||m.addEventListener("click",ud),(f=document.getElementById("btn-close-top-editor"))==null||f.addEventListener("click",Ka),(b=document.getElementById("btn-cancel-top-editor"))==null||b.addEventListener("click",Ka),(y=document.getElementById("btn-top-tab-write"))==null||y.addEventListener("click",()=>Qa("write")),(g=document.getElementById("btn-top-tab-preview"))==null||g.addEventListener("click",()=>Qa("preview")),(p=document.getElementById("btn-save-top-announcement"))==null||p.addEventListener("click",md),(v=document.getElementById("btn-close-doc-reader"))==null||v.addEventListener("click",od),(x=document.getElementById("btn-export-doc-md"))==null||x.addEventListener("click",id),(h=document.getElementById("btn-close-doc-editor"))==null||h.addEventListener("click",Ja),(k=document.getElementById("btn-cancel-doc-editor"))==null||k.addEventListener("click",Ja),(L=document.getElementById("btn-doc-tab-write"))==null||L.addEventListener("click",()=>Ya("write")),(w=document.getElementById("btn-doc-tab-preview"))==null||w.addEventListener("click",()=>Ya("preview")),(I=document.getElementById("btn-save-doc"))==null||I.addEventListener("click",cd);const c=document.getElementById("input-doc-attach-files");c==null||c.addEventListener("change",P=>{P.target.files&&dd(P.target.files)});const u=document.getElementById("input-doc-import-md");u==null||u.addEventListener("change",P=>{P.target.files&&P.target.files[0]&&ld(P.target.files[0])}),(E=document.getElementById("btn-close-link-editor"))==null||E.addEventListener("click",Za),($=document.getElementById("btn-cancel-link-editor"))==null||$.addEventListener("click",Za),(_=document.getElementById("btn-save-link"))==null||_.addEventListener("click",pd),(C=document.getElementById("btn-info-sql-modal"))==null||C.addEventListener("click",gd),(M=document.getElementById("btn-close-info-sql"))==null||M.addEventListener("click",fd),(N=document.getElementById("btn-copy-info-sql"))==null||N.addEventListener("click",bd)}function ba(e,t=!1){if(!e)return"";const n=e.split(`
`);let a="",s=!1,r=!1,o=!1,i="",d=!1,l=[],c=!1,u="",m="";const f=[];function b(){s&&(a+=`</ul>
`,s=!1),r&&(a+=`</ol>
`,r=!1),d&&(a+=Gs(l),l=[],d=!1),c&&(a+=hd(u,m),m="",c=!1)}for(let y=0;y<n.length;y++){let g=n[y];if(g.trim().startsWith("```")){o?(a+=`
                    <div class="relative my-3 group">
                        <pre class="bg-gray-900 text-gray-100 p-4 rounded-xl overflow-x-auto text-xs font-mono border border-gray-800 leading-relaxed"><code>${Ke(i.trim())}</code></pre>
...
`;continue}else b();if(g.trim().startsWith("|")&&g.trim().endsWith("|")){d||(b(),d=!0,l=[]),l.push(g.trim());continue}else d&&(a+=Gs(l),l=[],d=!1);if(g.trim()===""){b();continue}if(/^(\*{3,}|-{3,}|_{3,})$/.test(g.trim())){b(),a+=`<hr class="my-6 border-t border-gray-200">
`;continue}if(g.startsWith("# ")){b();const h=g.slice(2).trim(),k=`heading-${f.length}`;f.push({level:1,text:h,id:k}),a+=`<h1 id="${k}" class="text-2xl font-bold text-gray-900 mt-6 mb-3 pb-2 border-b border-gray-200">${Ze(h)}</h1>
`;continue}if(g.startsWith("## ")){b();const h=g.slice(3).trim(),k=`heading-${f.length}`;f.push({level:2,text:h,id:k}),a+=`<h2 id="${k}" class="text-xl font-bold text-gray-800 mt-5 mb-2.5">${Ze(h)}</h2>
`;continue}if(g.startsWith("### ")){b();const h=g.slice(4).trim(),k=`heading-${f.length}`;f.push({level:3,text:h,id:k}),a+=`<h3 id="${k}" class="text-lg font-bold text-gray-800 mt-4 mb-2">${Ze(h)}</h3>
`;continue}if(g.startsWith("#### ")){b();const h=g.slice(5).trim();a+=`<h4 class="text-base font-semibold text-gray-700 mt-3 mb-1.5">${Ze(h)}</h4>
`;continue}if(g.startsWith("> ")){b(),a+=`<blockquote class="border-l-4 border-teal-500 pl-4 py-1.5 my-3 bg-teal-50/50 text-xs text-gray-700 rounded-r">${Ze(g.slice(2))}</blockquote>
`;continue}const v=g.trim().match(/^[-*]\s*\[([ xX])\]\s*(.*)/);if(v){b();const h=v[1].toLowerCase()==="x";a+=`
                <div class="flex items-center gap-2 my-1 text-xs text-gray-700">
                    ...
                    <span class="${h?"line-through text-gray-400":""}">${Ze(v[2])}</span>
                </div>
...
`,s=!0);const h=g.trim().slice(2);a+=`  <li>${Ze(h)}</li>
...
`,r=!0),a+=`  <li>${Ze(x[2])}</li>
`;continue}b(),a+=`<p class="my-2 text-xs text-gray-700 leading-relaxed">${Ze(g)}</p>
...
`).filter(d=>d.trim()).map(d=>`<p class="my-1 text-xs text-gray-700 leading-relaxed">${Ze(d)}</p>`).join("");return`
    ...
    `}function Gs(e){if(e.length<2)return"";let t='<div class="overflow-x-auto my-4 scrollbar-thin"><table class="min-w-full text-xs border border-gray-200 rounded-xl overflow-hidden">';const n=e[0].split("|").slice(1,-1).map(a=>a.trim());t+='<thead class="bg-gray-50 border-b border-gray-200"><tr>',n.forEach(a=>{t+=`<th class="px-3.5 py-2.5 text-left font-bold text-gray-700 border-r border-gray-200 last:border-r-0">${Ze(a)}</th>`}),t+="</tr></thead><tbody>";for(let a=2;a<e.length;a++){const s=e[a].split("|").slice(1,-1).map(r=>r.trim());t+=`<tr class="${a%2===0?"bg-white":"bg-gray-50/40"} border-b border-gray-100 last:border-b-0 hover:bg-teal-50/30">`,s.forEach(r=>{t+=`<td class="px-3.5 py-2.5 text-gray-600 border-r border-gray-100 last:border-r-0">${Ze(r)}</td>`}),t+="</tr>"}return t+="</tbody></table></div>",t}function Ze(e){if(!e)return"";let t=Ke(e);return t=t.replace(/\*\*(.*?)\*\*/g,'<strong class="font-bold text-gray-900">$1</strong>'),t=t.replace(/\*(.*?)\*/g,'<em class="italic">$1</em>'),t=t.replace(/`([^`]+)`/g,'<code class="px-1.5 py-0.5 bg-gray-100 text-teal-700 rounded text-[11px] font-mono border border-gray-200">$1</code>'),t=t.replace(/\[(.*?)\]\((https?:\/\/[^\s)]+)\)/g,'<a href="$2" target="_blank" rel="noopener noreferrer" class="text-teal-600 hover:text-teal-800 underline font-semibold">$1 ↗</a>'),t}function fs(e){e.querySelectorAll(".btn-copy-code").forEach(t=>{t.addEventListener("click",()=>{var a;const n=((a=t.parentElement.querySelector("code"))==null?void 0:a.textContent)||"";navigator.clipboard.writeText(n).then(()=>{const s=t.textContent;t.textContent="コピー完了！",setTimeout(()=>{t.textContent=s},2e3)})})})}function Ke(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}const bs=void 0,ys=void 0;alert(`Supabaseの接続情報（環境変数）が正しく読み込めていません。
Vercel等の設定を確認してください。`),console.error("Missing SUPABASE_URL or SUPABASE_ANON_KEY");console.log("Checking Supabase URL:","Empty");!window.supabaseClient&&window.supabase&&window.supabase.createClient&&(window.supabaseClient=window.supabase.createClient(bs,ys));const S=window.supabaseClient;let F=null,xn=!1,he="user";function ya(e){return e=e.trim(),e?e.includes("@")?e:`${e}@ants.local`:""}function an(e){return e?e.endsWith("@ants.local")?e.split("@")[0]:e:""}let bn=0,st=null;function xd(e){const t=document.getElementById("loading-overlay");if(t){const n=t.querySelector("span");n&&(n.textContent=e)}st||(st=document.createElement("div"),st.id="loading-detail-text",st.className="fixed bottom-2 right-2 text-xs md:text-sm font-bold text-gray-600 bg-white/90 border border-gray-300 px-3 py-1.5 rounded shadow-lg pointer-events-none z-[9999] transition-opacity duration-300",document.body.appendChild(st)),st.textContent=e,st.style.opacity="1"}function j(e="通信中..."){bn++;const t=document.getElementById("loading-overlay");t&&bn===1&&t.classList.remove("hidden"),xd(e)}function q(){var e;bn--,bn<=0&&(bn=0,(e=document.getElementById("loading-overlay"))==null||e.classList.add("hidden"),st&&(st.style.opacity="0"))}function Ue(){var e;bn=0,(e=document.getElementById("loading-overlay"))==null||e.classList.add("hidden"),st&&(st.style.opacity="0")}async function ve(e,t="通信中..."){{alert("環境変数 (VITE_SUPABASE_URL) が設定されていません。Vercelの設定を確認してください。");return}}async function ae(e,t){if(F&&e!=="NAVIGATE")try{await S.from("action_logs").insert({user_email:F.email,action_type:e,details:t})}catch(n){console.error("Log error:",n)}}function Ws(){var e,t,n,a,s,r,o,i,d,l,c,u,m,f,b,y,g,p,v,x,h,k,L,w,I,E,$,_,C,M,N,P,U,O,B,A,T,D,G,H,W,R,z,J,ye,ne;if(!window.isDomInitialized)try{if(window.isDomInitialized=!0,document.title="bb-sys for arinko ants.",document.body){const V=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null,!1);let re;for(;re=V.nextNode();)re.nodeValue.includes("配車調整アプリ")&&(re.nodeValue=re.nodeValue.replace(/配車調整アプリ/g,"bb-sys for arinko ants.")),re.nodeValue.includes("少年野球に役立つツール for arinko ants.")&&(re.nodeValue=re.nodeValue.replace(/少年野球に役立つツール for arinko ants./g,"bb-sys for arinko ants."))}document.documentElement.style.setProperty("--layout-columns",ts),window.addEventListener("resize",Js),Js(),(e=document.getElementById("btn-login"))==null||e.addEventListener("click",zs),(t=document.getElementById("auth-form"))==null||t.addEventListener("submit",zs),(n=document.getElementById("btn-logout"))==null||n.addEventListener("click",Gn),(a=document.getElementById("btn-logout-menu"))==null||a.addEventListener("click",Gn),(s=document.getElementById("btn-clear-cache"))==null||s.addEventListener("click",vd),(r=document.getElementById("link-to-signup"))==null||r.addEventListener("click",V=>{V.preventDefault(),Q("signup-view")}),(o=document.getElementById("link-to-reset"))==null||o.addEventListener("click",V=>{V.preventDefault(),Q("password-reset-view")}),document.querySelectorAll(".link-back-to-login").forEach(V=>V.addEventListener("click",re=>{re.preventDefault(),Q("auth-view")})),(i=document.getElementById("btn-submit-signup"))==null||i.addEventListener("click",wd),(d=document.getElementById("btn-send-reset"))==null||d.addEventListener("click",Ed),(l=document.getElementById("btn-update-password"))==null||l.addEventListener("click",_d),(c=document.getElementById("btn-change-password"))==null||c.addEventListener("click",()=>{var V;(V=document.getElementById("change-password-modal"))==null||V.classList.remove("hidden")}),(u=document.getElementById("btn-close-change-password"))==null||u.addEventListener("click",()=>{var V;(V=document.getElementById("change-password-modal"))==null||V.classList.add("hidden")}),(m=document.getElementById("btn-submit-change-password"))==null||m.addEventListener("click",Id);const de=document.getElementById("btn-change-password");de&&(de.textContent="パスワード変更"),(f=document.getElementById("nav-users"))==null||f.addEventListener("click",Cn),(b=document.getElementById("btn-admin-add-user"))==null||b.addEventListener("click",adminAddUser),(y=document.getElementById("btn-reload-users"))==null||y.addEventListener("click",oe),(g=document.getElementById("btn-save-all-users"))==null||g.addEventListener("click",$d),(p=document.getElementById("admin-users-sort"))==null||p.addEventListener("change",V=>{localStorage.setItem("admin_users_sort",V.target.value),oe()}),(v=document.getElementById("btn-export-users"))==null||v.addEventListener("click",pl),(x=document.getElementById("btn-import-users"))==null||x.addEventListener("click",()=>document.getElementById("input-import-users-csv").click()),(h=document.getElementById("btn-download-users-sample"))==null||h.addEventListener("click",yl),(k=document.getElementById("input-import-users-csv"))==null||k.addEventListener("change",gl),(L=document.getElementById("btn-close-csv-modal"))==null||L.addEventListener("click",ca),(w=document.getElementById("btn-close-csv-modal-x"))==null||w.addEventListener("click",ca),(I=document.getElementById("btn-execute-csv-import"))==null||I.addEventListener("click",fl);const Ie=document.getElementById("btn-admin-add-user");if(Ie&&!document.getElementById("btn-admin-add-dummy-user")){const V=document.createElement("button");V.id="btn-admin-add-dummy-user",V.className="ml-2 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded shadow font-bold text-sm",V.textContent="代行専用メンバー追加",V.onclick=adminAddDummyUser,(E=Ie.parentNode)==null||E.appendChild(V)}const Ye=document.querySelector("#view-master #btn-load-logs");Ye&&Ye.remove();const se=document.querySelector("#view-master #log-list");if(se){const V=se.closest(".bg-white");V?V.remove():se.remove()}document.querySelectorAll("#view-master h2").forEach(V=>{V.textContent.includes("操作ログ")&&V.remove()});const Qe=document.getElementById("tab-master-admin");if(Qe&&!document.getElementById("tab-logs-admin")){const V=Qe.parentElement,re=document.createElement("button");re.id="tab-logs-admin",re.className="px-4 py-2 font-bold text-gray-500 hover:text-gray-700 border-b-2 border-transparent transition-colors",re.textContent="操作ログ",V==null||V.appendChild(re);const ke=document.createElement("div");ke.id="tab-content-logs-admin",ke.className="hidden",ke.innerHTML=`
            ...
            `;const Re=document.getElementById("tab-content-master-admin");Re&&Re.parentElement&&Re.parentElement.appendChild(ke)}const Me=V=>{[{btnId:"tab-users-admin",contentId:"tab-content-users-admin"},{btnId:"tab-master-admin",contentId:"tab-content-master-admin"},{btnId:"tab-logs-admin",contentId:"tab-content-logs-admin"}].forEach(ke=>{const Re=document.getElementById(ke.btnId),mt=document.getElementById(ke.contentId);!Re||!mt||(ke.btnId===V?(Re.className="px-4 py-2 font-bold text-blue-600 border-b-2 border-blue-600 transition-colors",mt.classList.remove("hidden"),V==="tab-logs-admin"&&Dn()):(Re.className="px-4 py-2 font-bold text-gray-500 hover:text-gray-700 border-b-2 border-transparent transition-colors",mt.classList.add("hidden")))})};($=document.getElementById("tab-users-admin"))==null||$.addEventListener("click",()=>Me("tab-users-admin")),(_=document.getElementById("tab-master-admin"))==null||_.addEventListener("click",()=>Me("tab-master-admin")),(C=document.getElementById("tab-logs-admin"))==null||C.addEventListener("click",()=>Me("tab-logs-admin")),(M=document.getElementById("btn-load-logs"))==null||M.addEventListener("click",Dn),(N=document.getElementById("btn-app-dispatch"))==null||N.addEventListener("click",()=>{var V;Q("app-view","dispatch"),xn?(V=document.getElementById("nav-dispatch"))==null||V.click():es()}),(P=document.getElementById("btn-app-attendance"))==null||P.addEventListener("click",async()=>{Q("attendance-view"),await ve(Pa,"出欠管理画面を準備中...")}),(U=document.getElementById("btn-app-dashboard"))==null||U.addEventListener("click",async()=>{await ve(Ra,"ダッシュボードを準備中..."),Q("dashboard-view")}),(O=document.getElementById("btn-app-info"))==null||O.addEventListener("click",async()=>{await ve(async()=>{await Yn({supabaseClient:S,currentUser:F,currentUserRole:he})},"Info画面を準備中..."),Q("info-view")}),(B=document.getElementById("btn-back-to-menu-info"))==null||B.addEventListener("click",()=>Q("app-menu-view")),(A=document.getElementById("btn-logout-info"))==null||A.addEventListener("click",Gn),(T=document.getElementById("btn-back-to-menu"))==null||T.addEventListener("click",()=>{Q("app-menu-view")}),(D=document.getElementById("btn-back-to-menu-att"))==null||D.addEventListener("click",()=>Q("app-menu-view")),(G=document.getElementById("btn-logout-att"))==null||G.addEventListener("click",Gn),(H=document.getElementById("btn-change-password-menu"))==null||H.addEventListener("click",hs);const Wt=(W=document.getElementById("app-menu-view"))==null?void 0:W.querySelector(".space-y-4");Wt&&(Wt.className="w-full max-w-xs mx-auto space-y-3 mt-4");const Tt=document.getElementById("btn-app-dispatch");Tt&&(Tt.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-blue-600 hover:bg-blue-700 hover:shadow-lg text-white text-left",Tt.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">🚗</span><span>配車調整</span></div><span class="text-white/60 text-sm font-normal">❯</span>');const ct=document.getElementById("btn-app-attendance");ct&&(ct.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-green-600 hover:bg-green-700 hover:shadow-lg text-white text-left",ct.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">📅</span><span>出欠管理</span></div><span class="text-white/60 text-sm font-normal">❯</span>');const ut=document.getElementById("btn-app-simulator");ut&&(ut.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-amber-600 hover:bg-amber-700 hover:shadow-lg text-white text-left",ut.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">⚾</span><span>ポジション設定</span></div><span class="text-white/60 text-sm font-normal">❯</span>',ut.onclick=()=>{Q("position-simulator-view"),Jn()});const at=document.getElementById("btn-app-info");at&&(at.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-teal-600 hover:bg-teal-700 hover:shadow-lg text-white text-left",at.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">ℹ️</span><span>Info</span></div><span class="text-white/60 text-sm font-normal">❯</span>',at.onclick=async()=>{await ve(async()=>{await Yn({supabaseClient:S,currentUser:F,currentUserRole:he})},"Info画面を準備中..."),Q("info-view")}),(R=document.getElementById("nav-info"))==null||R.addEventListener("click",async()=>{await ve(async()=>{await Yn({supabaseClient:S,currentUser:F,currentUserRole:he})},"Info画面を準備中..."),Q("info-view")}),(z=document.getElementById("nav-simulator"))==null||z.addEventListener("click",()=>{Q("position-simulator-view"),Jn()}),(J=document.getElementById("nav-simulator-att"))==null||J.addEventListener("click",()=>{Q("position-simulator-view"),Jn()}),(ye=document.getElementById("nav-dispatch-sim"))==null||ye.addEventListener("click",()=>{var V;Q("app-view","dispatch"),xn?(V=document.getElementById("nav-dispatch"))==null||V.click():es()}),(ne=document.getElementById("nav-attendance-sim"))==null||ne.addEventListener("click",async()=>{Q("attendance-view"),await ve(Pa,"出欠管理画面を準備中...")})}catch(de){console.error("DOM Initialization failed:",de),Ue(),Q("auth-view")}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ws):setTimeout(Ws,0);let Xa=!1;function da(e,t=null){if(Xa)return;const n="#"+e+(t?"-"+t:"");window.location.hash!==n&&history.pushState({screenId:e,subView:t},"",n)}function Q(e,t=null){["auth-view","signup-view","password-reset-view","password-update-view","app-menu-view","app-view","attendance-view","view-users","dashboard-view","dashboard-settings","position-simulator-view","info-view","survey-respond-view"].forEach(a=>{const s=document.getElementById(a);s&&s.classList.add("hidden")});const n=document.getElementById(e);n&&n.classList.remove("hidden"),da(e,t),e!=="auth-view"&&e!=="survey-respond-view"&&F&&ae("NAVIGATE",`画面遷移: ${e}${t?" > "+t:""}`)}function Kn(){let e=null,t=null,n=null;try{const a=new URLSearchParams(window.location.search);e=a.get("survey"),t=a.get("response"),n=a.get("d");let s=window.location.hash||"";if(s.startsWith("#/")&&(s="#"+s.substring(2)),s.includes("?")){const[r,o]=s.split("?");s=r;try{const i=new URLSearchParams(o);e||(e=i.get("survey")),t||(t=i.get("response")),n||(n=i.get("d"))}catch{}}if(s.startsWith("#survey-")||s.startsWith("#survey=")){const o=(s.startsWith("#survey-")?s.replace("#survey-",""):s.replace("#survey=","")).split("&");e||(e=o[0]);for(let i=1;i<o.length;i++){const d=o[i],l=d.indexOf("=");if(l!==-1){const c=d.substring(0,l),u=d.substring(l+1);c==="response"&&u&&!t&&(t=u),c==="d"&&u&&!n&&(n=u)}}}}catch(a){console.warn("parseSurveyUrlParams error:",a)}if(e)try{e=decodeURIComponent(e).trim().replace(/^\/+|\/+$/g,"")}catch{}if(t)try{t=decodeURIComponent(t).trim()}catch{}return{surveyId:e,responseId:t,surveyData:n||null}}window.addEventListener("popstate",async e=>{var t,n;Xa=!0;try{const{surveyId:a,responseId:s,surveyData:r}=Kn();if(a){await fn(a,s,r);return}e.state&&e.state.screenId?(Q(e.state.screenId,e.state.subView),e.state.screenId==="app-view"&&(e.state.subView==="users"?await Cn():e.state.subView==="master"?(t=document.getElementById("nav-master"))==null||t.click():(n=document.getElementById("nav-dispatch"))==null||n.click())):Q(F?"app-menu-view":"auth-view")}finally{Xa=!1}});S&&S.auth.onAuthStateChange(async(e,t)=>{if(e==="PASSWORD_RECOVERY"){Q("password-update-view");return}if(t&&xn&&F&&(e==="TOKEN_REFRESHED"||e==="USER_UPDATED")){console.log(`Bypassing auth state change handling for event: ${e}`);return}const n=async()=>{var o,i,d,l,c,u,m,f;const{surveyId:a,responseId:s,surveyData:r}=Kn();if(a){if(Ue(),t){F={...t.user};try{const{data:b}=await S.from("app_users").select("name, role").eq("email",F.email).single();b&&(F.name=b.name,he=b.role)}catch{}}await fn(a,s,r);return}if(t){j("ユーザー権限確認中...");try{const b=!F||F.id!==t.user.id;F={...t.user},b&&await ae("LOGIN","ログインしました");let y=!0,g=!0,p=!0,v=!0,x=!0,h=!1;try{let{data:J,error:ye}=await S.from("app_users").select("role, name, can_use_dispatch, can_use_dashboard, can_use_attendance, can_use_simulator, can_use_info, can_edit_info").eq("email",F.email).single();if(ye){const{data:ne}=await S.from("app_users").select("role, name, can_use_dispatch, can_use_dashboard, can_use_attendance, can_use_simulator, can_use_info").eq("email",F.email).single();J=ne}J?(he=J.role,F.name=J.name,J.can_use_dispatch===!1&&(y=!1),J.can_use_dashboard===!1&&(g=!1),J.can_use_attendance===!1&&(p=!1),J.can_use_simulator===!1&&(v=!1),J.can_use_info===!1&&(x=!1),h=J.can_edit_info===!0):he="user"}catch{he="user"}F.email==="hishinumak@gmail.com"&&(he="admin"),he==="admin"?(y=!0,g=!0,p=!0,v=!0,x=!0,h=!0):he==="leader"&&h===!1&&(h=!0),F.can_use_info=x,F.can_edit_info=h;let k=document.getElementById("btn-app-dashboard");if(g)if(k)k.classList.remove("hidden");else{const J=((o=document.getElementById("app-menu-view"))==null?void 0:o.querySelector(".space-y-3"))||((i=document.getElementById("app-menu-view"))==null?void 0:i.querySelector(".space-y-4"))||((d=document.getElementById("app-menu-view"))==null?void 0:d.querySelector(".grid"));J&&(k=document.createElement("button"),k.id="btn-app-dashboard",k.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-indigo-600 hover:bg-indigo-700 hover:shadow-lg text-white text-left",k.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">📊</span><span>分析</span></div><span class="text-white/60 text-sm font-normal">❯</span>',k.onclick=async()=>{await ve(Ra,"ダッシュボードを準備中..."),Q("dashboard-view")},J.appendChild(k))}else k&&k.classList.add("hidden");const L=document.getElementById("nav-users"),w=document.getElementById("nav-master"),I=document.getElementById("nav-dispatch"),E=document.getElementById("btn-app-dispatch"),$=document.getElementById("btn-goto-master"),_=document.getElementById("clear-db-button");let C=document.getElementById("btn-app-users-admin");if(L==null||L.classList.add("hidden"),he==="admin"?(I==null||I.classList.remove("hidden"),w==null||w.classList.remove("hidden")):he==="leader"?(I==null||I.classList.remove("hidden"),w==null||w.classList.add("hidden")):(I==null||I.classList.add("hidden"),w==null||w.classList.add("hidden")),he==="admin")if($==null||$.classList.remove("hidden"),_==null||_.classList.remove("hidden"),C)C.classList.remove("hidden");else{const J=((l=document.getElementById("app-menu-view"))==null?void 0:l.querySelector(".space-y-3"))||((c=document.getElementById("app-menu-view"))==null?void 0:c.querySelector(".space-y-4"))||((u=document.getElementById("app-menu-view"))==null?void 0:u.querySelector(".grid"));J&&(C=document.createElement("button"),C.id="btn-app-users-admin",C.className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl shadow-md transition duration-200 font-bold bg-purple-600 hover:bg-purple-700 hover:shadow-lg text-white text-left order-last",C.innerHTML='<div class="flex items-center space-x-3 text-base sm:text-lg"><span class="text-2xl">⚙️</span><span>管理者メニュー</span></div><span class="text-white/60 text-sm font-normal">❯</span>',C.onclick=()=>Tr(),J.appendChild(C))}else $==null||$.classList.add("hidden"),_==null||_.classList.add("hidden"),C&&C.classList.add("hidden");y?E==null||E.classList.remove("hidden"):E==null||E.classList.add("hidden");const M=document.getElementById("btn-app-attendance");p?M==null||M.classList.remove("hidden"):M==null||M.classList.add("hidden");const N=document.getElementById("btn-app-simulator"),P=document.getElementById("nav-simulator"),U=document.getElementById("nav-simulator-att"),O=document.getElementById("nav-dispatch-sim"),B=document.getElementById("nav-attendance-sim");v?(N==null||N.classList.remove("hidden"),P==null||P.classList.remove("hidden"),U==null||U.classList.remove("hidden")):(N==null||N.classList.add("hidden"),P==null||P.classList.add("hidden"),U==null||U.classList.add("hidden")),y?O==null||O.classList.remove("hidden"):O==null||O.classList.add("hidden"),p?B==null||B.classList.remove("hidden"):B==null||B.classList.add("hidden");const A=document.getElementById("btn-app-info"),T=document.getElementById("nav-info");x?(A==null||A.classList.remove("hidden"),T==null||T.classList.remove("hidden")):(A==null||A.classList.add("hidden"),T==null||T.classList.add("hidden"));const D=document.getElementById("user-email-display");D&&(D.textContent=F.name||an(F.email));const G=document.getElementById("sim-user-email-display");G&&(G.textContent=F.name||an(F.email));const{surveyId:H,responseId:W,surveyData:R}=Kn();if(H){await fn(H,W,R);return}const z=window.location.hash;if(z&&z!=="#app-menu-view"&&z!=="#auth-view"){const J=["app-view","attendance-view","dashboard-view","position-simulator-view","info-view"];let ye=!1;for(const ne of J)if(z.startsWith("#"+ne)){const de=z.length>ne.length+1?z.substring(ne.length+2):null;ne==="app-view"?(Q("app-view",de),xn?de==="users"?Cn():de==="master"?(m=document.getElementById("nav-master"))==null||m.click():(f=document.getElementById("nav-dispatch"))==null||f.click():es().then(()=>{var Ie,Ye;de==="users"?Cn():de==="master"?(Ie=document.getElementById("nav-master"))==null||Ie.click():(Ye=document.getElementById("nav-dispatch"))==null||Ye.click()}).catch(Ie=>{console.error("App init error:",Ie),Ue()})):ne==="attendance-view"?(Q("attendance-view"),Pa().catch(Ie=>{console.error("Attendance init error:",Ie),Ue()})):ne==="dashboard-view"?(Q("dashboard-view"),Ra().catch(Ie=>{console.error("Dashboard init error:",Ie),Ue()})):ne==="position-simulator-view"?(Q("position-simulator-view"),Jn()):ne==="info-view"&&(Q("info-view"),Yn({supabaseClient:S,currentUser:F,currentUserRole:he}).catch(Ie=>{console.error("Info init error:",Ie),Ue()})),ye=!0;break}ye||Q("app-menu-view")}else Q("app-menu-view")}catch(b){console.error("Auth state handling error:",b),Ue()}finally{q()}}else{F=null,Ue();const{surveyId:b,responseId:y,surveyData:g}=Kn();if(b){await fn(b,y,g);return}const p=document.getElementById("password-update-view");(!p||p.classList.contains("hidden"))&&Q("auth-view")}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{n().catch(console.error)}):setTimeout(()=>{n().catch(console.error)},0)});async function vd(e){if(e&&e.preventDefault&&e.preventDefault(),!!confirm(`ブラウザに保存されているログイン情報（キャッシュ）をクリアして、ページを再読み込みしますか？
（動作がおかしい・ログインできない場合にお試しください）`)){j("キャッシュクリア中...");try{await S.auth.signOut().catch(()=>{});const t=[];for(let n=0;n<localStorage.length;n++){const a=localStorage.key(n);a&&a.startsWith("sb-")&&t.push(a)}t.forEach(n=>localStorage.removeItem(n)),alert("キャッシュをクリアしました。ページを再読み込みします。"),location.reload()}catch{Ue()}}}let Ba=!1;async function zs(e){var r,o;if(e&&e.preventDefault&&e.preventDefault(),Ba)return;const t=((r=document.getElementById("email-address"))==null?void 0:r.value)||"",n=ya(t),a=((o=document.getElementById("password"))==null?void 0:o.value)||"",s=document.getElementById("auth-message");if(s&&s.classList.add("hidden"),!(!n||!a)){Ba=!0,j("ログイン認証中...");try{const{error:i}=await S.auth.signInWithPassword({email:n,password:a});i&&(s?(s.textContent="ログイン失敗: "+i.message,s.classList.remove("hidden"),s.classList.add("text-red-500")):alert("ログイン失敗: "+i.message))}catch(i){console.error("Login Error:",i);const d=i.message+`
...
`+d)}finally{q(),Ba=!1}}}async function Tr(){Q("app-view","users"),await Cn()}function hs(){const e=document.getElementById("change-password-modal");e&&(document.body.appendChild(e),e.classList.remove("hidden"),e.style.zIndex="9999")}let Ta=!1;async function wd(e){var i,d,l,c;if(e&&e.preventDefault&&e.preventDefault(),Ta)return;const t=((i=document.getElementById("signup-parent-name"))==null?void 0:i.value)||"",n=((d=document.getElementById("signup-player-name"))==null?void 0:d.value)||"",a=((l=document.getElementById("signup-email"))==null?void 0:l.value)||"";let s=((c=document.getElementById("signup-password"))==null?void 0:c.value)||"";const r=document.getElementById("signup-message");r&&r.classList.add("hidden");const o=document.getElementById("signup-password")!==null;if(o||(s=Math.random().toString(36).slice(-10)+"A1!"),!t||!n||!a||o&&s.length<6){r&&(r.textContent=o?"すべての項目を正しく入力してください(パスワードは6文字以上)":"すべての項目を正しく入力してください"),r&&r.classList.remove("hidden","text-green-600"),r&&r.classList.add("text-red-500");return}Ta=!0,j("利用申請を送信中...");try{const{data:u,error:m}=await S.auth.signUp({email:a,password:s});if(m){r&&(r.textContent="登録エラー: "+m.message),r&&r.classList.remove("hidden","text-green-600"),r&&r.classList.add("text-red-500");return}const{error:f}=await S.from("signup_requests").insert([{parent_name:t,player_name:n,email:a,status:"pending"}]);await S.auth.signOut(),f?(r&&(r.textContent="申請失敗: "+f.message),r&&r.classList.remove("hidden","text-green-600"),r&&r.classList.add("text-red-500")):(r&&(r.textContent=o?"アカウントが作成され、利用申請が送信されました。管理者の承認をお待ちください。":"利用申請が送信されました。管理者の承認後、「パスワードを忘れた場合」からパスワードを再設定してログインしてください。"),r&&r.classList.remove("text-red-500"),r&&r.classList.add("text-green-600"),r&&r.classList.remove("hidden"),document.getElementById("signup-parent-name")&&(document.getElementById("signup-parent-name").value=""),document.getElementById("signup-player-name")&&(document.getElementById("signup-player-name").value=""),document.getElementById("signup-email")&&(document.getElementById("signup-email").value=""),document.getElementById("signup-password")&&(document.getElementById("signup-password").value=""))}catch(u){Ue(),console.error("Signup Error:",u),r&&(r.textContent="登録処理中にエラーが発生しました。",r.classList.remove("hidden","text-green-600"),r.classList.add("text-red-500"))}finally{q(),Ta=!1}}async function Ed(e){var a;e&&e.preventDefault&&e.preventDefault();const t=((a=document.getElementById("reset-email"))==null?void 0:a.value)||"",n=document.getElementById("reset-message");if(n&&n.classList.add("hidden"),!!t){j("パスワード再設定メール送信中...");try{const{error:s}=await S.auth.resetPasswordForEmail(t,{redirectTo:window.location.origin});s?n?(n.textContent="送信失敗: "+s.message,n.classList.remove("hidden","text-green-600"),n.classList.add("text-red-500")):alert("送信失敗: "+s.message):n?(n.textContent="パスワード再設定メールを送信しました。",n.classList.remove("text-red-500"),n.classList.add("text-green-600"),n.classList.remove("hidden")):alert("パスワード再設定メールを送信しました。")}catch(s){console.error("Password reset error:",s)}finally{q()}}}async function _d(e){var a;e&&e.preventDefault&&e.preventDefault();const t=((a=document.getElementById("new-password"))==null?void 0:a.value)||"",n=document.getElementById("update-password-message");if(n&&n.classList.add("hidden"),!t||t.length<6){n?(n.textContent="6文字以上のパスワードを入力してください",n.classList.remove("hidden","text-green-600"),n.classList.add("text-red-500")):alert("6文字以上のパスワードを入力してください");return}j("パスワード更新中...");try{const{error:s}=await S.auth.updateUser({password:t});s?n?(n.textContent="更新失敗: "+s.message,n.classList.remove("hidden","text-green-600"),n.classList.add("text-red-500")):alert("更新失敗: "+s.message):(alert("パスワードが更新されました。再度ログインしてください。"),Q("auth-view"))}catch(s){console.error("Password update error:",s)}finally{q()}}async function Id(e){var n;e&&e.preventDefault&&e.preventDefault();const t=((n=document.getElementById("change-new-password"))==null?void 0:n.value)||"";if(!t||t.length<6)return alert("6文字以上のパスワードを入力してください");j("パスワード変更中...");try{const{error:a}=await S.auth.updateUser({password:t});if(a)alert("更新失敗: "+a.message);else{alert("パスワードが変更されました。");const s=document.getElementById("change-password-modal");s&&s.classList.add("hidden");const r=document.getElementById("change-new-password");r&&(r.value="")}}catch(a){console.error("Password change error:",a)}finally{q()}}async function Gn(e){e&&e.preventDefault&&e.preventDefault(),F&&await ae("LOGOUT","ログアウトしました"),j("ログアウト処理中...");try{await S.auth.signOut().catch(()=>{})}finally{q(),xn=!1,history.pushState(null,"",window.location.pathname)}}function Qn(e){const t=document.getElementById("nav-dispatch"),n=document.getElementById("nav-master"),a=document.getElementById("nav-users");e==="users"?(t==null||t.classList.add("hidden"),n==null||n.classList.add("hidden"),a==null||a.classList.add("hidden")):(a==null||a.classList.add("hidden"),he==="admin"?(t==null||t.classList.remove("hidden"),n==null||n.classList.remove("hidden")):he==="leader"?(t==null||t.classList.remove("hidden"),n==null||n.classList.add("hidden")):(t==null||t.classList.add("hidden"),n==null||n.classList.add("hidden")))}let ie=[],le=[],He=[],Bn=new Set;async function es(){var e,t,n;xn=!0,Qn("dispatch"),Le==null||Le.addEventListener("click",async()=>{var a,s;ln==null||ln.classList.remove("hidden"),cn==null||cn.classList.add("hidden"),(a=document.getElementById("view-users"))==null||a.classList.add("hidden"),Qn("dispatch"),Le==null||Le.classList.add("text-blue-300"),Le==null||Le.classList.remove("text-gray-400"),Se==null||Se.classList.remove("text-blue-300"),Se==null||Se.classList.add("text-gray-400"),(s=document.getElementById("nav-users"))==null||s.classList.remove("text-blue-300"),da("app-view","dispatch"),await Ys()}),Se==null||Se.addEventListener("click",async()=>{var a,s;cn==null||cn.classList.remove("hidden"),ln==null||ln.classList.add("hidden"),(a=document.getElementById("view-users"))==null||a.classList.add("hidden"),Qn("master"),Se==null||Se.classList.add("text-blue-300"),Se==null||Se.classList.remove("text-gray-400"),Le==null||Le.classList.remove("text-blue-300"),Le==null||Le.classList.add("text-gray-400"),(s=document.getElementById("nav-users"))==null||s.classList.remove("text-blue-300"),da("app-view","master"),await Bd(),Dn()}),(e=document.getElementById("btn-goto-master"))==null||e.addEventListener("click",()=>{Se==null||Se.click()}),(t=document.getElementById("btn-back-to-dispatch"))==null||t.addEventListener("click",()=>{Le==null||Le.click()});try{await Y.initMasterData(),ie.length===0&&le.length===0&&(await Y.bulkAddFamilies(Ld),await Y.bulkAddCars(Sd),await Y.syncMaster(),await Y.initMasterData()),await Ys(),Ad(),Zd(),(n=document.getElementById("btn-load-logs"))==null||n.addEventListener("click",Dn)}catch(a){console.error(a),We("データの読み込みに失敗しました。","error")}}async function Cn(){he==="admin"&&(document.getElementById("view-users").classList.remove("hidden"),document.getElementById("view-master").classList.add("hidden"),document.getElementById("view-dispatch").classList.add("hidden"),Qn("users"),document.getElementById("nav-users").classList.add("text-blue-300"),document.getElementById("nav-users").classList.remove("text-gray-400"),document.getElementById("nav-dispatch").classList.remove("text-blue-300"),document.getElementById("nav-master").classList.remove("text-blue-300"),da("app-view","users"),await oe())}async function oe(){j("メンバー・マスタ情報読み込み中...");try{const{data:e}=await S.from("app_users").select("*").order("created_at",{ascending:!1});let t=[],n=[],a=[],s=[],r=[];try{const{data:p}=await S.from("groups").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});p&&(t=p);const{data:v}=await S.from("user_groups").select("*");v&&(n=v);const{data:x}=await S.from("event_categories").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});x&&(a=x);const{data:h}=await S.from("user_attributes").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});h&&(s=h);try{const{data:L}=await S.from("event_locations").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!0});L&&(r=L)}catch(L){console.warn("event_locations table not created yet:",L)}const{data:k}=await S.from("master_data").select("*").eq("key","ATTENDANCE_DELEGATIONS").single();k&&k.data?window.adminDelegations=k.data:window.adminDelegations={}}catch(p){console.error("Groups DB Error:",p)}const o=localStorage.getItem("admin_users_sort")||"created_desc",i=document.getElementById("admin-users-sort");if(i&&(i.value=o),e&&e.length>0){const p=new Map(t.map(h=>[h.id,h.name])),v=new Map(s.map(h=>[h.id,h.name])),x=new Map(n.map(h=>[h.user_email,h.group_id]));if(o==="manual"){let h=[];try{const k=localStorage.getItem("admin_users_manual_order");k&&(h=JSON.parse(k))}catch(k){console.error("Failed to parse manual user order:",k)}e.sort((k,L)=>{let w=h.indexOf(k.email),I=h.indexOf(L.email);return w===-1&&(w=999999),I===-1&&(I=999999),w!==I?w-I:new Date(L.created_at||0)-new Date(k.created_at||0)})}else if(o==="created_desc")e.sort((h,k)=>new Date(k.created_at||0)-new Date(h.created_at||0));else if(o==="created_asc")e.sort((h,k)=>new Date(h.created_at||0)-new Date(k.created_at||0));else if(o==="name_asc")e.sort((h,k)=>(h.name||"").localeCompare(k.name||"","ja"));else if(o==="name_desc")e.sort((h,k)=>(k.name||"").localeCompare(h.name||"","ja"));else if(o==="email_asc")e.sort((h,k)=>(h.email||"").localeCompare(k.email||"","en"));else if(o==="email_desc")e.sort((h,k)=>(k.email||"").localeCompare(h.email||"","en"));else if(o==="role_desc"){const h={admin:3,leader:2,user:1};e.sort((k,L)=>{const w=h[k.role]||0,I=h[L.role]||0;return w!==I?I-w:new Date(L.created_at||0)-new Date(k.created_at||0)})}else o==="group_asc"?e.sort((h,k)=>{const L=p.get(x.get(h.email))||"",w=p.get(x.get(k.email))||"";return!L&&w?1:L&&!w?-1:L.localeCompare(w,"ja")}):o==="attribute_asc"&&e.sort((h,k)=>{const L=v.get(h.attribute_id)||"",w=v.get(k.attribute_id)||"";return!L&&w?1:L&&!w?-1:L.localeCompare(w,"ja")})}const d=document.getElementById("allowed-users-list");let l=`
        ...
        `;const f=(e||[]).map((p,v)=>{var $;const x=p.email.endsWith("@local.dummy"),h=(($=n.find(_=>_.user_email===p.email))==null?void 0:$.group_id)||"",k=t.map(_=>`<option value="${_.id}" ${h===_.id?"selected":""}>${_.name}</option>`).join(""),L=`
            ...
            <div class="user-admin-card flex items-stretch p-3 bg-white border rounded shadow-sm mb-2 hover:bg-gray-50 transition" data-email="${p.email}" data-index="${v}" data-old-role="${p.role}">
                ...
                <div class="flex-grow flex flex-col">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-gray-100 pb-2 mb-2">
                        ...
                        <input type="text" id="edit-email-${v}" value="${an(p.email)}" class="border p-1 rounded text-sm w-48 font-bold" ${p.email===F.email||x?"disabled":""}>
                        ...
                        <select id="edit-role-${v}" class="border p-1 rounded text-sm" ${p.email===F.email?"disabled":""}>
                    ...
                    <div class="flex items-center space-x-2 shrink-0">
                        ...
                        ${p.email!==F.email?`<button onclick="deleteAdminUser('${p.email}')" class="text-xs bg-red-500 hover:bg-red-600 text-white px-2 py-1 rounded shadow">削除</button>`:""}
                    </div>
                </div>
            ...
            `}).join("");d.innerHTML=f,kd(),d.querySelectorAll(".edit-manage-info-chk").forEach(p=>{p.addEventListener("change",v=>{if(v.target.checked){const x=v.target.getAttribute("data-index"),h=document.getElementById(`edit-use-info-${x}`);h&&(h.checked=!0)}})});const b=document.getElementById("admin-master-list");b&&(b.innerHTML=l+c+u+m,Wn("admin-attribute-list","user_attributes",oe),Wn("admin-category-list","event_categories",oe),Wn("admin-group-list","groups",oe),Wn("admin-location-list","event_locations",oe));const{data:y}=await S.from("signup_requests").select("*").eq("status","pending").order("created_at",{ascending:!1}),g=document.getElementById("signup-requests-list");!y||y.length===0?g.innerHTML='<p class="text-gray-500 text-sm">現在、承認待ちの申請はありません。</p>':g.innerHTML=y.map(p=>`
...
（※ログインはできず、他のメンバーからの代行入力専用アカウントとなります）`);if(!e||e.trim()==="")return;const t=`dummy_${Date.now()}@local.dummy`;j("代行専用メンバー追加処理中...");try{await S.from("app_users").insert([{email:t,name:e.trim(),role:"user"}]),await ae("ADD_DUMMY_USER",`代行専用メンバー「${e.trim()}」を追加しました`),await oe()}catch(n){console.error(n),alert("追加エラー: "+(n.message==="Load failed"||n.message==="Failed to fetch"?"通信に失敗しました。":n.message))}finally{q()}};window.deleteAdminUser=async function(e){if(confirm(`${e} のアクセス許可を取り消しますか？`)){j("ユーザー削除処理中...");try{await S.from("app_users").delete().eq("email",e),await ae("DELETE_USER",`ユーザー「${e}」を削除しました`),await oe()}catch(t){console.error(t),alert("削除エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}}};window.saveNewCategoryAdmin=async function(){var n;const e=document.getElementById("admin-new-category-name").value.trim(),t=((n=document.getElementById("admin-new-category-color"))==null?void 0:n.value)||"#bfdbfe";if(!e)return alert("カテゴリ名を入力してください");j("カテゴリ追加中...");try{const{error:a}=await S.from("event_categories").insert([{name:e,color:t}]);if(a)throw a;await oe()}catch(a){alert("追加エラー: "+(a.message==="Load failed"||a.message==="Failed to fetch"?"通信に失敗しました。":a.message))}finally{q()}};window.deleteCategoryAdmin=async function(e){if(confirm(`このカテゴリを削除しますか？
※既存のイベントに設定されているカテゴリ名には影響しませんが、新規作成・編集時に選択できなくなります。`)){j("カテゴリ削除中...");try{const{error:t}=await S.from("event_categories").delete().eq("id",e);if(t)throw t;await oe()}catch(t){alert("削除エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}}};window.renameCategoryAdmin=async function(e,t){const n=prompt("新しいカテゴリ名を入力してください:",t);if(!(!n||n.trim()===""||n===t)){j("カテゴリ名称変更中...");try{const{error:a}=await S.from("event_categories").update({name:n.trim()}).eq("id",e);if(a)throw a;await oe()}catch(a){alert("変更エラー: "+(a.message==="Load failed"||a.message==="Failed to fetch"?"通信に失敗しました。":a.message))}finally{q()}}};window.updateCategoryColorAdmin=async function(e,t){j("カテゴリ色変更中...");try{const{error:n}=await S.from("event_categories").update({color:t}).eq("id",e);if(n)throw n;await oe()}catch(n){alert("変更エラー: "+(n.message==="Load failed"||n.message==="Failed to fetch"?"通信に失敗しました。":n.message))}finally{q()}};window.updateGroupColorAdmin=async function(e,t){j("グループ色変更中...");try{const{error:n}=await S.from("groups").update({color:t}).eq("id",e);if(n)throw n;await oe()}catch(n){alert("色変更エラー: "+(n.message==="Load failed"||n.message==="Failed to fetch"?"通信に失敗しました。":n.message))}finally{q()}};window.saveNewGroupAdmin=async function(){var n;const e=document.getElementById("admin-new-group-name").value.trim(),t=((n=document.getElementById("admin-new-group-color"))==null?void 0:n.value)||"#d1fae5";if(!e)return alert("グループ名を入力してください");j("グループ追加中...");try{const{error:a}=await S.from("groups").insert([{name:e,color:t}]);if(a)throw a;await oe()}catch(a){alert("追加エラー: "+(a.message==="Load failed"||a.message==="Failed to fetch"?"通信に失敗しました。":a.message))}finally{q()}};window.deleteGroupAdmin=async function(e){if(confirm(`このグループを削除しますか？
※関連する出欠データやメンバー設定にも影響が出る可能性があります。`)){j("グループ削除中...");try{const{error:t}=await S.from("groups").delete().eq("id",e);if(t)throw t;await oe()}catch(t){alert("削除エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}}};window.renameGroupAdmin=async function(e,t){const n=prompt("新しいグループ名を入力してください:",t);if(!(!n||n.trim()===""||n===t)){j("グループ名称変更中...");try{const{error:a}=await S.from("groups").update({name:n.trim()}).eq("id",e);if(a)throw a;await oe()}catch(a){alert("変更エラー: "+(a.message==="Load failed"||a.message==="Failed to fetch"?"通信に失敗しました。":a.message))}finally{q()}}};window.saveNewLocationAdmin=async function(){const e=document.getElementById("admin-new-location-name").value.trim(),t=document.getElementById("admin-new-location-url").value.trim();if(!e)return alert("場所名を入力してください");j("場所追加中...");try{const{error:n}=await S.from("event_locations").insert([{name:e,url:t||null}]);if(n)throw n;await oe()}catch(n){alert("追加エラー: "+(n.message==="Load failed"||n.message==="Failed to fetch"?"通信に失敗しました。":n.message))}finally{q()}};window.deleteLocationAdmin=async function(e){if(confirm(`この場所をマスタから削除しますか？
※既存の予定データ内の場所テキスト自体は削除されません。`)){j("場所削除中...");try{const{error:t}=await S.from("event_locations").delete().eq("id",e);if(t)throw t;await oe()}catch(t){alert("削除エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}}};window.renameLocationAdmin=async function(e){j("場所データ読み込み中...");try{const{data:t,error:n}=await S.from("event_locations").select("*").eq("id",e).single();if(n)throw n;const a=document.getElementById("admin-edit-location-modal");a&&a.remove();const s=t.name||"",r=t.url||"",o=`
        ...
        `;document.body.insertAdjacentHTML("beforeend",o)}catch(t){alert("読み込みエラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}};window.saveLocationEditAdmin=async function(e){const t=document.getElementById("edit-location-name").value.trim(),n=document.getElementById("edit-location-url").value.trim();if(t==="")return alert("場所の名前は必須項目です。");j("場所マスタ更新中...");try{const{error:a}=await S.from("event_locations").update({name:t,url:n||null}).eq("id",e);if(a)throw a;const s=document.getElementById("admin-edit-location-modal");s&&s.remove(),await oe()}catch(a){alert("更新エラー: "+(a.message==="Load failed"||a.message==="Failed to fetch"?"通信に失敗しました。":a.message))}finally{q()}};function Wn(e,t,n){const a=document.getElementById(e);if(!a)return;let s=null;Array.from(a.children).forEach(r=>{r.setAttribute("draggable","true"),r.classList.add("cursor-move","select-none"),r.addEventListener("dragstart",o=>{s=r,o.dataTransfer.effectAllowed="move",r.classList.add("opacity-50")}),r.addEventListener("dragover",o=>{o.preventDefault(),o.dataTransfer.dropEffect="move";const i=o.target.closest('[draggable="true"]');if(i&&i!==s&&i.parentNode===a){const d=i.getBoundingClientRect(),l=(o.clientY-d.top)/(d.bottom-d.top)>.5;a.insertBefore(s,l?i.nextSibling:i)}}),r.addEventListener("dragend",async()=>{r.classList.remove("opacity-50"),s=null;const i=Array.from(a.children).map((d,l)=>{const c=d.dataset.id;return S.from(t).update({sort_order:l}).eq("id",c)});j("順序を保存中...");try{await Promise.all(i),n&&await n()}catch(d){console.error("Sort order save error:",d),alert("順序の保存に失敗しました。")}finally{q()}})})}function kd(){const e=document.getElementById("allowed-users-list");if(!e)return;if((localStorage.getItem("admin_users_sort")||"created_desc")!=="manual"){Array.from(e.children).forEach(a=>{a.removeAttribute("draggable"),a.classList.remove("cursor-move","select-none");const s=a.querySelector(".user-drag-handle");s&&(s.style.display="none")});return}let n=null;Array.from(e.children).forEach(a=>{const s=a.querySelector(".user-drag-handle");s?(s.style.display="flex",s.addEventListener("mousedown",()=>{a.setAttribute("draggable","true")}),s.addEventListener("mouseup",()=>{a.removeAttribute("draggable")})):a.setAttribute("draggable","true"),a.addEventListener("dragstart",r=>{if(a.getAttribute("draggable")!=="true"){r.preventDefault();return}n=a,r.dataTransfer.effectAllowed="move",a.classList.add("opacity-50")}),a.addEventListener("dragover",r=>{r.preventDefault(),r.dataTransfer.dropEffect="move";const o=r.target.closest(".user-admin-card");if(o&&o!==n&&o.parentNode===e){const i=o.getBoundingClientRect(),d=(r.clientY-i.top)/(i.bottom-i.top)>.5;e.insertBefore(n,d?o.nextSibling:o)}}),a.addEventListener("dragend",()=>{a.classList.remove("opacity-50"),a.removeAttribute("draggable"),n=null;const o=Array.from(e.children).map(i=>i.getAttribute("data-email")).filter(Boolean);localStorage.setItem("admin_users_manual_order",JSON.stringify(o))})})}window.saveNewUserAttributeAdmin=async function(){const e=document.getElementById("admin-new-attribute-name").value.trim();if(!e)return alert("属性名を入力してください");j("属性追加中...");try{const{error:t}=await S.from("user_attributes").insert([{name:e}]);if(t)throw t;await oe()}catch(t){alert("追加エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}};window.deleteUserAttributeAdmin=async function(e){if(confirm(`この属性を削除しますか？
※ユーザーに設定されている属性は解除されます。`)){j("属性削除中...");try{const{error:t}=await S.from("user_attributes").delete().eq("id",e);if(t)throw t;await oe()}catch(t){alert("削除エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}}};window.renameUserAttributeAdmin=async function(e,t){const n=prompt("新しい属性名を入力してください:",t);if(!(!n||n.trim()===""||n===t)){j("属性名称変更中...");try{const{error:a}=await S.from("user_attributes").update({name:n.trim()}).eq("id",e);if(a)throw a;await oe()}catch(a){alert("変更エラー: "+(a.message==="Load failed"||a.message==="Failed to fetch"?"通信に失敗しました。":a.message))}finally{q()}}};window.approveRequest=async function(e,t){j("申請承認中...");try{const{data:n}=await S.from("signup_requests").select("parent_name, player_name").eq("id",e).single(),a=n?`${n.parent_name} (${n.player_name})`:"";await S.from("app_users").insert([{email:t,role:"user",name:a}]),await S.from("signup_requests").update({status:"approved"}).eq("id",e);try{const{error:s}=await S.auth.resetPasswordForEmail(t,{redirectTo:window.location.origin});s&&(console.warn("Auto password reset email failed (rate limit):",s.message),alert(`メンバー承認は完了しました！

※ただし、Supabaseのメール送信制限（レートリミット等）により、パスワード設定案内メールの自動送信に失敗しました（エラー: `+s.message+`）。

お手数ですが、ログイン画面の『パスワードを忘れた場合』からユーザー自身で再設定を行っていただくよう案内するか、時間をおいてメンバーリストの『PWリセット送信』から再送信してください。`))}catch(s){console.error("Auto password reset email exception:",s)}await oe()}catch(n){console.error(n),alert("承認エラー: "+(n.message==="Load failed"||n.message==="Failed to fetch"?"通信に失敗しました。":n.message))}finally{q()}};window.rejectRequest=async function(e){if(confirm("この申請を拒否しますか？")){j("申請拒否中...");try{await S.from("signup_requests").update({status:"rejected"}).eq("id",e),await oe()}catch(t){console.error(t),alert("拒否エラー: "+(t.message==="Load failed"||t.message==="Failed to fetch"?"通信に失敗しました。":t.message))}finally{q()}}};const Y={initMasterData:async()=>ve(async()=>{const{data:e,error:t}=await S.from("master_data").select("*");if(t)throw t;if(ie=[],le=[],e){const n=e.find(s=>s.key==="FAMILIES"),a=e.find(s=>s.key==="CARS");n&&(ie=n.data||[]),a&&(le=a.data||[])}},"マスターデータ初期化中..."),getAllFamilies:async()=>ie,getFamily:async e=>ie.find(t=>t.familyName===e),addFamily:e=>{ie.push(e)},updateFamily:e=>{const t=ie.findIndex(n=>n.familyName===e.familyName);t>-1&&(ie[t]=e)},deleteFamily:e=>{ie=ie.filter(t=>t.familyName!==e)},bulkAddFamilies:e=>{ie=e},getAllCars:async()=>le,getCar:async e=>le.find(t=>t.id===e),addCar:e=>{le.push(e)},updateCar:e=>{const t=le.findIndex(n=>n.id===e.id);t>-1&&(le[t]=e)},deleteCar:e=>{le=le.filter(t=>t.id!==e)},bulkAddCars:e=>{le=e},syncMaster:async()=>ve(async()=>{const{error:e}=await S.from("master_data").upsert([{key:"FAMILIES",data:ie},{key:"CARS",data:le}]);if(e)throw e;await ae("UPDATE_MASTER","初期データ(または強制)のマスター保存を実行しました")},"マスターデータ同期中..."),saveState:async(e,t)=>ve(async()=>{const n=Date.now().toString(),{error:a}=await S.from("states").insert({id:n,name:t,created_at:Date.now(),state_data:e});if(a)throw a;return await ae("SAVE_DISPATCH",`配車データ「${t}」を保存しました`),!0},"配車状態を保存中..."),getAllSavedStates:async()=>ve(async()=>{const{data:e,error:t}=await S.from("states").select("*").order("created_at",{ascending:!1});if(t)throw t;return e.map(n=>({id:n.id,name:n.name,timestamp:n.created_at,state:n.state_data}))},"配車状態一覧を取得中..."),getState:async e=>ve(async()=>{const{data:t,error:n}=await S.from("states").select("*").eq("id",e).single();if(n)throw n;return t?{id:t.id,name:t.name,timestamp:t.created_at,state:t.state_data}:null},"配車状態を取得中..."),deleteState:async e=>ve(async()=>{const{error:t}=await S.from("states").delete().eq("id",e);if(t)throw t;return await ae("DELETE_DISPATCH",`配車データ(ID:${e})を削除しました`),!0},"配車状態を削除中..."),saveParking:async(e,t)=>ve(async()=>{const n="p"+Date.now()+Math.floor(Math.random()*1e3),{error:a}=await S.from("parkings").insert({id:n,name:t,created_at:Date.now(),parking_data:e});if(a)throw a;return await ae("SAVE_PARKING",`駐車場データ「${t}」を保存しました`),!0},"駐車場データを保存中..."),getAllSavedParking:async()=>ve(async()=>{const{data:e,error:t}=await S.from("parkings").select("*").order("created_at",{ascending:!1});if(t)throw t;return e.map(n=>({id:n.id,name:n.name,timestamp:n.created_at,parking:n.parking_data}))},"駐車場データ一覧を取得中..."),getParking:async e=>ve(async()=>{const{data:t,error:n}=await S.from("parkings").select("*").eq("id",e).single();if(n)throw n;return t?{id:t.id,name:t.name,timestamp:t.created_at,parking:t.parking_data}:null},"駐車場データを取得中..."),updateParking:async e=>ve(async()=>{const{error:t}=await S.from("parkings").update({name:e.name,parking_data:e.parking}).eq("id",e.id);if(t)throw t;return!0},"駐車場データを更新中..."),deleteParking:async e=>ve(async()=>{const{error:t}=await S.from("parkings").delete().eq("id",e);if(t)throw t;return await ae("DELETE_PARKING",`駐車場データ(ID:${e})を削除しました`),!0},"駐車場データを削除中..."),addParkingMaster:(e,t)=>{He.push({id:"p"+Date.now()+Math.floor(Math.random()*1e3),name:t,timestamp:Date.now(),parking:e,isNew:!0})},updateParkingMaster:e=>{const t=He.findIndex(n=>n.id===e.id);t>-1&&(He[t]=e,He[t].isModified=!0)},deleteParkingMaster:e=>{const t=He.find(n=>n.id===e);t&&!t.isNew&&Bn.add(e),He=He.filter(n=>n.id!==e)},syncAllMaster:async()=>ve(async()=>{const{error:e}=await S.from("master_data").upsert([{key:"FAMILIES",data:ie},{key:"CARS",data:le}]);if(e)throw e;for(const t of Bn)await S.from("parkings").delete().eq("id",t);Bn.clear();for(const t of He)if(t.isNew||t.isModified){const{error:n}=await S.from("parkings").upsert({id:t.id,name:t.name,created_at:t.timestamp,parking_data:t.parking});if(n)throw n;t.isNew=!1,t.isModified=!1}await ae("UPDATE_MASTER","マスターデータ(家族・車・駐車場)を一括保存しました")},"マスターデータ一括同期中..."),clearDatabase:async()=>ve(async()=>{ie=[],le=[],await S.from("master_data").delete().neq("key",""),await S.from("states").delete().neq("id",""),await S.from("parkings").delete().neq("id",""),await ae("CLEAR_DB","データベースの全リセットを実行しました")},"データベース初期化中...")},Ld=[{familyName:"山田家",order:1,members:[{id:"p1",name:"太郎",type:"選手",isFlagTarget:!0,data:{grade:"5年",school:"A小",other:"",memo:""}},{id:"p2",name:"山田父",type:"保護者",data:{memo:""}}]},{familyName:"佐藤家",order:2,members:[{id:"p3",name:"次郎",type:"選手",isFlagTarget:!0,data:{grade:"5年",school:"B小",other:"",memo:""}},{id:"p4",name:"佐藤母",type:"保護者",data:{memo:""}}]},{familyName:"スタッフ・個人",order:99,members:[{id:"p99",name:"監督",type:"その他",data:{memo:""}}]}],Sd=[{id:"c1",name:"山田カー",familyName:"山田家",baseCapacity:6,order:1},{id:"c2",name:"佐藤カー",familyName:"佐藤家",baseCapacity:5,order:2}];let Ut=[],la=[],ha=[],Vt=new Set,Gt=new Set,It=new Map,Mt=new Set,tt=new Set,nt=new Map,xe={groundName:"",designated:{name:"",limit:0,memo:""},other:{name:"",memo:""}},Be={date:"",name:"",timeline:"",notes:""},Z=[],ft={car:null,seat:null},Aa=null,Ca=null;const ts=3,Le=document.getElementById("nav-dispatch"),Se=document.getElementById("nav-master"),ln=document.getElementById("view-dispatch"),cn=document.getElementById("view-master"),ze=document.getElementById("participant-list"),Kt=document.getElementById("car-list"),Qt=document.getElementById("exclusion-list"),Da=document.getElementById("results");document.getElementById("text-output");const Xe=document.getElementById("family-list"),yt=document.getElementById("car-list-master"),At=document.getElementById("parking-list-master");function Js(){const e=document.getElementById("results-section"),t=document.getElementById("main-content");t&&(t.style.display="grid",t.style.gap="1.5rem",window.innerWidth>=768?(t.style.gridTemplateColumns=`repeat(${ts}, minmax(0, 1fr))`,e&&(e.style.gridColumn=`span ${ts}`)):(t.style.gridTemplateColumns="repeat(1, minmax(0, 1fr))",e&&(e.style.gridColumn="auto")))}async function Ys(){Ut=await Y.getAllFamilies(),la=await Y.getAllCars(),ha=Ut.flatMap(e=>e.members),Ar(),xa(),va(),Fn(),await xs(),await vs()}async function Bd(){He=await Y.getAllSavedParking()||[],Bn.clear(),Zt(),vn(),Ea()}async function Dn(){const e=document.getElementById("btn-load-logs");if(e&&!document.getElementById("btn-download-logs-csv")){const s=document.createElement("button");s.id="btn-download-logs-csv",s.className="ml-2 bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-sm font-bold shadow",s.textContent="CSVダウンロード",s.onclick=Td,e.parentNode.insertBefore(s,e.nextSibling)}try{const s=new Date;s.setMonth(s.getMonth()-6),await S.from("action_logs").delete().lt("created_at",s.toISOString())}catch(s){console.error("Log rotation error:",s)}e&&(e.textContent="読込中...");const{data:t,error:n}=await S.from("action_logs").select("*").order("created_at",{ascending:!1}).limit(50);if(e&&(e.textContent="最新を読み込み"),n){console.error("Failed to load logs:",n);return}const a=document.getElementById("log-list");if(a){if(!t||t.length===0){a.innerHTML='<p class="text-gray-500 text-center py-4">ログはありません</p>';return}a.innerHTML=t.map(s=>`
        ...
        `).join("")}}async function Td(){j("ログ取得中...");try{const{data:e,error:t}=await S.from("action_logs").select("*").order("created_at",{ascending:!1}).limit(1e4);if(t)throw t;if(!e||e.length===0)return alert("ログデータがありません");const n=[["日時","アクション","ユーザー","詳細"]];e.forEach(i=>{const d=new Date(i.created_at).toLocaleString("ja-JP"),l=c=>`"${String(c||"").replace(/"/g,'""')}"`;n.push([l(d),l(i.action_type),l(i.user_email),l(i.details)])});const a=new Uint8Array([239,187,191]),s=new Blob([a,n.map(i=>i.join(",")).join(`
`)],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(s),o=document.createElement("a");o.href=r,o.download=`action_logs_${new Date().toISOString().split("T")[0]}.csv`,o.click(),URL.revokeObjectURL(r)}catch(e){console.error(e),alert("CSVの作成に失敗しました: "+e.message)}finally{q()}}function Ad(){var e,t,n,a,s,r,o,i,d,l,c,u,m,f,b;ze==null||ze.addEventListener("change",Dd),ze==null||ze.addEventListener("input",Nd),ze==null||ze.addEventListener("click",Cd),Kt==null||Kt.addEventListener("change",Pd),Qt==null||Qt.addEventListener("change",Od),(e=document.getElementById("assign-button"))==null||e.addEventListener("click",Md),(t=document.getElementById("dispatch-message-close"))==null||t.addEventListener("click",ws),Da==null||Da.addEventListener("change",qd),(n=document.getElementById("export-state-button"))==null||n.addEventListener("click",Hd),(a=document.getElementById("import-state-input"))==null||a.addEventListener("change",Ud),(s=document.getElementById("show-text-output-button"))==null||s.addEventListener("click",()=>{var y;(y=document.getElementById("text-output-container"))==null||y.classList.toggle("hidden"),jn()}),(r=document.getElementById("copy-text-output-button"))==null||r.addEventListener("click",Fd),(o=document.getElementById("toggle-details-button"))==null||o.addEventListener("click",jd),(i=document.getElementById("save-state-db-button"))==null||i.addEventListener("click",Vd),(d=document.getElementById("load-state-db-button"))==null||d.addEventListener("click",Gd),(l=document.getElementById("delete-state-db-button"))==null||l.addEventListener("click",Wd),(c=document.getElementById("save-parking-db-button"))==null||c.addEventListener("click",zd),(u=document.getElementById("load-parking-db-button"))==null||u.addEventListener("click",Jd),(m=document.getElementById("delete-parking-db-button"))==null||m.addEventListener("click",Yd),(f=document.getElementById("clear-db-button"))==null||f.addEventListener("click",Kd),(b=document.getElementById("btn-clear-inputs"))==null||b.addEventListener("click",window.clearCurrentInputs)}function Ar(){nt.clear(),Ut.forEach(e=>{e.members.forEach(t=>{const n={grade:"",school:"",other:"",memo:"",...t.data||{}};t.isFlagTarget||(n.grade="",n.school="",n.other=""),nt.set(t.id,n)})})}function xa(){if(ze){if(ze.innerHTML="",Ut.length===0)return ze.innerHTML='<p class="text-gray-500">データなし</p>';Ut.forEach(e=>{const t=document.createElement("details");t.className="bg-gray-50 rounded border",t.open=!0;const n=document.createElement("summary");n.className="p-3 cursor-pointer select-none flex justify-between items-center",n.innerHTML=`<span class="font-semibold">${e.familyName}</span><div class="space-x-1"><button data-family-id="${e.familyName}" data-check-action="check" class="text-xs bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded">全員参加</button><button data-family-id="${e.familyName}" data-check-action="uncheck" class="text-xs bg-gray-400 hover:bg-gray-500 text-white py-1 px-2 rounded">全員不参加</button></div>`;const a=document.createElement("div");a.className="p-3 border-t border-gray-200 space-y-3",e.members.forEach(s=>{const r=Vt.has(s.id),o=nt.get(s.id)||{grade:"",school:"",other:"",memo:""};let i=s.isFlagTarget?`<input type="text" data-id="${s.id}" data-type="grade" value="${o.grade}" placeholder="学年" class="w-full text-sm p-1 border rounded" ${r?"":"disabled"}>
            ...
            </div></div>`})}}function Fn(){if(!Qt)return;Qt.innerHTML="";const e=ha.filter(t=>Vt.has(t.id));if(e.length===0)return Qt.innerHTML='<p class="text-gray-500 text-sm">参加者を選択してください</p>';e.forEach(t=>{Qt.innerHTML+=`<div class="flex items-center"><input type="checkbox" id="ex-${t.id}" data-id="${t.id}" data-action="exclude-participant" class="mr-3" ${tt.has(t.id)?"checked":""}><label for="ex-${t.id}">${t.name} (${t.type})</label></div>`})}function Dd(e){const t=e.target;if(t.dataset.action==="select-participant"){const n=t.dataset.id,a=document.getElementById(`data-inputs-${n}`);t.checked?(Vt.add(n),a&&(a.classList.remove("opacity-50"),a.querySelectorAll("input").forEach(s=>s.disabled=!1))):(Vt.delete(n),tt.delete(n),a&&(a.classList.add("opacity-50"),a.querySelectorAll("input").forEach(s=>s.disabled=!0))),Fn()}}function Nd(e){const t=e.target;if(t.dataset.type){const n=nt.get(t.dataset.id);n[t.dataset.type]=t.value,nt.set(t.dataset.id,n)}}function Pd(e){var a;const t=e.target,n=(a=t.closest("[data-car-id]"))==null?void 0:a.dataset.carId;n&&(t.dataset.action==="select-car"?t.checked?(Gt.add(n),document.getElementById(`car-options-${n}`).classList.remove("hidden")):(Gt.delete(n),Mt.delete(n),document.getElementById(`car-options-${n}`).classList.add("hidden")):t.dataset.action==="select-driver"?t.value?It.set(n,t.value):It.delete(n):t.dataset.action==="select-luggage"&&(t.checked?Mt.add(n):Mt.delete(n)))}function Od(e){const t=e.target;t.dataset.action==="exclude-participant"&&(t.checked?tt.add(t.dataset.id):tt.delete(t.dataset.id))}function Md(){var y,g,p,v,x,h,k,L,w,I;if(Gt.size===0)return We("車を選択してください","error");Be={date:((y=document.getElementById("event-date"))==null?void 0:y.value)||"",name:((g=document.getElementById("event-name"))==null?void 0:g.value)||"",timeline:((p=document.getElementById("event-timeline"))==null?void 0:p.value)||"",notes:((v=document.getElementById("event-notes"))==null?void 0:v.value)||""},xe={groundName:((x=document.getElementById("ground-name"))==null?void 0:x.value)||"",designated:{name:((h=document.getElementById("parking-designated-name"))==null?void 0:h.value)||"指定駐車場",limit:parseInt((k=document.getElementById("parking-designated-limit"))==null?void 0:k.value)||999,memo:((L=document.getElementById("parking-designated-memo"))==null?void 0:L.value)||""},other:{name:((w=document.getElementById("parking-other-name"))==null?void 0:w.value)||"指定以外",memo:((I=document.getElementById("parking-other-memo"))==null?void 0:I.value)||""}};let e=!1;if(Z&&Z.length>0&&Z.some(E=>E.id!=="excluded-car")){if(confirm(`すでに配車結果が存在します。
現在の配車状態を【維持】して、追加・変更分のみを反映しますか？
（「キャンセル」を選ぶと、全てリセットして最初からやり直すか確認します）`))e=!0;else if(!confirm(`現在の状態を【全てリセット】して、最初から割り当てをやり直しますか？
（キャンセルを選ぶと処理を中断します）`))return}let t=[],n=new Map,a=[];const s=ha.filter(E=>Vt.has(E.id)).map(E=>{const $=Ut.find(C=>C.members.some(M=>M.id===E.id)),_=nt.get(E.id)||{};return{...E,grade:_.grade,school:_.school,other:_.other,memo:_.memo,familyName:$?$.familyName:null}});if(Gt.forEach(E=>{const $=It.get(E),_=la.find(N=>N.id===E);if(!_)return;if(!$)return t.push(`${_.name}のドライバー未選択`);const C=s.find(N=>N.id===$);if(!C)return t.push(`${_.name}のドライバーが参加者にいません`);n.set(E,C);const M=Mt.has(E);a.push({id:E,name:_.name,familyName:_.familyName,baseCapacity:M?2:_.baseCapacity,driverId:$,capacity:M?1:_.baseCapacity-1,hasLuggage:M})}),t.length>0)return We(t.join("<br>"),"error");const r=new Set(Array.from(n.values()).map(E=>E.id));let o=s.filter(E=>tt.has(E.id)&&!r.has(E.id)),i=[];e?a.forEach(E=>{let $=Z.find(C=>C.id===E.id),_=[];$&&(_=$.members.filter(C=>{if(!C)return!1;let M=s.some(U=>U.id===C.id),N=tt.has(C.id),P=r.has(C.id);return M&&!N&&!P}),_.length>E.capacity&&(_=_.slice(0,E.capacity))),i.push({...E,driver:n.get(E.id),members:_})}):i=a.map(E=>({...E,driver:n.get(E.id),members:[]}));let d=new Set(r);i.forEach(E=>E.members.forEach($=>{$&&d.add($.id)}));let l=s.filter(E=>!d.has(E.id)&&!tt.has(E.id));i.reduce((E,$)=>E+$.capacity,0),i.reduce((E,$)=>E+$.members.length,0);let c=[...l];const u={保護者:1,兄弟:2,選手:3,その他:4};i.forEach(E=>{E.driver&&E.familyName&&c.filter(_=>_.familyName===E.familyName).sort((_,C)=>(u[_.type]||9)-(u[C.type]||9)).forEach(_=>{E.members.length<E.capacity&&(E.members.push(_),c=c.filter(C=>C.id!==_.id))})}),c.sort((E,$)=>E.isFlagTarget===$.isFlagTarget?Math.random()-.5:E.isFlagTarget?-1:1).forEach(E=>{let $=[],_=0;if(i.forEach(C=>{if(C.members.length>=C.capacity)return;let M=C.members.filter(N=>N).reduce((N,P)=>N+(P.isFlagTarget&&E.isFlagTarget?(E.grade===P.grade?1:0)+(E.school===P.school?1:0):0),0);M>_?(_=M,$=[C]):M===_&&$.push(C)}),$.length>0)$[Math.floor(Math.random()*$.length)].members.push(E);else{let C=i.filter(M=>M.members.length<M.capacity);C.length>0&&C[0].members.push(E)}}),i.forEach(E=>{for(E.members=E.members.filter($=>$);E.members.length<E.capacity;)E.members.push(null)}),e?i.sort((E,$)=>{let _=Z.findIndex(M=>M.id===E.id),C=Z.findIndex(M=>M.id===$.id);return _!==-1&&C!==-1?_-C:_!==-1?-1:C!==-1?1:$.members.filter(M=>M&&M.type==="選手").length-E.members.filter(M=>M&&M.type==="選手").length}):i.sort((E,$)=>$.members.filter(_=>_&&_.type==="選手").length-E.members.filter(_=>_&&_.type==="選手").length);let m=0;i.forEach(E=>{if(e){let $=Z.find(_=>_.id===E.id);$?(E.assignedParking=$.assignedParking,E.assignedParking==="designated"&&m++):m<xe.designated.limit?(E.assignedParking="designated",m++):E.assignedParking="other"}else m<xe.designated.limit?(E.assignedParking="designated",m++):E.assignedParking="other"});const f=new Set(r);i.forEach(E=>{E.members.forEach($=>{$&&f.add($.id)})}),s.filter(E=>!f.has(E.id)&&!tt.has(E.id)).forEach(E=>{o.some($=>$.id===E.id)||o.push(E)}),i.push({id:"excluded-car",name:"別便",capacity:999,baseCapacity:999,driver:null,members:o,hasLuggage:!1,assignedParking:"excluded"}),Z=i,wa(),jn()}function wa(){const e=document.getElementById("results");if(!e)return;if(e.innerHTML="",ft={car:null,seat:null},Z.length===0){e.innerHTML='<p class="text-gray-500 bg-white p-4 rounded shadow">結果なし</p>',Ks();return}(Be.name||Be.date)&&(e.innerHTML+=`<h2 class="text-2xl font-bold mb-2">${Be.date} ${Be.name} ${xe.groundName?`@${xe.groundName}`:""}</h2>`);const t=Z.filter(r=>r.assignedParking==="designated"),n=Z.filter(r=>r.assignedParking==="other"),a=Z.filter(r=>r.id==="excluded-car"),s=(r,o,i)=>`<div class="bg-white rounded shadow p-4"><h3 class="font-bold text-lg mb-2">◆${o.name||"別便"} ${r==="designated"&&o.limit<999?`(${o.limit}台)`:""}</h3><p class="text-sm text-gray-600 mb-4 whitespace-pre-line">${o.memo}</p><div class="grid grid-cols-1 md:grid-cols-3 gap-4">${i.map(Rd).join("")}</div></div>`;e.innerHTML+=s("designated",xe.designated,t),e.innerHTML+=s("other",xe.other,n),a[0].members.length>0&&(e.innerHTML+=s("excluded",{name:"別便",memo:""},a)),Ks()}function Rd(e){var r,o;`${e.id}`;let t="",n="",a="";const s=`swap-car-${e.id}`;if(e.id==="excluded-car"){t=`<div class="p-4 border-b bg-gray-100 flex-shrink-0"><h4 class="font-bold text-lg text-gray-700">合計: ${e.members.length}名</h4></div>`,a=e.members.map((d,l)=>{var f;if(!d)return"";const c=(((f=nt.get(d.id))==null?void 0:f.memo)||"").trim(),u=d.isFlagTarget&&(d.grade||d.school||d.other)?[d.grade,d.school,d.other].filter(Boolean).join(" "):"",m=`seat-${e.id}-${d.id}`;return`<li class="p-2 bg-gray-100 rounded shadow-sm flex items-center justify-between">
            ...
            </div>`;const u=e.driver,m=u?u.id:"empty",f=u?`[D] ${u.name} (${u.type})`:"ドライバー空席",b=u&&(((r=nt.get(u.id))==null?void 0:r.memo)||"").trim(),y=`seat-${e.id}-driver`;n=`
            ...
            <li class="p-2 ${u?"bg-blue-100":"bg-red-50"} rounded shadow-sm flex items-center">
                 ...
                 <label for="${y}" class="flex flex-col min-w-0 ${u?"text-blue-800":"text-red-700"}">
                    ...
                    ${b?`<span class="text-xs ${u?"text-blue-600":"text-red-600"} ml-2 break-words">[${b}]</span>`:""}
        ...
        </div>`;for(let g=0;g<e.capacity;g++){const p=e.members[g];if(p){const v=(((o=nt.get(p.id))==null?void 0:o.memo)||"").trim(),x=p.isFlagTarget&&(p.grade||p.school||p.other)?[p.grade,p.school,p.other].filter(Boolean).join(" "):"",h=`seat-${e.id}-${p.id}`;a+=`<li class="p-2 bg-gray-100 rounded shadow-sm flex items-center justify-between">
                                    <div class="flex items-center min-w-0">
                                ...
                                </li>`}}}return`<div class="bg-white border rounded-lg shadow-md car-dropzone flex flex-col">${t}${n}<ul id="members-dropzone-${e.id}" class="p-4 space-y-2 min-h-[50px] members-dropzone flex-grow overflow-y-auto">${a}</ul></div>`}function qd(e){const t=e.target;if(t.type!=="checkbox"||!t.dataset.swapType)return;const n=t.dataset.swapType;if(ft[n]&&ft[n].el===t){ft[n]=null,t.closest("div").classList.remove("swap-selected");return}const a={carId:t.dataset.carId,pid:t.dataset.participantId,isD:t.dataset.isDriver==="true",idx:parseInt(t.dataset.slotIndex),el:t};if(t.closest("div").classList.add("swap-selected"),n==="car"&&ft.seat||n==="seat"&&ft.car)return t.checked=!1,We("車と席の混在不可","error");if(!ft[n]){ft[n]=a;return}const s=ft[n],r=a;if(n==="car"){const o=Z.find(d=>d.id===s.carId),i=Z.find(d=>d.id===r.carId);if(o&&i)if(o.assignedParking===i.assignedParking){const d=Z.indexOf(o),l=Z.indexOf(i);d>-1&&l>-1&&([Z[d],Z[l]]=[Z[l],Z[d]])}else{const d=o.assignedParking;o.assignedParking=i.assignedParking,i.assignedParking=d}}else{const o=Z.find(c=>c.id===s.carId),i=Z.find(c=>c.id===r.carId),d=s.pid==="empty"?null:s.isD?o.driver:o.members[s.idx],l=r.pid==="empty"?null:r.isD?i.driver:i.members[r.idx];s.isD?o.driver=l:o.id!=="excluded-car"?o.members[s.idx]=l:(o.members=o.members.filter(c=>c&&c.id!==(d==null?void 0:d.id)),l&&o.members.push(l)),r.isD?i.driver=d:i.id!=="excluded-car"?i.members[r.idx]=d:(i.members=i.members.filter(c=>c&&c.id!==(l==null?void 0:l.id)),d&&i.members.push(d)),[o,i].forEach(c=>{if(c.id!=="excluded-car")for(c.members=c.members.filter(u=>u);c.members.length<c.capacity;)c.members.push(null);else c.members=c.members.filter(u=>u)})}wa(),jn()}function jn(){const e=document.getElementById("text-output");if(!e)return;if(Z.length===0){e.value="";return}const t=xe.groundName?`@${xe.groundName}`:"";let n=[`${Be.date} ${Be.name}${t}
`];Be.timeline&&n.push(Be.timeline+`
...
◆別便`),r.members.filter(o=>o).forEach(o=>n.push("・"+(o.type==="選手"?"★":"")+o.name))),Be.notes&&n.push(`
◆その他
`+Be.notes),e.value=n.join(`
`)}function Fd(){const e=document.getElementById("text-output");e&&(navigator.clipboard.writeText(e.value),We("コピーしました","success"))}function jd(){const e=document.getElementById("toggle-details-button"),t=e.textContent==="すべて開く";ze.querySelectorAll("details").forEach(n=>n.open=t),e.textContent=t?"すべて閉じる":"すべて開く"}function Cr(){var e,t,n,a,s,r,o,i,d,l;return Be={date:((e=document.getElementById("event-date"))==null?void 0:e.value)||"",name:((t=document.getElementById("event-name"))==null?void 0:t.value)||"",timeline:((n=document.getElementById("event-timeline"))==null?void 0:n.value)||"",notes:((a=document.getElementById("event-notes"))==null?void 0:a.value)||""},xe={groundName:((s=document.getElementById("ground-name"))==null?void 0:s.value)||"",designated:{name:((r=document.getElementById("parking-designated-name"))==null?void 0:r.value)||"指定駐車場",limit:parseInt((o=document.getElementById("parking-designated-limit"))==null?void 0:o.value)||999,memo:((i=document.getElementById("parking-designated-memo"))==null?void 0:i.value)||""},other:{name:((d=document.getElementById("parking-other-name"))==null?void 0:d.value)||"指定以外",memo:((l=document.getElementById("parking-other-memo"))==null?void 0:l.value)||""}},{selectedParticipantIds:Array.from(Vt),selectedCarIds:Array.from(Gt),selectedDrivers:Array.from(It.entries()),selectedLuggage:Array.from(Mt),excludedParticipantIds:Array.from(tt),participantData:Array.from(nt.entries()),currentAssignments:Z,parkingInfo:xe,eventInfo:Be}}function Dr(e){var t,n,a,s,r;Vt=new Set(e.selectedParticipantIds||[]),Gt=new Set(e.selectedCarIds||[]),It=new Map(e.selectedDrivers||[]),Mt=new Set(e.selectedLuggage||[]),tt=new Set(e.excludedParticipantIds||[]),nt=new Map(e.participantData||[]),xe=e.parkingInfo||{groundName:"",designated:{name:"",limit:0,memo:""},other:{name:"",memo:""}},Be=e.eventInfo||{date:"",name:"",timeline:"",notes:""},document.getElementById("event-date")&&(document.getElementById("event-date").value=Be.date||""),document.getElementById("event-name")&&(document.getElementById("event-name").value=Be.name||""),document.getElementById("event-timeline")&&(document.getElementById("event-timeline").value=Be.timeline||""),document.getElementById("event-notes")&&(document.getElementById("event-notes").value=Be.notes||""),document.getElementById("ground-name")&&(document.getElementById("ground-name").value=xe.groundName||""),document.getElementById("parking-designated-name")&&(document.getElementById("parking-designated-name").value=((t=xe.designated)==null?void 0:t.name)||""),document.getElementById("parking-designated-limit")&&(document.getElementById("parking-designated-limit").value=((n=xe.designated)==null?void 0:n.limit)||""),document.getElementById("parking-designated-memo")&&(document.getElementById("parking-designated-memo").value=((a=xe.designated)==null?void 0:a.memo)||""),document.getElementById("parking-other-name")&&(document.getElementById("parking-other-name").value=((s=xe.other)==null?void 0:s.name)||""),document.getElementById("parking-other-memo")&&(document.getElementById("parking-other-memo").value=((r=xe.other)==null?void 0:r.memo)||""),Z=e.currentAssignments||[],wa(),jn()}function Hd(){const e=new Blob([JSON.stringify(Cr(),null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download="state.json",t.click()}function Ud(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Dr(JSON.parse(a.target.result)),xa(),va(),Fn()},n.readAsText(t)}async function Vd(){const e=document.getElementById("saved-state-select"),t=e.value;let n=`${document.getElementById("event-date").value}_${document.getElementById("event-name").value}`,a=!1,s=null;if(t){const r=e.options[e.selectedIndex];confirm(`現在「${r.text}」が選択されています。
このデータに上書き保存しますか？
（「キャンセル」を選ぶと新規保存になります）`)&&(a=!0,n=r.text,s=t)}if(!a){const r=prompt("保存名",n);if(!r)return;n=r}try{a&&s&&await Y.deleteState(s),await Y.saveState(Cr(),n),await xs();const r=document.getElementById("saved-state-select");for(let o=0;o<r.options.length;o++)if(r.options[o].text===n){r.selectedIndex=o;break}We(a?"上書き保存しました":"保存しました","success")}catch{We("保存に失敗しました","error")}}async function Gd(){const e=document.getElementById("saved-state-select").value;if(!e)return;const t=await Y.getState(e);t&&(Dr(t.state),xa(),va(),Fn(),We("読込完了","success"))}async function Wd(){const e=document.getElementById("saved-state-select").value;e&&(await Y.deleteState(e),await xs(),We("削除完了","success"))}async function xs(){const e=await Y.getAllSavedStates(),t=document.getElementById("saved-state-select");t&&(t.innerHTML='<option value="">作業一覧...</option>'+e.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""))}async function zd(){const e=document.getElementById("saved-parking-select"),t=e.value;let n=document.getElementById("ground-name").value||"新規駐車場",a=!1,s=null;if(t){const o=e.options[e.selectedIndex];confirm(`現在「${o.text}」が選択されています。
このデータに上書き保存しますか？
（「キャンセル」を選ぶと新規保存になります）`)&&(a=!0,n=o.text,s=t)}if(!a){const o=prompt("駐車場保存名",n);if(!o)return;n=o}const r={groundName:document.getElementById("ground-name").value,designated:{name:document.getElementById("parking-designated-name").value,limit:parseInt(document.getElementById("parking-designated-limit").value),memo:document.getElementById("parking-designated-memo").value},other:{name:document.getElementById("parking-other-name").value,memo:document.getElementById("parking-other-memo").value}};try{a&&s&&await Y.deleteParking(s),await Y.saveParking(r,n),await vs();const o=document.getElementById("saved-parking-select");for(let i=0;i<o.options.length;i++)if(o.options[i].text===n){o.selectedIndex=i;break}We(a?"駐車場を上書き保存しました":"駐車場を保存しました","success")}catch{We("保存に失敗しました","error")}}async function Jd(){const e=document.getElementById("saved-parking-select").value;if(!e)return;const t=await Y.getParking(e);t&&(document.getElementById("ground-name").value=t.parking.groundName,document.getElementById("parking-designated-name").value=t.parking.designated.name,document.getElementById("parking-designated-limit").value=t.parking.designated.limit,document.getElementById("parking-designated-memo").value=t.parking.designated.memo,document.getElementById("parking-other-name").value=t.parking.other.name,document.getElementById("parking-other-memo").value=t.parking.other.memo,We("駐車場読込完了","success"))}async function Yd(){const e=document.getElementById("saved-parking-select").value;e&&(await Y.deleteParking(e),await vs(),We("駐車場削除完了","success"))}async function vs(){const e=await Y.getAllSavedParking(),t=document.getElementById("saved-parking-select");t&&(t.innerHTML='<option value="">駐車場一覧...</option>'+e.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""))}async function Kd(){confirm("全データをリセットしますか？")&&(await Y.clearDatabase(),location.reload())}window.clearCurrentInputs=function(){if(!confirm(`現在の入力内容（イベント情報、選択メンバー、車、駐車場、配車結果など）をすべてクリアして、初期状態に戻しますか？
（※データベースに保存されているマスタデータや過去の保存データは削除されません）`))return;const e=document.getElementById("event-date");e&&(e.value="");const t=document.getElementById("event-name");t&&(t.value="");const n=document.getElementById("event-timeline");n&&(n.value="");const a=document.getElementById("event-remarks");a&&(a.value="");const s=document.getElementById("ground-name");s&&(s.value="");const r=document.getElementById("parking-name");r&&(r.value="");const o=document.getElementById("parking-limit");o&&(o.value="99");const i=document.getElementById("parking-remarks");i&&(i.value="");const d=document.getElementById("other-parking-name");d&&(d.value="");const l=document.getElementById("other-parking-remarks");l&&(l.value=""),Vt.clear(),Gt.clear(),It.clear(),Mt.clear(),tt.clear(),nt.clear(),Ar(),Z=[],xa(),va(),Fn(),wa(),jn(),window.att_swapSelectedMember=null,window.att_swapSelectedCar=null,We("画面の入力をクリアしました。","success")};function We(e,t="info"){const n=document.getElementById("dispatch-message");let a="bg-blue-100 text-blue-700 border-blue-200";t==="error"?a="bg-red-100 text-red-700 border-red-200":t==="success"?a="bg-green-100 text-green-700 border-green-200":t==="warning"&&(a="bg-yellow-100 text-yellow-800 border-yellow-200"),n.className=`p-4 h-full border rounded-lg ${a}`,document.getElementById("dispatch-message-text").innerHTML=e,n.classList.remove("hidden"),Aa&&clearTimeout(Aa),t!=="warning"&&(Aa=setTimeout(ws,5e3))}function ws(){document.getElementById("dispatch-message").classList.add("hidden")}function Qd(){if(!Z||Z.length===0)return!1;for(const t of Z){if(t.id==="excluded-car")continue;if((t.driver?1:0)+t.members.filter(a=>a!==null).length>t.baseCapacity)return!0}const e=Z.find(t=>t.id==="excluded-car");return e?e.members.some(t=>t&&!tt.has(t.id)):!1}function Ks(){if(Qd())We("定員オーバーです。車の台数が足りないか、定員を超過している車があります。","warning");else{const e=document.getElementById("dispatch-message"),t=document.getElementById("dispatch-message-text");e&&!e.classList.contains("hidden")&&t&&t.innerHTML.includes("定員オーバー")&&ws()}}function Zd(){var t,n,a,s,r,o,i;const e=document.querySelector("#view-master h2");if(e&&!document.getElementById("btn-back-to-dispatch-master")){const d=document.createElement("button");d.id="btn-back-to-dispatch-master",d.className="bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-100 px-4 py-2 rounded shadow font-bold text-sm mb-4 flex items-center w-fit",d.innerHTML='<span class="mr-1">◀</span> 配車調整に戻る',d.addEventListener("click",()=>{var l;return(l=document.getElementById("nav-dispatch"))==null?void 0:l.click()}),e.parentElement.insertBefore(d,e)}(t=document.getElementById("add-family-button"))==null||t.addEventListener("click",el),Xe==null||Xe.addEventListener("click",tl),Xe==null||Xe.addEventListener("input",al),Xe==null||Xe.addEventListener("change",nl),(n=document.getElementById("add-car-button"))==null||n.addEventListener("click",sl),yt==null||yt.addEventListener("click",rl),yt==null||yt.addEventListener("input",ol),(a=document.getElementById("add-parking-button-master"))==null||a.addEventListener("click",il),At==null||At.addEventListener("click",dl),At==null||At.addEventListener("input",ll),(s=document.getElementById("export-master-button"))==null||s.addEventListener("click",cl),(r=document.getElementById("import-master-input"))==null||r.addEventListener("change",ul),(o=document.getElementById("master-message-close"))==null||o.addEventListener("click",Nr),(i=document.getElementById("save-master-db-button"))==null||i.addEventListener("click",Xd)}async function Xd(){const e=document.getElementById("save-master-db-button");try{e.textContent="保存中...",await Y.syncAllMaster(),ns("マスターデータをサーバーに保存しました","success"),He=await Y.getAllSavedParking()||[],Dn()}catch(t){ns("保存に失敗しました: "+t.message,"error")}finally{e.textContent="マスターデータを保存 (更新)"}}function Zt(){Xe&&(Xe.innerHTML="",ie.sort((e,t)=>(e.order??99)-(t.order??99)).forEach((e,t)=>{const n=e.members.map(a=>`<div class="p-2 border rounded bg-gray-50 member-grid"><input data-id="${a.id}" data-f="name" value="${a.name}" class="col-span-3 md:col-span-1 p-1 border"><select data-id="${a.id}" data-f="type" class="col-span-2 md:col-span-1 p-1 border"><option ${a.type==="選手"?"selected":""}>選手</option><option ${a.type==="保護者"?"selected":""}>保護者</option><option ${a.type==="兄弟"?"selected":""}>兄弟</option><option ${a.type==="その他"?"selected":""}>その他</option></select><input data-id="${a.id}" data-f="data.grade" value="${a.data.grade||""}" placeholder="学年" class="col-span-1 border"><input data-id="${a.id}" data-f="data.school" value="${a.data.school||""}" placeholder="学校" class="col-span-2 md:col-span-1 border"><input data-id="${a.id}" data-f="data.other" value="${a.data.other||""}" placeholder="他" class="col-span-2 md:col-span-1 border"><input data-id="${a.id}" data-f="data.memo" value="${a.data.memo||""}" placeholder="備考" class="col-span-2 md:col-span-1 border"><div class="col-span-3 md:col-span-1 flex items-center justify-between"><label class="text-xs"><input type="checkbox" data-id="${a.id}" data-f="isFlagTarget" ${a.isFlagTarget?"checked":""}>同乗優先</label><button data-action="del-m" data-id="${a.id}" class="bg-red-500 text-white px-2 py-1 rounded text-xs">削</button></div></div>`).join("");Xe.innerHTML+=`<div class="bg-white border rounded shadow" data-fname="${e.familyName}"><div class="family-header"><input data-action="ren-f" value="${e.familyName}" class="font-bold border p-1"><div class="space-x-2"><button data-action="up" class="bg-gray-400 text-white px-2 rounded text-xs">▲</button><button data-action="down" class="bg-gray-400 text-white px-2 rounded text-xs">▼</button><button data-action="del-f" class="bg-red-500 text-white px-2 py-1 rounded text-xs">家族削除</button></div></div><div class="p-3 space-y-2">${n}</div><button data-action="add-m" class="ml-3 mb-3 bg-blue-500 text-white px-2 py-1 rounded text-xs">＋メンバー</button></div>`}))}function el(){const e=prompt("家族名");e&&(Y.addFamily({familyName:e,order:99,members:[{id:"p"+Date.now(),name:"新規",type:"選手",isFlagTarget:!0,data:{}}]}),Zt())}async function tl(e){const t=e.target,n=t.dataset.action,a=t.closest("[data-fname]");if(!a)return;const s=a.dataset.fname;if(n==="del-f"&&confirm("削除?")&&(Y.deleteFamily(s),Zt()),n==="add-m"){const r=await Y.getFamily(s);r.members.push({id:"p"+Date.now(),name:"新規",type:"保護者",isFlagTarget:!1,data:{}}),Y.updateFamily(r),Zt()}if(n==="del-m"){const r=await Y.getFamily(s);r.members=r.members.filter(o=>o.id!==t.dataset.id),Y.updateFamily(r),Zt()}if(n==="up"||n==="down"){ie.sort((i,d)=>(i.order??99)-(d.order??99)),ie.forEach((i,d)=>{i.order=d});const r=ie.findIndex(i=>i.familyName===s),o=n==="up"?r-1:r+1;if(o>=0&&o<ie.length){const i=ie[r].order;ie[r].order=ie[o].order,ie[o].order=i,Zt()}}}function nl(e){const t=e.target,n=t.closest("[data-fname]");if(!n)return;const a=n.dataset.fname;if(t.dataset.action==="ren-f"){const s=t.value.trim();if(s&&s!==a){if(ie.find(i=>i.familyName===s)){alert(`家族名「${s}」は既に存在します。別の名前を入力してください。`),t.value=a;return}const o=ie.find(i=>i.familyName===a);if(o){o.familyName=s,n.dataset.fname=s;let i=!1;le.forEach(d=>{d.familyName===a&&(d.familyName=s,i=!0)}),i&&vn()}}else s||(t.value=a)}}async function al(e){const t=e.target;if(t.dataset.action==="ren-f")return;const n=t.dataset.id,a=t.dataset.f,s=t.closest("[data-fname]").dataset.fname;if(!n||!a)return;const r=await Y.getFamily(s),o=r.members.find(d=>d.id===n),i=t.type==="checkbox"?t.checked:t.value;a.startsWith("data.")?o.data[a.split(".")[1]]=i:o[a]=i,Y.updateFamily(r)}function vn(){yt&&(yt.innerHTML="",le.sort((e,t)=>(e.order??99)-(t.order??99)).forEach(e=>{yt.innerHTML+=`<div class="p-3 border rounded bg-gray-50 flex flex-wrap gap-2 items-center" data-cid="${e.id}"><button data-act="up" class="bg-gray-400 text-white px-2 py-1 text-xs">▲</button><button data-act="down" class="bg-gray-400 text-white px-2 py-1 text-xs">▼</button><input data-f="name" value="${e.name}" class="p-1 border text-sm w-32"><input data-f="familyName" value="${e.familyName}" class="p-1 border text-sm w-32"><input type="number" data-f="baseCapacity" value="${e.baseCapacity}" class="p-1 border text-sm w-16"><button data-act="del" class="bg-red-500 text-white px-2 py-1 rounded text-xs">削</button></div>`}))}function sl(){Y.addCar({id:"c"+Date.now(),name:"新規車",familyName:"",baseCapacity:5,order:99}),vn()}function rl(e){const t=e.target,n=t.dataset.act,a=t.closest("[data-cid]");if(!a)return;const s=a.dataset.cid;if(n==="del"&&(Y.deleteCar(s),vn()),n==="up"||n==="down"){le.sort((i,d)=>(i.order??99)-(d.order??99)),le.forEach((i,d)=>{i.order=d});const r=le.findIndex(i=>i.id===s),o=n==="up"?r-1:r+1;if(o>=0&&o<le.length){const i=le[r].order;le[r].order=le[o].order,le[o].order=i,vn()}}}async function ol(e){const t=e.target,n=t.dataset.f,a=t.closest("[data-cid]").dataset.cid;if(!n)return;const s=await Y.getCar(a);s[n]=t.type==="number"?parseInt(t.value):t.value,Y.updateCar(s)}function Ea(){At.innerHTML="",He.forEach(e=>{At.innerHTML+=`
        ...
        </div>`})}function il(){Y.addParkingMaster({groundName:"",designated:{name:"",limit:0,memo:""},other:{name:"",memo:""}},"新規P"),Ea()}function dl(e){e.target.dataset.act==="del"&&(Y.deleteParkingMaster(e.target.closest("[data-pid]").dataset.pid),Ea())}function ll(e){const t=e.target,n=t.dataset.f,a=t.closest("[data-pid]").dataset.pid;if(!n)return;const s=He.find(o=>o.id===a),r=t.type==="number"?parseInt(t.value):t.value;if(n==="name")s.name=r;else{const o=n.split(".");o.length===2?s[o[0]][o[1]]=r:s[o[0]][o[1]][o[2]]=r}Y.updateParkingMaster(s)}async function cl(){const e={families:ie,cars:le,parking:await Y.getAllSavedParking()},t=document.createElement("a");t.href=URL.createObjectURL(new Blob([JSON.stringify(e)],{type:"application/json"})),t.download="master.json",t.click()}function ul(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{const s=JSON.parse(a.target.result);if(Y.bulkAddFamilies(s.families),Y.bulkAddCars(s.cars),s.parking){He.forEach(r=>Bn.add(r.id)),He=[];for(let r of s.parking)He.push({id:r.id||"p"+Date.now()+Math.floor(Math.random()*1e3),name:r.name,timestamp:r.timestamp||Date.now(),parking:r.parking,isNew:!0})}Zt(),vn(),Ea(),ns("読込完了 (※まだ保存されていません。保存ボタンを押してください)","info")},n.readAsText(t)}function ns(e,t="info"){const n=document.getElementById("master-message");n.className=`p-4 mb-4 border rounded-lg ${t==="error"?"bg-red-100 text-red-700":t==="success"?"bg-green-100 text-green-700":"bg-blue-100 text-blue-700"}`,document.getElementById("master-message-text").innerHTML=e,n.classList.remove("hidden"),Ca&&clearTimeout(Ca),Ca=setTimeout(Nr,5e3)}function Nr(){document.getElementById("master-message").classList.add("hidden")}let $t={type:"",add:[],update:[],delete:[]};function Pr(e,t,n,a,s,r=""){$t={type:e,add:t,update:n,delete:a},document.getElementById("csv-confirm-title").textContent=s,document.getElementById("csv-add-count").textContent=t.length,document.getElementById("csv-update-count").textContent=n.length,document.getElementById("csv-delete-count").textContent=a.length;const o=document.getElementById("csv-confirm-warning");r?(o.innerHTML=r,o.classList.remove("hidden")):o.classList.add("hidden"),document.getElementById("tab-csv-add").onclick=()=>un("add"),document.getElementById("tab-csv-update").onclick=()=>un("update"),document.getElementById("tab-csv-delete").onclick=()=>un("delete"),t.length>0?un("add"):n.length>0?un("update"):un("delete"),document.getElementById("csv-confirm-modal").classList.remove("hidden")}function ca(){document.getElementById("csv-confirm-modal").classList.add("hidden");const e=document.getElementById("input-import-users-csv");e&&(e.value="");const t=document.getElementById("input-import-events-csv");t&&(t.value="")}function un(e){["add","update","delete"].forEach(n=>{const a=document.getElementById(`tab-csv-${n}`);n===e?(a.classList.add("text-blue-600","border-blue-600"),a.classList.remove("text-gray-500","border-transparent")):(a.classList.remove("text-blue-600","border-blue-600"),a.classList.add("text-gray-500","border-transparent"))}),ml(e)}function ml(e){const t=document.getElementById("csv-confirm-content"),n=$t[e];if(!n||n.length===0){t.innerHTML='<p class="text-gray-500 p-4">対象のデータはありません。</p>';return}let a="";if($t.type==="users"){const s=e==="add",r=e==="update";a+=`
...
※上記情報をコピーし、対象のユーザーへお伝えください。`),alert(r),ca(),await oe()}catch(e){console.error(e),alert("保存に失敗しました: "+e.message)}finally{q()}}window.showCSVConfirmModal=Pr;window.closeCSVConfirmModal=ca;window.parseCSV=Or;window.escapeCSV=Es;function yl(){const n=[["メールアドレス","氏名","役割","所属グループ名","ユーザー属性名","配車利用可(1/0)","成績利用可(1/0)","出欠利用可(1/0)","代行入力先(カンマ区切りメールアドレス)","代行専用(1/0)","初期パスワード","削除(1/0)"],["sample_parent@example.com","山田 太郎","一般ユーザー","選手・保護者","A軍","1","1","1","sample_child1@example.com,sample_child2@example.com","0","tempPw123","0"],["sample_child1@example.com","山田 一郎","一般ユーザー","選手・保護者","A軍","1","0","1","","0","tempPw123","0"],["sample_child2@example.com","山田 二郎","一般ユーザー","選手・保護者","A軍","1","0","1","","0","tempPw123","0"],["","代行専用の子ども","一般ユーザー","選手・保護者","A軍","0","0","1","","1","","0"]].map(r=>r.map(Es).join(",")).join(`
`),a=new Blob([new Uint8Array([239,187,191]),n],{type:"text/csv;charset=utf-8;"}),s=document.createElement("a");s.href=URL.createObjectURL(a),s.download="members_sample.csv",s.click()}const hl=Object.freeze(Object.defineProperty({__proto__:null,get csvImportState(){return $t},get currentUser(){return F},get currentUserRole(){return he},forceHideLoading:Ue,goToUsersAdmin:Tr,hideLoading:q,logAction:ae,openChangePasswordModal:hs,showLoading:j,supabaseClient:S,switchAuthScreen:Q,withLoading:ve},Symbol.toStringTag,{value:"Module"}));
